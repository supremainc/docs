...
95199: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_17_monitoring_monitoring_door_status_in_airfob_pro_mdx_10e_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-17-monitoring-monitoring-door-status-in-airfob-pro-mdx-10e.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_17_monitoring_monitoring_door_status_in_airfob_pro_mdx_10e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-door-status","title":"Monitoring Door Status","description":"Learn how to monitor real-time door status, remotely control locks, and manage door access using both web portal and mobile app in BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/17-monitoring-monitoring-door-status-in-airfob-pro.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-door-status","permalink":"/docs/en/platform/biostar_air/monitoring-door-status","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/17-monitoring-monitoring-door-status-in-airfob-pro.mdx","tags":[],"version":"current","sidebarPosition":17,"frontMatter":{"id":"monitoring-door-status","title":"Monitoring Door Status","description":"Learn how to monitor real-time door status, remotely control locks, and manage door access using both web portal and mobile app in BioStar Air.","keywords":["monitoring","door status","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Event Logs and Audit Logs","permalink":"/docs/en/platform/biostar_air/event-and-audit-logs"},"next":{"title":"Managing Roll Call & Fire Muster","permalink":"/docs/en/platform/biostar_air/managing-roll-call-fire-muster"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/17-monitoring-monitoring-door-status-in-airfob-pro.mdx
