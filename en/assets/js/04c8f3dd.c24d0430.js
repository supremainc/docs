...
var site_docs_platform_biostar_air_managing_door_groups_mdx_04c_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-door-groups","title":"출입문 그룹 관리하기","description":"출입문을 그룹으로 구성하여 출입 통제 정책을 효율적으로 관리합니다. 출입 등급과 권한을 그룹 단위로 할당하여 복잡한 보안 요구사항을 간단하게 구현합니다.","source":"@site/docs/platform/biostar_air/managing-door-groups.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-door-groups","permalink":"/docs/en/platform/biostar_air/managing-door-groups","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-door-groups.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-door-groups","title":"출입문 그룹 관리하기","description":"출입문을 그룹으로 구성하여 출입 통제 정책을 효율적으로 관리합니다. 출입 등급과 권한을 그룹 단위로 할당하여 복잡한 보안 요구사항을 간단하게 구현합니다.","keywords":["출입문 그룹","장치 그룹","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"등록 출입문 관리하기","permalink":"/docs/en/platform/biostar_air/managing-registered-doors"},"next":{"title":"출입문 스케줄 관리하기","permalink":"/docs/en/platform/biostar_air/managing-door-schedules"}}')
