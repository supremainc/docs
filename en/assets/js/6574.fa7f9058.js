"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6574"], {
...
72319: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
/* ESM import */var _chunk_6JRP7KZX_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94280);
/* ESM import */var _chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13674);
/* ESM import */var _chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(70803);
/* ESM import */var _chunk_IIMUDSI4_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(71088);
/* ESM import */var _chunk_VV3M67IP_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(52101);
/* ESM import */var _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(91105);
/* ESM import */var _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(41029);
/* ESM import */var _chunk_H2D2JQ3I_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17897);
/* ESM import */var _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(97832);
/* ESM import */var _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(42901);
/* ESM import */var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(85587);
/* ESM import */var d3__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(27818);
/* ESM import */var khroma__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(73265);
/* ESM import */var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(13328);
...
var FlowDB = class {
  ...
  sanitizeText(txt) {
    return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default.sanitizeText */.SY.sanitizeText(txt, this.config);
  }
  /**
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("abc78 Got edge...", edge);
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("addLink", _start, _end, id);
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default.runFunc */.w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default.formatUrl */.w8.formatUrl(linkStr, this.config);
  ...
  addSubGraph(_id, list, _title) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  defaultConfig() {
    return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .defaultConfig2.flowchart */.Fy.flowchart;
  }
};
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)(async function(text, id, _version, diag) {
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("REF0:");
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("Drawing state diagram (v2)", id);
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Data: ", data4Layout);
  ...
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.warn */.cM.warn(
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("REF1:", data4Layout);
  await (0,_chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */.sY)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default.insertTitle */.w8.insertTitle(
    svg,
    "flowchartTitleText",
