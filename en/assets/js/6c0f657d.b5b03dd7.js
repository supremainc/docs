...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_monitoring_event_and_audit_logs_mdx_6c0_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-event-and-audit-logs","title":"Use Event and Audit Logs","description":"This guide explains how to monitor and analyze event and audit logs in BioStar Air, apply filters, export data, and track administrative activity.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/monitoring-event-and-audit-logs.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-event-and-audit-logs","permalink":"/docs/en/platform/biostar_air/monitoring-event-and-audit-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring-event-and-audit-logs.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-event-and-audit-logs","title":"Use Event and Audit Logs","description":"This guide explains how to monitor and analyze event and audit logs in BioStar Air, apply filters, export data, and track administrative activity.","keywords":["Monitoring","Event Logs","Audit Logs","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Monitoring","permalink":"/docs/en/platform/biostar_air/monitoring"},"next":{"title":"Check Alert & Report History","permalink":"/docs/en/platform/biostar_air/monitoring-alert-report-history"}}')
...
const frontMatter = {
	...
	title: 'Use Event and Audit Logs',
