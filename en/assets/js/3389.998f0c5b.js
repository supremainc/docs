"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["3389"], {
49235: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var constant = __webpack_require__(96498);
...
var map = __webpack_require__(97345);
...
var toFinite = __webpack_require__(29116);
...
var graphlib = __webpack_require__(50043);
...
var merge = __webpack_require__(41777);
...
var _overRest = __webpack_require__(89647);
// EXTERNAL MODULE: ./node_modules/lodash-es/_setToString.js + 2 modules
var _setToString = __webpack_require__(89186);
...
var _baseExtremum = __webpack_require__(91201);
...
var lodash_es_last = __webpack_require__(59685);
...
var _root = __webpack_require__(52434);
...
function buildLayerMatrix(g) {
  var layering = map/* default */.Z(range(util_maxRank(g) + 1), function () {
    return [];
  });
  forEach/* default */.Z(g.nodes(), function (v) {
    var node = g.node(v);
...
var _baseLt = __webpack_require__(23278);
...
var _baseKeys = __webpack_require__(22769);
...
var graphlib_graph = __webpack_require__(61135);
...
function nesting_graph_run(g) {
  ...
  var height = lodash_es_max(lodash_es_values/* default */.Z(depths)) - 1; // Note: depths is an Object not an array
...
var _baseClone = __webpack_require__(16124);
...
var _baseMap = __webpack_require__(10301);
 ...
 */
var sortBy_sortBy = (0,_baseRest/* default */.Z)(function(collection, iteratees) {
  if (collection == null) {
    return [];
  }
...
function initOrder(g) {
  ...
  var layers = map/* default */.Z(range(maxRank + 1), function () {
    return [];
  });
...
var _castFunction = __webpack_require__(93898);
...
var _baseFor = __webpack_require__(45467);
...
function findType2Conflicts(g, layering) {
  ...
  function scan(south, southPos, southEnd, prevNorthBorder, nextNorthBorder) {
    var v;
    forEach/* default */.Z(range(southPos, southEnd), function (i) {
      v = south[i];
      if (g.node(v).dummy) {
...
function findSmallestWidthAlignment(g, xss) {
  return lodash_es_minBy(lodash_es_values/* default */.Z(xss), function (xs) {
...
function alignCoordinates(xss, alignTo) {
  var alignToVals = lodash_es_values/* default */.Z(alignTo),
  ...
  forEach/* default */.Z(['u', 'd'], function (vert) {
    forEach/* default */.Z(['l', 'r'], function (horiz) {
      ...
      var xsVals = lodash_es_values/* default */.Z(xs);
...
function balance(xss, align) {
  return lodash_es_mapValues(xss.ul, function (ignore, v) {
    if (align) {
      ...
      var xs = sortBy(map/* default */.Z(xss, v));
      return (xs[1] + xs[2]) / 2;
    }
  });
}
...
function positionX(g) {
  ...
  forEach/* default */.Z(['u', 'd'], function (vert) {
    adjustedLayering = vert === 'u' ? layering : lodash_es_values/* default */.Z(layering).reverse();
    forEach/* default */.Z(['l', 'r'], function (horiz) {
      if (horiz === 'r') {
        adjustedLayering = map/* default */.Z(adjustedLayering, function (inner) {
          return lodash_es_values/* default */.Z(inner).reverse();
        });
      }
...
function buildLayoutGraph(inputGraph) {
  ...
  g.setGraph(
    merge/* default */.Z({}, graphDefaults, selectNumberAttrs(graph, graphNumAttrs), pick(graph, graphAttrs)),
  );
  ...
  forEach/* default */.Z(inputGraph.edges(), function (e) {
    ...
    g.setEdge(
      e,
      merge/* default */.Z({}, edgeDefaults, selectNumberAttrs(edge, edgeNumAttrs), pick(edge, edgeAttrs)),
    );
  });
...
61135: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/lodash-es/filter.js
var lodash_es_filter = __webpack_require__(37627);
...
// EXTERNAL MODULE: ./node_modules/lodash-es/values.js + 1 modules
var values = __webpack_require__(96433);
// EXTERNAL MODULE: ./node_modules/lodash-es/reduce.js + 2 modules
var reduce = __webpack_require__(81748);
...
class Graph {
  ...
  sources() {
    var self = this;
    return lodash_es_filter/* default */.Z(this.nodes(), function (v) {
  ...
  inEdges(v, u) {
    ...
    if (inV) {
      ...
      return lodash_es_filter/* default */.Z(edges, function (edge) {
        return edge.v === u;
      });
    }
  }
...
50043: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  k: () => (/* reexport safe */ _graph_js__WEBPACK_IMPORTED_MODULE_0__.k)
});
/* ESM import */var _graph_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61135);
