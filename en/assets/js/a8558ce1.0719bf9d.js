"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["68556"], {
...
43721: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_installation_mdx_a85_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-doorinterface-ul-installation-mdx-a85.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_installation_mdx_a85_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/installation.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/installation","permalink":"/docs/en/device/doorinterface_ul/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","keywords":["Install","Door Interface","Device"],"isTranslationMissing":false},"sidebar":"doorinterface_ul","previous":{"title":"Getting Started","permalink":"/docs/en/device/doorinterface_ul/getting-started"},"next":{"title":"Product Specifications","permalink":"/docs/en/device/doorinterface_ul/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/installation.mdx
