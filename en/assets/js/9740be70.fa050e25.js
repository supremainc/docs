...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_integration_quickstart_mdx_974_namespaceObject = JSON.parse('{"id":"platform/biostar_air/integration-quickstart","title":"Getting Started with API Integrations","description":"Learn how to set up a BioStar Air demo site, register compatible readers, generate API keys, and start testing integrations with cloud APIs.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/integration-quickstart.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/integration-quickstart","permalink":"/en/platform/biostar_air/integration-quickstart","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/integration-quickstart.mdx","tags":[],"version":"current","frontMatter":{"id":"integration-quickstart","title":"Getting Started with API Integrations","description":"Learn how to set up a BioStar Air demo site, register compatible readers, generate API keys, and start testing integrations with cloud APIs.","keywords":["integration","quickstart","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Federated Sites","permalink":"/en/platform/biostar_air/federated-sites"},"next":{"title":"E200 QR Scanner - Wiring and Configuration","permalink":"/en/platform/biostar_air/wiring-and-configuration"}}')
