...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_enclosure_getting_started_mdx_9dd_namespaceObject = JSON.parse('{"id":"device/enclosure/getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/enclosure/getting-started.mdx","sourceDirName":"device/enclosure","slug":"/device/enclosure/getting-started","permalink":"/en/device/enclosure/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/enclosure/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","keywords":["Components","Name","Feature","Cable","Connector"],"isTranslationMissing":false},"sidebar":"enclosure","previous":{"title":"Safety Instructions","permalink":"/en/device/enclosure/safety-instructions"},"next":{"title":"Installation","permalink":"/en/device/enclosure/installation"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      src: "/img/en/device/name-function-each-part-inside-encr.png",
      width: "85%",
      zoomFactor: .4,
      mgWidth: 500,
      mgHeight: 500
