"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["48078"], {
...
86722: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_custom_install_mdx_daa_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-x-custom-install-mdx-daa.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_custom_install_mdx_daa_namespaceObject = JSON.parse('{"id":"platform/biostar_x/custom-install","title":"Custom Installation","description":"This guides the user on how to set up a custom installation to integrate with a database that the user has already installed.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/custom-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/custom-install","permalink":"/en/platform/biostar_x/custom-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/custom-install.mdx","tags":[],"version":"current","frontMatter":{"id":"custom-install","title":"Custom Installation","description":"This guides the user on how to set up a custom installation to integrate with a database that the user has already installed.","keywords":["Custom installation"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Express Installation","permalink":"/en/platform/biostar_x/express-install"},"next":{"title":"Upgrade","permalink":"/en/platform/biostar_x/migration-x"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/custom-install.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["This document provides a step-by-step guide on how to install ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
      }), " using the ", (0,jsx_runtime.jsx)(Cmd, {
        code: "biostar2.install.customInstall",
        className: "bold"
      }), " method. ", (0,jsx_runtime.jsx)(Cmd, {
        code: "biostar2.install.customInstall",
        className: "bold"
      }), " creates a database schema in conjunction with an existing database (MariaDB, MS SQL Server) installed on a local or remote server. Prepare the database and user account to be linked before starting the installation."]
