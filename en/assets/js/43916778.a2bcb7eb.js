"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["65083"], {
18304: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Here are the network settings for the registered device. In the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "device.info.network",
        product: "2"
      }), " section, you can set the device's TCP/IP, RS-485, and server communication network."]
      ...
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["For more information about IP address settings during device registration, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: ["To set the device to use dynamic IP, click the checkbox for the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "device.info.useDhcp",
        product: "2"
      }), " option. The device will automatically receive an IP address from the DHCP server, which may change. In this case, the IP address of the device may change."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "static-ip-settings",
      children: "Static IP settings"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["To set the device's IP address statically, uncheck the checkbox for the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "device.info.useDhcp",
        product: "2"
      }), " option. You can enter the device's network information in the details below."]
      ...
      children: ["In the ", (0,jsx_runtime.jsx)(Cmd, {
        ...
        product: "2"
      }), " group, you can enable or disable the device's wireless LAN settings. Detailed settings are available in the device's user guide."]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            ...
            product: "2"
          }), ": When using the intelligent slave, if an exception occurs such as authentication failure, enter the exception code in decimal (0-18446744073709551615) or hexadecimal (0-FFFFFFFFFFFFFFFF) format to record an accurate log. Hexadecimal can be input using numbers or letters."]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
