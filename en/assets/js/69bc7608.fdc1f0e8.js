"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["7247"], {
...
90617: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_07_user_management_managing_card_templates_in_airfob_pro_mdx_69b_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-07-user-management-managing-card-templates-in-airfob-pro-mdx-69b.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_07_user_management_managing_card_templates_in_airfob_pro_mdx_69b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-card-templates","title":"Managing Card Templates","description":"Learn how to create, customize, and manage mobile card templates with branding elements including logos, colors, and user properties in BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/07-user-management-managing-card-templates-in-airfob-pro.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-card-templates","permalink":"/docs/en/platform/biostar_air/managing-card-templates","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/07-user-management-managing-card-templates-in-airfob-pro.mdx","tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"id":"managing-card-templates","title":"Managing Card Templates","description":"Learn how to create, customize, and manage mobile card templates with branding elements including logos, colors, and user properties in BioStar Air.","keywords":["card templates","BioStar Air","user management"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Managing User Groups","permalink":"/docs/en/platform/biostar_air/managing-user-groups"},"next":{"title":"Managing and Adding Users in the BioStar Air App","permalink":"/docs/en/platform/biostar_air/managing-adding-users"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/07-user-management-managing-card-templates-in-airfob-pro.mdx
