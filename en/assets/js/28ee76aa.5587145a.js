...
var site_docs_platform_biostar_x_enroll_credential_pin_mdx_28e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-pin","title":"PIN 등록하기","description":"사용자가 장치에 비밀번호를 입력해 출입할 수 있도록 비밀번호를 할당하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/enroll-credential-pin.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-pin","permalink":"/docs/en/platform/biostar_x/enroll-credential-pin","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-pin.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-pin","title":"PIN 등록하기","description":"사용자가 장치에 비밀번호를 입력해 출입할 수 있도록 비밀번호를 할당하는 방법을 안내합니다.","keywords":["PIN","등록","크리덴셜","인증","비밀번호"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"QR/Barcode 등록하기","permalink":"/docs/en/platform/biostar_x/enroll-credential-qrbarcode"},"next":{"title":"Setting User Permissions","permalink":"/docs/en/platform/biostar_x/set-permission"}}')
