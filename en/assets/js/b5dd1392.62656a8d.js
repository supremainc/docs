...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_ip_camera_support_and_configuration_mdx_b5d_namespaceObject = JSON.parse('{"id":"platform/biostar_air/ip-camera-support-and-configuration","title":"IP Camera Support and Configuration","description":"Learn how to set up ONVIF-compatible IP cameras, configure live and recorded video streams, and integrate camera footage with access events in BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/ip-camera-support-and-configuration.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/ip-camera-support-and-configuration","permalink":"/en/platform/biostar_air/ip-camera-support-and-configuration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/ip-camera-support-and-configuration.mdx","tags":[],"version":"current","frontMatter":{"id":"ip-camera-support-and-configuration","title":"IP Camera Support and Configuration","description":"Learn how to set up ONVIF-compatible IP cameras, configure live and recorded video streams, and integrate camera footage with access events in BioStar Air.","keywords":["IP Camera","BioStar Air","camera configuration"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"SIP Intercom for BioStation 3","permalink":"/en/platform/biostar_air/sip-intercom-for-biostation3"},"next":{"title":"Troubleshooting for Video Playback","permalink":"/en/platform/biostar_air/video-troubleshooting"}}')
