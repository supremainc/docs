"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["62331"], {
29961: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
function center(node) {
  return node.targetLinks.length ? node.depth
      : node.sourceLinks.length ? min_min(node.sourceLinks, targetDepth) - 1
      : 0;
}
...
function Sankey() {
  ...
  function initializeNodeBreadths(columns) {
    const ky = min_min(columns, c => (y1 - y0 - (c.length - 1) * py) / sum_sum(c, sankey_value));
...
/* ESM default export */ const path = (path_path);
...
/* ESM default export */ function sankeyLinkHorizontal() {
...
var sankeyDiagram_QLVOVGJD_links = [];
var sankeyDiagram_QLVOVGJD_nodes = [];
var nodesMap = /* @__PURE__ */ new Map();
var clear2 = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)(() => {
  sankeyDiagram_QLVOVGJD_links = [];
  sankeyDiagram_QLVOVGJD_nodes = [];
...
var addLink = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)((source, target, value) => {
  sankeyDiagram_QLVOVGJD_links.push(new SankeyLink(source, target, value));
}, "addLink");
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)((ID) => {
  ID = chunk_YTJNT7DU/* .common_default.sanitizeText */.Y2.sanitizeText(ID, (0,chunk_YTJNT7DU/* .getConfig2 */.D7)());
  let node = nodesMap.get(ID);
  if (node === void 0) {
    node = new SankeyNode(ID);
    nodesMap.set(ID, node);
    sankeyDiagram_QLVOVGJD_nodes.push(node);
  }
  return node;
}, "findOrCreateNode");
var getNodes = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)(() => sankeyDiagram_QLVOVGJD_nodes, "getNodes");
var getLinks = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)(() => sankeyDiagram_QLVOVGJD_links, "getLinks");
var getGraph = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)(() => ({
  nodes: sankeyDiagram_QLVOVGJD_nodes.map((node) => ({ id: node.ID })),
  links: sankeyDiagram_QLVOVGJD_links.map((link) => ({
...
var draw = /* @__PURE__ */ (0,chunk_YTJNT7DU/* .__name */.K2)(function(text, id, _version, diagObj) {
  ...
  const defaultSankeyConfig = chunk_YTJNT7DU/* .defaultConfig2.sankey */.ME.sankey;
  let sandboxElement;
