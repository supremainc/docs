"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["374"], {
92581: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ee: () => (styles_default),
  J8: () => (stateDiagram_default),
  _$: () => (stateRenderer_v3_unified_default),
  oI: () => (StateDB)
});
/* ESM import */var _chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13674);
/* ESM import */var _chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70803);
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(async function(text, id, _version, diag) {
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("REF0:");
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Drawing state diagram (v2)", id);
...
var setupDoc = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.trace */.cM.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(item.description, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)()),
...
var dataFetcher = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(itemId, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeTextOrArray */.SY.sanitizeTextOrArray(newNode.description, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)());
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.trace */.cM.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
  ...
  if (parsedItem.doc) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.trace */.cM.trace("Adding nodes children ");
...
var StateDB = class {
  ...
  setRootDoc(o) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Setting root doc", o);
    this.rootDoc = o;
    if (this.version === 1) {
      this.extract(o);
    } else {
  ...
  extract(_doc) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info(doc);
    this.clear(true);
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Extract initial document:", doc);
    doc.forEach((item) => {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.warn */.cM.warn("Statement", item.stmt);
      switch (item.stmt) {
        case STMT_STATE:
          this.addState(
            item.id.trim(),
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes = null, styles = null, textStyles = null) {
    ...
    if (!this.currentDocument.states.has(trimmedId)) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Adding state ", trimmedId, descr);
    ...
    if (descr) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Setting state description", trimmedId, descr);
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(doc2.note.text, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)());
    }
    if (classes) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Setting state classes", trimmedId, classes);
      const classesList = typeof classes === "string" ? [classes] : classes;
      classesList.forEach((cssClass) => this.setCssClass(trimmedId, cssClass.trim()));
    }
    if (styles) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Setting state styles", trimmedId, styles);
  ...
  logDocuments() {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Documents = ", this.documents);
  }
  getRelations() {
  ...
  addRelationObjs(item1, item2, relationTitle) {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(relationTitle, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        title: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(title, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)())
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState.descriptions.push(_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(_descr, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)()));
  }
  cleanupLabel(label) {
...
13674: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  j: () => (setupViewPortForSVG),
  q: () => (getDiagramElement)
});
/* ESM import */var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(85587);
/* ESM import */var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27818);
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */.eW)((svg, padding, cssDiagram, useMaxWidth) => {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log.debug */.cM.debug(`viewBox configured: ${viewBox} with padding: ${padding}`);
}, "setupViewPortForSVG");
