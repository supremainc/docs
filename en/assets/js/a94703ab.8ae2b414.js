"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["16785"], {
71238: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function BackToTopButton() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
        ...
        className: (0,clsx/* ["default"] */.A)('clean-btn', ThemeClassNames/* .ThemeClassNames.common.backToTopButton */.G.common.backToTopButton, styles_module.backToTopButton, shown && styles_module.backToTopButtonShow),
        type: "button",
        onClick: scrollToTop
    });
}
...
var accessibilityUtils = __webpack_require__(11292);
...
var Logo = __webpack_require__(23390);
...
var announcementBar = __webpack_require__(39860);
...
var ExternalLink = __webpack_require__(15380);
;// CONCATENATED MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/DocSidebarItem/Link/styles.module.css
// extracted by css-extract-rspack-plugin
/* ESM default export */ const Link_styles_module = ({"menuExternalLink":"menuExternalLink_NmtK","linkLabel":"linkLabel_WmDU"});
...
function LinkLabel({ label }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
        title: label,
        className: Link_styles_module.linkLabel,
        children: label
    });
}
function DocSidebarItemLink({ item, onItemClick, activePath, level, index, ...props }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemLink */.G.docs.docSidebarItemLink, ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemLinkLevel */.G.docs.docSidebarItemLinkLevel(level), 'menu__list-item', className),
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Link/* ["default"] */.A, {
            ...
            ...props,
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(LinkLabel, {
                    label: label
                }),
...
;// CONCATENATED MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/DocSidebarItem/Category/styles.module.css
// extracted by css-extract-rspack-plugin
/* ESM default export */ const Category_styles_module = ({"categoryLink":"categoryLink_byQd","categoryLinkLabel":"categoryLinkLabel_W154"});
...
function useAutoExpandActiveCategory({ isActive, collapsed, updateCollapsed, activePath }) {
    ...
    const previousActivePath = (0,reactUtils/* .usePrevious */.ZC)(activePath);
    (0,react.useEffect)(()=>{
...
function CategoryLinkLabel({ label }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
        title: label,
        className: Category_styles_module.categoryLinkLabel,
        children: label
    });
}
function DocSidebarItemCategory(props) {
    const visibleChildren = (0,docsUtils/* .useVisibleSidebarItems */.Y)(props.item.items, props.activePath);
    if (visibleChildren.length === 0) {
        return /*#__PURE__*/ (0,jsx_runtime.jsx)(DocSidebarItemCategoryEmpty, {
            ...props
        });
    } else {
        return /*#__PURE__*/ (0,jsx_runtime.jsx)(DocSidebarItemCategoryCollapsible, {
            ...props
        });
    }
}
...
function DocSidebarItemCategoryCollapsible({ item, onItemClick, activePath, level, index, ...props }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("li", {
        className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemCategory */.G.docs.docSidebarItemCategory, ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemCategoryLevel */.G.docs.docSidebarItemCategoryLevel(level), 'menu__list-item', {
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Link/* ["default"] */.A, {
                        className: (0,clsx/* ["default"] */.A)(Category_styles_module.categoryLink, 'menu__link', {
                        ...
                        ...props,
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(CategoryLinkLabel, {
                            label: label
                        })
                    }),
...
function DocSidebarItemHtml({ item, level, index }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemLink */.G.docs.docSidebarItemLink, ThemeClassNames/* .ThemeClassNames.docs.docSidebarItemLinkLevel */.G.docs.docSidebarItemLinkLevel(level), defaultStyle && [
...
function DocSidebarItems_DocSidebarItems({ items, ...props }) {
...
function DocSidebarDesktopContent({ path, sidebar, className }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("nav", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("ul", {
            className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.docs.docSidebarMenu */.G.docs.docSidebarMenu, 'menu__list'),
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(DocSidebarItems, {
                items: sidebar,
                activePath: path,
                level: 1
...
var navbarMobileSidebar = __webpack_require__(95224);
...
function DocRootLayoutSidebar({ sidebar, hiddenSidebarContainer, setHiddenSidebarContainer }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("aside", {
        className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.docs.docSidebarContainer */.G.docs.docSidebarContainer, Sidebar_styles_module.docSidebarContainer, hiddenSidebarContainer && Sidebar_styles_module.docSidebarContainerHidden),
        onTransitionEnd: (e)=>{
...
var Content = __webpack_require__(49452);
...
function DocRoot(props) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(metadataUtils/* .HtmlClassNameProvider */.e3, {
        className: (0,clsx/* ["default"] */.A)(ThemeClassNames/* .ThemeClassNames.page.docsDocPage */.G.page.docsDocPage),
...
49452: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (NotFoundContent)
});
...
/* ESM import */var _theme_Heading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3381);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
