"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["44098"], {
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_access_control_manage_access_group_mdx_2b9_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-access-control-manage-access-group","title":"Manage Access Groups","description":"Set access groups using access levels and user group information.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-access-control-manage-access-group.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-access-control-manage-access-group","permalink":"/en/platform/biostar_x/settings-access-control-manage-access-group","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-access-control-manage-access-group.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-access-control-manage-access-group","title":"Manage Access Groups","description":"Set access groups using access levels and user group information.","keywords":["Access group","Access level","User group"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Manage Access Levels","permalink":"/en/platform/biostar_x/settings-access-control-manage-access-level"},"next":{"title":"Manage Floor Levels","permalink":"/en/platform/biostar_x/settings-access-control-manage-floor-level"}}')
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Set up access levels. For more information about registering access levels, refer to ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Set up floor levels. For more information about the floor levels, refer to ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Set up user groups. For more information about registering user groups, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["If the desired access level is not available, you will need to register a new access level. For more information about registering access levels, refer to ", (0,jsx_runtime.jsx)(_components.a, {
              href: "settings-access-control-manage-access-level",
              children: "the following"
            }), "."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["If the desired floor level is not available, you will need to register a new floor level. For more information about the floor levels, refer to ", (0,jsx_runtime.jsx)(_components.a, {
              href: "settings-access-control-manage-floor-level",
              children: "the following"
            }), "."]
          }), "\n"]
