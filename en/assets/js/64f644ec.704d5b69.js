"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["18534"], {
10297: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_extendedmodule_product_specifications_mdx_64f_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-extendedmodule-product-specifications-mdx-64f.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_extendedmodule_product_specifications_mdx_64f_namespaceObject = JSON.parse('{"id":"device/extendedmodule/product-specifications","title":"Product Specifications","description":"Provides key specifications of the product, including size, features, and performance.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/extendedmodule/product-specifications.mdx","sourceDirName":"device/extendedmodule","slug":"/device/extendedmodule/product-specifications","permalink":"/docs/en/device/extendedmodule/product-specifications","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/extendedmodule/product-specifications.mdx","tags":[],"version":"current","frontMatter":{"id":"product-specifications","title":"Product Specifications","description":"Provides key specifications of the product, including size, features, and performance.","keywords":["General","Interfaces","Dimensions"],"isTranslationMissing":false},"sidebar":"extendedmodule","previous":{"title":"Installation","permalink":"/docs/en/device/extendedmodule/installation"},"next":{"title":"Appendices","permalink":"/docs/en/device/extendedmodule/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/extendedmodule/product-specifications.mdx
