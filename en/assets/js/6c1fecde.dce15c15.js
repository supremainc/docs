...
9454: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_advanced_ac_scheduled_lock_mdx_6c1_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-advanced-ac-scheduled-lock","title":"스케줄 잠금 구역","description":"스케줄 잠금 구역 설정 방법을 안내합니다. 스케줄 잠금 구역은 특정 시간에 출입문을 잠그는 기능을 제공합니다.","source":"@site/docs/platform/biostar_x/settings-advanced-ac-scheduled-lock.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-advanced-ac-scheduled-lock","permalink":"/docs/en/platform/biostar_x/settings-advanced-ac-scheduled-lock","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-advanced-ac-scheduled-lock.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-advanced-ac-scheduled-lock","title":"스케줄 잠금 구역","description":"스케줄 잠금 구역 설정 방법을 안내합니다. 스케줄 잠금 구역은 특정 시간에 출입문을 잠그는 기능을 제공합니다.","keywords":["고급 출입 통제","스케줄 잠금"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"화재 경보 구역","permalink":"/docs/en/platform/biostar_x/settings-advanced-ac-fire-alarm"},"next":{"title":"스케줄 개방 구역","permalink":"/docs/en/platform/biostar_x/settings-advanced-ac-scheduled-unlock"}}')
