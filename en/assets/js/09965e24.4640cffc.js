"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["7720"], {
...
var site_docs_platform_biostar_x_plugins_mdx_099_namespaceObject = JSON.parse('{"id":"platform/biostar_x/plugins","title":"플러그인","description":"BioStar X 플러그인(Plugins)은 BioStar X 플랫폼의 확장 기능으로, 고객의 특별한 요구사항이나 기존 시스템과의 연동을 위해 추가 기능을 제공합니다.","source":"@site/docs/platform/biostar_x/plugins.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/plugins","permalink":"/docs/en/platform/biostar_x/plugins","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/plugins.mdx","tags":[],"version":"current","frontMatter":{"id":"plugins","title":"플러그인","description":"BioStar X 플러그인(Plugins)은 BioStar X 플랫폼의 확장 기능으로, 고객의 특별한 요구사항이나 기존 시스템과의 연동을 위해 추가 기능을 제공합니다.","keywords":["플러그인","BioStar X"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"리모트 액세스 설정하기","permalink":"/docs/en/platform/biostar_x/settings-remote-access"},"next":{"title":"Explore UI","permalink":"/docs/en/platform/biostar_x/ui-overview"}}')
...
const plugins_toc = [..._bsx_what_is_plugins/* .toc */.RM, ...toc, ..._bsx_register_plugin/* .toc */.RM, ..._bsx_manage_plugins/* .toc */.RM];
