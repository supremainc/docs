...
var site_docs_platform_biostar_air_partner_install_guide_mdx_f25_namespaceObject = JSON.parse('{"id":"platform/biostar_air/partner-install-guide","title":"파트너 및 설치 관리자","description":"고객 사이트 생성, 크레딧 분배, 페더레이션 사이트 관리 등 파트너 포털 운영 방법과 SIP 인터폰, IP 카메라, SIO2 모듈 등 하드웨어 설치 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/partner-install-guide.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/partner-install-guide","permalink":"/docs/en/platform/biostar_air/partner-install-guide","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/partner-install-guide.mdx","tags":[],"version":"current","frontMatter":{"id":"partner-install-guide","title":"파트너 및 설치 관리자","description":"고객 사이트 생성, 크레딧 분배, 페더레이션 사이트 관리 등 파트너 포털 운영 방법과 SIP 인터폰, IP 카메라, SIO2 모듈 등 하드웨어 설치 방법을 안내합니다.","keywords":["파트너 포털","AirFob","리셀러"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"리포트 구성하기","permalink":"/docs/en/platform/biostar_air/configuring-reports"},"next":{"title":"파트너 포털 사용하기","permalink":"/docs/en/platform/biostar_air/biostar-air-partner-portal-detailed-use"}}')
