...
var site_docs_device_biostation_3_settings_mdx_ea6_namespaceObject = JSON.parse('{"id":"device/biostation_3/settings","title":"설정","description":"Description","source":"@site/docs/device/biostation_3/settings.mdx","sourceDirName":"device/biostation_3","slug":"/device/biostation_3/settings","permalink":"/docs/en/device/biostation_3/settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3/settings.mdx","tags":[],"version":"current","frontMatter":{"id":"settings","title":"설정","description":"Description","keywords":["keyword1","keyword2"],"isTranslationMissing":true},"sidebar":"bioStation3","previous":{"title":"인증","permalink":"/docs/en/device/biostation_3/authentication"},"next":{"title":"이벤트 로그","permalink":"/docs/en/device/biostation_3/event-log"}}')
