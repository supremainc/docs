"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["54532"], {
43557: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_extendedmodule_sc_product_specifications_mdx_558_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-extendedmodule-sc-product-specifications-mdx-558.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_extendedmodule_sc_product_specifications_mdx_558_namespaceObject = JSON.parse('{"id":"device/extendedmodule_sc/product-specifications","title":"Product Specifications","description":"Provides key specifications of the product, including size, features, and performance.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/extendedmodule_sc/product-specifications.mdx","sourceDirName":"device/extendedmodule_sc","slug":"/device/extendedmodule_sc/product-specifications","permalink":"/docs/en/device/extendedmodule_sc/product-specifications","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/extendedmodule_sc/product-specifications.mdx","tags":[],"version":"current","frontMatter":{"id":"product-specifications","title":"Product Specifications","description":"Provides key specifications of the product, including size, features, and performance.","keywords":["General","Interfaces","Dimensions"],"isTranslationMissing":false},"sidebar":"extendedmodule_sc","previous":{"title":"Installation","permalink":"/docs/en/device/extendedmodule_sc/installation"},"next":{"title":"Appendices","permalink":"/docs/en/device/extendedmodule_sc/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/extendedmodule_sc/product-specifications.mdx
