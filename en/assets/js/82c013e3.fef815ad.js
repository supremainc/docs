...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_videos_rule_mdx_82c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-videos-rule","title":"Set camera rules","description":"Learn how to set camera rules in conjunction with VMS on BioStar X.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-videos-rule.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-videos-rule","permalink":"/docs/en/platform/biostar_x/settings-videos-rule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-videos-rule.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-videos-rule","title":"Set camera rules","description":"Learn how to set camera rules in conjunction with VMS on BioStar X.","keywords":["Camera","Rules","Settings"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Set up the camera","permalink":"/docs/en/platform/biostar_x/settings-videos-camera"},"next":{"title":"Manage Map","permalink":"/docs/en/platform/biostar_x/settings-map-management"}}')
...
const frontMatter = {
	...
	title: 'Set camera rules',
	description: 'Learn how to set camera rules in conjunction with VMS on BioStar X.',
	keywords: [
		'Camera',
		'Rules',
		'Settings'
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "Rules are settings to send events and bookmarks to the VMS server by combining events that occur at the camera and door. Through proper camera rule settings, you can utilize the following security management features."
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["The camera rule feature can be used with additional options in the ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "Advanced"
