"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["35380"], {
24865: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_api_user_management_mdx_435_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-api-user-management-mdx-435.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_api_user_management_mdx_435_namespaceObject = JSON.parse('{"id":"platform/biostar_air/api-user-management","title":"Using the User Management API","description":"This guide explains how to create, update, and deactivate users using the BioStar Air API, outlines the recommended integration scope, and includes Python sample code.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/api-user-management.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/api-user-management","permalink":"/docs/en/platform/biostar_air/api-user-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/api-user-management.mdx","tags":[],"version":"current","frontMatter":{"id":"api-user-management","title":"Using the User Management API","description":"This guide explains how to create, update, and deactivate users using the BioStar Air API, outlines the recommended integration scope, and includes Python sample code.","keywords":["User Management","API","BioStar Air","Python sample code"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"API Authentication","permalink":"/docs/en/platform/biostar_air/api-authentication"},"next":{"title":"Troubleshooting","permalink":"/docs/en/platform/biostar_air/troubleshooting"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/api-user-management.mdx
