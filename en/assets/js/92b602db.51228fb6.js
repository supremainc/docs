"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["3583"], {
6583: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_credential_card_manage_mdx_92b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-credential-card-manage","title":"카드 관리하기","description":"출입 인증을 위한 카드 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-credential-card-manage.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-credential-card-manage","permalink":"/docs/en/platform/biostar_x/settings-credential-card-manage","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-credential-card-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-credential-card-manage","title":"카드 관리하기","description":"출입 인증을 위한 카드 관리 방법을 안내합니다.","keywords":["카드","관리"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"크리덴션 관리하기","permalink":"/docs/en/platform/biostar_x/settings-credential-manage"},"next":{"title":"Wiegand 카드 데이터 형식 변경하기","permalink":"/docs/en/platform/biostar_x/settings-credential-card-change-data-format"}}')
