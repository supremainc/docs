...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_reference_compares_rfid_devices_funcs_mdx_36c_namespaceObject = JSON.parse('{"id":"reference/compares/rfid-devices-funcs","title":"Compare Features","description":"🔶: Support may vary depending on the product model.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/reference/compares/rfid-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/rfid-devices-funcs","permalink":"/en/reference/compares/rfid-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/rfid-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"rfid-devices-funcs","title":"Compare Features","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Compare Specifications","permalink":"/en/reference/compares/face-devices-specs"},"next":{"title":"Compare Specifications","permalink":"/en/reference/compares/rfid-devices-specs"}}')
