...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "The user list displays all registered users, showing their ID, name, email address, usage period, credential status, and state by default. Users are listed in order by their ID."
