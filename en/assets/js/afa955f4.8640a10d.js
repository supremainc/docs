...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_remote_access_mdx_afa_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-remote-access","title":"Set up Remote Access","description":"Learn how to configure remote access using the ngrok service.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-remote-access","permalink":"/docs/en/platform/biostar_x/settings-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-remote-access","title":"Set up Remote Access","description":"Learn how to configure remote access using the ngrok service.","keywords":["Remote Access","ngrok"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Directory Integration Settings","permalink":"/docs/en/platform/biostar_x/settings-diretory-integration"},"next":{"title":"사용자 리모트 액세스 설정하기","permalink":"/docs/en/platform/biostar_x/settings-external-remote-access"}}')
