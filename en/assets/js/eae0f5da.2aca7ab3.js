"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["55369"], {
...
19165: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_regulatory_information_mdx_eae_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-doorinterface-ul-regulatory-information-mdx-eae.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_regulatory_information_mdx_eae_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/regulatory-information","title":"Regulatory Information","description":"Provides information on regulations and certifications complied with by the product.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/regulatory-information.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/regulatory-information","permalink":"/docs/en/device/doorinterface_ul/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Regulatory Information","description":"Provides information on regulations and certifications complied with by the product.","keywords":["Regulatory","FCC"],"isTranslationMissing":false},"sidebar":"doorinterface_ul","previous":{"title":"Product Specifications","permalink":"/docs/en/device/doorinterface_ul/product-specifications"},"next":{"title":"Appendices","permalink":"/docs/en/device/doorinterface_ul/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/regulatory-information.mdx
