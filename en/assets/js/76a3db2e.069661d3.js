"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["75942"], {
...
95592: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_35_suprema_pass_app_location_issues_mdx_76a_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-35-suprema-pass-app-location-issues-mdx-76a.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_35_suprema_pass_app_location_issues_mdx_76a_namespaceObject = JSON.parse('{"id":"platform/biostar_air/location-services-issues","title":"Why Do I Need to Enable Location Services?","description":"Learn how to enable location services in the Suprema Pass app for secure Bluetooth communication and mobile access card functionality.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/35-suprema-pass-app-location-issues.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/location-services-issues","permalink":"/docs/en/platform/biostar_air/location-services-issues","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/35-suprema-pass-app-location-issues.mdx","tags":[],"version":"current","sidebarPosition":35,"frontMatter":{"id":"location-services-issues","title":"Why Do I Need to Enable Location Services?","description":"Learn how to enable location services in the Suprema Pass app for secure Bluetooth communication and mobile access card functionality.","keywords":["location services","Suprema Pass","Bluetooth"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Troubleshooting Adding Users in Bulk","permalink":"/docs/en/platform/biostar_air/troubleshooting-adding-users-in-bulk"},"next":{"title":"Troubleshooting","permalink":"/docs/en/platform/biostar_air/troubleshooting-suprema-pass-app"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/35-suprema-pass-app-location-issues.mdx
