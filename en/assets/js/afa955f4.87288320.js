...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_remote_access_mdx_afa_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-remote-access","title":"Set up Remote Access","description":"This guide explains how to set up remote access via the ngrok service.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-remote-access","permalink":"/en/platform/biostar_x/settings-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-remote-access","title":"Set up Remote Access","description":"This guide explains how to set up remote access via the ngrok service.","keywords":["remote","access","ngrok"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Directory Integration Settings","permalink":"/en/platform/biostar_x/settings-diretory-integration"},"next":{"title":"Integrate Virtual Device Event Log","permalink":"/en/platform/biostar_x/settings-virtual-device-event-log"}}')
