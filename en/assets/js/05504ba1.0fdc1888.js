"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["5561"], {
...
27117: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_14_elevator_management_managing_elevator_access_in_airfob_pro_mdx_055_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-14-elevator-management-managing-elevator-access-in-airfob-pro-mdx-055.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_14_elevator_management_managing_elevator_access_in_airfob_pro_mdx_055_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-elevator-access","title":"Managing Elevator Access","description":"Learn how to configure elevator access control, set floor permissions, and manage user access levels using Suprema\'s OM120 module in BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/14-elevator-management-managing-elevator-access-in-airfob-pro.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-elevator-access","permalink":"/docs/en/platform/biostar_air/managing-elevator-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/14-elevator-management-managing-elevator-access-in-airfob-pro.mdx","tags":[],"version":"current","sidebarPosition":14,"frontMatter":{"id":"managing-elevator-access","title":"Managing Elevator Access","description":"Learn how to configure elevator access control, set floor permissions, and manage user access levels using Suprema\'s OM120 module in BioStar Air.","keywords":["elevator access","BioStar Air","OM120"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Managing Door Schedules","permalink":"/docs/en/platform/biostar_air/managing-door-schedules"},"next":{"title":"Managing Door Access","permalink":"/docs/en/platform/biostar_air/managing-door-access"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/14-elevator-management-managing-elevator-access-in-airfob-pro.mdx
