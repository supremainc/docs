...
var site_docs_platform_biostar_x_enroll_credential_authmode_mdx_c42_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-authmode","title":"인증 모드 설정하기","description":"장치 기본값 또는 개인별 맞춤 인증 모드를 설정하여 사용자마다 다른 인증 방식을 적용하세요.","source":"@site/docs/platform/biostar_x/enroll-credential-authmode.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-authmode","permalink":"/docs/en/platform/biostar_x/enroll-credential-authmode","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-authmode.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-authmode","title":"인증 모드 설정하기","description":"장치 기본값 또는 개인별 맞춤 인증 모드를 설정하여 사용자마다 다른 인증 방식을 적용하세요.","keywords":["인증 모드","설정","개인 인증","확장 인증","장치 기본값"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"보안 수준 설정하기","permalink":"/docs/en/platform/biostar_x/enroll-credential-securitylevel"},"next":{"title":"지문 등록하기","permalink":"/docs/en/platform/biostar_x/enroll-credential-fingerprint"}}')
