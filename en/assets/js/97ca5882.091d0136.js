...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_device_details_advanced_mdx_97c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-details-advanced","title":"Advanced Settings","description":"In the Advanced Settings section, configure Master Administrator, Device Management, Display/Sound, Operating Conditions, and Actions.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-device-details-advanced.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-details-advanced","permalink":"/docs/en/platform/biostar_x/settings-device-details-advanced","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-details-advanced.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-details-advanced","title":"Advanced Settings","description":"In the Advanced Settings section, configure Master Administrator, Device Management, Display/Sound, Operating Conditions, and Actions.","keywords":["Device","advanced"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Authentication Settings","permalink":"/docs/en/platform/biostar_x/settings-device-details-auth"},"next":{"title":"Thermal and Mask Settings","permalink":"/docs/en/platform/biostar_x/settings-device-details-thermal-mask"}}')
