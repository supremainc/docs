"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["9629"], {
...
48167: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_06_user_management_managing_user_groups_mdx_1f6_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-06-user-management-managing-user-groups-mdx-1f6.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_06_user_management_managing_user_groups_mdx_1f6_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-user-groups","title":"Managing User Groups","description":"Learn how to create, organize, and manage user groups and subgroups for efficient user categorization and access control administration in BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/06-user-management-managing-user-groups.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-user-groups","permalink":"/docs/en/platform/biostar_air/managing-user-groups","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/06-user-management-managing-user-groups.mdx","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"id":"managing-user-groups","title":"Managing User Groups","description":"Learn how to create, organize, and manage user groups and subgroups for efficient user categorization and access control administration in BioStar Air.","keywords":["user management","BioStar Air","user groups"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"User Card and Credential Types","permalink":"/docs/en/platform/biostar_air/user-card-types"},"next":{"title":"Managing Card Templates","permalink":"/docs/en/platform/biostar_air/managing-card-templates"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/06-user-management-managing-user-groups.mdx
