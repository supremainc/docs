...
var site_docs_device_biostation_3_admin_menu_mdx_cf2_namespaceObject = JSON.parse('{"id":"device/biostation_3/admin-menu","title":"관리자 메뉴","description":"Description","source":"@site/docs/device/biostation_3/admin-menu.mdx","sourceDirName":"device/biostation_3","slug":"/device/biostation_3/admin-menu","permalink":"/docs/en/device/biostation_3/admin-menu","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3/admin-menu.mdx","tags":[],"version":"current","frontMatter":{"id":"admin-menu","title":"관리자 메뉴","description":"Description","keywords":["대시보드"],"isTranslationMissing":true},"sidebar":"bioStation3","previous":{"title":"사용하기","permalink":"/docs/en/device/biostation_3/using-device"},"next":{"title":"사용자","permalink":"/docs/en/device/biostation_3/user"}}')
