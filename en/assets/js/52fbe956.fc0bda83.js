...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_getting_started_mdx_52f_namespaceObject = JSON.parse('{"id":"device/doorinterface/getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface/getting-started.mdx","sourceDirName":"device/doorinterface","slug":"/device/doorinterface/getting-started","permalink":"/en/device/doorinterface/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","keywords":["Components","Name","Feature","Cable","Connector"],"isTranslationMissing":false},"sidebar":"doorinterface","previous":{"title":"Safety Instructions","permalink":"/en/device/doorinterface/safety-instructions"},"next":{"title":"Installation","permalink":"/en/device/doorinterface/installation"}}')
