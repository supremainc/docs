...
68728: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["You can assign a separate security level to users regardless of the biometric 1", ":N", " security level set on the device. If users frequently fail authentication when the device's 1", ":N", " security level is set high, consider lowering the ", (0,jsx_runtime.jsx)(Cmd, {
