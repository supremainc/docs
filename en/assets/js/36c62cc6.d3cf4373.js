"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["68338"], {
99214: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_reference_compares_rfid_devices_funcs_mdx_36c_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-reference-compares-rfid-devices-funcs-mdx-36c.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_reference_compares_rfid_devices_funcs_mdx_36c_namespaceObject = JSON.parse('{"id":"reference/compares/rfid-devices-funcs","title":"Compare Features","description":"🔶: Support may vary depending on the product model.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/reference/compares/rfid-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/rfid-devices-funcs","permalink":"/docs/en/reference/compares/rfid-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/rfid-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"rfid-devices-funcs","title":"Compare Features","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Compare Specifications","permalink":"/docs/en/reference/compares/face-devices-specs"},"next":{"title":"Compare Specifications","permalink":"/docs/en/reference/compares/rfid-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/reference/compares/rfid-devices-funcs.mdx
...
const contentTitle = 'Compare RFID Devices Features';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "compare-rfid-devices-features",
        children: "Compare RFID Devices Features"
      })
