"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["4220"], {
...
55208: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
...
/* ESM import */var _chunk_IIMUDSI4_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(71088);
/* ESM import */var _chunk_VV3M67IP_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52101);
/* ESM import */var _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91105);
/* ESM import */var _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(41029);
/* ESM import */var _chunk_H2D2JQ3I_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17897);
/* ESM import */var _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(97832);
/* ESM import */var _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(42901);
/* ESM import */var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(85587);
/* ESM import */var d3__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(27818);
/* ESM import */var khroma__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(73265);
/* ESM import */var khroma__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(13328);
...
var ErDB = class {
  ...
  addEntity(name, alias = "") {
    if (!this.entities.has(name)) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info("Added new entity :", name);
    } else if (!this.entities.get(name)?.alias && alias) {
      this.entities.get(name).alias = alias;
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info(`Add alias '${alias}' to entity '${name}'`);
    }
  ...
  addAttributes(entityName, attribs) {
    ...
    for (i = attribs.length - 1; i >= 0; i--) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.debug */.cM.debug("Added attribute ", attribs[i].name);
    }
  }
  /**
   * Add a relationship
  ...
  addRelationship(entA, rolA, entB, rSpec) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.debug */.cM.debug("Added new relationship :", rel);
  }
  getRelationships() {
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */.eW)(async function(text, id, _version, diag) {
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info("REF0:");
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info("Drawing er diagram (unified)", id);
  ...
  const padding = 8;
  _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_8__/* .utils_default.insertTitle */.w8.insertTitle(
    svg,
    "erDiagramTitleText",
