...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_tna_settings_mdx_a80_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-settings","title":"Set Time & Attendance","description":"You can register devices to use for attendance management or set the sender information to be used when sending notification emails.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/tna-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-settings","permalink":"/en/platform/biostar_x/tna-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-settings","title":"Set Time & Attendance","description":"You can register devices to use for attendance management or set the sender information to be used when sending notification emails.","keywords":["T&A (Time and Attendance)","Settings"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Edit T&A Report","permalink":"/en/platform/biostar_x/tna-report-edit"},"next":{"title":"Manage Visitors","permalink":"/en/platform/biostar_x/visitor"}}')
