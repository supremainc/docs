"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["68103"], {
94970: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var QuadrantBuilder = class {
  ...
  getDefaultConfig() {
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.chartWidth || 500,
      chartWidth: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.chartHeight || 500,
      titlePadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.titlePadding || 10,
      titleFontSize: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.titleFontSize || 20,
      quadrantPadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.quadrantPadding || 5,
      xAxisLabelPadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.xAxisLabelPadding || 5,
      yAxisLabelPadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.yAxisLabelPadding || 5,
      xAxisLabelFontSize: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.xAxisLabelFontSize || 16,
      yAxisLabelFontSize: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.yAxisLabelFontSize || 16,
      quadrantLabelFontSize: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.quadrantLabelFontSize || 16,
      quadrantTextTopPadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.quadrantTextTopPadding || 5,
      pointTextPadding: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.pointTextPadding || 5,
      pointLabelFontSize: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.pointLabelFontSize || 12,
      pointRadius: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.pointRadius || 5,
      xAxisPosition: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.xAxisPosition || "top",
      yAxisPosition: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.yAxisPosition || "left",
      quadrantInternalBorderStrokeWidth: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
      quadrantExternalBorderStrokeWidth: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default.quadrantChart */.UI.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
    };
  }
  ...
  clear() {
    ...
    this.data = this.getDefaultData();
    this.classes = /* @__PURE__ */ new Map();
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log.info */.Rm.info("clear called");
  }
  setData(data) {
  ...
  setConfig(config2) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log.trace */.Rm.trace("setConfig called with: ", config2);
    this.config = { ...this.config, ...config2 };
  }
  setThemeConfig(themeConfig) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log.trace */.Rm.trace("setThemeConfig called with: ", themeConfig);
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */.K2)((txt, id, _version, diagObj) => {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log.debug */.Rm.debug("Rendering quadrant chart\n" + txt);
