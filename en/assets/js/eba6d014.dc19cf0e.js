"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["13441"], {
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_manage_server_mdx_eba_namespaceObject = JSON.parse('{"id":"platform/biostar_x/manage-server","title":"Start and Stop Server","description":"Learn how to start and stop services of the BioStar X server using BioStar X Service Manager.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/manage-server.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/manage-server","permalink":"/en/platform/biostar_x/manage-server","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/manage-server.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-server","title":"Start and Stop Server","description":"Learn how to start and stop services of the BioStar X server using BioStar X Service Manager.","keywords":["BioStar X setting","Server Management"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Server Management","permalink":"/en/platform/biostar_x/server-management"},"next":{"title":"Service Settings","permalink":"/en/platform/biostar_x/service-settings"}}')
