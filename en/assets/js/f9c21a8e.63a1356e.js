...
6368: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_monitoring_device_mdx_f9c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/monitoring-device","title":"Monitoring Device","description":"Monitor devices and cameras connected to all areas and doors in real time. Efficient management is possible through various features, including checking the status of devices and cameras, viewing detailed information, and playing camera video.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/monitoring-device.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/monitoring-device","permalink":"/docs/en/platform/biostar_x/monitoring-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/monitoring-device.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-device","title":"Monitoring Device","description":"Monitor devices and cameras connected to all areas and doors in real time. Efficient management is possible through various features, including checking the status of devices and cameras, viewing detailed information, and playing camera video.","keywords":["Monitoring","Device","Camera"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Monitoring Map","permalink":"/docs/en/platform/biostar_x/monitoring-map"},"next":{"title":"Monitoring Video","permalink":"/docs/en/platform/biostar_x/monitoring-video"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["You can access the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "arena.title"
      }), " page by clicking on ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "arena.title"
      }), " from the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "shell.header.launcher"
      }), " page or selecting ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "arena.title"
      }), " from the shortcut list in the upper left corner of the screen."]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "The video tiles are added sequentially from the upper left of the screen. An error message will appear if there is no space to add more video on the current screen."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
