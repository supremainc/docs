...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_server_https_mdx_7d8_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-server-https","title":"Install HTTPS Certificate","description":"In order to connect BioStar X through HTTPS, it is necessary to register the IP address where BioStar X is installed and install the certificate.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-server-https.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-server-https","permalink":"/docs/en/platform/biostar_x/settings-server-https","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-server-https.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-server-https","title":"Install HTTPS Certificate","description":"In order to connect BioStar X through HTTPS, it is necessary to register the IP address where BioStar X is installed and install the certificate.","keywords":["HTTPS","Certificate"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Server Detailed Settings","permalink":"/docs/en/platform/biostar_x/settings-server-server"},"next":{"title":"Activate License","permalink":"/docs/en/platform/biostar_x/settings-license"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["To connect BioStar X via HTTPS, you must register the IP address where ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
