"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["9129"], {
6745: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_server_https_mdx_7d8_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-server-https","title":"HTTPS","description":"In order to connect BioStar X through HTTPS, it is necessary to register the IP address where BioStar X is installed and install the certificate.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-server-https.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-server-https","permalink":"/docs/en/platform/biostar_x/settings-server-https","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-server-https.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-server-https","title":"HTTPS","description":"In order to connect BioStar X through HTTPS, it is necessary to register the IP address where BioStar X is installed and install the certificate.","keywords":["HTTPS","Certificate"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Server Detailed Settings","permalink":"/docs/en/platform/biostar_x/settings-server-server"},"next":{"title":"라이선스 활성화하기","permalink":"/docs/en/platform/biostar_x/settings-license"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "In order to connect BioStar X through HTTPS, it is necessary to register the IP address where BioStar X is installed and install the certificate. For correct network connection, install the certificate before using BioStar X."
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Enter the IP address of the PC where BioStar X is installed and click ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Enrollment"
          }), "."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["When you restart the web browser and enter the registered IP address, ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Secure"
          }), " will appear on the address bar of the web browser."]
        }), "\n"]
      }), "\n"]
    })]
  });
