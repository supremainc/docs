...
var site_docs_platform_biostar_x_settings_credential_card_change_data_format_mdx_168_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-credential-card-change-data-format","title":"Wiegand 카드 데이터 형식 변경하기","description":"사용 중인 Wiegand 카드 데이터 형식을 한 번에 변경하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-credential-card-change-data-format.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-credential-card-change-data-format","permalink":"/docs/en/platform/biostar_x/settings-credential-card-change-data-format","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-credential-card-change-data-format.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-credential-card-change-data-format","title":"Wiegand 카드 데이터 형식 변경하기","description":"사용 중인 Wiegand 카드 데이터 형식을 한 번에 변경하는 방법을 안내합니다.","keywords":["카드","데이터","형식"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"카드 관리하기","permalink":"/docs/en/platform/biostar_x/settings-credential-card-manage"},"next":{"title":"CSN Mobile Card Deletion Management Guidelines","permalink":"/docs/en/platform/biostar_x/settings-credential-card-csn-mobile"}}')
