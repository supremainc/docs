...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_dashboard_adding_widget_mdx_d2b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/dashboard-adding-widget","title":"Adding Widgets","description":"Add widgets to the dashboard to view the information you want.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/dashboard-adding-widget.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/dashboard-adding-widget","permalink":"/docs/en/platform/biostar_x/dashboard-adding-widget","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/dashboard-adding-widget.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-adding-widget","title":"Adding Widgets","description":"Add widgets to the dashboard to view the information you want.","keywords":["DASHBOARD","Widget"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"DASHBOARD","permalink":"/docs/en/platform/biostar_x/how-to-guide-dashboard"},"next":{"title":"Edit Widget","permalink":"/docs/en/platform/biostar_x/dashboard-edit-widget"}}')
