...
var site_docs_platform_biostar_air_configuring_ta_mdx_5b7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-ta","title":"근태 관리(T&A) 구성하기","description":"BioStar Air에서 근태 관리 설정을 구성하는 방법, 모바일 근태 관리 추적을 활성화하는 방법, 장치에 근태 관리를 할당하는 방법, 근태 기록을 내보내는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/configuring-ta.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-ta","permalink":"/docs/en/platform/biostar_air/configuring-ta","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/configuring-ta.mdx","tags":[],"version":"current","frontMatter":{"id":"configuring-ta","title":"근태 관리(T&A) 구성하기","description":"BioStar Air에서 근태 관리 설정을 구성하는 방법, 모바일 근태 관리 추적을 활성화하는 방법, 장치에 근태 관리를 할당하는 방법, 근태 기록을 내보내는 방법을 안내합니다.","keywords":["T&A","근태","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"커스텀 Wiegand 카드 형식 구성하기","permalink":"/docs/en/platform/biostar_air/custom-wiegand-card-formats"},"next":{"title":"근태 보고서 구성하기","permalink":"/docs/en/platform/biostar_air/reports-time-attendance-reports"}}')
