...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_manage_door_group_mdx_10e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-manage-door-group","title":"Manage Door Group","description":"This guide describes how to set up groups to easily manage multiple doors.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-manage-door-group.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-manage-door-group","permalink":"/en/platform/biostar_x/settings-manage-door-group","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-manage-door-group.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-manage-door-group","title":"Manage Door Group","description":"This guide describes how to set up groups to easily manage multiple doors.","keywords":["Door","Group"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Manage Doors","permalink":"/en/platform/biostar_x/settings-manage-door"},"next":{"title":"Register Door","permalink":"/en/platform/biostar_x/settings-door-add"}}')
