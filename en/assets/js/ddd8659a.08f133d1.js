"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["59463"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_add_sub_db_mdx_ddd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ add_sub_db_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-x-add-sub-db-mdx-ddd.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_add_sub_db_mdx_ddd_namespaceObject = JSON.parse('{"id":"platform/biostar_x/add-sub-db","title":"Add Auxiliary Database","description":"When adding a communication server, add and connect an auxiliary database to reduce the load on the main server.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/add-sub-db.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/add-sub-db","permalink":"/docs/en/platform/biostar_x/add-sub-db","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/add-sub-db.mdx","tags":[],"version":"current","frontMatter":{"id":"add-sub-db","title":"Add Auxiliary Database","description":"When adding a communication server, add and connect an auxiliary database to reduce the load on the main server.","keywords":["Database","Add","Connect"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Change the Database","permalink":"/docs/en/platform/biostar_x/change-db"},"next":{"title":"IP 주소 변경하기","permalink":"/docs/en/platform/biostar_x/change-ip-address"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common/_bsx-sub-db-create-table-query-mariadb.mdx
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common/_bsx-sub-db-create-table-query-mssql.mdx
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/add-sub-db.mdx
...
const add_sub_db_toc = [{
  ...
  "value": "IP address communication settings",
  "id": "ip-address-communication-settings",
  "level": 3
}, {
  "value": "Add auxiliary database",
  "id": "add-sub-db",
  "level": 2
}, {
  "value": "MariaDB",
  ...
  "value": "Auxiliary database",
  "id": "auxiliary-database",
  "level": 4
}, {
  "value": "Check for FederatedX usage",
  "id": "check-for-federatedx-usage",
  "level": 4
}, {
  "value": "Register server alias",
  "id": "register-server-alias",
  "level": 4
}, {
  "value": "Table link settings",
  "id": "table-link-settings",
  "level": 4
}, ...toc, {
  "value": "Service Manager settings",
  ...
  "value": "Grant permissions for the main database",
  "id": "grant-permissions-for-the-main-database",
  "level": 4
}, {
  "value": "Grant permissions for the auxiliary database",
  "id": "grant-permissions-for-the-auxiliary-database",
  "level": 4
}, {
  "value": "Service Manager settings",
  "id": "service-manager-settings-1",
  "level": 4
}, {
  "value": "Generate Linked Temp Table query",
  "id": "generate-linked-temp-table-query",
  "level": 4
}, ..._bsx_sub_db_create_table_query_mssql_toc, {
  "value": "Execute query in the auxiliary database.",
  "id": "execute-query-in-the-auxiliary-database",
  "level": 4
}];
function add_sub_db_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "When adding a communication server, add and connect an auxiliary database to reduce the load on the main server."
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["You need a ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "multi-communication server"
            }), " license to add an auxiliary database. For more information on licensing policy, refer to ", (0,jsx_runtime.jsx)(_components.a, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["For more information on installing a communication server, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "If you are using a domain or hostname instead of an IP address for communication between databases in a MariaDB environment, be sure to check the following guidance."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["If you do not use an IP address, ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "If you are communicating using a domain or hostname, ensure that user and permissions are registered for localhost."
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["If you installed BioStar X using the convenient installation method, the root account is registered only for localhost, so you must add the server's IP address or ", (0,jsx_runtime.jsx)(_components.em, {
            children: "127.0.0.1"
          }), "."]
        }), "\n"]
      }), "\n"]
      ...
      id: "registration-method",
      children: "Registration method"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Check if a password is set for the account with Host ", (0,jsx_runtime.jsx)(_components.em, {
        children: "127.0.0.1"
      }), " and User root; if not set, be sure to establish a password and grant permissions."]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: "If blank, the password is not set, so be sure to run the query in the following items to add a password and grant permissions."
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Set a password and grant permissions for the account with Host ", (0,jsx_runtime.jsx)(_components.em, {
            children: "127.0.0.1"
          }), " and User root."]
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      id: "ip-address-communication-settings",
      children: "IP address communication settings"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "The following settings can force communication via IP address."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["After installing ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "BioStar X"
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Open the ", (0,jsx_runtime.jsx)(_components.em, {
            children: "my.cnf"
          }), " file with the owner's permissions and add the ", (0,jsx_runtime.jsx)(_components.code, {
            children: "skip-name-resolve"
          }), " option to the [mysqld] section."]
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "Restart the MariaDB service."
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "add-sub-db",
      children: "Add auxiliary database"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "This section provides guidance on adding an auxiliary database. Depending on the type of database being used, there are two methods: MariaDB and SQL Server."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "mariadb",
      children: "MariaDB"
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "main-database",
          children: "Main database"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Grant the account and permissions to access the main database from the new auxiliary database."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "auxiliary-database",
          children: "Auxiliary database"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Grant the account and permissions to access the new auxiliary database from the main database."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "check-for-federatedx-usage",
          children: "Check for FederatedX usage"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Run the command below in both the main and auxiliary databases to check if the FederatedX storage engine is enabled."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: ["If the query result shows ", (0,jsx_runtime.jsx)(_components.code, {
            children: "Engine : FEDERATED, Support : YES"
          }), ", it is already installed. If the FederatedX storage engine is not installed, execute the query below."]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: (0,jsx_runtime.jsxs)(_components.p, {
            children: ["Check if the ", (0,jsx_runtime.jsx)(_components.em, {
              children: "ha_federatedx.dll"
            }), " file exists in the ", (0,jsx_runtime.jsx)(_components.em, {
              children: "lib/plugin"
            }), " folder under the path where MariaDB is installed. Typically, the dll file exists at ", (0,jsx_runtime.jsx)(_components.em, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "register-server-alias",
          children: "Register server alias"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Register a server alias to allow the federatedX table created in the auxiliary database to access the source table in the main database."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: ["If you need to change information about Host, Port, DB, User, or Password for the existing registered server name, it can be modified using the ", (0,jsx_runtime.jsx)(_components.code, {
            children: "Alter"
          }), " statement. You may also change certain information only."]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "table-link-settings",
          children: "Table link settings"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Follow the steps below to link the necessary tables in the auxiliary database to the tables in the main database."
        }), (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["The following is the query to generate ", (0,jsx_runtime.jsx)(_components.code, {
                children: "CREATE TABLE"
              }), " statements in the main database."]
            }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-sql",
              ...
              type: "info",
              children: (0,jsx_runtime.jsxs)(_components.p, {
                children: ["Due to the nature of FederatedX, it is recommended to set ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "Table_type"
                }), " to 'BASE TABLE'. ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "VIEW type"
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["Be sure to input the ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "CREATE"
                }), " statement generated by the above query into the auxiliary database."]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "service-manager-settings",
          children: "Service Manager settings"
        }), (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Enter each item in the database addition screen."
            }), "\n", (0,jsx_runtime.jsx)(Image, {
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
                ...
                children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                  children: [(0,jsx_runtime.jsx)(Cmd, {
                    ...
                    children: "TA"
                  }), ": Enter the name, user, and password of the AC, TA databases."]
                }), "\n"]
              }), "\n"]
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Click Test Connection at the top right of the screen to check if the database is connected normally."
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Click Save at the top right of the screen to save settings."
            }), "\n"]
          }), "\n"]
        })]
      })]
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "grant-permissions-for-the-main-database",
          children: "Grant permissions for the main database"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Grant the following permissions on the main database with an account that has sysadmin privileges."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "grant-permissions-for-the-auxiliary-database",
          children: "Grant permissions for the auxiliary database"
        }), (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["Connect User Mapping for tables and users in the auxiliary database with an account that has sysadmin privileges. At this time, adding the ", (0,jsx_runtime.jsx)(_components.code, {
                children: "db_owner"
              }), " role is necessary."]
            }), "\n", (0,jsx_runtime.jsx)(Image, {
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Grant the following permissions to the database to be added."
            }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "After completing the settings, Linked Server settings for both main and auxiliary databases will be automatically applied."
              }), "\n"]
            }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "Even when modifying database information, the Linked Server settings will be automatically changed. When modifying the main database, the changes will reflect in the Linked Server settings of all registered auxiliary databases. When modifying the auxiliary database, only changes for the main database and that auxiliary database will be reflected."
              }), "\n"]
            }), "\n"]
          })
        })]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "generate-linked-temp-table-query",
          children: "Generate Linked Temp Table query"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "Run the query below in the main database to generate the Linked Temp Table query to be created in the auxiliary database."
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: (0,jsx_runtime.jsxs)(_components.admonition, {
            type: "info",
            children: [(0,jsx_runtime.jsxs)(_components.p, {
              children: ["This is an example of a ", (0,jsx_runtime.jsx)(_components.code, {
                children: "CREATE"
              }), " statement generated by the above query."]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "execute-query-in-the-auxiliary-database",
          children: "Execute query in the auxiliary database."
        }), (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Copy the previously generated ", (0,jsx_runtime.jsx)(_components.code, {
            children: "CREATE SYNONYM"
          }), " query in full. Connect to the auxiliary database server to be added, write the query as below, and execute it. It will be stored in Synonyms in the AC schema of the auxiliary database."]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
