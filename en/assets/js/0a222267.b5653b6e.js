"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["25600"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_doormodule_getting_started_mdx_0a2_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-doormodule-getting-started-mdx-0a2.json
var site_docs_device_doormodule_getting_started_mdx_0a2_namespaceObject = JSON.parse('{"id":"device/doormodule/getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","source":"@site/docs/device/doormodule/getting-started.mdx","sourceDirName":"device/doormodule","slug":"/device/doormodule/getting-started","permalink":"/docs/en/device/doormodule/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doormodule/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","keywords":["구성품","명칭","기능","케이블","커넥터"],"isTranslationMissing":true},"sidebar":"doormodule","previous":{"title":"안전을 위한 주의 사항","permalink":"/docs/en/device/doormodule/safety-instructions"},"next":{"title":"설치하기","permalink":"/docs/en/device/doormodule/installation"}}')
...
;// CONCATENATED MODULE: ./docs/device/doormodule/getting-started.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "Supervised Input을 사용할 때 아래 LED 상태를 참고하세요."
      ...
      children: "이 제품은 다양한 입출력과 Wiegand 연결을 지원하며, 슈프리마 장치와 타사 장치를 연동하여 확장성을 높일 수 있습니다."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Supervised Input도 사용할 수 있으며 Supervised Input은 단락, 합선, On, Off 상태를 확인할 수 있습니다."
