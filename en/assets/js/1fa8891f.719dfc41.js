...
var site_docs_platform_biostar_x_change_port_mdx_1fa_namespaceObject = JSON.parse('{"id":"platform/biostar_x/change-port","title":"포트 변경하기","description":"BioStar X의 기본 포트(443)를 사용할 수 없을 때 포트를 변경하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/change-port.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/change-port","permalink":"/docs/en/platform/biostar_x/change-port","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/change-port.mdx","tags":[],"version":"current","frontMatter":{"id":"change-port","title":"포트 변경하기","description":"BioStar X의 기본 포트(443)를 사용할 수 없을 때 포트를 변경하는 방법을 안내합니다.","keywords":["BioStar X Setting","포트"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"서버 관리하기","permalink":"/docs/en/platform/biostar_x/manage-server"},"next":{"title":"데이터베이스 변경하기","permalink":"/docs/en/platform/biostar_x/change-db"}}')
