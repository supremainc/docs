...
var site_docs_platform_biostar_x_settings_system_audit_trail_mdx_ae9_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-system-audit-trail","title":"감사 추적 관리하기","description":"감사 추적은 사용자의 접속 정보뿐만 아니라 시스템에서 변경되는 모든 정보를 모두 추적합니다. 각 항목에 대한 필터를 설정하여 정렬할 수도 있습니다.","source":"@site/docs/platform/biostar_x/settings-system-audit-trail.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-system-audit-trail","permalink":"/docs/en/platform/biostar_x/settings-system-audit-trail","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-system-audit-trail.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-system-audit-trail","title":"감사 추적 관리하기","description":"감사 추적은 사용자의 접속 정보뿐만 아니라 시스템에서 변경되는 모든 정보를 모두 추적합니다. 각 항목에 대한 필터를 설정하여 정렬할 수도 있습니다.","keywords":["keyword1","keyword2"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"시스템 설정하기","permalink":"/docs/en/platform/biostar_x/settings-system"},"next":{"title":"시스템 백업 및 복원하기","permalink":"/docs/en/platform/biostar_x/settings-system-system-backup-restore"}}')
