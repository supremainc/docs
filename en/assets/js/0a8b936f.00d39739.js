"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["68441"], {
...
40976: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_xpass_d_2_installation_mdx_0a8_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-xpass-d-2-installation-mdx-0a8.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_xpass_d_2_installation_mdx_0a8_namespaceObject = JSON.parse('{"id":"device/xpass_d2/installation","title":"Installation","description":"Provides the complete installation procedures and connection examples required for the device.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/xpass_d2/installation.mdx","sourceDirName":"device/xpass_d2","slug":"/device/xpass_d2/installation","permalink":"/docs/en/device/xpass_d2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xpass_d2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Installation","description":"Provides the complete installation procedures and connection examples required for the device.","keywords":["Bracket","Power","Network","Input","Relay","Standalone","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xpassd2","previous":{"title":"Getting Started","permalink":"/docs/en/device/xpass_d2/getting-started"},"next":{"title":"Product Specifications","permalink":"/docs/en/device/xpass_d2/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/xpass_d2/installation.mdx
...
const toc = [{
  ...
  "value": "Wiegand and other cable connections",
  "id": "wiegand-and-other-cable-connections",
  "level": 2
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "This document explains the installation method based on the million type. Install the gang box type and keypad type in the same way."
      })
      ...
      children: "This product can be used as an RFID card or mobile card reader by connecting to a master device or CoreStation."
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      id: "wiegand-and-other-cable-connections",
      children: "Wiegand and other cable connections"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
