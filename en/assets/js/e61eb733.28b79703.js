...
48038: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function getting_started_createMdxContent(props) {
  ...
  if (!Column) getting_started_missingMdxReference("Column", true);
  if (!Columns) getting_started_missingMdxReference("Columns", true);
