"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["87435"], {
24550: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* ESM default export */ const lodash_es_uniqueId = (uniqueId);
...
var map = __webpack_require__(26506);
...
/* ESM default export */ const _baseRange = (baseRange);
...
var toFinite = __webpack_require__(40338);
...
/* ESM default export */ const _createRange = (createRange);
 ...
 * // => []
 */
var range_range = _createRange();

/* ESM default export */ const range = (range_range);

// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(48481);
...
var merge = __webpack_require__(28788);
...
/* ESM default export */ const _flatRest = (flatRest);
...
var _baseExtremum = __webpack_require__(45255);
...
/* ESM default export */ const _baseGt = (baseGt);
...
/* ESM default export */ const lodash_es_max = (max_max);

// EXTERNAL MODULE: ./node_modules/lodash-es/last.js
var lodash_es_last = __webpack_require__(98242);
...
var now_now = function() {
  return _root/* ["default"].Date.now */.A.Date.now();
};

/* ESM default export */ const now = (now_now);
...
function buildLayerMatrix(g) {
  var layering = map/* ["default"] */.A(range(util_maxRank(g) + 1), function () {
    return [];
  });
  forEach/* ["default"] */.A(g.nodes(), function (v) {
    var node = g.node(v);
...
var _baseLt = __webpack_require__(22488);
...
/* ESM default export */ const lodash_es_minBy = (minBy);
...
var _baseKeys = __webpack_require__(14293);
...
/* ESM default export */ const _asciiSize = (asciiSize);
...
/* ESM default export */ const _hasUnicode = (hasUnicode);
...
/* ESM default export */ const _unicodeSize = (unicodeSize);
...
/* ESM default export */ const _stringSize = (stringSize);
...
/* ESM default export */ const lodash_es_size = (size_size);
...
var graphlib_graph = __webpack_require__(10622);
...
function nesting_graph_run(g) {
  ...
  var height = lodash_es_max(lodash_es_values/* ["default"] */.A(depths)) - 1; // Note: depths is an Object not an array
...
var _baseClone = __webpack_require__(47262);
...
/* ESM default export */ const cloneDeep = (cloneDeep_cloneDeep);
...
/* ESM default export */ const _baseZipObject = (baseZipObject);
...
/* ESM default export */ const zipObject = (zipObject_zipObject);
...
var _baseMap = __webpack_require__(48704);
...
/* ESM default export */ const _baseSortBy = (baseSortBy);
...
/* ESM default export */ const _compareAscending = (compareAscending);
...
/* ESM default export */ const _compareMultiple = (compareMultiple);
...
/* ESM default export */ const _baseOrderBy = (baseOrderBy);
 ...
 */
var sortBy_sortBy = (0,_baseRest/* ["default"] */.A)(function(collection, iteratees) {
  if (collection == null) {
    return [];
  }
...
function initOrder(g) {
  ...
  var layers = map/* ["default"] */.A(range(maxRank + 1), function () {
    return [];
  });
...
function order_order(g) {
  var maxRank = util_maxRank(g),
    downLayerGraphs = buildLayerGraphs(g, range(1, maxRank + 1), 'inEdges'),
    upLayerGraphs = buildLayerGraphs(g, range(maxRank - 1, -1, -1), 'outEdges');
...
var _castFunction = __webpack_require__(30157);
...
/* ESM default export */ const lodash_es_forOwn = (forOwn);
...
/* ESM default export */ const lodash_es_forIn = (forIn);
...
function findType2Conflicts(g, layering) {
  ...
  function scan(south, southPos, southEnd, prevNorthBorder, nextNorthBorder) {
    var v;
    forEach/* ["default"] */.A(range(southPos, southEnd), function (i) {
      v = south[i];
      if (g.node(v).dummy) {
...
function findSmallestWidthAlignment(g, xss) {
  return lodash_es_minBy(lodash_es_values/* ["default"] */.A(xss), function (xs) {
...
function alignCoordinates(xss, alignTo) {
  var alignToVals = lodash_es_values/* ["default"] */.A(alignTo),
  ...
  forEach/* ["default"] */.A(['u', 'd'], function (vert) {
    forEach/* ["default"] */.A(['l', 'r'], function (horiz) {
      ...
      var xsVals = lodash_es_values/* ["default"] */.A(xs);
...
function balance(xss, align) {
  return lodash_es_mapValues(xss.ul, function (ignore, v) {
    if (align) {
      ...
      var xs = sortBy(map/* ["default"] */.A(xss, v));
      return (xs[1] + xs[2]) / 2;
    }
  });
}
...
function positionX(g) {
  ...
  forEach/* ["default"] */.A(['u', 'd'], function (vert) {
    adjustedLayering = vert === 'u' ? layering : lodash_es_values/* ["default"] */.A(layering).reverse();
    forEach/* ["default"] */.A(['l', 'r'], function (horiz) {
      if (horiz === 'r') {
        adjustedLayering = map/* ["default"] */.A(adjustedLayering, function (inner) {
          return lodash_es_values/* ["default"] */.A(inner).reverse();
        });
      }
...
function runLayout(g, time) {
  ...
  time('    rank', () => rank_rank(asNonCompoundGraph(g)));
...
function buildLayoutGraph(inputGraph) {
  ...
  g.setGraph(
    merge/* ["default"] */.A({}, graphDefaults, selectNumberAttrs(graph, graphNumAttrs), pick(graph, graphAttrs)),
  );
  ...
  forEach/* ["default"] */.A(inputGraph.edges(), function (e) {
    ...
    g.setEdge(
      e,
      merge/* ["default"] */.A({}, edgeDefaults, selectNumberAttrs(edge, edgeNumAttrs), pick(edge, edgeAttrs)),
    );
  });
...
function selectNumberAttrs(obj, attrs) {
  return lodash_es_mapValues(pick(obj, attrs), Number);
}
...
10622: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/lodash-es/filter.js
var lodash_es_filter = __webpack_require__(56756);
...
/* ESM default export */ const lodash_es_union = (union);

// EXTERNAL MODULE: ./node_modules/lodash-es/values.js + 1 modules
var values = __webpack_require__(91940);
// EXTERNAL MODULE: ./node_modules/lodash-es/reduce.js + 2 modules
var reduce = __webpack_require__(12003);
...
class Graph {
  ...
  sources() {
    var self = this;
    return lodash_es_filter/* ["default"] */.A(this.nodes(), function (v) {
  ...
  inEdges(v, u) {
    ...
    if (inV) {
      ...
      return lodash_es_filter/* ["default"] */.A(edges, function (edge) {
        return edge.v === u;
      });
    }
  }
...
48481: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  T: () => (/* reexport safe */ _graph_js__WEBPACK_IMPORTED_MODULE_0__.T)
});
/* ESM import */var _graph_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10622);
