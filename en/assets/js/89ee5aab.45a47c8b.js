"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["2656"], {
88371: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["Check the contents of the security warning message and click ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmd, {
            code: "biostar2.install.ok",
            className: "bold"
          }), "."]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Image, {
...
59770: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_express_install_mdx_89e_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-x-express-install-mdx-89e.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_express_install_mdx_89e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/express-install","title":"Express Installation","description":"This guide provides steps to quickly install BioStar X by automatically creating the embedded MariaDB server and database.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/express-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/express-install","permalink":"/docs/en/platform/biostar_x/express-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/express-install.mdx","tags":[],"version":"current","frontMatter":{"id":"express-install","title":"Express Installation","description":"This guide provides steps to quickly install BioStar X by automatically creating the embedded MariaDB server and database.","keywords":["Express installation"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Check network priority","permalink":"/docs/en/platform/biostar_x/check-ethernet"},"next":{"title":"Custom Installation","permalink":"/docs/en/platform/biostar_x/custom-install"}}')
...
var _biostar_install_steps = __webpack_require__(88371);
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/express-install.mdx
...
const toc = [..._biostar_install_steps/* .toc */.RM, ..._install_note/* .toc */.RM];
function _createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["This procedure guides you step-by-step to install ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
      }), " using ", (0,jsx_runtime.jsx)(Cmd, {
        code: "biostar2.install.expressInstall",
        className: "bold"
      }), ". ", (0,jsx_runtime.jsx)(Cmd, {
        code: "biostar2.install.expressInstall",
        className: "bold"
      }), " automatically installs the embedded MariaDB server and creates the database, allowing for quick installation without separate database configuration."]
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["To proceed with ", (0,jsx_runtime.jsx)(Cmd, {
          code: "biostar2.install.customInstall",
          className: "bold"
        }), " to connect with an already installed database, refer to ", (0,jsx_runtime.jsx)(_components.a, {
          href: "custom-install",
          children: "the following"
        }), "."]
      })
