...
var site_docs_platform_biostar_air_site_additional_settings_mdx_884_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-additional-settings","title":"추가 기능 설정하기","description":"QR 코드 리더기, IP 카메라 연동, 웹훅 등 BioStar Air의 확장 기능을 활성화하고 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/site-additional-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-additional-settings","permalink":"/docs/en/platform/biostar_air/site-additional-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-additional-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-additional-settings","title":"추가 기능 설정하기","description":"QR 코드 리더기, IP 카메라 연동, 웹훅 등 BioStar Air의 확장 기능을 활성화하고 구성하는 방법을 안내합니다.","keywords":["사이트 추가 설정","추가 설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"보안 설정하기","permalink":"/docs/en/platform/biostar_air/site-security-settings"},"next":{"title":"관리자 계정 및 역할 관리하기","permalink":"/docs/en/platform/biostar_air/managing-administrators"}}')
