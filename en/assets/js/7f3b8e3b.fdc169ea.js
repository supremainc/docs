"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["9825"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_02_user_management_managing_users_in_airfob_pro_mdx_7f3_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-02-user-management-managing-users-in-airfob-pro-mdx-7f3.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_02_user_management_managing_users_in_airfob_pro_mdx_7f3_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-users","title":"Managing Users","description":"Learn how to manage users, configure access permissions, and perform bulk operations in the BioStar Air Portal for comprehensive user administration.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/02-user-management-managing-users-in-airfob-pro.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-users","permalink":"/docs/en/platform/biostar_air/managing-users","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/02-user-management-managing-users-in-airfob-pro.mdx","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"id":"managing-users","title":"Managing Users","description":"Learn how to manage users, configure access permissions, and perform bulk operations in the BioStar Air Portal for comprehensive user administration.","keywords":["user management","BioStar Air","user groups","access levels"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"BioStar Air Login","permalink":"/docs/en/platform/biostar_air/biostar-air-login"},"next":{"title":"Adding Individual Users","permalink":"/docs/en/platform/biostar_air/adding-individual-users"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/02-user-management-managing-users-in-airfob-pro.mdx
