"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["23075"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doormodule_installation_mdx_da7_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-doormodule-installation-mdx-da7.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doormodule_installation_mdx_da7_namespaceObject = JSON.parse('{"id":"device/doormodule/installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/doormodule/installation.mdx","sourceDirName":"device/doormodule","slug":"/device/doormodule/installation","permalink":"/docs/en/device/doormodule/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doormodule/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","keywords":["Install","Door Interface","Device"],"isTranslationMissing":false},"sidebar":"doormodule","previous":{"title":"Getting Started","permalink":"/docs/en/device/doormodule/getting-started"},"next":{"title":"Product Specifications","permalink":"/docs/en/device/doormodule/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/doormodule/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "Secure the product tightly using spacers and fixing screws at the position where the product will be mounted."
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "You can connect up to 31 card readers with the product, and up to 7 biometric devices can be connected in combination with 24 card readers."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
