"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["89194"], {
8132: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_device_info_settings_mdx_59b_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ device_info_settings_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-device-info-settings-mdx-59b.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_device_info_settings_mdx_59b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/device-info-settings","title":"Device Information and Configuration Options","description":"This page describes the information available for each device model on the BioStar Air portal and explains the configuration options for network, authentication, and time and attendance management.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/device-info-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/device-info-settings","permalink":"/docs/en/platform/biostar_air/device-info-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/device-info-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"device-info-settings","title":"Device Information and Configuration Options","description":"This page describes the information available for each device model on the BioStar Air portal and explains the configuration options for network, authentication, and time and attendance management.","keywords":["Device Information","Configuration Options","BioStar Air"],"toc_max_heading_level":2,"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Manage Registered Devices","permalink":"/docs/en/platform/biostar_air/managing-registered-devices"},"next":{"title":"Manage Device Groups","permalink":"/docs/en/platform/biostar_air/manage-device-group"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common/_bsair-device-info-settings.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h3, {
      ...
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Action"
      }), " feature lets you control the device's functions."]
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/device-info-settings.mdx
