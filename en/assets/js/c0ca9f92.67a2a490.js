"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["76803"], {
...
65425: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_outputmodule_installation_mdx_c0c_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-outputmodule-installation-mdx-c0c.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_outputmodule_installation_mdx_c0c_namespaceObject = JSON.parse('{"id":"device/outputmodule/installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/outputmodule/installation.mdx","sourceDirName":"device/outputmodule","slug":"/device/outputmodule/installation","permalink":"/docs/en/device/outputmodule/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/outputmodule/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","keywords":["Install","Power","RS-485","Relay","AUX","Enclosure","Tamper"],"isTranslationMissing":false},"sidebar":"outputmodule","previous":{"title":"Getting Started","permalink":"/docs/en/device/outputmodule/getting-started"},"next":{"title":"Product Specifications","permalink":"/docs/en/device/outputmodule/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/outputmodule/installation.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "The method for connecting the relay may vary depending on the type of elevator. For more details, contact the elevator construction company."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "Each relay output must be correctly connected to the control panel and floor buttons."
          }), "\n"]
        }), "\n"]
      })
