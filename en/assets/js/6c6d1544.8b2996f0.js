...
var site_docs_device_vionyx_webserver_ui_navigation_mdx_6c6_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/ui-navigation","title":"사용자 인터페이스 이해하기","description":"ViOnyx Web Server의 웹 인터페이스 구조, 왼쪽 메인 메뉴, 오른쪽 정보 및 도구를 안내합니다.","source":"@site/docs/device/vionyx_webserver/ui-navigation.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/ui-navigation","permalink":"/docs/en/device/vionyx_webserver/ui-navigation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/ui-navigation.mdx","tags":[],"version":"current","frontMatter":{"id":"ui-navigation","title":"사용자 인터페이스 이해하기","description":"ViOnyx Web Server의 웹 인터페이스 구조, 왼쪽 메인 메뉴, 오른쪽 정보 및 도구를 안내합니다.","keywords":["UI","메뉴","네비게이션","인터페이스"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"시작하기","permalink":"/docs/en/device/vionyx_webserver/getting-started"},"next":{"title":"라이브 영상 보기","permalink":"/docs/en/device/vionyx_webserver/live-basic"}}')
