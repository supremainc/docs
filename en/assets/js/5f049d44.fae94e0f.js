"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["56554"], {
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_check_door_status_mdx_5f0_namespaceObject = JSON.parse('{"id":"platform/biostar_x/check-door-status","title":"Check Door Status","description":"You can monitor the status of the entrance door in real-time to operate the security system reliably. You can also check the abnormal status of the device assigned to the entrance door.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/check-door-status.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/check-door-status","permalink":"/docs/en/platform/biostar_x/check-door-status","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/check-door-status.mdx","tags":[],"version":"current","frontMatter":{"id":"check-door-status","title":"Check Door Status","description":"You can monitor the status of the entrance door in real-time to operate the security system reliably. You can also check the abnormal status of the device assigned to the entrance door.","keywords":["Monitoring","Doors"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Monitor Doors","permalink":"/docs/en/platform/biostar_x/monitoring-door"},"next":{"title":"Door Control","permalink":"/docs/en/platform/biostar_x/control-door"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["You can monitor the status of the entrance door in real-time to operate the security system reliably. Check the abnormal status of the device assigned to the entrance door at a glance through the status icon provided in ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "shell.header.arena"
      }), " and respond immediately when a problem occurs."]
      ...
      children: ["Click ", (0,jsx_runtime.jsx)(Cmd, {
        ...
        sid: "shell.header.arena"
      }), " from the shortcut list at the top left of the screen. You can check the status of each entrance door in the ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "arena.tree.door.title"
      }), " tab located in the left sidebar of the screen."]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["For more information on advanced access control settings, refer to ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.thead, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: "Displays device abnormal statuses such as disconnection, communication server errors, and synchronization errors."
            })]
            ...
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: "Displays the status when entrance door alarms (forced door opening, prolonged door opening, APB, fire alarms, emergency openings) or AI video analysis alarms (loitering detection, intrusion detection, etc.) occur."
            })]
          })]
        })]
      })
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["You can connect the entrance door and the camera in video rules to set alarms. For more information on video rule settings, refer to ", (0,jsx_runtime.jsx)(_components.a, {
              href: "settings-videos-rule",
              children: "the following"
            }), "."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["When linked with the VMS server, AI event alarms for videos can be sent to ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "BioStar X"
            }), ". For more information, refer to the manual for the VMS server."]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.thead, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: "The entrance door is locked."
            })]
          }), (0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              style: {
      ...
      children: "You can check the security status of the entrance door or advanced access control settings."
    }), "\n", (0,jsx_runtime.jsx)("div", {
      className: "col2--20-80 overflow-x",
      children: (0,jsx_runtime.jsxs)(_components.table, {
        children: [(0,jsx_runtime.jsx)(_components.thead, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: "This is the icon for inactive settings. Inactive settings do not generate alarms."
            })]
          }), (0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              style: {
      ...
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["The security status is displayed only when the entrance door is set to ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "guard"
        }), ". For more information on security settings, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "You can check the floor access control status via the elevator."
    }), "\n", (0,jsx_runtime.jsx)("div", {
      className: "col2--20-80 overflow-x",
      children: (0,jsx_runtime.jsxs)(_components.table, {
        children: [(0,jsx_runtime.jsx)(_components.thead, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: "The corresponding floor is locked via the elevator."
            })]
          }), (0,jsx_runtime.jsxs)(_components.tr, {
            children: [(0,jsx_runtime.jsx)(_components.td, {
              style: {
              ...
              children: "The corresponding floor is unlocked via the elevator."
            })]
          })]
        })]
      })
