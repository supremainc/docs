"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["36334"], {
...
39422: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_28_device_management_configuring_the_airfob_patch_and_tag_mdx_0ec_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-platform-biostar-air-28-device-management-configuring-the-airfob-patch-and-tag-mdx-0ec.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_28_device_management_configuring_the_airfob_patch_and_tag_mdx_0ec_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-the-airfob-patch-and-tag","title":"Configuring the Airfob Patch and Tag","description":"Learn how to configure Airfob Patch and Tag devices, set up BLE mode, and customize card ID output methods for upgrading existing access control systems to BioStar Air.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/28-device-management-configuring-the-airfob-patch-and-tag.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-the-airfob-patch-and-tag","permalink":"/en/platform/biostar_air/configuring-the-airfob-patch-and-tag","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/28-device-management-configuring-the-airfob-patch-and-tag.mdx","tags":[],"version":"current","sidebarPosition":28,"frontMatter":{"id":"configuring-the-airfob-patch-and-tag","title":"Configuring the Airfob Patch and Tag","description":"Learn how to configure Airfob Patch and Tag devices, set up BLE mode, and customize card ID output methods for upgrading existing access control systems to BioStar Air.","keywords":["Airfob","Patch","Tag","configuration"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Configuring Time & Attendance (T&A)","permalink":"/en/platform/biostar_air/configuring-ta"},"next":{"title":"Configuring the SIO2 Secure Module","permalink":"/en/platform/biostar_air/configuring-the-sio2-secure-module"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/28-device-management-configuring-the-airfob-patch-and-tag.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "By following these steps, you can ensure that your Airfob Patch and Tag devices are properly configured to meet your specific access control needs."
    })]
  });
}
function MDXContent(props = {}) {
