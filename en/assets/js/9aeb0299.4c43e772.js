...
var site_docs_platform_biostar_2_custom_install_mdx_9ae_namespaceObject = JSON.parse('{"id":"platform/biostar2/custom-install","title":"사용자 정의 설치하기","description":"사용자가 이미지 설치한 데이터베이스와 연동하기 위한 사용자 정의 설치 방식을 안내합니다.","source":"@site/docs/platform/biostar2/custom-install.mdx","sourceDirName":"platform/biostar2","slug":"/platform/biostar2/custom-install","permalink":"/docs/en/platform/biostar2/custom-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar2/custom-install.mdx","tags":[],"version":"current","frontMatter":{"id":"custom-install","title":"사용자 정의 설치하기","description":"사용자가 이미지 설치한 데이터베이스와 연동하기 위한 사용자 정의 설치 방식을 안내합니다.","keywords":["사용자 정의 설치"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"간편 설치하기","permalink":"/docs/en/platform/biostar2/express-install"},"next":{"title":"로그인하기","permalink":"/docs/en/platform/biostar2/login"}}')
