"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["44873"], {
18661: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: "Before running the face migration feature, check the following items."
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["It is a feature that generates two types of face templates from user images already stored on the BioStar X server. To synchronize only the template for facial authentication during user synchronization, proceed with ", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: [(0,jsx_runtime.jsx)("summary", {
        ...
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "BioStar X"
        }), " optimized synchronization performance by changing to send only templates when synchronizing the user's face to the device. Therefore, support for the FaceStation F2 v1.x.x firmware, which can only extract templates from the device, will be discontinued. If you are currently using FaceStation F2 firmware version 1.x.x, upgrade to the latest firmware to use ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "BioStar X"
        }), " with FaceStation F2."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            ...
            children: ["Before proceeding with ", (0,jsx_runtime.jsx)(Cmd, {
              sid: "team.menu.faceMigration"
            }), ", if you synchronize by adding BioStation 3 or BioEntry W3 to an environment that only used FaceStation F2, the template type will differ, and the NPU type template will be extracted from the image, which may take considerable time depending on the number of faces enrolled on the server."]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: (0,jsx_runtime.jsx)(_components.strong, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Check the contents of the warning popup and click ", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["After a successful migration, sync the user information to the device to apply the changes. For more information about how to send user information to the device, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["For more information about how to save only the template without saving the user's facial image to the server, refer to ", (0,jsx_runtime.jsx)(_components.a, {
