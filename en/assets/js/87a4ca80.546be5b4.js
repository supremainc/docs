...
const toc = [{
  ...
  "id": "확장-브래킷",
  "level": 3
}, ..._device_power_connection/* .toc */.RM, ..._device_network_connection/* .toc */.RM, ..._device_door_sensor_connection/* .toc */.RM, ..._device_relay_connection/* .toc */.RM, ..._device_standalone_connection/* .toc */.RM, ..._device_secure_io2_connection/* .toc */.RM, ..._device_wiegand_connection/* .toc */.RM, ..._device_reset_network_settings/* .toc */.RM, ..._device_factory_reset/* .toc */.RM];
function _createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    h2: "h2",
