"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["2917"], {
80100: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_device_manage_device_users_mdx_c73_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-manage-device-users","title":"Manage Users Enrolled on Device","description":"This document provides guidance on managing users enrolled in the device.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-device-manage-device-users.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-manage-device-users","permalink":"/docs/en/platform/biostar_x/settings-device-manage-device-users","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-manage-device-users.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-manage-device-users","title":"Manage Users Enrolled on Device","description":"This document provides guidance on managing users enrolled in the device.","keywords":["Device","User"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Register Slave","permalink":"/docs/en/platform/biostar_x/settings-adding-slave-device"},"next":{"title":"Upgrade Firmware","permalink":"/docs/en/platform/biostar_x/settings-device-upgrade-firmware"}}')
...
const frontMatter = {
	...
	title: 'Manage Users Enrolled on Device',
	description: 'This document provides guidance on managing users enrolled in the device.',
	keywords: [
		'Device',
		'User'
	],
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["You can check the number of users, fingerprints, faces, and cards enrolled on the device. Information about users not registered on ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "user.syncStatus.same",
            product: "2"
          }), ": User not registered on the ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "BioStar X"
          }), " server"]
        }), "\n"]
      }), "\n"]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["For more information about the device's settings, refer to the ", (0,jsx_runtime.jsx)(_components.a, {
