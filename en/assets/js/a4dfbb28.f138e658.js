...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), " feature lets users adjust the Bluetooth detection sensitivity between their mobile device and the Airfob (Airfob). This feature helps ensure smooth authentication and reduces unauthorized access attempts and authentication failures."]
