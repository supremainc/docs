"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["58923"], {
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_access_control_manage_access_level_mdx_cf0_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-access-control-manage-access-level","title":"Manage Access Levels","description":"Set the time periods during which a user may access a door and register them as an access level.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-access-control-manage-access-level.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-access-control-manage-access-level","permalink":"/en/platform/biostar_x/settings-access-control-manage-access-level","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-access-control-manage-access-level.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-access-control-manage-access-level","title":"Manage Access Levels","description":"Set the time periods during which a user may access a door and register them as an access level.","keywords":["Access level"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Access Control Settings","permalink":"/en/platform/biostar_x/settings-access-control"},"next":{"title":"Manage Access Groups","permalink":"/en/platform/biostar_x/settings-access-control-manage-access-group"}}')
...
const frontMatter = {
	...
	description: 'Set the time periods during which a user may access a door and register them as an access level.',
	keywords: [
		'Access level'
	],
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["You can predefine time to apply to access levels through schedule settings. For more information about schedule settings, refer to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      id: "addAccessLevel",
      children: "Register access level"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Click ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "button.apply",
            product: "2"
          }), " at the bottom of the screen to register the access level."]
        }), "\n"]
      }), "\n"]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "Up to 128 access levels can be registered per access group."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["If the desired door is not available, you need to register a new door. For more information about door enrollment, refer to ", (0,jsx_runtime.jsx)(_components.a, {
              href: "settings-door-add",
              children: "the following"
            }), "."]
          }), "\n"]
