...
var site_docs_device_vionyx_webserver_live_basic_mdx_a4a_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/live-basic","title":"라이브 영상 보기","description":"VyOnyx Web Server의 Live 메뉴에서 실시간으로 카메라 영상을 확인하고, 채널과 뷰 모드를 선택하고, 화면을 확대/축소하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/live-basic.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/live-basic","permalink":"/docs/en/device/vionyx_webserver/live-basic","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/live-basic.mdx","tags":[],"version":"current","frontMatter":{"id":"live-basic","title":"라이브 영상 보기","description":"VyOnyx Web Server의 Live 메뉴에서 실시간으로 카메라 영상을 확인하고, 채널과 뷰 모드를 선택하고, 화면을 확대/축소하는 방법을 안내합니다.","keywords":["실시간","영상","Live","모니터링","뷰 모드"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"사용자 인터페이스 이해하기","permalink":"/docs/en/device/vionyx_webserver/ui-navigation"},"next":{"title":"AI 이벤트 및 규칙 설정하기","permalink":"/docs/en/device/vionyx_webserver/configure-ai-events-and-rules"}}')
