"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["67493"], {
...
91537: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_getting_started_mdx_13f_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-device-doorinterface-ul-getting-started-mdx-13f.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_device_doorinterface_ul_getting_started_mdx_13f_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/getting-started.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/getting-started","permalink":"/docs/en/device/doorinterface_ul/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","keywords":["Components","Name","Feature","Cable","Connector"],"isTranslationMissing":false},"sidebar":"doorinterface_ul","previous":{"title":"Safety Instructions","permalink":"/docs/en/device/doorinterface_ul/safety-instructions"},"next":{"title":"Installation","permalink":"/docs/en/device/doorinterface_ul/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/device/doorinterface_ul/getting-started.mdx
