...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_add_sub_db_mdx_ddd_namespaceObject = JSON.parse('{"id":"platform/biostar_x/add-sub-db","title":"Add Auxiliary Database","description":"When adding a communication server, add and connect an auxiliary database to reduce the load on the main server.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/add-sub-db.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/add-sub-db","permalink":"/en/platform/biostar_x/add-sub-db","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/add-sub-db.mdx","tags":[],"version":"current","frontMatter":{"id":"add-sub-db","title":"Add Auxiliary Database","description":"When adding a communication server, add and connect an auxiliary database to reduce the load on the main server.","keywords":["Database","Add","Connect"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Change the Database","permalink":"/en/platform/biostar_x/change-db"},"next":{"title":"Launcher","permalink":"/en/platform/biostar_x/ui-launcher"}}')
