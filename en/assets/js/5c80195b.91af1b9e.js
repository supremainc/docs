"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["7337"], {
...
var site_docs_platform_biostar_x_settings_videos_mdx_5c8_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-videos","title":"비디오 설정하기","description":"BioStar X와 VMS를 연동하여 통합 영상 보안 관리 시스템을 구축하는 방법을 단계별로 안내합니다. VMS 서버 연동부터 카메라 설정, 규칙 구성까지 전체 과정을 다룹니다.","source":"@site/docs/platform/biostar_x/settings-videos.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-videos","permalink":"/docs/en/platform/biostar_x/settings-videos","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-videos.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-videos","title":"비디오 설정하기","description":"BioStar X와 VMS를 연동하여 통합 영상 보안 관리 시스템을 구축하는 방법을 단계별로 안내합니다. VMS 서버 연동부터 카메라 설정, 규칙 구성까지 전체 과정을 다룹니다.","keywords":["비디오","VMS","연동","카메라","설정","규칙"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"Occupancy limit zone","permalink":"/docs/en/platform/biostar_x/settings-advanced-ac-occupancy"},"next":{"title":"VMS 연동하기","permalink":"/docs/en/platform/biostar_x/settings-video-integration"}}')
