...
var site_docs_platform_biostar_x_change_ip_mdx_9c8_namespaceObject = JSON.parse('{"id":"platform/biostar_x/change-ip","title":"메인 서버의 IP 주소 변경하기","description":"BioStar X 메인 서버 설치 후 IP 주소를 변경하는 방법을 안내합니다. Windows 서버 IP 변경부터 BioStar X Service Manager를 통한 적용, 커뮤니케이션 서버 설정까지 전체 절차를 포함합니다.","source":"@site/docs/platform/biostar_x/change-ip.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/change-ip","permalink":"/docs/en/platform/biostar_x/change-ip","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/change-ip.mdx","tags":[],"version":"current","frontMatter":{"id":"change-ip","title":"메인 서버의 IP 주소 변경하기","description":"BioStar X 메인 서버 설치 후 IP 주소를 변경하는 방법을 안내합니다. Windows 서버 IP 변경부터 BioStar X Service Manager를 통한 적용, 커뮤니케이션 서버 설정까지 전체 절차를 포함합니다.","keywords":["IP 주소 변경","BioStar X Service Manager","메인 서버","커뮤니케이션 서버"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"Service Settings","permalink":"/docs/en/platform/biostar_x/service-settings"},"next":{"title":"Change the Port","permalink":"/docs/en/platform/biostar_x/change-port"}}')
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["IP 주소를 변경하지 않고 웹 브라우저 창을 닫으려면 ", (0,jsx_runtime.jsx)(Cmd, {
              children: "Leave"
            }), " 버튼을 클릭하세요."]
          }), "\n"]
        }), "\n"]
