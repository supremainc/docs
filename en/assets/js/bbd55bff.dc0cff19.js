"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6988"], {
...
13847: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_xstation_2_installation_mdx_bbd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-xstation-2-installation-mdx-bbd.json
var site_docs_device_xstation_2_installation_mdx_bbd_namespaceObject = JSON.parse('{"id":"device/xstation_2/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/xstation_2/installation.mdx","sourceDirName":"device/xstation_2","slug":"/device/xstation_2/installation","permalink":"/docs/en/device/xstation_2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xstation_2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":true},"sidebar":"xstation2","previous":{"title":"시작하기","permalink":"/docs/en/device/xstation_2/getting-started"},"next":{"title":"사용하기","permalink":"/docs/en/device/xstation_2/using-device"}}')
...
;// CONCATENATED MODULE: ./docs/device/xstation_2/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "이 문서에서는 XS2-QDPB, XS2-QAPB 모델의 형상을 기준으로 설치 방법을 설명합니다. XS2-DPB, XS2-APB, XS2-ODPB, XS2-OAPB 모델의 경우에도 동일한 방법으로 설치하세요."
      })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "케이블 커버를 장착한 뒤 커버에 끼워져 있는 4개의 나사를 돌려 단단히 고정하고, 고정된 브래킷 위에 제품을 장착하세요."
        }), "\n", (0,jsx_runtime.jsx)(Image, {
