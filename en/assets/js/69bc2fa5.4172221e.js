...
var site_docs_platform_biostar_air_manage_door_mdx_69b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-door","title":"출입문","description":"BioStar Air에서 출입문을 등록하고 설정하며, 그룹과 스케줄을 통해 효율적으로 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-door.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-door","permalink":"/docs/en/platform/biostar_air/manage-door","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-door.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-door","title":"출입문","description":"BioStar Air에서 출입문을 등록하고 설정하며, 그룹과 스케줄을 통해 효율적으로 관리하는 방법을 안내합니다.","keywords":["출입문 관리","출입 장치","릴레이","출입문 그룹","출입문 스케줄","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"바이오인식 장치와 크리덴셜","permalink":"/docs/en/platform/biostar_air/biometric-readers-and-credentials"},"next":{"title":"등록 출입문 관리하기","permalink":"/docs/en/platform/biostar_air/managing-registered-doors"}}')
