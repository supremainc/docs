...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_ip_camera_support_and_configuration_mdx_b5d_namespaceObject = JSON.parse('{"id":"platform/biostar_air/ip-camera-support-and-configuration","title":"IP Camera Support and Setup","description":"Set up ONVIF-compatible IP cameras in BioStar Air, configure live and recorded video streams, and integrate camera footage with access events.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/ip-camera-support-and-configuration.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/ip-camera-support-and-configuration","permalink":"/docs/en/platform/biostar_air/ip-camera-support-and-configuration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/ip-camera-support-and-configuration.mdx","tags":[],"version":"current","frontMatter":{"id":"ip-camera-support-and-configuration","title":"IP Camera Support and Setup","description":"Set up ONVIF-compatible IP cameras in BioStar Air, configure live and recorded video streams, and integrate camera footage with access events.","keywords":["IP camera","BioStar Air","camera configuration"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Configure SIP Intercom for BioStation 3","permalink":"/docs/en/platform/biostar_air/sip-intercom-for-biostation3"},"next":{"title":"Configure SIO2 Secure Module","permalink":"/docs/en/platform/biostar_air/configuring-the-sio2-secure-module"}}')
