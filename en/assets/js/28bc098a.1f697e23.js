...
var site_docs_platform_biostar_air_monitoring_alert_report_history_mdx_28b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-alert-report-history","title":"알림 & 리포트 이력 확인하기","description":"BioStar Air에서 생성된 알림 및 리포트의 이력을 확인하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/monitoring-alert-report-history.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-alert-report-history","permalink":"/docs/en/platform/biostar_air/monitoring-alert-report-history","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring-alert-report-history.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-alert-report-history","title":"알림 & 리포트 이력 확인하기","description":"BioStar Air에서 생성된 알림 및 리포트의 이력을 확인하는 방법을 안내합니다.","keywords":["모니터링","알림 이력","리포트 이력","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"이벤트 및 변경 로그 사용하기","permalink":"/docs/en/platform/biostar_air/monitoring-event-and-audit-logs"},"next":{"title":"출입문 상태 모니터링하기","permalink":"/docs/en/platform/biostar_air/monitoring-door-status"}}')
