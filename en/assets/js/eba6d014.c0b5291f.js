"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["3441"], {
67621: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_manage_server_mdx_eba_namespaceObject = JSON.parse('{"id":"platform/biostar_x/manage-server","title":"Start and stop server","description":"Learn how to start and stop services of the BioStar X server using BioStar X Service Manager.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/manage-server.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/manage-server","permalink":"/docs/en/platform/biostar_x/manage-server","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/manage-server.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-server","title":"Start and stop server","description":"Learn how to start and stop services of the BioStar X server using BioStar X Service Manager.","keywords":["BioStar X setting","Manage server"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Manage server","permalink":"/docs/en/platform/biostar_x/server-management"},"next":{"title":"Service Settings","permalink":"/docs/en/platform/biostar_x/service-settings"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Check how to manage services of the BioStar X server using ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X Service Manager"
      }), ". You can start or stop individual services."]
      ...
      children: ["Provides a tool to manage the status of the ", (0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: "BioStar X Service Manager"
      }), " on Windows. The ", (0,jsx_runtime.jsx)(Cmd, {
        children: "BioStar X Service Manager"
      }), " window appears."]
