"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["1961"], {
64386: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_air_integration_quickstart_mdx_974_namespaceObject = JSON.parse('{"id":"platform/biostar_air/integration-quickstart","title":"Getting Started with API Integrations","description":"Learn how to set up a BioStar Air demo site, register compatible readers, generate API keys, and start testing integrations with cloud APIs.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_air/integration-quickstart.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/integration-quickstart","permalink":"/docs/en/platform/biostar_air/integration-quickstart","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/integration-quickstart.mdx","tags":[],"version":"current","frontMatter":{"id":"integration-quickstart","title":"Getting Started with API Integrations","description":"Learn how to set up a BioStar Air demo site, register compatible readers, generate API keys, and start testing integrations with cloud APIs.","keywords":["integration","quickstart","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Federated Sites","permalink":"/docs/en/platform/biostar_air/federated-sites"},"next":{"title":"E200 QR Scanner - Wiring and Configuration","permalink":"/docs/en/platform/biostar_air/wiring-and-configuration"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "Use the BioStar Air Demo App (Android only):"
