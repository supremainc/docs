...
1. Click a URL `http://[IPaddress]/Features/DuiRIO/Enabled/Set?value=true`.
   ...
   <Image src='/img/integration/genetec/rio-protocol-hardware.png' alone />
...
<Image src='/img/integration/genetec/profile-image-quality-setting.png' alone />
...
1. In the **Config Tool**, click the **Plugins** under **Tasks**.
   ...
   <Image src='/img/integration/genetec/config-tool-tasks-plugins.png' alone />
...
1. Click the **Search Device** button. All available devices will appear.
   ...
   <Image src='/img/integration/genetec/device-management2.png' alone />
...
1. Select the device to add by checking the **Select** box, and click the **Add Devices** button. To register all devices, click the Add **All Devices** button.
   ...
   <Image src='/img/integration/genetec/device-management3.png' alone />
...
1. Synchronization information of connected Suprema devices can be checked.
   ...
   <Image src='/img/integration/genetec/device-sync-information2.png' alone />

   <Image src='/img/integration/genetec/device-sync-information3.png' alone />
...
<Image src='/img/integration/genetec/device-settings-information.png' alone />

<div className='overflow-x cols3--10-30-60'>
| No. | Item | Description |
| :--: | -- | -- |
| 1 | **Name** | Enter a device name. |
| 2 | **Description** | View the product name, ID, and IP. |
| 3 | **Device ID** | View the device ID. |
| 4 | **Firmware Version** | Click **Upgrade** to install a new firmware version. |
| 5 | **Kernel Version** | View the kernel version. |
| 6 | **Time Zone** | Set the time zone of the device. |
| 7 | **Device Type** | View the device type. |
| 8 | **Product Name** | View the model name. |
| 9 | **Hardware Version** | View the hardware version. |
| 10 | **Time Synchronization with Server** | Select the option to synchronize the time information of the device with the server. |
| 11 | **Display Date** | View the displayed time. |
| 12 | **Date Format** | Select a date format. |
| 13 | **Get Time** | Click the button to fetch the time set in the device. |
</div>
...
<Image src='/img/integration/genetec/device-settings-network.png' alone />
...
<Image src='/img/integration/genetec/device-settings-authentication1.png' alone />
...
<Image src='/img/integration/genetec/device-settings-authentication2.png' alone />
...
<Image src='/img/integration/genetec/device-settings-advanced.png' alone />

<div className='overflow-x cols3--10-30-60'>
| No. | Item | Description |
| :--: | -- | -- |
| 1 | **Language** | Sets the display language of the device. |
| 2 | **Device Volume** | Controls the device’s default volume. |
| 3 | **Menu Timeout** | Sets the timeout for the menu screen. |
| 4 | **Intercom Speaker Volume** | Sets the speaker volume when using the Intercom function. |
| 5 | **Intercom Microphone Volume** | Sets the microphone volume when using the Intercom function. |
| 6 | **Backlight Timeout** | Sets the timeout for the backlight. |
| 7 | **Msg. Timeout** | Sets the timeout period for various messages to disappear automatically. |
| 8 | **Screen Saver** | Sets this option to use the screen saver feature. It reduces unnecessary energy consumption by lowering the brightness of the LCD screen when the device is not in use. |
| 9 | **Use Voice** | Enables voice guidance. |
| 10 | **Sound** | Configures the sound effect for boot, authentication success, and authentication failure events.<br/>Click **Find** and select a \*.wav file (less than 500 KB). |
| 11 | **Input/Output** | You can select input/output mode. |
| 12 | **Wiegand I/p Format** | You can set a format for Wiegand. |
| 13 | **Output Mode** | You can set the Wiegand signal output mode. If it is set to **Normal**, a card will be scanned in the set Wiegand format. If it is set to **ByPass**, CSN will be sent regardless of Wiegand authentication. **ByPass** should be set when using the device without an entrance door control function.<br/>If it is set to **Normal** mode, it is possible to set **Fail Code**, and select a value to be transmitted when Wiegand card authentication fails. |
| 14 | **Pulse Width(μs)** | You can set the pulse width of the Wiegand signal. |
| 15 | **Pulse Interval(μs)** | You can set the pulse interval of the Wiegand signal. |
| 16 | **Output info** | You can select the information output to the device when the user authenticates. |
</div>
...
<Image src='/img/integration/genetec/device-settings-mask.png' alone />
...
<Image src='/img/integration/genetec/device-settings-intercom.png' alone />

<div className='overflow-x cols3--10-30-60'>
| No. | Item | Description |
| :--: | -- | -- |
| 1 | **SIP Server Address** | Enter SIP server address. |
| 2 | **SIP Server Port** | Enter SIP server port. |
| 3 | **SIP Username** | Enter username of your SIP account. |
| 4 | **Password** | Enter password of your SIP account. |
| 5 | **Authorization ID** | Enter authorization ID of your SIP account. |
| 6 | **Registration Duration(sec)** | Enter Registration Duration in seconds. The device (SIP endpoint) tries to register to the SIP server every set Registration Duration.<br/>- Registration Duration can be set between 60 to 600 secs. |
| 7 | **Open Door Button(DTMF)** | Set a button to open the door on the phone. |
| 8 | **Outbound Proxy Server** | If your SIP service has a separate (outbound) proxy server, set this to **Use**. |
| 9 | **Outbound Proxy Server Address** | Enter the outbound proxy server address. |
| 10 | **Outbound Proxy Server Port** | Enter the outbound proxy server port. |
| 11 | **Display Extension Number** | If you mind the device displaying extension numbers on the screen, set this to **Not Use**. |
| 12 | **Extension Number** | Register extension numbers up to 128. Click **Edit** to add or delete.<br/>- **Add**: Add an extension number.<br/>- **Delete**: Delete an extension number. |
</div>
...
1. In the **Config Tool**, click the **Access Control** under **Tasks**.
   ...
   <Image src='/img/integration/genetec/config-tool-tasks-access-control.png' alone />
...
1. Select the device to assign by checking the **Select** box, and click the **Assign** or **Assign Selected** button. To assign all devices, click the **Assign All** button.
   ...
   <Image src='/img/integration/genetec/manage-suprema-devices4.png' alone />

## Door Configuration

1. In the **Config Tool**, click the **Area view** under **Tasks**.

   <Image src='/img/integration/genetec/config-tool-tasks-area-view.png' alone />

1. Select the door and go to the **Hardware** tab.

1. Assign Suprema devices to **Reader**, **Request to exit**, and **Entry sensor**.

   <Image src='/img/integration/genetec/area-view-hardware.png' alone />
