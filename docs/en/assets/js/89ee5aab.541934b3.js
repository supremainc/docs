...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_platform_biostar_x_express_install_mdx_89e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/express-install","title":"Express Installation","description":"This guide provides instructions on how to set up BioStar X quickly.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/platform/biostar_x/express-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/express-install","permalink":"/docs/en/platform/biostar_x/express-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/express-install.mdx","tags":[],"version":"current","frontMatter":{"id":"express-install","title":"Express Installation","description":"This guide provides instructions on how to set up BioStar X quickly.","keywords":["Express installation"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"네트워크 우선순위 확인하기","permalink":"/docs/en/platform/biostar_x/check-ethernet"},"next":{"title":"Custom Installation","permalink":"/docs/en/platform/biostar_x/custom-install"}}')
...
const toc = [..._biostar_install_steps/* .toc */.RM];
function _createMdxContent(props) {
  const _components = {
    a: "a",
    p: "p",
