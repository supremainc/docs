...
* **BioStar X**와 호환되는 VMS를 사용하세요. [BioStar X VMS](https://www.supremainc.com/ko/platform/video-ac-integrated-system-biostar-x-vms.asp) 또는 **Nx Witness v5.1.5** 계열의 VMS를 사용할 수 있습니다.

</Include>

<Xclude lang='ko'>

* **BioStar X**와 호환되는 VMS를 사용하세요. **Nx Witness v5.1.5** 계열의 VMS를 사용할 수 있습니다.
...
VMS 서버와 정상 연동되었다면 <Cmd sid='setting.menu.video.root' /> → <Cmd sid='setting.menu.video.video' /> 메뉴에서 연결된 카메라를 확인할 수 있습니다. 자세한 내용은 [다음 문서](settings-videos-camera)를 참고하세요.
