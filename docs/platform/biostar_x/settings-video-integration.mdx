...
* 호환되는 VMS는 아래와 같습니다. 
  ...
  * [Leopard VMS](http://www.naiz.co.kr/kr/w/sub.asp?avan=1002020000)

  * [Nx Witness](https://www.networkoptix.com/nx-witness) v5.1.5, v6.x.x
...
1. <Cmd sid='video.setting.integration.title' product='2' /> 옵션을 <Cmd sid='common.use' product='2' />으로 설정하세요.
    ...
    <Image src='/img/biostarx-settings-video-integration-add-type.png' />

1. <Cmd>VMS 종류</Cmd> 옵션에서 연동하려는 VMS 서버의 종류를 선택하세요.
