...
* **BioStar X**와 호환되는 VMS를 사용하세요. [BioStar X VMS](https://www.supremainc.com/ko/platform/video-ac-integrated-system-biostar-x-vms.asp) 또는 **Nx Witness v5.1.5** 또는 **v6.x.x** 계열의 VMS를 사용할 수 있습니다.
