...
* **BioStar X**는 32비트 운영체제를 위한 설치 파일을 제공하지 않습니다.
...
* MS SQL Server와 **BioStar X**가 서로 다른 PC에 설치되어 있는 경우 **BioStar X**를 설치한 PC에 [Native Client](https://www.microsoft.com/ko-kr/download/details.aspx?id=50402)를 설치해야 합니다.
