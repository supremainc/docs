...
description: Learn how to set up elevator access control, configure floor permissions, create access levels, and manage scheduling with Suprema's OM120 module in BioStar Air.
