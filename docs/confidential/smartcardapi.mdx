  ...
  hierarchy={[
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: "cardAuthMode", type: "uint8_t", size: 1, description: "<b>IR Face</b> 기반 카드 인증 모드 설정값입니다. 개인 인증 모드로 장치에 설정된 인증 모드가 아닌 카드에 저장된 인증 모드를 사용하게 됩니다.", 
            notes: [
            ...
            { name: "cardAuthModeEx", 
              ...
              notes: [
                ...
                "<b>IR Face</b> 기반은 <code>cardAuthMode</code>를 사용하세요.",
