...
node generatepdf -u "http://localhost:4000/cover/biostarx" --prince-args="--page-size='a4' --page-margin='0mm' --style=./print.css --javascript" -o ./pdf/biostarx.pdf --dest ./pdf --include-index
