...
node generatepdf -u "http://localhost:4000/platform/biostar_x/appendices" --prince-args="--page-size='a4' --page-margin='0mm' --style=./print.css --javascript" -o ./pdf/document.pdf --include-index

REM PDF에서 주석을 제거하는 명령어
REM 마지막 파일명은 위 -o 옵션과 동일하게 설정하세요.

pdfcpu annot remove -pages 1 ./pdf/document.pdf
