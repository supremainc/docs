...
node generatepdf -u "http://localhost:3000/device/bioentry_w3" --prince-args="--page-size='a4' --page-margin='0mm' --style=./print.css --javascript" -o ./pdf/document.pdf --include-index
