...
const cmdAirKo = JSON.parse(readFileSync(`${__dirname}/../static/data/remark-cmd/air/ko.json`, 'utf-8'));
const cmdAirEn = JSON.parse(readFileSync(`${__dirname}/../static/data/remark-cmd/air/en.json`, 'utf-8'));
const cmdAirEs = JSON.parse(readFileSync(`${__dirname}/../static/data/remark-cmd/air/es.json`, 'utf-8'));
const cmdAirJa = JSON.parse(readFileSync(`${__dirname}/../static/data/remark-cmd/air/ja.json`, 'utf-8'));
