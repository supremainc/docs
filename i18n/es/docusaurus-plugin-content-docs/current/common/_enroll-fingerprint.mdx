...
* Como la huella dactilar inscrita inicialmente con frecuencia no se introduce correctamente, vuelva a registrarla siguiendo las [Precauciones para el registro de huellas dactilares](#cautions-enrolling-fingerprint).
