...
## Método correcto de ingreso de huellas dactilares <Badge only>BS3M-ODB, BS3M-OAPB</Badge> {/* #cautions-enrolling-fingers */}
...
#### Precauciones para la inscripción de huellas dactilares {/* #cautions-enrolling-fingerprint */}
...
* Como la huella dactilar inscrita inicialmente con frecuencia no se introduce correctamente, vuelva a registrarla siguiendo las [Precauciones para la inscripción de huellas dactilares](#cautions-enrolling-fingerprint).
