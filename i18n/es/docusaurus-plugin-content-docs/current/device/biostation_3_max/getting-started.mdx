...
<ProdImg src="/img/device/name-function-each-part-bs3m.svg" className="none" width="70%" />
...
* Mantenga la distancia entre la cámara del dispositivo y el código QR o código de barras a 8-25 cm.
