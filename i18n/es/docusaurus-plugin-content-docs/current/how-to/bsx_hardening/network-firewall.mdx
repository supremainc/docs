...
Cuando se implementa Multi Communications Server, usa los mismos puertos de comunicación del servidor principal (`51212`, `51219`). Los administradores deben asegurar el acceso a estos puertos entre Multi Communications Server y el servidor principal, según la topología.
