...
* Utiliza un VMS compatible con **BioStar X**. Utiliza [BioStar X VMS](https://www.supremainc.com/ko/platform/video-ac-integrated-system-biostar-x-vms.asp) o la serie **Nx Witness v5.1.5** de VMS.

</Include>

<Xclude lang='ko'>

* Utiliza un VMS compatible con **BioStar X**. Utiliza la serie **Nx Witness v5.1.5** de VMS.
...
1. Ve a la ruta *C:\Program Files\BioStar X\third* y ejecuta la consola de comandos.
   ...
   Si el VMS está instalado en un servidor diferente de **BioStar X**, copia el archivo *scaleUtil-1.0-all.jar* al servidor VMS y sigue los pasos siguientes.
...
La ruta de instalación del certificado puede variar según el VMS. Consulta los siguientes ejemplos.
