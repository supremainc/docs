...
* La función de integración de VMS está disponible como opción adicional para licencias superiores a **Avanzado**. Para más información sobre la política de licencias, consulta [lo siguiente](licensing#features-add-ons).
...
Si el servidor VMS se integra correctamente, verifica las cámaras conectadas en el menú <Cmd sid='setting.menu.video.root' /> → <Cmd sid='setting.menu.video.video' />. Para obtener más información, consulte [lo siguiente](settings-videos-camera).
