...
Debe activarse la licencia **Event Log API**. Para obtener más información sobre las políticas de licencia, consulte <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.

:::info

Para obtener más información sobre cómo aplicar licencias, consulte <DocLink docId='platform/biostar_x/settings-license-biostar-x-license' />.
...
Para obtener más información sobre los grupos de dispositivos, consulte <DocLink docId='platform/biostar_x/settings-manage-device-group' />.
...
* Para obtener más información sobre el uso de la API, consulte la [API de BioStar X](../../developer/bsxapi?api=virtual-device-event-import).
...
* Para obtener más información sobre cómo ver eventos en el menú <Cmd sid='shell.header.arena' />, consulte <DocLink docId='platform/biostar_x/monitoring-event' />.

* Para obtener más información sobre el menú <Cmd sid='shell.header.data' />, consulte <DocLink docId='platform/biostar_x/data-generate-reports' />.
...
* Para obtener más información sobre <Cmd sid='setting.menu.system.auditTrail' />, consulte <DocLink docId='platform/biostar_x/settings-system-audit-trail' />.
