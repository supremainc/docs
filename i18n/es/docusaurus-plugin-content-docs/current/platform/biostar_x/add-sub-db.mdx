...
description: Al agregar un servidor de comunicaciones múltiples, agrega y conecta una base de datos auxiliar. Esto reduce la carga en el servidor principal.
keywords:
  - Base de datos
  - Agregar
  - Conectar
...
Al agregar un servidor de comunicaciones múltiples, agrega y conecta una base de datos auxiliar. Esto reduce la carga en el servidor principal.

:::info

* Necesitas una licencia de **servidor de comunicación múltiple** para agregar una base de datos auxiliar. Para obtener más información sobre las políticas de licencia, consulte <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
...
3. Haz clic en <Cmd>+ Add Database</Cmd> en la esquina superior derecha de la pantalla.
