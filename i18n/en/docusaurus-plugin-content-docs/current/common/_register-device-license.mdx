...
1. After loading the license file, <Cmd sid='setting.server.license.name' />, <Cmd sid='setting.server.license.device.count' />, and <Cmd sid='setting.server.license.device.list' /> appear. For details, refer to [this document](#check-device-license).
