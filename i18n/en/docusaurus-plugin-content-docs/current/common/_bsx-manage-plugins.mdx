...
* The time and attendance management plugin is available as an additional option. For more information on licensing policies, refer to [the following](../biostar_x/licensing#features-add-ons).
