...
* The attendance management plugin can be used through additional options. For more information on licensing policies, refer to [the following](../biostar_x/licensing#features-add-ons).
