...
<Include product='biostation_2a,bioentry_w3,xstation_2'>
...
**When connecting PoE+ power, always use PoE+ or PoE++ standards only**.

* Using standard PoE may cause unstable operation and can potentially damage the device permanently.
