...
* If another program is using port 443, the BioStar X Setting program runs automatically and allows you to change the port number. For more information on changing the port number, see <DocLink docId='platform/biostar_x/change-port' />.

* For more information on changing database settings, see <DocLink docId='platform/biostar_x/change-db' />.
