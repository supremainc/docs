...
1. Go to **Inbound Rules** and remove or disable rules that are not required.

1. Create explicit allow rules for:
...
1. Set all other inbound traffic to **Block**.

1. Go to **Outbound Rules** and restrict to known trusted endpoints.
