...
When Multi Communications Server is deployed, it uses the same Main Server communication ports (`51212`, `51219`). Administrators should ensure these ports are reachable between the Multi Communications Server and the Main Server according to the deployment topology.
