...
<Item top={37}>Visual Camera</Item>

<Item top={62}>Infrared Camera</Item>

<Item top={122}>Display</Item>

<Item top={260}>RF card and mobile access card authentication unit</Item>

<Item top={418}>LED Indicator</Item>

</Callout>
<Callout width={469} position='right'>

<Item top={225}>Cable Connector</Item>

<Item top={310}>Speaker</Item>

<Item top={378}>Reset Button</Item>

</Callout>

<Callout width={280} position='right'>

<Item top={400}>USB (Type-C) Memory Slot</Item>
