...
2. Select <Cmd>USER</Cmd> → <Image src='/img/common/ico-info.svg' ico alone />.User usage information appears.
   ...
   * <Cmd>Face</Cmd>: Enroll a face for user authentication. Press <Cmd>Face</Cmd> → <Cmd>Next</Cmd> and enroll a face according to the instructions on the screen. To add more faces, press <Image src='/img/common/ico-add.svg' ico alone />. Please refer to [Enrolling User Faces](#enrolling-user-faces) to learn more about face enrollment.

   * <Cmd>Card / QR Code</Cmd>: Enroll a card for user authentication. Press <Cmd>Card / QR Code</Cmd> → <Cmd>Next</Cmd> and scan the card that will be assigned to the user. To enroll an additional card, press <Cmd>Card / QR Code</Cmd> → <Image src='/img/common/ico-add.svg' ico alone />.

   * <Cmd>PIN</Cmd>: Enter the PIN you wish to use. Click <Cmd>PIN</Cmd> → <Cmd>Next</Cmd> to register the PIN to use. Enter the PIN again for confirmation and press <Cmd>OK</Cmd>. Enter a number between 8 and 16 digits to prevent leaking.
...
3. To complete the registration of user information, press <Cmd>Save</Cmd>.
...
2. Select <Cmd>USER</Cmd> → <Image src='/img/common/ico-add.svg' ico alone />.

3. Select <Cmd>Face</Cmd> → <Cmd>Next</Cmd>.

4. Adjust a distance between the face and screen and look straight at the camera of the device.

5. Once your face is captured successfully, press <Cmd>OK</Cmd> → <Cmd>Save</Cmd>. To retake a photo, press <Cmd>Re-Shot</Cmd>.
...
2. Select <Cmd>USER</Cmd> → <Image src='/img/common/ico-search.svg' ico alone />.

3. Select your search terms. You can search for a user by <Cmd>All</Cmd>, <Cmd>User ID</Cmd>, <Cmd>Name</Cmd>, <Cmd>Face</Cmd> and <Cmd>Card</Cmd>.

4. Select the user to modify.

5. Modify the information by referring to [Registering User Information](#registering-user-information) and press <Cmd>OK</Cmd>.

   * To delete a user, select <Image src='/img/common/ico-delete.svg' ico alone /> and then press <Cmd>OK</Cmd>.
...
2. Select <Cmd>USER</Cmd> → <Image src='/img/common/ico-delete.svg' ico alone />.

3. Check <Cmd>Delete All</Cmd> to delete all registered users and press <Cmd>OK</Cmd>.

4. When you press <Cmd>OK</Cmd>, all registered users will be deleted.
...
2. Select <Cmd>USER</Cmd> → <Image src='/img/common/ico-add.svg' ico alone />, and choose a credential you want to enroll.<br/> User usage information appears.
