...
<Image src='/img/device/installation-network-direct-connection-bs3.png' className='none' width='60%' alone />
...
<Image src='/img/device/installation-sio2-connection-bs3.png' className='none' width='60%' />
