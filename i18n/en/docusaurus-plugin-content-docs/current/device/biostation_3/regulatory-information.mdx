...
keywords: [Regulatory, Licenses, FCC, CE]
---
...
1. You can view **Regulatory & Licenses** press the <Image src='/img/common/ico-regulatory.svg' ico alone /> on the upper right corner of **DASHBOARD**.
