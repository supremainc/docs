...
If the administrator has not been designated, the <Cmd sid='ui_109' product='dev' /> screen will be displayed when you press <Image src='/img/common/ico-menu.svg' ico alone />.
