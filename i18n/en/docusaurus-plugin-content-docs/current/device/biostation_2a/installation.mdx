...
2. Fix the bracket firmly using fixing screws through the bracket to the position where BioStation 3 will be installed.
...
4. Install BioStation 3 onto the fixed bracket.

   <Image src='/img/device/installation-device3-bs3.svg' className='none' alone />

5. Connect BioStation 3 to the bracket by rotating the product fixing screw of BioStation 3.
