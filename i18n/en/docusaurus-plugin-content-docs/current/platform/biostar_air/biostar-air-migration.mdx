...
keywords: [migration, BioStar Air, BioStar Air]
---

## Feature Overview

BioStar Air is the rebranded version of BioStar Air, designed to reflect Suprema’s unified cloud access control strategy. Both platforms share the same backend infrastructure and core features. However, new features and improvements will be rolled out under the BioStar Air brand moving forward.
