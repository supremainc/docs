...
* Connect the white 4-pin pin-and-socket connector to the **CON**port on the bottom of the QR scanner. This connector is **polarized** (with a groove), so it only fits in one direction.
