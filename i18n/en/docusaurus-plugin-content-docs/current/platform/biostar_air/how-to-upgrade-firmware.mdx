...
1. Select devices running an outdated firmware version (anything below **2.9** as of August 2025) by checking the box on the left side.
...
1. Select the latest firmware version **2.9** or **2.10**, depending on the reader, (as of August 2025) and confirm the update.
...
1. Click on the **Firmware Update** button.
...
1. Select the latest version **2.9** or **2.10**, depending on the reader, (as of August 2025) and confirm the update.
...
Learn more about device management in BioStar Air by watching the following video:
