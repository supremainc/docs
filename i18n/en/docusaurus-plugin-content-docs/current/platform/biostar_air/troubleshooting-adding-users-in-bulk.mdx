...
* If you need to include additional fields (for example, employee ID or department), use the <Cmd sid='user_setting_templ_action' product='air' />(<IcAirUtemplate />) feature at the top of the user list to add them. When a field is added, the downloaded CSV file automatically includes the corresponding column.
