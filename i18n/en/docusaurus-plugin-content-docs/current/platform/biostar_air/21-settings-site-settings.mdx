...
keywords: [site settings, configuration]
---
...
* **Country**: Set during site creation and cannot be changed later. If a change is necessary, it must be done through the BioStar Air Partner Portal.
...
* **T&A on Mobile**: Related to time and attendance features, refet to [the following](configuring-ta).
...
* **QR Reader**: Enables support for QR code readers connected to readers. If no QR readers are in use, this setting should remain off.
