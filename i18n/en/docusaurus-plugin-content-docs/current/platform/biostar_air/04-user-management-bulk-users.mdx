...
If you run into any issues with your CSV upload, we've written a more detailed guide to help you work through common problems. It also includes Excel formulas to help you validate and de-duplicate your data. [Troubleshooting Adding Users in Bulk](troubleshooting-adding-users-in-bulk)