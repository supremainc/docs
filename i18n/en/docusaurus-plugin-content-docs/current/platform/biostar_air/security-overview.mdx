...
* Service availability: 99.9% uptime ([per SLA](https://supremainc.com/en/util/biostar-air-service-level-agreement.html))

* API security: token-based authentication, HTTPS only, strict endpoint validation

* Portal access: cloud-based for global management; a private cloud option is under development
