...
You can export the queried event list as a CSV file. 

1. Click <Cmd sid='reportApp.export' product='2' /> at the top right of the screen.

2. When the <Cmd sid='reportApp.exportReport' product='2' /> window appears, select <Cmd>CSN</Cmd> from <Cmd sid='reportApp.fileFormat' product='2' />.

   <Image src='/img/biostarx-data-export-all-report-csv.png' />

3. You can edit the file name to be saved in <Cmd sid='reportApp.fileName' product='2' />.

4. Enter <Cmd sid='auditTrail.export.reason' product='2' /> (optional) and click <Cmd sid='reportApp.export' product='2' />.

5. Save the CSV file to your desired location on your local path.

:::info

<Cmd sid='auditTrail.export.reason' product='2' /> is optional. Check records for export reasons in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.auditTrail.root' /> → <Cmd sid='setting.menu.auditTrail.acAuditLog' />.
...
<Cmd sid='printOption.printReason' product='2' /> is optional. Check records for print reasons in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.auditTrail.root' /> → <Cmd sid='setting.menu.auditTrail.acAuditLog' />.
