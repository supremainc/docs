...
<Cmd sid='auditTrail.export.reason' product='2' /> is optional. View <Cmd sid='team.menu.export.exportReason' /> records under <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.system.root' /> → <Cmd sid='setting.menu.system.auditTrail' />.
