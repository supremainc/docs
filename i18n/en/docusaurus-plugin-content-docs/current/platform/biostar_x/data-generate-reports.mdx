...
2. <Cmd sid='reportApp.user' product='2' />: Create a report by selecting a template relevant to the user.

3. <Cmd sid='reportApp.event' product='2' />: Create a <Cmd sid='reportApp.customReport' product='2' /> by selecting desired Events, Periods, and Filters (<Cmd>USERS</Cmd>, <Cmd>DOORS</Cmd>, <Cmd>DEVICES</Cmd>).
