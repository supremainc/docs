...
* The feature to connect cameras to the door through the VMS server is available as an additional option with an **Advanced** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
