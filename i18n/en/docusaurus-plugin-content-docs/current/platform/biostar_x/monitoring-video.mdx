...
* Video monitoring is available with additional options for **Advanced** licenses and higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
