...
* For more information on linking a camera to the door, refer to the [following](#).
...
* For more information on the features available in the <Cmd sid='arena.map.doorControl' /> tool, refer to the [following](control-door).
