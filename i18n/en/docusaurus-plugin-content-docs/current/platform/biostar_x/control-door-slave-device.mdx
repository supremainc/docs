...
* This feature requires the door to be connected to a camera in order to be used. For instructions on linking a door to a camera, see <DocLink docId='platform/biostar_x/settings-videos-rule' />.
