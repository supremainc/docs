...
Go to <Cmd>Settings</Cmd> → <IcLicense/> <Cmd>License</Cmd> → <Cmd>BioStar X License</Cmd> menu.
...
* For more information about <Cmd>License</Cmd>, refer to [the following document](settings-license).
