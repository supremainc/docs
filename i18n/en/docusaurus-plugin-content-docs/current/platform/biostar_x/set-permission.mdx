...
This guide describes how to set user access permissions. This guide explains how to set user access permissions. Users can set which spaces they can access and what times they can access them through access permissions.
