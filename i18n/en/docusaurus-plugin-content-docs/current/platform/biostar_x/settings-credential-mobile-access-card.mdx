...
4. Click <Cmd sid='setting.mobileCredential.connect' product='2' /> when all settings are complete.
...
* [Mobile Access Card Enrollment](enroll-credential#enroll-mobile)
