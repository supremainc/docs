...
To use mobile access cards in **BioStar X**, complete the sign-up and initial setup of the Airfob Portal first. For more information, see <DocLink inner='#airfob-portal-setup' />.
