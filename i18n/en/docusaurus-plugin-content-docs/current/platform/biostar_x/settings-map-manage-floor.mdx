...
* Register doors before configuring floors. For more information on registering doors, see <DocLink docId='platform/biostar_x/settings-door-add' />.

* For more information on map monitoring, see <DocLink docId='platform/biostar_x/monitoring-map' />.

* The add floor and floor settings features are available with an **Essential** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
...
2. Click <Cmd sid='setting.menu.map.root' /> → <Cmd sid='setting.menu.map.floor' /> on the left sidebar.
...
15. After completing all settings and saving the configured floor, click <Cmd sid='button.apply' product='2' />.
...
* For more information on the icons and status of the doors and cameras on the floor, see <DocLink docId='platform/biostar_x/monitoring-map#component-and-options' />.
...
2. On the left sidebar, click <Cmd sid='setting.menu.map.root' /> → <Cmd sid='setting.menu.map.floor' />.
