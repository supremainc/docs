...
| [**Upgradable**](#license-upgrade)<br/>*(Door/User/Admin)*                                                                                      | User, admin only |    ❌    |     ❌     |  Add on  |   Add on   |  Add on |
...
| **GIS map**                           | System            | You can set area and facility, floor using the GIS map.                                                                                                                                                                |
| **Video**                             | Camera            | Applies when using a Video Management System (VMS) not provided by Suprema.                                                                                                                                            |
| **Fingerprint server matching**       | Fingerprint       | This is the server matching method that compares the fingerprint scanned from the device with the fingerprint template stored in the server database. An annual maintenance contract is required for advanced support. |
...
| ** personnel check** (**Roll Call**)  | System            | *                                                                                                                                                                                                                      |
...
| -------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Mobile app**       | System       | *                                                                                                                                                                                                                                                                                |
| **API**              | System       | Includes 10 users. An annual maintenance contract is required for advanced support.                                                                                                                                                                                              |
| **Event log API**    | System       | The system can receive and log event logs via external API. This allows third-party applications or services to directly add event data to the access control system for centralized logging and security.                                                                       |
