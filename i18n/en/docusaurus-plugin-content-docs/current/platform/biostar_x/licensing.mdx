...
Try the **BioStar X License Calculator** to help you determine the license types and quantities that match your needs. This tool helps you resolve complex licensing requirements.
...
| [**Upgradable**](#license-upgrade)<br/>*(Door/Users/Operators)*                                                                                      | Users, Operators only |    ❌    |   Add on  |  Add on  |   Add on   |  Add on |
