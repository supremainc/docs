...
|     ![Door icon](/img/common/monitoring-map-floor-door-icon.svg)     | **Door**: Clicking the door will display a popup menu that allows you to control that door. For more information on the provided features, refer to the [following](control-door). |
...
* Clicking the door will display a popup menu that allows you to control that door. For more information on the provided features, refer to the [following](control-door).
