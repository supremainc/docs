...
The <Cmd>Advanced Access Control</Cmd> option is only available with an **Advanced** or higher license. For more information on the licensing policy, see <DocLink docId='platform/biostar_x/licensing' />.
