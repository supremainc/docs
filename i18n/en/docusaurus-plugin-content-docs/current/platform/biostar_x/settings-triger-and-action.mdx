...
2. Click <Cmd sid='setting.menu.triggerAndAction.root' /> on the left sidebar of the screen. 
...
* <Cmd sid='common.quickAction' product='2' /> can be set in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.customInterface.root' />. For more information on <Cmd sid='common.quickAction' product='2' />, see <DocLink docId='platform/biostar_x/settings-custom-interface' />.
