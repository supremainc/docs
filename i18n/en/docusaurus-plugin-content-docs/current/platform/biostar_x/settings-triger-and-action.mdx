...
2. Click <Cmd sid='setting.menu.accessManagement.root' /> → <Cmd sid='setting.menu.triggerAndAction.root' /> on the left sidebar. 

3. Click <Cmd sid='setting.menu.accessManagement.root' /> → <Cmd sid='button.func.addTriggerAndAction' product='2' /> in the upper left corner of the screen.
...
Setting <Cmd sid='common.quickAction' product='2' /> allows you to control multiple doors at once using <Cmd sid='common.quickAction' product='2' /> on the **BioStar X** main screen. Click the <Cmd sid='triggerAction.quickAction' product='2' /> checkbox.

:::info

* This feature is only available when the <Cmd sid='triggerAction.schedule' product='2' /> option is set to <Cmd>Always</Cmd>.

* <Cmd sid='common.quickAction' product='2' /> can be set in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.accessManagement.root' /> → <Cmd sid='setting.menu.customInterface.root' />. For more information on <Cmd sid='common.quickAction' product='2' />, see <DocLink docId='platform/biostar_x/settings-custom-interface' />.
...
The <Cmd sid='common.zone' product='2' /> option can be enabled as an additional option with an **Essential** license or higher. For more information on the licensing policy, see <DocLink docId='platform/biostar_x/licensing' />.
