...
2. Click <Cmd sid='setting.menu.triggerAndAction.root' /> in the left sidebar. 
...
* <Cmd sid='common.quickAction' product='2' /> can be set in <Cmd sid='shell.header.setting' /> → <Cmd>Custom Interface</Cmd>. For more information about <Cmd sid='common.quickAction' product='2' />, refer to the [following](settings-custom-interface).
