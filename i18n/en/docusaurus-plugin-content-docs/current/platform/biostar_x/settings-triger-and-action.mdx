...
The <Cmd>Advanced Access Control</Cmd> option is only available with an **Advanced** or higher license. For more information on the license policy, refer to the [following](licensing).
