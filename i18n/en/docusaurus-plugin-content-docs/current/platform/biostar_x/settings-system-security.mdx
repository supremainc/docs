...
* If the multi-communication server is not connected, the system disables the <Cmd sid="setting.sever.secure.comm.menu" product='2' /> option and blocks changes to it.
