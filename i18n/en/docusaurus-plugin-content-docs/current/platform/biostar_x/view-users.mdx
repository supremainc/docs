...
<Cmd sid='printOption.printReason' product='2' /> is optional. Check <Cmd sid='printOption.printReason' product='2' /> records in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.system.root' /> → <Cmd sid='setting.menu.system.auditTrail' />.
