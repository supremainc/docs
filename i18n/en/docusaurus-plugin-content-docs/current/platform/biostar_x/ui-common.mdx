...
7. <IcAccount width='26' height='26' /> **Account**: Go to <Cmd sid='setting.menu.preferences.root' /> or change the password of the currently logged-in user.
   ...
   * For more information on <Cmd sid='setting.menu.preferences.root' />, refer to [the following](settings-preferences).

   * For more information on changing the password of the currently logged-in user, refer to [the following](set-permission#changeLoginUserPassword).
