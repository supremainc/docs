...
3. <Cmd sid='shell.header.action' />: Execute the **action** feature set by the server user. Clicking the button displays the action list. For more details, refer to the [following](settings-custom-interface).
