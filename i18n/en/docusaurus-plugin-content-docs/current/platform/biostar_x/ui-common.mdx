...
3. <Cmd sid='shell.header.action' />: Execute the **action** feature set by the server user. Clicking the button displays the action list. For more information, see <DocLink docId='platform/biostar_x/settings-custom-interface' />.
...
7. <IcAccount width='26' height='26' /> **Account**: Go to <Cmd sid='setting.menu.preferences.root' /> or change the password of the currently logged-in user.

   * For more information on the <Cmd sid='setting.menu.preferences.root' /> menu, see <DocLink docId='platform/biostar_x/settings-preferences' />.

   * For more information on changing the password of the currently logged-in user, see <DocLink docId='platform/biostar_x/set-permission#changeLoginUserPassword' />.

8. <IcLogout width='26' height='26' /> **Logout**: End the session of the currently logged-in user and log out.
