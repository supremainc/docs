...
* The <Cmd sid="setting.menu.visitor.visitor" product='2' /> setting is available as an additional option with an **Essential** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.

* Activate the <Cmd sid="setting.server.automaticUserSync" product='2' /> or <Cmd sid="setting.server.serverMatching.use" product='2' /> option to use the <Cmd sid="setting.menu.visitor.visitor" product='2' />. For more information, see <DocLink docId='platform/biostar_x/settings-server-server' />.

:::

## Visitor settings {/* #settings-visitor */}

1. Click <Cmd sid='shell.header.setting' /> on the <Cmd sid='shell.header.launcher' /> page.

2. Click <Cmd sid='setting.menu.visitor.root' /> → <Cmd sid="setting.menu.visitor.visitor" /> on the left sidebar.
...
### Visitor site settings {/* #settings-visitor-site */}
...
* <Cmd sid="visitor.accessGroup" product='2' />: You can select the access group to assign to the visitor.
  ...
  Pre-setting access groups for visitors makes management easier. For more information on access group settings, see <DocLink docId='platform/biostar_x/settings-access-control-manage-access-group' />.
...
Click <Cmd sid="visitor.setting.button.apply" product='2' /> to save visitor site settings.

</Step>
<Step>

### Visitor PC settings {/* #settings-visitor-pc */}
...
* <Cmd sid="common.card" product='2' /> <Cmd sid="setting.server.enrollment_device.device_name" product='2' />: Select a device to issue the card to visitors when visitors access the site using the card authentication. The card device name is only activated if you have set a visit where you have selected to use the card.
...
### Select visitor PC {/* #settings-visitor-assign-pc */}
...
### Shortcut to visitor application page {/* #settings-visitor-pc-link */}

You can create a shortcut icon for the visitor application page on the desktop of the application PC. Drag the URL of <Cmd sid="visitor.link.visitPCKIOSK" product='2' /> item to the desktop.
...
## Set terms & visitor settings {/* #settings-visitor-terms */}
...
## Set custom visitor fields {/* #settings-visitor-custom-field */}
