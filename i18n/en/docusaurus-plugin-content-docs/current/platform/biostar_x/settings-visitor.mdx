...
* The <Cmd sid="common.visitor" product='2' /> setting is available as an additional option with an **Essential** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.

* Activate the <Cmd sid="setting.server.automaticUserSync" product='2' /> or <Cmd sid="setting.server.serverMatching.use" product='2' /> option to use the <Cmd sid="common.visitor" product='2' />. For more information, see <DocLink docId='platform/biostar_x/settings-server-server' />.
...
2. Click <Cmd sid="common.visitor" product='2' /> on the left sidebar.
