...
* The <Cmd sid="common.visitor" product='2' /> setting is available through additional options with an **Advanced** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
...
2. In the left sidebar, click the <Cmd sid="common.visitor" product='2' />.
...
## Terms & set visitor {#settings-visitor-terms}
