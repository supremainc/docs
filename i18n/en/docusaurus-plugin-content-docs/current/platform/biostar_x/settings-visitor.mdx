...
* The <Cmd sid="common.visitor" product='2' /> setting is available through additional options with an **Advanced** license or higher. For more information on licensing policy, refer to [the following](licensing#features-add-ons).

* Activate the <Cmd sid="setting.server.automaticUserSync" product='2' /> or <Cmd sid="setting.server.serverMatching.use" product='2' /> option to use the <Cmd sid="common.visitor" product='2' />. For more information, refer to [the following](settings-server-server).
...
* <Cmd sid="visitor.accessGroup" product='2' />: You can select the access group to assign to the visitor.
  ...
  Pre-setting access groups for visitors makes management easier. For more information on access group settings, refer to [the following](settings-access-control-manage-access-group).
