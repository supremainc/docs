...
* The <Cmd sid="setting.menu.visitor.visitor" /> setting is available as an additional option with an **Essential** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.

* Activate the <Cmd sid="setting.server.automaticUserSync" product='2' /> or <Cmd sid="setting.server.serverMatching.use" product='2' /> option to use the <Cmd sid="setting.menu.visitor.visitor" />. For more information, see <DocLink docId='platform/biostar_x/settings-server-server' />.
