...
3. When the login screen appears, log in with the administrator account.
   ...
   * If you see a **Not Secure** warning in the web browser's address bar, you need to install the HTTPS certificate. For more information on installing a certificate, see <DocLink docId='platform/biostar_x/settings-server-https' />.
...
* **BioStar X** uses **port 443** by default. If there is a program using port **443**, close it and try connecting again. If you cannot close the program, run the **BioStar X Service Manager** to change the port number. For more information, see <DocLink docId='platform/biostar_x/change-port' />.
