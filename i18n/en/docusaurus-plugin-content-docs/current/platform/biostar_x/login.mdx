...
3. When the login screen appears, log in with the administrator account.
   ...
   * When you first log in, a **Not Secure** warning will be displayed in the address bar of your web browser. To apply the HTTPS protocol, refer to the [following](settings-server-https).
...
* **BioStar X** uses **port 443** by default. If there is a program using port **443**, close it and try connecting again. If you cannot close the program, run **BioStar Setting** to change the port number. For more information, refer to the [following](change-port).
