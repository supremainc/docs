...
* User PINs can be registered through CSV import. For more information, refer to the [following](#). {/* PIN 등록 > CSV 가져오기 */}
...
4. In the <Cmd sid='team.menu.export.dataFile.title' /> window, select the device to which the data file will be applied and click <Cmd sid='common.button.ok' />.
