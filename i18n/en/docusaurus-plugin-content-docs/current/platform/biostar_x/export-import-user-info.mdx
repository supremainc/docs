...
1. Click <IcMoreW /> in the top right corner of the screen, then select <Cmd sid='team.menu.export.title' /> → <Cmd sid='team.menu.export.csv' />.
...
1. Click <IcMoreW /> in the top right corner of the screen, then select <Cmd sid='team.menu.import.title' /> → <Cmd sid='team.menu.import.csv' />.
...
* User PINs can be registered through CSV import. For more information, refer to the [following](#) {/* PIN registration > CSV Import */}.
...
1. Click <IcMoreW /> in the top right corner of the screen, then select <Cmd sid='team.menu.export.title' /> → <Cmd sid='team.menu.export.dataFile' />.

1. In the <Cmd sid='team.menu.export.dataFile.title' /> window, select the device to which the data file will be applied and click <Cmd sid='common.button.ok' />.
