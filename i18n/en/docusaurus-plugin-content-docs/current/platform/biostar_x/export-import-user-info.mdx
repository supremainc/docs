...
When importing files exported from **BioStar X** into devices, you must rename the file name as follows. This will be automatically processed in future firmware updates for each device.
