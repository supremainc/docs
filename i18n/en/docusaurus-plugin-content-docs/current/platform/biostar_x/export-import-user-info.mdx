...
4. In the <Cmd sid='team.menu.export.csv' /> <Cmd sid='team.menu.import.title' /> window, set the <Cmd>Start import at row</Cmd> and click the <Cmd sid='common.button.continue' /> button.

   <Image src='/img/biostarx-user-import-01.png' />

5. User data fields from the CSV file will automatically map to user data fields in **BioStar X**. Click <Cmd>ReMap</Cmd> to remap fields with the same names.
