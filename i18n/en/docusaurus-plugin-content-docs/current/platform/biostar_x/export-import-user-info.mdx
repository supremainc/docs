...
<Cmd sid='team.menu.export.exportReason' /> is optional. Check records for export reasons in <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.auditTrail.root' /> → <Cmd sid='setting.menu.auditTrail.acAuditLog' />.
