...
You can set emergency open permissions to allow specific users to access all doors in emergency situations. When the door is opened with a card that has emergency open permissions, it will remain open for a certain time, allowing anyone to enter.
...
3. When the user preview screen appears, go to the <Cmd sid='team.user.credential.title' /> section.
...
Complete the setting of emergency open permissions. Users can open all doors with the access card that has been set with emergency open permissions.

:::info

* You can select more than one card credential to grant emergency open permissions.

* To revoke emergency open permissions, click the checkbox in the <Cmd sid='team.user.table.lockOverride' /> item for the selected card credentials again.
