...
You must first add the card credentials before setting the emergency open permissions. For more information on adding card credentials, see <DocLink docId='platform/biostar_x/enroll-credential-card' />.
...
* Depending on the device, emergency open functionality may not be supported. Refer to the supported devices and firmware versions below.
  ...
  * XPass Q2 firmware v1.0.0 or later
