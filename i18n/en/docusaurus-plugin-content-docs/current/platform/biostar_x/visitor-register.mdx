...
* The visitor application PC must be configured separately, and visitor settings must precede it. For more information on visitor settings, refer to <DocLink docId='platform/biostar_x/settings-visitor' />.

* If there is no shortcut icon for the visitor application page on the visitor application PC, see <DocLink docId='platform/biostar_x/settings-visitor#settings-visitor-pc-link' /> to create a shortcut icon.
...
* For more information on creating terms of use and a privacy policy for visitor access, see <DocLink docId='platform/biostar_x/settings-visitor#settings-visitor-terms' />.
...
* For more information on access groups, see <DocLink docId='platform/biostar_x/settings-access-control-manage-access-group' />.
