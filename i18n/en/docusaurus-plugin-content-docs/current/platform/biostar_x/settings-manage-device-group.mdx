...
keywords: [device, Device Group]
---

This document provides guidance on the device group feature that allows for efficient management of multiple devices. By using device groups, you can manage several devices bundled into one group, making it useful for applying settings or monitoring devices in large systems.
...
2. In the left sidebar, click <Cmd>Device</Cmd>.

3. Right-click <Cmd sid='menu.device.allDeviceGroups' product='2' /> in the device list.

4. Click <Cmd sid='device.addDeviceGroup' product='2' /> in the pop-up menu.
...
4. Click <Cmd sid='device.menu.renameDeviceGroup' product='2' /> in the pop-up menu.
