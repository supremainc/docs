...
7. Click the <Image src='/img/menus/ico-more-white.svg' ico alone /> button to access various features related to users.
   ...
   * <Cmd sid='team.menu.columnLayout' />: Change header items of columns in the user list. For more information, refer to the [following](view-users#user-list-column-settings).
