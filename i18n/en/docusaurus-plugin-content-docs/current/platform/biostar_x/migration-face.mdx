...
Before running the face migration feature, please check the following items.
...
3. After checking the warning pop-up message, click <Cmd sid='common.acknowledge' />.
...
* After a successful migration, please sync the user information to the device to apply the changes. For more information on how to send user information to the device, refer to the [following](transfer-user-info-to-device).
...
* For more information on how to save only the template without saving the user's facial image to the server, refer to the [following](#).
