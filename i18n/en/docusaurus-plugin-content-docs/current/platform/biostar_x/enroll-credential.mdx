...
Enroll credentials and set the appropriate security level in the <Cmd sid='user.fingerSecurityLevel' product='2' /> field. A higher security level may lead to a lower authentication rate or a higher false rejection rate (FRR).
...
* Mobile access cards must be linked with the Airfob portal to be used. For more information on integrating with the Airfob portal and using mobile access cards, see <DocLink docId='platform/biostar_x/settings-credential-mobile-access-card' />.

:::

## Enroll credentials {/* #enroll-credential */}
