...
* Mobile access cards must be linked with the AirPop portal to be used. For more information on integrating with the AirPop portal and using mobile access cards, see <DocLink docId='platform/biostar_x/settings-credential-mobile-access-card' />.
