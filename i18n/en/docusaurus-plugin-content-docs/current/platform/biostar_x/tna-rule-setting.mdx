...
For more information on the <Cmd sid='tab.payCode' product='2' className='normal' /> settings, see <DocLink docId='platform/biostar_x/tna-rule-shift-paycode' />.
...
For more information on the <Cmd sid='tab.shift' product='2' className='normal' /> settings, see <DocLink docId='platform/biostar_x/tna-rule-shift-day' />.
...
For more information on the <Cmd sid='tab.scheduleTemplate' product='2' className='normal' /> settings, see <DocLink docId='platform/biostar_x/tna-rule-shift-schedule' />.
...
For more information on the <Cmd sid='rule.rule' product='2' className='normal' /> settings, see <DocLink docId='platform/biostar_x/tna-rule-shift-overtime' />.
...
For more information on the <Cmd sid='ta.schedule' product='2' className='normal' /> settings, see <DocLink docId='platform/biostar_x/tna-rule-schedule' />.
