...
## Register occupancy limit {/* #addOccupancyZone */}
...
6. Configure the details of the occupancy limit setting in the <Cmd sid='common.configuration' product='2' /> section. For more information, see <DocLink inner='#setting' />.

7. In the <Cmd sid='zone.occupancy.countByPass' product='2' /> section, you can select access groups that can always bypass the occupancy limit setting. For more information, see <DocLink inner='#countByPass' />.
...
* A device configured with <Cmd sid='door.dualAuthentication' product='2' /> on a door cannot be assigned to <Cmd sid='zone.entryDevices' product='2' /> or <Cmd sid='zone.exitDevices' product='2' />.
...
## Always-pass headcount setting {/* #countByPass */}
