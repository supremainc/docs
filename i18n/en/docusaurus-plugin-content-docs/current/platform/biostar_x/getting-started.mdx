...
* If you are using Windows 8.1, refer to the following link to install the KB2919355 update. Link 1

* If you are using MS SQL 2012 Express, refer to the following link to install the Service Pack 3. [Link 2](https://www.microsoft.com/download/details.aspx?id=49996)

* If you are using MS SQL 2014 Express, refer to the following link to install Service Pack 2. [Link 3](https://www.microsoft.com/en-us/download/details.aspx?id=53168)
