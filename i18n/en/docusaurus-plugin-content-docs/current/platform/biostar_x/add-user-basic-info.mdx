...
* <Cmd sid='team.user.table.id' /> may have different values that can be set according to the <Cmd sid='setting.menu.server.server' /> menu under <Cmd sid='shell.header.setting' /> → <Cmd sid="setting.userDevice.useridType" product='2' /> option. For more information, see <DocLink docId='platform/biostar_x/settings-server-server#userid-type' />.
