...
* **Photo**: Register the user's photo. You can take a photo with the webcam or upload a photo from your PC. When you hover over the profile, the tools available will be displayed.
  ...
  * <IcUpload/>: You can upload an image file saved on your PC.
  ...
  For more information, see <DocLink docId='platform/biostar_x/enroll-credential-face#erollbywebcambyphoto' />.
...
* Select <Cmd sid='team.user.table.group' />: Select the user's group. For more information on adding and managing user groups, see <DocLink docId='platform/biostar_x/user-group-manage' />.
...
* The available values for <Cmd sid='team.user.table.id' /> vary by the <Cmd sid="setting.userDevice.useridType" product='2' /> option in the <Cmd sid='shell.header.setting' /> → <Cmd sid='setting.menu.system.root' /> → <Cmd sid='setting.menu.server.server' /> menu. For more information, see <DocLink docId='platform/biostar_x/settings-server-server#userid-type' />.
...
For more information on adding <Cmd sid='team.userTemplate.table.customField' />, see <DocLink docId='platform/biostar_x/settings-server-server#custom-field' />.
