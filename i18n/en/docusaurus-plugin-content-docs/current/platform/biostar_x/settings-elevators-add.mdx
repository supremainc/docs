...
* Set the access level, access group, and floor level for access control before registering the elevator. For more information, see <DocLink docId='platform/biostar_x/settings-access-control' />.
...
3. Click <Cmd sid='elevator.add.button' product='2' /> in the upper left of the screen.

   <Image src='/img/biostarx-setting-elevator-add-btn.png' />

4. Once the <Cmd sid='elevator.new.title' product='2' /> screen appears, set each section item in order.

   * <Cmd sid='common.information' product='2' />: Set the basic information for the elevator. For more information, see <DocLink inner='#info' />.

   * <Cmd sid='common.detail' product='2' />: Set the detailed information for the elevator. For more information, see <DocLink inner='#details' />.
...
* For more information on registering elevator groups, see <DocLink docId='platform/biostar_x/settings-manage-elevators-group' />.
...
In the <Cmd sid='door.alarm' product='2' /> section, you can set actions to be performed when tamper inputs or separate input signals are detected. Click <Cmd sid='button.plusAdd' product='2' /> to add work conditions and actions.
