...
* Set the access level, access group, and floor level for access control before enrolling the elevator. For more information, refer to [this document](#).
...
2. Click <Cmd>Elevator</Cmd> on the left sidebar of the screen.
