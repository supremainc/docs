...
* Set the access level, access group, and floor level for access control before registering the elevator. For more information, refer to [this document](#).
...
* For more information on registering elevator groups, refer to the [following](settings-manage-elevators-group).
