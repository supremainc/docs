...
* The <Cmd sid='user.adsync.exclude' product='2' /> option is available as an add-on for **Essential** licenses or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
