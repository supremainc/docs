...
You can change the default device name. Enter your desired device name in the <Cmd sid='device.info.name' product='2' /> field. You can enter a device name up to 48 characters. The device name can be up to 48 characters long and is used to identify the device in the device list.
...
For more information on creating, renaming, or deleting device groups, see <DocLink docId='platform/biostar_x/settings-manage-device-group' />.

:::

## Firmware upgrade

You can check the device's firmware version in the <Cmd sid='device.info.firmwareVersion' product='2' /> section. To upgrade the firmware, click the <Cmd sid='button.firmwareUpgrade' product='2' /> button.

:::info

For more information on upgrading device firmware, see <DocLink docId='platform/biostar_x/settings-device-upgrade-firmware' />.
...
* <Cmd sid='common.dst' product='2' />: You can apply the user's configured daylight saving time to the device. To add a new daylight saving time, see <DocLink docId='platform/biostar_x/settings-system-daylight-saving-time' />.
...
When the device is locked due to operating conditions and actions, click the <Cmd sid='device.info.locked' product='2' /> <Cmd sid='device.info.unlock' product='2' /> button to unlock the device. You can unlock the device.

:::info

For more information on trigger conditions and action settings, see <DocLink docId='platform/biostar_x/settings-triger-and-action' />.
