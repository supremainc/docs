...
* To check if there are any issues with the SMTP settings, enter the email address to receive the email and click <Cmd sid="button.smtpSettingTest" product='2' />.
