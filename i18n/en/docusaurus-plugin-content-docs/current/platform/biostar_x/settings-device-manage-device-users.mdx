...
keywords: [ Device, User ]
---

You can check the number of users, fingerprints, faces, and cards enrolled on the device. Information about users not registered on **BioStar X** can be compared with registered user information, and you can send or delete this information on the **BioStar X** server.

1. Click  <Cmd sid='shell.header.setting' /> from the <Cmd sid='shell.header.launcher' /> page.

1. Click <Cmd>Device</Cmd> on the left sidebar.

1. Select the device from the <Cmd sid='menu.device.allDeviceGroups' product='2' /> list and right-click.

1. Click <Cmd sid='button.manageUsersInDevice' product='2' /> from the pop-up menu.
...
* <Cmd sid='user.syncStatus.same' product='2' />: User not registered on the **BioStar X** server
...
* For more information on the device's settings, refer to [the following document](#).
