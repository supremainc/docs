...
* The add zone and settings feature is available through additional options with an **Essential** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
...
3. Click <Cmd sid='setting.area.table.action.newArea' /> in the upper right of the area list screen.
...
7. Set the zone in your desired shape. Click the mouse to start drawing and drag to set the zone.
   ...
   To reset the area, you must delete the configured area. To delete the area, click <IcFremove />.
...
10. Once the area settings are complete, click <Cmd sid='button.apply' product='2' /> in the lower right of the screen.
...
4. In the map under the <Cmd sid='setting.area.configuration.section.title' /> section, click <IcFremove /> at the top left of the already created area.
...
6. To set the area as desired and save, click <Cmd sid='button.apply' product='2' /> in the lower right of the screen.
