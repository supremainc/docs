...
You can configure floors and facilities and manage zones. You can manage and verify the zones you are securing through the map. Configuring zones provides functionality to access and monitor the facilities and floors in the respective zone on the <Cmd sid='shell.header.arena' /> page.
...
1. Click <Cmd sid='setting.menu.map.root' /> → <Cmd sid='setting.menu.map.area' /> on the left sidebar.

1. Click <Cmd>New Area</Cmd> at the top right of the zone list screen.

1. Enter the name and description of the zone you want to add in the <Cmd sid='setting.area.information.section.title' /> section of the <Cmd sid='setting.area.page.title' /> screen.

1. Set the location of the zone to add on the map in the <Cmd sid='setting.area.configuration.section.title' /> section.

1. Right-click on the map and select <Cmd sid='setting.area.label.setArea' />.

    <Image src='/img/biostarx-settings-map-area-add-01.png' />

1. Set the zone in your desired shape. Click the mouse to start drawing and drag to set the zone.

    <Image src='/img/biostarx-settings-map-area-drawing.gif' alone />

1. To add facilities to the configured zone, right-click and select <Cmd>Add Facility</Cmd>.
...
1. When the <Cmd sid='setting.area.label.addFacility' /> window appears, select the facility to add and click <Cmd sid='common.apply' />.
...
1. Click <Cmd>Apply</Cmd> when you complete the zone configuration.
...
1. Select the zone you want to reset from the zone list.

1. Click the existing zone on the map in the <Cmd sid='setting.area.configuration.section.title' /> section.

1. When the zone deletion confirmation message appears, click <Cmd sid='common.delete' />.

    <Image src='/img/biostarx-settings-map-area-reset.png' />

1. Right-click on the map and select <Cmd sid='setting.area.label.setArea' />.

1. Set the zone in your desired shape and click <Cmd sid='common.apply' /> to save.
...
1. Check the checkbox of the zone you want to delete from the zone list.

1. Click <Cmd sid='common.delete' /> at the top right of the screen.
