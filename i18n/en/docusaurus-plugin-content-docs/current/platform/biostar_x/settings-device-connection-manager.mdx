...
* For specifications and installation of the communication server, refer to the following documents.
  ...
  * Click the following to install the communication server
...
4. Select the device(s) you want to move from the device list. You can select multiple devices.
...
5. In the <Cmd sid='settings.deviceConnectionManager.selectedSelectLabel' product='2' /> section on the right, select the target server to which you want to move the devices.

6. To move the devices, click the <Cmd sid='settings.deviceConnectionManager.moveButtonTitle' product='2' /> button.

7. In the message window, verify the total number of devices to be moved, the number of TCP/IP connected devices, and the name and IP address of the server to which you are moving.

8. Click the <Cmd sid='button.apply' product='2' /> button.
