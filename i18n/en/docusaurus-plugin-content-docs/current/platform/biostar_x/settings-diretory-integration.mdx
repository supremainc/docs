...
* The **Entra ID** integration setting is available in **BioStar 2.9.9** or later.
...
1. Click <Cmd sid='setting.activeDirectory.menu' product='2' /> on the left sidebar.

1. Select <Cmd sid='settings.activeDirectory.AdServerNew' product='2' /> in <Cmd sid='settings.activeDirectory.title' product='2' />.
...
1. Select <Cmd sid='settings.activeDirectory.AdServerOld' product='2' /> in <Cmd sid='settings.activeDirectory.title' product='2' />.
...
1. Go to the <Cmd sid='common.user' product='2' /> menu.

1. Click on the user you want to exclude from the integration in the <Cmd sid='menu.user.allUserGroups' product='2' /> list.

1. When the detail information screen of the selected user appears, click the checkbox of <Cmd sid='user.adsync.exclude' product='2' /> in <Cmd sid='common.advanced' product='2' />.

    <Image src='/img/biostar2-user-advance-exclude-sync.png' />

1. Click <Cmd sid='button.apply' product='2' />.
...
1. Click <Cmd sid='common.setting' product='2' /> → <Cmd sid='setting.activeDirectory.menu' product='2' />.

1. Select <Cmd sid='settings.activeDirectory.notUse' product='2' /> in <Cmd sid='settings.activeDirectory.title' product='2' />.

    <Image src='/img/biostar2-setting-directory-unset.png' />

1. When the <Cmd sid='alert.warning' product='2' /> message appears, click <Cmd sid='button.continue' product='2' />.
