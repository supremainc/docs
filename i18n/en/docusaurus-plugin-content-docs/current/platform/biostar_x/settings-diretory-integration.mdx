...
## Integrate with Entra ID {#intergratewithentraid}
...
## Integrate with Active Directory {#integratewithactivedirectory}
...
## Exclude the directory integration {#excludeintegration}
