...
The **Entra ID** or **Active Directory** integration setting is available when the **Advance** license is activated. For more information about the license policy, refer to the [following](licensing).
