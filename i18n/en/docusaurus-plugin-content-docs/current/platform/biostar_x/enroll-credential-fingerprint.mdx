...
* <Cmd sid='common.quality' product='2' />: You can adjust the fingerprint enrollment quality. Cannot enroll fingerprint information if it does not meet the configured quality level.
...
* <Cmd sid='button.scan' product='2' />: Select the added fingerprint number and click the button. Place your finger on the fingerprint scanner or device sensor to scan the fingerprint.

  <Image src='/img/biostarx-new-user-credential-finger-nth.png' />

* <Cmd sid='button.delete' product='2' />: This allows deleting an enrolled fingerprint. Select the fingerprint number to delete and click the button.

* <Cmd sid='button.chkDuplicated' product='2' />: You can check if it is a previously enrolled fingerprint.

* <Cmd sid='user.duress' product='2' />: To enroll a fingerprint as a [duress fingerprint](../../reference/glossary#duress), select this option and scan the fingerprint. If you are threatened or forced to open the door, you can use that fingerprint to send a notification.
