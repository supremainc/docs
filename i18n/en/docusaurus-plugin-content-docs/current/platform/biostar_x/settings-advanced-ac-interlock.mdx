...
## Register interlock {/* #addInterlockZone */}
...
6. Set the details of the interlock setting in the <Cmd sid='common.setting' product='2' /> section. For more information, see <DocLink inner='#setting' />.
