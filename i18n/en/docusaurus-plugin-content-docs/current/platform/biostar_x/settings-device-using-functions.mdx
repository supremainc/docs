...
1. Select the device from the <Cmd sid='menu.device.allDeviceGroups' product='2' /> list and right-click.

1. Select the desired feature from the pop-up menu.
...
* <Cmd sid='button.batchEdit' product='2' />: Change information for multiple devices at once. This option is available when selecting more than one device. For more information on device information settings, refer to the [following document](#).

* <Cmd sid='button.manageUsersInDevice' product='2' />: Upload or delete user information registered on the device in **BioStar X**. For more details, refer to the [following document](settings-device-manage-device-users).

* <Cmd sid='button.firmwareUpgrade' product='2' />: Easily upgrade the device firmware. For more details, refer to the [following document](settings-device-upgrade-firmware).
...
* For more information on the <Cmd sid='device.menu.addWiegandDevice' product='2' /> feature, refer to [the following document](settings-adding-wiegand).

* For more information on the <Cmd sid='device.menu.searchSlaveDevice' product='2' /> feature, refer to [the following document](settings-adding-slave-device).
