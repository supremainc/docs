...
* <Cmd sid='button.manageUsersInDevice' product='2' />: Upload or delete user information registered on the device in **BioStar X**. For more information, refer to the [following document](settings-device-manage-device-users).

* <Cmd sid='button.firmwareUpgrade' product='2' />: Easily upgrade the device firmware. For more information, refer to the [following document](settings-device-upgrade-firmware).
