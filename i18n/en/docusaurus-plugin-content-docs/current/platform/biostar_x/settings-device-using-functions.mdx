...
* <Cmd sid='button.batchEdit' product='2' />: Change information for multiple devices at once. This option is available when selecting more than one device. For more information on device information settings, refer to the [following](#).
...
* For more information on the <Cmd sid='device.menu.addWiegandDevice' product='2' /> feature, refer to the [following](settings-adding-wiegand).

* For more information on the <Cmd sid='device.menu.searchSlaveDevice' product='2' /> feature, refer to the [following](settings-adding-slave-device).
