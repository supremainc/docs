...
* For more details on the settings in the <Cmd sid='video.setting.tag.title' product='2' /> section, refer to [the following](#vms-event-bookmark).
...
If the VMS server is integrated normally, you can check the connected cameras in the <Cmd sid='setting.menu.video.root' /> → <Cmd sid='setting.menu.video.video' /> menu. For more details, refer to the [the following](settings-videos-camera).
...
* For more details on the bookmark function in VMS, refer to [the following link](https://resources.vmsproxy.com/nx_6.0_help/using_bookmarks.html).

* For more details on the event function in VMS, refer to [the following link](https://resources.vmsproxy.com/nx_6.0_help/events_available_in_vms.html).
