...
You can check the access history of the user in the <Cmd sid='team.event.trace' /> section below the preview screen. 

:::info

* You can check real-time access events on the <Cmd sid='shell.header.arena' /> page. For more information, see <DocLink docId='platform/biostar_x/monitoring-event' />.

* Past access events can be viewed on the <Cmd sid='shell.header.data' /> page. For more information, see <DocLink docId='platform/biostar_x/how-to-guide-data' />.
