...
* You must first generate a report to modify the attendance records. For more information on generating reports, see <DocLink docId='platform/biostar_x/tna-report' />.
...
2. **Daily attendance record**: Shows the daily attendance record.
   ...
   * Click in/out times to add/modify/delete attendance records. After clicking the in/out times, click <IcEdit /> to modify the registered attendance record, and click <Cmd sid='button.apply' product='2' /> to save changes.

   * Click <IcEdit /> to add an absence. You need a time code set as absence to add vacation. Click <IcTrash2 /> for the added user absence to delete it.
...
For more information on creating time rules, see <DocLink docId='platform/biostar_x/tna-rule-shift-paycode' />.
...
3. **Daily attendance record**: Shows the daily attendance record.
   ...
   * Click working hours (in white) to add/modify/delete attendance records. Click <IcEdit /> to modify the registered attendance record, and click <Cmd sid='button.apply' product='2' /> to save changes.
