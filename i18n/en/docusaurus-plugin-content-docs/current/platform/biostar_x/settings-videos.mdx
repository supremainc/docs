...
The video settings feature is available through additional options with an **Advanced** license or higher. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.
