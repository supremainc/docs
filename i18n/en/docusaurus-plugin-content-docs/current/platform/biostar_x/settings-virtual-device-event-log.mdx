...
The **Event Log API** license must be activated. For more information on licensing policies, see <DocLink docId='platform/biostar_x/licensing#features-add-ons' />.

:::info

For more information on applying licenses, see <DocLink docId='platform/biostar_x/settings-license-biostar-x-license' />.
...
For more information on device groups, see <DocLink docId='platform/biostar_x/settings-manage-device-group' />.
...
* Cannot be specified as a device for <Cmd sid='shell.header.tna' /> setting.
...
* For more information on using the API, see the [BioStar X API](../../developer/bsxapi?api=virtual-device-event-import).
...
* For more information on viewing events in the <Cmd sid='shell.header.arena' /> menu, see <DocLink docId='platform/biostar_x/monitoring-event' />.

* For more information on the <Cmd sid='shell.header.data' /> menu, see <DocLink docId='platform/biostar_x/data-generate-reports' />.
...
* For more information on <Cmd sid='setting.menu.system.auditTrail' />, see <DocLink docId='platform/biostar_x/settings-system-audit-trail' />.
