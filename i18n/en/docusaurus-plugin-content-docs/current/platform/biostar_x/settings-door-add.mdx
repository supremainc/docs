...
* Set access levels, access groups, and floor levels for access control before enrolling doors. For more information, refer to [this document](#).

* Enroll devices before registering doors. For more information on device enrollment, refer to the following.
...
* <Cmd sid='door.dualAuthentication' product='2' />: Set to require two people (a regular user and an administrator) to authenticate credentials to open the door.
  ...
  * For more details on schedule settings, refer to [the following document](settings-schedule).
