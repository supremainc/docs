...
* If you change information for a user who is already registered on the device, you must resend the user information to reflect the changes on the device. To use the option to synchronize user information with the device via <Cmd sid='setting.server.automaticUserSync' product='2' />, refer to the [following](#).
