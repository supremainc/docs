...
* You can approve visitor requests or add visitors from the overall visitor list. For more information on visitor registration, see <DocLink docId='platform/biostar_x/visitor-register' />.
