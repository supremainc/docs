...
* When two or more network adapters (LAN cards) are installed on the server
...
If none of the above situations apply, there is no need to change the network priority. Skip this step and proceed with the installation of **BioStar X**. For detailed instructions on installing **BioStar X**, see <DocLink docId='platform/biostar_x/express-install' />.
