...
If none of the above situations apply, there is no need to change the network priority. Skip this step and proceed with the installation of **BioStar X**. For more information on installing **BioStar X**, see <DocLink docId='platform/biostar_x/express-install' />.
