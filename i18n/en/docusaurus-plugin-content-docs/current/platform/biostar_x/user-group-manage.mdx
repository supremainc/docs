...
2. On the left sidebar of the screen, select <Cmd sid='team.user.tree.userGroupRootName' /> from the <Cmd sid='team.tree.userGroup' /> tab and right-click.
...
You can expand or collapse the user group list. In the <Cmd sid='team.tree.userGroup' /> tab, select <Cmd sid='team.user.tree.userGroupRootName' /> and right-click. Click <Cmd sid='team.expandAll' /> or <Cmd sid='team.collapseAll' /> in the popup menu.

<Image src='/img/biostarx-user-group-expand-collapse.png' />

If there are subgroups within the group, you can expand or collapse them. Select the parent group and right-click. Click <Cmd sid='common.tree.contextMenu.expandBelow' /> or <Cmd sid='common.tree.contextMenu.collapseBelow' /> in the popup menu.
