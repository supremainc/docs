...
* Multiple Master Admins can be registered, and they are deleted only through factory reset.
...
* Firmware downgrade is not allowed on new devices.
...
1. To register a **Master Admin**, you must register at least two types of credentials. Select and enroll your preferred two credential types.
...
* Firmware-upgraded devices support firmware downgrade, and the two-step authentication info will be deleted when downgrading.
