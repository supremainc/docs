...
* [Directory Integration Settings](../platform/biostar_x/settings-diretory-integration): Added **Add/Update/Delete** modes to directory service integration settings
...
* [Set Up the Camera](../platform/biostar_x/settings-videos-camera#addCameraPermission): Added instructions for configuring camera group permission settings

* Added support specifications for BioStation 3 Max and XPass Q2 devices
...
* Applied v1.0.2 update for [BioEntry W3](../device/bioentry_w3/)

  * Updated wall mount bracket images

  * Added [RS-485 usage precautions](../device/bioentry_w3/getting-started#cable)
