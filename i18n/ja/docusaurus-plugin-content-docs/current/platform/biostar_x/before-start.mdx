...
* **BioStar X** が使用するポートの既定値については、<DocLink docId='platform/biostar_x/service-settings' />をご参照ください。他のプログラムが同じポートを占有している場合、**BioStar X** が正常に動作しない可能性があります。
...
#### Windows 認証のデータベース設定 {/* #windows-authentication-database-settings */}
