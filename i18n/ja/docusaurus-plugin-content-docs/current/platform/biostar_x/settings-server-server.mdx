...
<Cmd sid='common.serverMatching' product='2' /> は **アドバンス**(Advanced) 以上のライセンスで機能追加オプション(Feature Add-ons)を有効にした場合に使用できます。 ライセンス ポリシーの詳細については、[次のドキュメント](licensing) を参照してください。
