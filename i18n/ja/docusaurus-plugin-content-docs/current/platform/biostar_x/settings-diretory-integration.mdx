...
**Entra ID** または **Active Directory** 設定機能は、**アドバンス** ライセンス以上で追加オプションとして利用できます。 ライセンスポリシーの詳細については、<DocLink docId='platform/biostar_x/licensing#features-add-ons' />を参照してください。
...
Entra IDと連携するには、<Cmd sid='common.setting' product='2' /> → <Cmd sid='setting.server' product='2' /> メニューで<Cmd sid='setting.userDevice.useridType' product='2' />項目を<Cmd sid='setting.userDevice.useridType.alphanumeric' product='2' />に設定する必要があります。
...
* Active Directoryと連携するには、<Cmd sid='common.setting' product='2' /> → <Cmd sid='setting.server' product='2' /> メニューで<Cmd sid='setting.userDevice.useridType' product='2' />項目を<Cmd sid='setting.userDevice.useridType.alphanumeric' product='2' />に設定する必要があります。
