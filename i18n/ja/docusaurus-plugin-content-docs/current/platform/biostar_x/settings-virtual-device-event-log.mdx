...
「イベントログ API」ライセンスが有効になっている必要があります。ライセンスポリシーの詳細については、<DocLink docId='platform/biostar_x/licensing#features-add-ons' />を参照してください。

:::info

ライセンスの適用に関する詳細は、<DocLink docId='platform/biostar_x/settings-license-biostar-x-license' />を参照してください。
...
デバイスグループの詳細については、<DocLink docId='platform/biostar_x/settings-manage-device-group' />を参照してください。
...
* API の利用に関する詳細は[BioStar X API](../../developer/bsxapi?api=virtual-device-event-import)を参照してください。
...
* <Cmd sid='shell.header.arena' /> メニューでのイベント照会の詳細は、<DocLink docId='platform/biostar_x/monitoring-event' />を参照してください。

* <Cmd sid='shell.header.data' /> メニューに関する詳細は、<DocLink docId='platform/biostar_x/data-generate-reports' />を参照してください。
...
* <Cmd sid='setting.menu.system.auditTrail' /> について詳しくは、<DocLink docId='platform/biostar_x/settings-system-audit-trail' />を参照してください。
