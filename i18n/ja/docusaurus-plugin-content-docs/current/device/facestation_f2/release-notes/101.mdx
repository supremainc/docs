...
1. Time shown on the device was displayed incorrectly when setting up time with the BioStar Device SDK.

1. An abnormal device shutdown occurred when sending face templates of FaceStation 2 or FaceLite to the device by using the BioStar Device SDK.
