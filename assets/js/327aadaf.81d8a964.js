...
var site_docs_platform_biostar_air_video_troubleshotting_mdx_327_namespaceObject = JSON.parse('{"id":"platform/biostar_air/video-troubleshooting","title":"비디오 재생 관련 문제 해결","description":"BioStar Air에서 비디오 재생 문제 해결 및 ONVIF Profile G 지원 여부, 코덱 호환성, SD 카드 포맷 문제 해결 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/video-troubleshotting.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/video-troubleshooting","permalink":"/platform/biostar_air/video-troubleshooting","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/video-troubleshotting.mdx","tags":[],"version":"current","frontMatter":{"id":"video-troubleshooting","title":"비디오 재생 관련 문제 해결","description":"BioStar Air에서 비디오 재생 문제 해결 및 ONVIF Profile G 지원 여부, 코덱 호환성, SD 카드 포맷 문제 해결 방법을 안내합니다.","keywords":["IP 카메라","녹화된 비디오 재생","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"IP 카메라 지원 및 설정하기","permalink":"/platform/biostar_air/ip-camera-support-and-configuration"},"next":{"title":"개요","permalink":"/platform/biostar_air/suprema-pass-app-overview"}}')
