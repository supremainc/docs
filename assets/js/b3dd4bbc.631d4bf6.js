"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["21038"], {
...
var site_docs_platform_biostar_x_enroll_credential_mobile_mdx_b3d_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-mobile","title":"모바일 출입 카드 등록하기","description":"슈프리마의 에어팝 포털(Airfob Portal)과 연동하여 모바일 출입 카드를 사용하면, 사용자에게 모바일 출입 카드를 발급할 수 있습니다.","source":"@site/docs/platform/biostar_x/enroll-credential-mobile.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-mobile","permalink":"/platform/biostar_x/enroll-credential-mobile","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-mobile.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-mobile","title":"모바일 출입 카드 등록하기","description":"슈프리마의 에어팝 포털(Airfob Portal)과 연동하여 모바일 출입 카드를 사용하면, 사용자에게 모바일 출입 카드를 발급할 수 있습니다.","keywords":["모바일 출입 카드","등록","크리덴셜","인증","카드"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"출입 카드 등록하기","permalink":"/platform/biostar_x/enroll-credential-card"},"next":{"title":"QR/Barcode 등록하기","permalink":"/platform/biostar_x/enroll-credential-qrbarcode"}}')
