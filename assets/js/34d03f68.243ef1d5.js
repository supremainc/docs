...
var site_docs_platform_biostar_x_user_manage_mdx_34d_namespaceObject = JSON.parse('{"id":"platform/biostar_x/user-manage","title":"사용자 관리하기","description":"사용자를 추가하고 기본 정보 및 권한, 크리덴셜을 등록하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/user-manage.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/user-manage","permalink":"/docs/platform/biostar_x/user-manage","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/user-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"user-manage","title":"사용자 관리하기","description":"사용자를 추가하고 기본 정보 및 권한, 크리덴셜을 등록하는 방법을 안내합니다.","keywords":["사용자","크리덴셜","기본 정보"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자 그룹 관리하기","permalink":"/docs/platform/biostar_x/user-group-manage"},"next":{"title":"사용자 추가하기","permalink":"/docs/platform/biostar_x/add-user"}}')
