...
var site_docs_platform_biostar_x_lockoverride_mdx_4b8_namespaceObject = JSON.parse('{"id":"platform/biostar_x/lockoverride","title":"비상 개방 허용하기","description":"비상 상황에서 특정 사용자의 카드 크리덴셜에 출입을 허용하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/lockoverride.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/lockoverride","permalink":"/docs/platform/biostar_x/lockoverride","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/lockoverride.mdx","tags":[],"version":"current","frontMatter":{"id":"lockoverride","title":"비상 개방 허용하기","description":"비상 상황에서 특정 사용자의 카드 크리덴셜에 출입을 허용하는 방법을 안내합니다.","keywords":["비상","개방","출입"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"얼굴 마이그레이션","permalink":"/docs/platform/biostar_x/migration-face"},"next":{"title":"모니터링","permalink":"/docs/platform/biostar_x/how-to-guide-monitoring"}}')
