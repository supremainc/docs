...
var site_docs_device_facestation_2_installation_mdx_70e_namespaceObject = JSON.parse('{"id":"device/facestation_2/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/facestation_2/installation.mdx","sourceDirName":"device/facestation_2","slug":"/device/facestation_2/installation","permalink":"/device/facestation_2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/facestation_2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"facestation2","previous":{"title":"시작하기","permalink":"/device/facestation_2/getting-started"},"next":{"title":"사용하기","permalink":"/device/facestation_2/using-device"}}')
