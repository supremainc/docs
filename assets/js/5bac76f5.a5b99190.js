"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["61935"], {
...
var site_docs_platform_biostar_x_settings_map_manage_facility_mdx_5ba_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-map-manage-facility","title":"시설 구성하기","description":"시설을 구성하고 층을 배치하세요. 층을 순차적으로 배치하여 실제 시설의 구조를 표현할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-map-manage-facility.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-map-manage-facility","permalink":"/platform/biostar_x/settings-map-manage-facility","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-map-manage-facility.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-map-manage-facility","title":"시설 구성하기","description":"시설을 구성하고 층을 배치하세요. 층을 순차적으로 배치하여 실제 시설의 구조를 표현할 수 있습니다.","keywords":["구역","시설","층"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"층 구성하기","permalink":"/platform/biostar_x/settings-map-manage-floor"},"next":{"title":"구역 구성하기","permalink":"/platform/biostar_x/settings-map-manage-area"}}')
