...
var site_docs_platform_biostar_air_diff_unlock_lock_schedule_mdx_9d5_namespaceObject = JSON.parse('{"id":"platform/biostar_air/diff-unlock-lock-schedule","title":"열림 스케줄과 잠김 스케줄 차이 이해하기","description":"BioStar Air의 열림 스케줄과 잠김 스케줄의 차이를 비교하고 각각의 사용 사례를 소개합니다.","source":"@site/docs/platform/biostar_air/diff-unlock-lock-schedule.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/diff-unlock-lock-schedule","permalink":"/docs/platform/biostar_air/diff-unlock-lock-schedule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/diff-unlock-lock-schedule.mdx","tags":[],"version":"current","frontMatter":{"id":"diff-unlock-lock-schedule","title":"열림 스케줄과 잠김 스케줄 차이 이해하기","description":"BioStar Air의 열림 스케줄과 잠김 스케줄의 차이를 비교하고 각각의 사용 사례를 소개합니다.","keywords":["열림 스케줄","잠김 스케줄","스케줄","출입 제어"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"비디오 재생 관련 문제 해결","permalink":"/docs/platform/biostar_air/video-troubleshooting"},"next":{"title":"v2.11","permalink":"/docs/platform/biostar_air/release-notes/v2_11"}}')
