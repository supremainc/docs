...
var site_docs_platform_biostar_x_settings_videos_rule_mdx_170_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-videos-rule","title":"비디오 규칙 설정하기","description":"BioStar X에서 VMS와 연동하여 비디오 규칙을 설정하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-videos-rule.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-videos-rule","permalink":"/platform/biostar_x/settings-videos-rule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-videos-rule.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-videos-rule","title":"비디오 규칙 설정하기","description":"BioStar X에서 VMS와 연동하여 비디오 규칙을 설정하는 방법을 안내합니다.","keywords":["카메라","규칙","설정"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"카메라 설정하기","permalink":"/platform/biostar_x/settings-videos-camera"},"next":{"title":"맵 관리하기","permalink":"/platform/biostar_x/settings-map-management"}}')
