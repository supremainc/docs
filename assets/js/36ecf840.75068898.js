"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6139"], {
...
6535: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_x_express_install_mdx_36e_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-x-express-install-mdx-36e.json
var site_docs_platform_biostar_x_express_install_mdx_36e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/express-install","title":"간편 설치하기","description":"내장된 MariaDB 서버와 데이터베이스를 자동으로 생성하여 BioStar X를 빠르게 설치하는 과정을 안내합니다.","source":"@site/docs/platform/biostar_x/express-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/express-install","permalink":"/docs/platform/biostar_x/express-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/express-install.mdx","tags":[],"version":"current","frontMatter":{"id":"express-install","title":"간편 설치하기","description":"내장된 MariaDB 서버와 데이터베이스를 자동으로 생성하여 BioStar X를 빠르게 설치하는 과정을 안내합니다.","keywords":["간편 설치"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"네트워크 우선순위 확인하기","permalink":"/docs/platform/biostar_x/check-ethernet"},"next":{"title":"사용자 정의 설치하기","permalink":"/docs/platform/biostar_x/custom-install"}}')
...
;// CONCATENATED MODULE: ./docs/platform/biostar_x/express-install.mdx
