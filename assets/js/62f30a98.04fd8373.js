...
var site_docs_platform_biostar_x_service_settings_mdx_62f_namespaceObject = JSON.parse('{"id":"platform/biostar_x/service-settings","title":"서비스 설정","description":"BioStar X Service Manager의 Service Settings에서는 시스템의 핵심 서비스들을 구성하고 관리할 수 있습니다.","source":"@site/docs/platform/biostar_x/service-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/service-settings","permalink":"/platform/biostar_x/service-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/service-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"service-settings","title":"서비스 설정","description":"BioStar X Service Manager의 Service Settings에서는 시스템의 핵심 서비스들을 구성하고 관리할 수 있습니다.","keywords":["Service Settings","Service Manager","BioStar X"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"서버 시작 및 종료","permalink":"/platform/biostar_x/manage-server"},"next":{"title":"포트 변경하기","permalink":"/platform/biostar_x/change-port"}}')
