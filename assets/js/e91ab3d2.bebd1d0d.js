"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["15249"], {
69171: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_user_group_manage_mdx_e91_namespaceObject = JSON.parse('{"id":"platform/biostar_x/user-group-manage","title":"사용자 그룹 관리하기","description":"사용자 그룹을 활용하여 관리 효율성, 확장성을 높이고 출입 통제 운영을 최적화하세요.","source":"@site/docs/platform/biostar_x/user-group-manage.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/user-group-manage","permalink":"/platform/biostar_x/user-group-manage","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/user-group-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"user-group-manage","title":"사용자 그룹 관리하기","description":"사용자 그룹을 활용하여 관리 효율성, 확장성을 높이고 출입 통제 운영을 최적화하세요.","keywords":["사용자","그룹","출입 통제"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자","permalink":"/platform/biostar_x/how-to-guide-user"},"next":{"title":"사용자 등록하기","permalink":"/platform/biostar_x/add-user"}}')
...
const frontMatter = {
	...
	title: '사용자 그룹 관리하기',
	description: '사용자 그룹을 활용하여 관리 효율성, 확장성을 높이고 출입 통제 운영을 최적화하세요.',
	keywords: [
		'사용자',
		'그룹',
		'출입 통제'
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["그룹을 다른 그룹으로 드래그하여 이동시키면 대상 그룹의 하위 그룹으로 설정할 수 있습니다. ", (0,jsx_runtime.jsx)(Cmd, {
              sid: "team.user.tree.userGroupRootName"
            }), "로 그룹을 이동시키면 최상위 그룹으로 설정할 수 있습니다."]
          }), "\n"]
        }), "\n"]
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["그룹 내 하위 그룹이 있다면 하위 그룹을 확장하거나 축소할 수 있습니다. 상위 그룹을 선택하고 마우스 오른쪽 버튼을 클릭하세요. 팝업 메뉴에서 ", (0,jsx_runtime.jsx)(Cmd, {
