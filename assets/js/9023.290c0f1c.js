...
26839: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ee: () => (styles_default),
  P0: () => (classDiagram_default),
  b0: () => (classRenderer_v3_unified_default),
  dR: () => (ClassDB)
});
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((txt) => _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(txt, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
  ...
  splitClassNameAndType(_id) {
    const id = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(_id, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(className, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)());
  ...
  addRelation(classRelation) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.cM.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)()
    );
    classRelation.relationTitle2 = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    ...
    ids.split(",").forEach((_id) => {
      ...
      if (theClass) {
        theClass.link = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.formatUrl */.w8.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.sanitizeText */.SY.sanitizeText(_domId, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)());
    const config = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.runFunc */.w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(async function(text, id, _version, diag) {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.info */.cM.info("Drawing class diagram (v3)", id);
