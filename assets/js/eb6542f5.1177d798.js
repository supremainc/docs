...
var site_docs_platform_biostar_x_settings_device_details_auth_mdx_eb6_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-details-auth","title":"인증 설정하기","description":"장치의 사용자 인증에 대한 설정을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-details-auth.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-details-auth","permalink":"/docs/platform/biostar_x/settings-device-details-auth","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-details-auth.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-details-auth","title":"인증 설정하기","description":"장치의 사용자 인증에 대한 설정을 안내합니다.","keywords":["장치","인증"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"네트워크 설정하기","permalink":"/docs/platform/biostar_x/settings-device-details-network"},"next":{"title":"UI 알아보기","permalink":"/docs/platform/biostar_x/ui-overview"}}')
