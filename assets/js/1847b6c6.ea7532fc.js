...
var site_docs_platform_biostar_air_04_1_troubleshooting_adding_users_in_bulk_mdx_184_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제 해결하기","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/04-1-troubleshooting-adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","permalink":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/04-1-troubleshooting-adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제 해결하기","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","keywords":["문제 해결","대량 사용자","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"일괄 작업으로 사용자 추가하기","permalink":"/platform/biostar_air/adding-users-in-bulk"},"next":{"title":"사용자 카드 및 크리덴셜 유형","permalink":"/platform/biostar_air/user-card-types"}}')
