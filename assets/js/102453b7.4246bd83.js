...
var site_docs_device_vionyx_webserver_configure_privacy_overlay_mdx_102_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/configure-privacy-overlay","title":"프라이버시 및 오버레이 설정하기","description":"민감한 영역을 마스킹하고 얼굴을 자동 블러처리하며, 영상에 날짜/시간과 카메라 이름을 표시하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/configure-privacy-overlay.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/configure-privacy-overlay","permalink":"/docs/device/vionyx_webserver/configure-privacy-overlay","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/configure-privacy-overlay.mdx","tags":[],"version":"current","frontMatter":{"id":"configure-privacy-overlay","title":"프라이버시 및 오버레이 설정하기","description":"민감한 영역을 마스킹하고 얼굴을 자동 블러처리하며, 영상에 날짜/시간과 카메라 이름을 표시하는 방법을 안내합니다.","keywords":["Privacy","Overlay","프라이버시","오버레이","마스킹","블러"],"isTranslationMissing":false},"sidebar":"aicamwebserver","previous":{"title":"카메라 설정 변경하기","permalink":"/docs/device/vionyx_webserver/configure-camera-settings"},"next":{"title":"날짜와 시간 설정하기","permalink":"/docs/device/vionyx_webserver/configure-date-time"}}')
