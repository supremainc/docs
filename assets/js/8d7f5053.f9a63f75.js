...
var site_docs_platform_biostar_air_location_services_issues_mdx_8d7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/location-services-issues","title":"위치 서비스를 활성화해야 하나요?","description":"슈프리마 패스 앱에서 안전한 블루투스 통신 및 모바일 출입 카드 기능을 위해 위치 서비스를 활성화하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/location-services-issues.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/location-services-issues","permalink":"/docs/platform/biostar_air/location-services-issues","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/location-services-issues.mdx","tags":[],"version":"current","frontMatter":{"id":"location-services-issues","title":"위치 서비스를 활성화해야 하나요?","description":"슈프리마 패스 앱에서 안전한 블루투스 통신 및 모바일 출입 카드 기능을 위해 위치 서비스를 활성화하는 방법을 안내합니다.","keywords":["위치 서비스","슈프리마 패스","Bluetooth"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"모바일 카드가 작동하지 않아요","permalink":"/docs/platform/biostar_air/troubleshooting-suprema-pass-app"},"next":{"title":"비디오 재생 관련 문제 해결","permalink":"/docs/platform/biostar_air/video-troubleshooting"}}')
