"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["29458"], {
...
var site_docs_platform_biostar_x_monitoring_device_mdx_3a5_namespaceObject = JSON.parse('{"id":"platform/biostar_x/monitoring-device","title":"장치 모니터링하기","description":"모든 구역과 출입문에 연결된 장치 및 카메라를 실시간으로 모니터링하세요. 장치와 카메라의 상태 점검, 상세 정보 확인, 카메라 영상 재생 등 다양한 기능을 통해 효율적으로 관리할 수 있습니다.","source":"@site/docs/platform/biostar_x/monitoring-device.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/monitoring-device","permalink":"/platform/biostar_x/monitoring-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/monitoring-device.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-device","title":"장치 모니터링하기","description":"모든 구역과 출입문에 연결된 장치 및 카메라를 실시간으로 모니터링하세요. 장치와 카메라의 상태 점검, 상세 정보 확인, 카메라 영상 재생 등 다양한 기능을 통해 효율적으로 관리할 수 있습니다.","keywords":["모니터링","장치","카메라"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"맵 모니터링하기","permalink":"/platform/biostar_x/monitoring-map"},"next":{"title":"비디오 모니터링하기","permalink":"/platform/biostar_x/monitoring-video"}}')
