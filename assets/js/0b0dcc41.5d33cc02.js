...
var site_docs_platform_biostar_x_settings_adding_custom_account_mdx_0b0_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-adding-custom-account","title":"커스텀 권한 추가하기","description":"사용자가 원하는 권한 등급을 추가하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-adding-custom-account.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-adding-custom-account","permalink":"/platform/biostar_x/settings-adding-custom-account","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-adding-custom-account.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-adding-custom-account","title":"커스텀 권한 추가하기","description":"사용자가 원하는 권한 등급을 추가하는 방법을 안내합니다.","keywords":["계정","운영 권한","커스텀 권한"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"운영 권한 관리하기","permalink":"/platform/biostar_x/settings-manage-account"},"next":{"title":"출입 통제 설정하기","permalink":"/platform/biostar_x/settings-access-control"}}')
