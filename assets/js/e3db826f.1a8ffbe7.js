...
var site_docs_platform_biostar_air_manage_device_with_app_mdx_e3d_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-device-with-app","title":"모바일 앱에서 장치 관리하기","description":"BioStar Air 모바일 앱을 통해 장치를 등록하고 제거하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-device-with-app.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-device-with-app","permalink":"/docs/platform/biostar_air/manage-device-with-app","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-device-with-app.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device-with-app","title":"모바일 앱에서 장치 관리하기","description":"BioStar Air 모바일 앱을 통해 장치를 등록하고 제거하는 방법을 안내합니다.","keywords":["BioStar Air","장치 등록","모바일 앱"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"모바일 앱에서 사용자 관리하기","permalink":"/docs/platform/biostar_air/managing-users-with-app"},"next":{"title":"사이트 관리하기","permalink":"/docs/platform/biostar_air/site-management"}}')
...
const frontMatter = {
	...
	description: 'BioStar Air 모바일 앱을 통해 장치를 등록하고 제거하는 방법을 안내합니다.',
	keywords: [
		'BioStar Air',
		'장치 등록',
		'모바일 앱'
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "장치를 BioStar Air 시스템에 추가하려면 BioStar Air 모바일 앱을 사용해야 합니다.\n모바일 앱에서는 무선 연결을 통해 새로운 장치를 등록하거나 기존 장치를 제거할 수 있습니다."
