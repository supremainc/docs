...
var site_docs_platform_biostar_air_manage_device_group_mdx_04e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-device-group","title":"장치 그룹 관리하기","description":"장치를 그룹으로 묶어 효율적으로 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-device-group.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-device-group","permalink":"/docs/platform/biostar_air/manage-device-group","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-device-group.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device-group","title":"장치 그룹 관리하기","description":"장치를 그룹으로 묶어 효율적으로 관리하는 방법을 안내합니다.","keywords":["장치 그룹","장치 관리","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"장치 정보 및 설정 옵션 안내","permalink":"/docs/platform/biostar_air/device-info-settings"},"next":{"title":"에어팝 패치(Patch)와 태그(Tag) 구성하기","permalink":"/docs/platform/biostar_air/configuring-the-airfob-patch-and-tag"}}')
