"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6551"], {
69240: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_how_to_guide_advanced_settings_mdx_fb4_namespaceObject = JSON.parse('{"id":"platform/biostar_x/how-to-guide-advanced-settings","title":"고급 설정","description":"어드밴스(Advanced) 이상의 라이선스를 활성화했을 때 사용할 수 있는 고급 설정 기능을 안내합니다.","source":"@site/docs/platform/biostar_x/how-to-guide-advanced-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/how-to-guide-advanced-settings","permalink":"/docs/platform/biostar_x/how-to-guide-advanced-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/how-to-guide-advanced-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"how-to-guide-advanced-settings","title":"고급 설정","description":"어드밴스(Advanced) 이상의 라이선스를 활성화했을 때 사용할 수 있는 고급 설정 기능을 안내합니다.","keywords":["고급 설정","엘리베이터","고급 출입 통제","맵"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"기본 설정 구성하기","permalink":"/docs/platform/biostar_x/settings-preferences"},"next":{"title":"엘리베이터 관리하기","permalink":"/docs/platform/biostar_x/settings-manage-elevators"}}')
