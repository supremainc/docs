...
var site_docs_platform_biostar_air_monitoring_audit_logs_mdx_2c9_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-audit-logs","title":"변경 로그 사용하기","description":"BioStar Air에서 변경 로그를 모니터링 및 분석하고, 필터 적용, 데이터 내보내기 및 관리 활동 추적 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/monitoring-audit-logs.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-audit-logs","permalink":"/docs/platform/biostar_air/monitoring-audit-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring-audit-logs.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-audit-logs","title":"변경 로그 사용하기","description":"BioStar Air에서 변경 로그를 모니터링 및 분석하고, 필터 적용, 데이터 내보내기 및 관리 활동 추적 방법을 안내합니다.","keywords":["모니터링","변경 로그","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"이벤트 로그 사용하기","permalink":"/docs/platform/biostar_air/monitoring-event-logs"},"next":{"title":"알림 & 리포트 이력 확인하기","permalink":"/docs/platform/biostar_air/monitoring-alert-report-history"}}')
