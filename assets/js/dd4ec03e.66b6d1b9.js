...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      pages: "tutorial-express-install",
...
var site_docs_platform_biostar_x_tutorial_custom_install_mdx_dd4_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tutorial-custom-install","title":"사용자 정의 설치하기","description":"사용자가 이미지 설치한 데이터베이스와 연동하기 위한 사용자 정의 설치 방식을 안내합니다.","source":"@site/docs/platform/biostar_x/tutorial-custom-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tutorial-custom-install","permalink":"/docs/platform/biostar_x/tutorial-custom-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tutorial-custom-install.mdx","tags":[],"version":"current","frontMatter":{"id":"tutorial-custom-install","title":"사용자 정의 설치하기","description":"사용자가 이미지 설치한 데이터베이스와 연동하기 위한 사용자 정의 설치 방식을 안내합니다.","keywords":["사용자 정의 설치"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"간편 설치하기","permalink":"/docs/platform/biostar_x/tutorial-express-install"},"next":{"title":"로그인하기","permalink":"/docs/platform/biostar_x/tutorial-login"}}')
