"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["58479"], {
...
var site_docs_platform_biostar_x_settings_map_manage_floor_mdx_dd0_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-map-manage-floor","title":"층 구성하기","description":"구역과 시설을 구성하기 전에 층을 구성하세요. 층 이미지에 출입문과 카메라를 배치해 시각적으로 확인할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-map-manage-floor.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-map-manage-floor","permalink":"/platform/biostar_x/settings-map-manage-floor","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-map-manage-floor.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-map-manage-floor","title":"층 구성하기","description":"구역과 시설을 구성하기 전에 층을 구성하세요. 층 이미지에 출입문과 카메라를 배치해 시각적으로 확인할 수 있습니다.","keywords":["맵","층","시설","출입문","카메라","배치도","이미지"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"맵 관리하기","permalink":"/platform/biostar_x/settings-map-management"},"next":{"title":"시설 구성하기","permalink":"/platform/biostar_x/settings-map-manage-facility"}}')
    ...
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "setting.floor.configuration.section.title"
          }), " 섹션에 업로드한 이미지에 출입문을 추가하려면 이미지의 원하는 위치에서 오른쪽 마우스 버튼을 클릭하고 ", (0,jsx_runtime.jsx)(Cmd, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["출입문을 이미지에 배치하려면 ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "common.apply"
          }), " 버튼을 클릭하세요."]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["카메라를 이미지에 배치하려면 ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "common.apply"
          }), " 버튼을 클릭하세요."]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "층에 배치된 출입문과 카메라의 위치를 변경하려면 해당 출입문 또는 카메라를 클릭한 상태에서 원하는 위치로 드래그하세요."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["층에 배치된 출입문과 카메라의 아이콘 및 상태에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: ["층의 이미지에서 삭제하려는 출입문 또는 카메라의 ", (0,jsx_runtime.jsx)(IcFremove, {}), " 아이콘을 클릭하세요. 해당 출입문 또는 카메라를 삭제할 수 있습니다."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "카메라-촬영-범위-설정",
      children: "카메라 촬영 범위 설정"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["층의 이미지에서 촬영 범위를 설정할 카메라에서 마우스 오른쪽 버튼을 클릭하세요. 팝업 메뉴에서 ", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "촬영 범위를 변경하려면 녹색 영역으로 마우스 포인터를 이동하세요. 마우스 포인터가 십자 모양으로 변경되면 마우스를 클릭한 상태에서 원하는 위치로 드래그하세요."
        }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: ["층의 이미지를 삭제하려면 층 이미지에서 마우스 오른쪽 버튼을 클릭하고 팝업 메뉴에서 ", (0,jsx_runtime.jsx)(Cmd, {
