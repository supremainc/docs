"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["76782"], {
...
var site_docs_platform_biostar_x_tna_report_mdx_180_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-report","title":"근태 기록 확인하기","description":"시스템을 통해 수집된 사용자의 근태 이벤트로 근태 보고서를 생성할 수 있으며, 시간 기록을 편집하거나 CSV 파일이나 PDF파일로 내보내기할 수 있습니다.","source":"@site/docs/platform/biostar_x/tna-report.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-report","permalink":"/platform/biostar_x/tna-report","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-report.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-report","title":"근태 기록 확인하기","description":"시스템을 통해 수집된 사용자의 근태 이벤트로 근태 보고서를 생성할 수 있으며, 시간 기록을 편집하거나 CSV 파일이나 PDF파일로 내보내기할 수 있습니다.","keywords":["근태 기록","보고서"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"근무 스케줄 설정하기","permalink":"/platform/biostar_x/tna-rule-schedule"},"next":{"title":"근태 기록 수정하기","permalink":"/platform/biostar_x/tna-report-edit"}}')
