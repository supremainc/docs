"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["95646"], {
...
var site_docs_platform_biostar_x_tna_rule_schedule_mdx_a66_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-rule-schedule","title":"근무 스케줄 설정하기","description":"설정된 주간 근무 규칙, 기타 근무 규칙, 기간, 휴일을 사용자에게 지정하여 근무 스케줄을 생성 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/tna-rule-schedule.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-rule-schedule","permalink":"/platform/biostar_x/tna-rule-schedule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-rule-schedule.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-rule-schedule","title":"근무 스케줄 설정하기","description":"설정된 주간 근무 규칙, 기타 근무 규칙, 기간, 휴일을 사용자에게 지정하여 근무 스케줄을 생성 방법을 안내합니다.","keywords":["근무 스케줄","근무 규칙"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"기타 근무 규칙 설정하기","permalink":"/platform/biostar_x/tna-rule-shift-overtime"},"next":{"title":"근태 기록 확인하기","permalink":"/platform/biostar_x/tna-report"}}')
