...
var site_docs_platform_biostar_x_enroll_credential_fingerprint_mdx_1b2_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-fingerprint","title":"지문 등록하기","description":"출입을 위한 인증 수단으로 사용자의 지문을 등록해 사용할 수 있습니다. 지문 인증을 지원하는 장치를 통해 사용자의 지문 정보를 등록하세요.","source":"@site/docs/platform/biostar_x/enroll-credential-fingerprint.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-fingerprint","permalink":"/platform/biostar_x/enroll-credential-fingerprint","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-fingerprint.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-fingerprint","title":"지문 등록하기","description":"출입을 위한 인증 수단으로 사용자의 지문을 등록해 사용할 수 있습니다. 지문 인증을 지원하는 장치를 통해 사용자의 지문 정보를 등록하세요.","keywords":["지문","등록","크리덴셜","인증","바이오메트릭"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"인증 모드 설정하기","permalink":"/platform/biostar_x/enroll-credential-authmode"},"next":{"title":"얼굴 등록하기","permalink":"/platform/biostar_x/enroll-credential-face"}}')
