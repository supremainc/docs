...
var site_docs_platform_biostar_air_monitoring_mdx_d79_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring","title":"모니터링","description":"BioStar Air에서 실시간 모니터링을 통해 시스템 상태를 추적하고, 이벤트 로그를 분석하며, 출입문을 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/monitoring.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring","permalink":"/docs/platform/biostar_air/monitoring","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring","title":"모니터링","description":"BioStar Air에서 실시간 모니터링을 통해 시스템 상태를 추적하고, 이벤트 로그를 분석하며, 출입문을 관리하는 방법을 안내합니다.","keywords":["모니터링","이벤트 로그","출입문 관리","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"층 레벨 관리하기","permalink":"/docs/platform/biostar_air/manage-floor-level"},"next":{"title":"이벤트 및 변경 로그 사용하기","permalink":"/docs/platform/biostar_air/monitoring-event-and-audit-logs"}}')
