"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["13165"], {
...
var site_docs_platform_biostar_x_settings_map_management_mdx_78e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-map-management","title":"맵 관리하기","description":"층, 시설, 구역을 설정하고 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-map-management.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-map-management","permalink":"/platform/biostar_x/settings-map-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-map-management.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-map-management","title":"맵 관리하기","description":"층, 시설, 구역을 설정하고 관리하는 방법을 안내합니다.","keywords":["맵","층","시설","구역"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"비디오 규칙 설정하기","permalink":"/platform/biostar_x/settings-videos-rule"},"next":{"title":"층 구성하기","permalink":"/platform/biostar_x/settings-map-manage-floor"}}')
