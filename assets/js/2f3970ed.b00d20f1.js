...
var site_docs_platform_biostar_air_troubleshooting_suprema_pass_app_mdx_2f3_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-suprema-pass-app","title":"모바일 카드가 작동하지 않아요","description":"슈프리마 패스 앱에서 모바일 카드 인증 문제, Bluetooth 및 위치 권한 문제, 연결 실패 해결 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/troubleshooting-suprema-pass-app.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-suprema-pass-app","permalink":"/docs/platform/biostar_air/troubleshooting-suprema-pass-app","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/troubleshooting-suprema-pass-app.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-suprema-pass-app","title":"모바일 카드가 작동하지 않아요","description":"슈프리마 패스 앱에서 모바일 카드 인증 문제, Bluetooth 및 위치 권한 문제, 연결 실패 해결 방법을 안내합니다.","keywords":["문제 해결","모바일 카드","Airfob"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"위치 서비스를 활성화해야 하나요?","permalink":"/docs/platform/biostar_air/location-services-issues"},"next":{"title":"비디오 재생 관련 문제 해결","permalink":"/docs/platform/biostar_air/video-troubleshooting"}}')
