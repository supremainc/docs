...
var site_docs_platform_biostar_x_add_sub_db_mdx_286_namespaceObject = JSON.parse('{"id":"platform/biostar_x/add-sub-db","title":"보조 데이터베이스 추가하기","description":"커뮤니케이션 서버를 추가했을 때 메인 서버의 부하를 줄이기 위해 커뮤니케이션 서버와 연동할 보조 데이터베이스를 추가하고 연결하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/add-sub-db.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/add-sub-db","permalink":"/docs/platform/biostar_x/add-sub-db","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/add-sub-db.mdx","tags":[],"version":"current","frontMatter":{"id":"add-sub-db","title":"보조 데이터베이스 추가하기","description":"커뮤니케이션 서버를 추가했을 때 메인 서버의 부하를 줄이기 위해 커뮤니케이션 서버와 연동할 보조 데이터베이스를 추가하고 연결하는 방법을 안내합니다.","keywords":["데이터베이스","추가","연결"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"데이터베이스 변경하기","permalink":"/docs/platform/biostar_x/change-db"},"next":{"title":"런처","permalink":"/docs/platform/biostar_x/ui-launcher"}}')
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["보조 데이터베이스를 추가하려면 ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "멀티 커뮤니케이션"
            }), " 서버 라이선스가 필요합니다. 라이선스 정책에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
            metastring: "title='Example'",
            children: "CREATE USER 'biostar2_ac_user'@'192.168.12.42' IDENTIFIED BY 'password';\n\nGRANT ALL PRIVILEGES ON biostar2_ac.* TO 'biostar2_ac_user'@'192.168.12.42';\nFLUSH PRIVILEGES;\n"
          })
        })]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
            metastring: "title='Example'",
            children: "CREATE USER 'biostar2_ac_user'@'192.168.12.161' IDENTIFIED BY 'password';\n\nGRANT ALL PRIVILEGES ON biostar2_ac.* TO 'biostar2_ac_user'@'192.168.12.161';\nFLUSH PRIVILEGES;\n"
          })
        })]
      }), (0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
            metastring: "title='Example'",
            children: "CREATE SERVER 'default' FOREIGN DATA WRAPPER mysql OPTIONS (HOST '192.168.12.161', PORT 3312, DATABASE 'biostar2_ac', USER 'biostar2_ac_user', PASSWORD 'password');\n  \nALTER SERVER 'default' OPTIONS (HOST '192.168.12.161', PORT 3312, DATABASE 'biostar2_ac', USER 'biostar2_ac_usermt__fttid__', PASSWORD 'password');\n"
          })
        })]
      }), (0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["화면 오른족 상단의 ", (0,jsx_runtime.jsx)(Cmd, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "데이터베이스 정보를 수정할 때에도 Linked Server 설정은 자동 변경됩니다. 메인 데이터베이스를 수정할 때에는 등록되어 있는 모든 보조 데이터베스에 Linked Server 설정이 변경된 정보로 반영됩니다. 보조 데이터베이스를 수정할 때에는 메인 데이터베이스와 해당 보조 데이터베이스만 변경된 정보로 반영됩니다."
              }), "\n"]
            }), "\n"]
          })
        })]
