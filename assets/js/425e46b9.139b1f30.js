"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["73443"], {
4170: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_manage_server_mdx_425_namespaceObject = JSON.parse('{"id":"platform/biostar_x/manage-server","title":"서버 시작 및 종료","description":"BioStar X Service Manager를 사용하여 BioStar X 서버의 서비스를 시작하고 종료하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/manage-server.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/manage-server","permalink":"/platform/biostar_x/manage-server","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/manage-server.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-server","title":"서버 시작 및 종료","description":"BioStar X Service Manager를 사용하여 BioStar X 서버의 서비스를 시작하고 종료하는 방법을 안내합니다.","keywords":["BioStar X Setting","서버 관리"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"서버 관리","permalink":"/platform/biostar_x/server-management"},"next":{"title":"서비스 설정","permalink":"/platform/biostar_x/service-settings"}}')
