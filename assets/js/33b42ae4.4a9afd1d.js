"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["38492"], {
73589: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_device_details_network_mdx_33b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-details-network","title":"네트워크 설정하기","description":"장치의 TCP/IP, RS-485, 서버 통신 등의 네트워크 설정을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-details-network.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-details-network","permalink":"/platform/biostar_x/settings-device-details-network","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-details-network.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-details-network","title":"네트워크 설정하기","description":"장치의 TCP/IP, RS-485, 서버 통신 등의 네트워크 설정을 안내합니다.","keywords":["장치","네트워크","TCP/IP","RS-485","서버 통신","시리얼 통신","인텔리전트 슬레이브"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"기본 정보 설정하기","permalink":"/platform/biostar_x/settings-device-details-info"},"next":{"title":"인증 설정하기","permalink":"/platform/biostar_x/settings-device-details-auth"}}')
