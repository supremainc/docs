"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["21302"], {
96357: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_device_biostation_3_event_log_mdx_7c6_namespaceObject = JSON.parse('{"id":"device/biostation_3/event-log","title":"이벤트 로그","description":"장치에서 발생한 이벤트 기록을 확인하는 방법을 설명합니다.","source":"@site/docs/device/biostation_3/event-log.mdx","sourceDirName":"device/biostation_3","slug":"/device/biostation_3/event-log","permalink":"/device/biostation_3/event-log","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3/event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"event-log","title":"이벤트 로그","description":"장치에서 발생한 이벤트 기록을 확인하는 방법을 설명합니다.","keywords":["검색","로그","삭제","사용량"],"isTranslationMissing":false},"sidebar":"biostation3","previous":{"title":"설정","permalink":"/device/biostation_3/settings"},"next":{"title":"문제 해결","permalink":"/device/biostation_3/troubleshooting"}}')
