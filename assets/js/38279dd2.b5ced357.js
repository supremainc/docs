"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["13367"], {
...
var site_docs_platform_biostar_x_settings_triger_and_action_mdx_382_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-triger-and-action","title":"작업 조건 및 동작 설정하기","description":"장치, 출입문, 구역에서 특정 이벤트가 발생했을 때 사용자가 원하는 동작을 장치나 BioStar X가 수행하도록 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-triger-and-action.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-triger-and-action","permalink":"/platform/biostar_x/settings-triger-and-action","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-triger-and-action.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-triger-and-action","title":"작업 조건 및 동작 설정하기","description":"장치, 출입문, 구역에서 특정 이벤트가 발생했을 때 사용자가 원하는 동작을 장치나 BioStar X가 수행하도록 설정할 수 있습니다.","keywords":["작업","동작"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"스케줄 설정하기","permalink":"/platform/biostar_x/settings-schedule"},"next":{"title":"이벤트 로그 가져오기","permalink":"/platform/biostar_x/settings-event-log-import"}}')
