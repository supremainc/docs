...
var site_docs_device_extendedmodule_installation_mdx_264_namespaceObject = JSON.parse('{"id":"device/extendedmodule/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/extendedmodule/installation.mdx","sourceDirName":"device/extendedmodule","slug":"/device/extendedmodule/installation","permalink":"/docs/device/extendedmodule/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/extendedmodule/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"extendedmodule","previous":{"title":"시작하기","permalink":"/docs/device/extendedmodule/getting-started"},"next":{"title":"제품 사양","permalink":"/docs/device/extendedmodule/product-specifications"}}')
