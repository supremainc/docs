...
var site_docs_platform_biostar_air_troubleshooting_adding_users_in_bulk_mdx_dcd_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","permalink":"/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","keywords":["문제 해결","대량 사용자","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"문제 해결","permalink":"/docs/platform/biostar_air/troubleshooting"},"next":{"title":"모바일 카드가 작동하지 않아요","permalink":"/docs/platform/biostar_air/troubleshooting-suprema-pass-app"}}')
