...
var site_docs_platform_biostar_air_10_device_management_configuring_time_and_attendance_ta_mdx_528_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-ta","title":"근태 관리(T&A) 설정하기","description":"BioStar Air에서 근태 관리 설정을 구성하는 방법, 모바일 근태 관리 추적을 활성화하는 방법, 장치에 근태 관리를 할당하는 방법, 근태 기록을 내보내는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/10-device-management-configuring-time-and-attendance-ta.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-ta","permalink":"/platform/biostar_air/configuring-ta","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/10-device-management-configuring-time-and-attendance-ta.mdx","tags":[],"version":"current","sidebarPosition":10,"frontMatter":{"id":"configuring-ta","title":"근태 관리(T&A) 설정하기","description":"BioStar Air에서 근태 관리 설정을 구성하는 방법, 모바일 근태 관리 추적을 활성화하는 방법, 장치에 근태 관리를 할당하는 방법, 근태 기록을 내보내는 방법을 안내합니다.","keywords":["T&A","근태","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"등록 장치 관리하기","permalink":"/platform/biostar_air/managing-registered-devices"},"next":{"title":"Airfob 패치(Patch)와 태그(Tag) 구성하기","permalink":"/platform/biostar_air/configuring-the-airfob-patch-and-tag"}}')
