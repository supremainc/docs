"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["8244"], {
...
24105: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  toc: () => (/* binding */ toc),
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_06_user_management_managing_user_groups_mdx_ccd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-06-user-management-managing-user-groups-mdx-ccd.json
var site_docs_platform_biostar_air_06_user_management_managing_user_groups_mdx_ccd_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-user-groups","title":"사용자 그룹 관리하기","description":"BioStar Air에서 효율적인 사용자 분류 및 출입 통제 관리를 위해 사용자 그룹과 하위 그룹을 생성 및 구성, 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/06-user-management-managing-user-groups.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-user-groups","permalink":"/docs/platform/biostar_air/managing-user-groups","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/06-user-management-managing-user-groups.mdx","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"id":"managing-user-groups","title":"사용자 그룹 관리하기","description":"BioStar Air에서 효율적인 사용자 분류 및 출입 통제 관리를 위해 사용자 그룹과 하위 그룹을 생성 및 구성, 관리하는 방법을 안내합니다.","keywords":["사용자 관리","BioStar Air","사용자 그룹"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"사용자 카드 유형","permalink":"/docs/platform/biostar_air/user-card-types"},"next":{"title":"카드 템플릿 관리하기","permalink":"/docs/platform/biostar_air/managing-card-templates"}}')
...
;// CONCATENATED MODULE: ./docs/platform/biostar_air/06-user-management-managing-user-groups.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "그룹별로 사용자 목록을 필터링하여 액세스 수준을 빠르게 관리할 수 있습니다."
        }), "\n", (0,jsx_runtime.jsxs)(_components.blockquote, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "예, 인사부"
          }), "\n"]
