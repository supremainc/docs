...
var site_docs_device_vionyx_webserver_edit_delete_ai_event_mdx_4c7_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/edit-delete-ai-event","title":"AI 이벤트 수정 및 삭제하기","description":"생성한 AI 이벤트의 설정을 수정하거나 불필요한 이벤트를 삭제할 수 있습니다.","source":"@site/docs/device/vionyx_webserver/edit-delete-ai-event.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/edit-delete-ai-event","permalink":"/docs/device/vionyx_webserver/edit-delete-ai-event","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/edit-delete-ai-event.mdx","tags":[],"version":"current","frontMatter":{"id":"edit-delete-ai-event","title":"AI 이벤트 수정 및 삭제하기","description":"생성한 AI 이벤트의 설정을 수정하거나 불필요한 이벤트를 삭제할 수 있습니다.","keywords":["AI 이벤트","관리","설정","삭제"],"isTranslationMissing":false},"sidebar":"aicamwebserver","previous":{"title":"인원 카운팅 이벤트 설정하기","permalink":"/docs/device/vionyx_webserver/configure-counting-people"},"next":{"title":"AI 규칙(Rule) 설정하기","permalink":"/docs/device/vionyx_webserver/set-ai-rule"}}')
