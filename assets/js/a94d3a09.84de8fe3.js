"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["70773"], {
...
var site_docs_platform_biostar_x_ui_settings_mdx_a94_namespaceObject = JSON.parse('{"id":"platform/biostar_x/ui-settings","title":"설정","description":"설정 페이지의 사용자 인터페이스(User Interface)를 안내합니다.","source":"@site/docs/platform/biostar_x/ui-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/ui-settings","permalink":"/platform/biostar_x/ui-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/ui-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"ui-settings","title":"설정","description":"설정 페이지의 사용자 인터페이스(User Interface)를 안내합니다.","keywords":["설정","UI"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"대시보드","permalink":"/platform/biostar_x/ui-dashboard"},"next":{"title":"라이선스 정책","permalink":"/platform/biostar_x/licensing"}}')
