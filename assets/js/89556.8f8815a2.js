"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["89556"], {
90421: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  CP: () => (drawEmbeddedImage),
  HT: () => (getTextObj),
  PB: () => (getNoteRect),
  aC: () => (drawImage),
  lC: () => (drawBackgroundRect),
  m: () => (drawText),
  tk: () => (drawRect)
});
...
87199: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
/* ESM import */var _chunk_D6G4REZN_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90421);
/* ESM import */var _chunk_XZIHB7SX_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51968);
...
/* ESM import */var d3__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69890);
/* ESM import */var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16750);
...
var SequenceDB = class {
  ...
  parseMessage(str) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug(`parseMessage: ${JSON.stringify(message)}`);
    return message;
  }
  ...
  addLinks(actorId, text) {
    ...
    try {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.error */.Rm.error("error while parsing actor link text", e);
    }
  }
  ...
  addProperties(actorId, text) {
    ...
    try {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.error */.Rm.error("error while parsing actor properties text", e);
    }
  }
  ...
  addDetails(actorId, text) {
    ...
    try {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.error */.Rm.error("error while parsing actor details text", e);
    }
  }
...
var drawText = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.lineBreakRegex */.Y2.lineBreakRegex);
...
var _drawTextCandidateFunc = /* @__PURE__ */ function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const lines = content.split(_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.lineBreakRegex */.Y2.lineBreakRegex);
...
var bounds = {
  ...
  insert: /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(startx, starty, stopx, stopy) {
    const _startx = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(startx, stopx);
    const _stopx = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(startx, stopx);
    const _starty = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(starty, stopy);
    const _stopy = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(starty, stopy);
  ...
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(bump) {
    ...
    this.data.stopy = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
...
async function boundMessage(_diagram, msgModel) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
var drawMessage = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  const textDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_chunk_D6G4REZN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getTextObj */.HT)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${startx},${lineStartY} H ${startx + _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
...
var addActorRenderingData = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.height = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(maxHeight, height);
    }
...
var activationBounds = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(actor, actors) {
  ...
  const left = activations.reduce(
    function(acc, activation) {
      return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(acc, activation.startx);
    },
    actorObj.x + actorObj.width / 2 - 1
  );
  const right = activations.reduce(
    function(acc, activation) {
      return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(acc, activation.stopx);
    },
    actorObj.x + actorObj.width / 2 + 1
  );
  return [left, right];
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(async function(_text, id, _version, diagObj) {
  ...
  bounds.init();
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug(diagObj.db);
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.error */.Rm.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug("createdActors", createdActors);
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug("destroyedActors", destroyedActors);
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug(`models:`, bounds.models);
}, "draw");
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors.get(msg.to) && actors.get(msg.from)) {
      ...
      const wrappedMessage = msg.wrap ? _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      ...
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
var getRequiredPopupWidth = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of actors.keys()) {
    ...
    if (actor.wrap) {
      actor.description = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(
        actor.description,
    ...
    actor.width = actor.wrap ? conf.width : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(maxHeight, conf.height);
}
...
var buildNoteModel = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(async function(msg, actors, diagObj) {
  ...
  let textDimensions = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .hasKatex */.Wi)(msg.message) ? await (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateMathMLDimensions */.Dl)(msg.message, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.D7)()) : _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(
    shouldWrap ? _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
    startx: fromActor.x,
    stopx: 0,
    starty: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, textDimensions.width) : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(
      shouldWrap ? _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(msg.message, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(conf.width, fromActor.width) : _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
  ...
  if (shouldWrap) {
    noteModel.message = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(
      msg.message,
      noteModel.width - 2 * conf.wrapPadding,
      noteFont(conf)
    );
  }
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug(
...
var buildMessageModel = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.wrapLabel */._K.wrapLabel(
      msg.message,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default.calculateTextDimensions */._K.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
...
var calculateLoopBounds = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)(async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(current.from, noteModel.startx);
        current.to = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMin */.Y2.getMin(msgModel.startx, current.from);
            current.to = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(msgModel.stopx, current.to);
            current.width = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default.getMax */.Y2.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
  ...
  bounds.activations = [];
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug("Loop type widths:", loops);
  return loops;
}, "calculateLoopBounds");
