...
var site_docs_platform_biostar_air_02_user_management_managing_users_mdx_00f_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-users","title":"사용자 관리하기","description":"BioStar Air 포털에서 사용자 관리 및 대량 작업 수행, 자격 증명(모바일 카드, RFID, 얼굴 인식, PIN, 웹 카드)을 추가 및 구성, 액세스 등급 설정, 사용자 그룹 관리, 유효 기간 구성 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/02-user-management-managing-users.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-users","permalink":"/platform/biostar_air/managing-users","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/02-user-management-managing-users.mdx","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"id":"managing-users","title":"사용자 관리하기","description":"BioStar Air 포털에서 사용자 관리 및 대량 작업 수행, 자격 증명(모바일 카드, RFID, 얼굴 인식, PIN, 웹 카드)을 추가 및 구성, 액세스 등급 설정, 사용자 그룹 관리, 유효 기간 구성 방법을 안내합니다.","keywords":["사용자 관리","BioStar Air","사용자 그룹","출입 권한"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"BioStar Air 로그인","permalink":"/platform/biostar_air/biostar-air-login"},"next":{"title":"개별 사용자 추가하기","permalink":"/platform/biostar_air/adding-individual-users"}}')
