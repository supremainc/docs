"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["20751"], {
...
var site_docs_platform_biostar_x_enroll_credential_qrbarcode_mdx_353_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-qrbarcode","title":"QR/Barcode 등록하기","description":"BioStar X QR 생성 및 외부 발급 QR/Barcode를 사용자 인증 수단으로 등록하는 과정을 안내합니다.","source":"@site/docs/platform/biostar_x/enroll-credential-qrbarcode.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-qrbarcode","permalink":"/platform/biostar_x/enroll-credential-qrbarcode","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-qrbarcode.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-qrbarcode","title":"QR/Barcode 등록하기","description":"BioStar X QR 생성 및 외부 발급 QR/Barcode를 사용자 인증 수단으로 등록하는 과정을 안내합니다.","keywords":["QR 코드","바코드","등록","크리덴셜","인증"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"모바일 출입 카드 등록하기","permalink":"/platform/biostar_x/enroll-credential-mobile"},"next":{"title":"PIN 등록하기","permalink":"/platform/biostar_x/enroll-credential-pin"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: "이후 사용자가 출입 인증할 때 QR 코드를 발급하여 사용자 정보에 등록된 이메일 주소로 전송합니다. 사용자는 이메일에 포함된 QR 코드를 장치에 스캔하여 출입할 수 있습니다."
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.p, {
