...
var site_docs_platform_biostar_air_account_settings_mdx_161_namespaceObject = JSON.parse('{"id":"platform/biostar_air/account-settings","title":"계정 설정하기","description":"BioStar Air 계정 정보 변경, 알림 설정, SIP 인터폰 설정, 계정 삭제 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/account-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/account-settings","permalink":"/docs/platform/biostar_air/account-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/account-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"account-settings","title":"계정 설정하기","description":"BioStar Air 계정 정보 변경, 알림 설정, SIP 인터폰 설정, 계정 삭제 방법을 알아보세요.","keywords":["계정 설정","프로필","알림","SIP 인터폰","계정 관리"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"커스텀 Wiegand 카드 형식 설정하기","permalink":"/docs/platform/biostar_air/custom-wiegand-card-formats"},"next":{"title":"리포트 구성하기","permalink":"/docs/platform/biostar_air/configuring-reports"}}')
