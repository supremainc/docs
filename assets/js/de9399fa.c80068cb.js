...
var site_docs_platform_biostar_x_settings_advanced_ac_apb_mdx_de9_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-advanced-ac-apb","title":"안티패스백 구역 설정하기","description":"안티패스백 구역 설정 방법을 안내합니다. 안티패스백 구역은 출입문을 기준으로 생성된 안티패스백보다 향상된 기능을 제공합니다.","source":"@site/docs/platform/biostar_x/settings-advanced-ac-apb.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-advanced-ac-apb","permalink":"/docs/platform/biostar_x/settings-advanced-ac-apb","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-advanced-ac-apb.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-advanced-ac-apb","title":"안티패스백 구역 설정하기","description":"안티패스백 구역 설정 방법을 안내합니다. 안티패스백 구역은 출입문을 기준으로 생성된 안티패스백보다 향상된 기능을 제공합니다.","keywords":["고급 출입 통제","안티패스백"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"고급 출입 통제 설정하기","permalink":"/docs/platform/biostar_x/settings-advanced-ac"},"next":{"title":"기본 설정","permalink":"/docs/platform/biostar_x/settings-preferences"}}')
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "common.info",
            product: "2"
          }), " 섹션에서 추가할 안티패스백 구역의 이름과 설명을 입력하세요."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "common.alarm",
            product: "2"
          }), " 섹션에서 안티패스백 위반이 발생했을 때 수해할 동작을 설정하세요."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
