"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["31038"], {
39056: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_data_settings_mdx_051_namespaceObject = JSON.parse('{"id":"platform/biostar_x/data-settings","title":"리포트 저장 경로 설정하기","description":"자동 생성 스케줄을 설정했다면 리포트를 저장할 경로를 설정하세요.","source":"@site/docs/platform/biostar_x/data-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/data-settings","permalink":"/platform/biostar_x/data-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/data-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"data-settings","title":"리포트 저장 경로 설정하기","description":"자동 생성 스케줄을 설정했다면 리포트를 저장할 경로를 설정하세요.","keywords":["리포트 저장","자동 생성"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"자동 생성 스케줄 설정하기","permalink":"/platform/biostar_x/data-automatic-report-schedule"},"next":{"title":"대시보드","permalink":"/platform/biostar_x/how-to-guide-dashboard"}}')
