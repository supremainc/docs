...
var site_docs_platform_biostar_air_managing_roll_call_fire_muster_mdx_f81_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-roll-call-fire-muster","title":"비상 호출","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/managing-roll-call-fire-muster.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-roll-call-fire-muster","permalink":"/docs/platform/biostar_air/managing-roll-call-fire-muster","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-roll-call-fire-muster.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-roll-call-fire-muster","title":"비상 호출","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","keywords":["Roll call","비상 호출","화재 소집 구역","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"출입문 상태 모니터링하기","permalink":"/docs/platform/biostar_air/monitoring-door-status"},"next":{"title":"사이트 설정하기","permalink":"/docs/platform/biostar_air/settings"}}')
