...
var site_docs_device_bioentry_p_2_installation_mdx_4ac_namespaceObject = JSON.parse('{"id":"device/bioentry_p2/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/bioentry_p2/installation.mdx","sourceDirName":"device/bioentry_p2","slug":"/device/bioentry_p2/installation","permalink":"/device/bioentry_p2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_p2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"bioentryp2","previous":{"title":"시작하기","permalink":"/device/bioentry_p2/getting-started"},"next":{"title":"제품 사양","permalink":"/device/bioentry_p2/product-specifications"}}')
