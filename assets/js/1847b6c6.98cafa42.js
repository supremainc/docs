"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["1469"], {
35704: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_air_04_1_troubleshooting_adding_users_in_bulk_mdx_184_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-adding-users-in-bulk","title":"Troubleshooting Adding Users in Bulk","description":"Learn how to troubleshoot common issues when adding users in bulk using the BioStar Air Portal.","source":"@site/docs/platform/biostar_air/04-1-troubleshooting-adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","permalink":"/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/04-1-troubleshooting-adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-adding-users-in-bulk","title":"Troubleshooting Adding Users in Bulk","description":"Learn how to troubleshoot common issues when adding users in bulk using the BioStar Air Portal.","keywords":["troubleshooting","bulk users","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Adding Users in Bulk","permalink":"/docs/platform/biostar_air/adding-users-in-bulk"},"next":{"title":"User Card Types","permalink":"/docs/platform/biostar_air/user-card-types"}}')
...
const toc = [{
  ...
  "id": "excel-formulas-for-pre-validation",
  "level": 2
}, {
  "value": "Upload Errors? Here’s What to Check",
  "id": "upload-errors-heres-what-to-check",
  "level": 2
}];
