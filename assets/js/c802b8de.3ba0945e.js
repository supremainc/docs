...
var site_docs_platform_biostar_x_settings_server_mdx_c80_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-server","title":"서버 설정하기","description":"BioStar X 서버의 기본 정보, 사용자 및 장치 관리, 자동 업그레이드, HTTPS 인증서 등 서버 운영에 필요한 다양한 설정 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-server.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-server","permalink":"/platform/biostar_x/settings-server","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-server.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-server","title":"서버 설정하기","description":"BioStar X 서버의 기본 정보, 사용자 및 장치 관리, 자동 업그레이드, HTTPS 인증서 등 서버 운영에 필요한 다양한 설정 방법을 안내합니다.","keywords":["서버 설정","HTTPS"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"퀵 액션 사용하기","permalink":"/platform/biostar_x/settings-custom-interface"},"next":{"title":"서버 상세 설정하기","permalink":"/platform/biostar_x/settings-server-server"}}')
