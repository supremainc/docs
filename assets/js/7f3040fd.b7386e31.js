...
var site_docs_platform_biostar_x_settings_device_usb_agent_mdx_7f3_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-usb-agent","title":"USB 에이전트 설정하기","description":"클라이언트 PC에서 BioStar X에 접속했을 때 USB 지문 등록 장치 및 카드 등록 장치를 사용하기 위한 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-usb-agent.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-usb-agent","permalink":"/platform/biostar_x/settings-device-usb-agent","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-usb-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-usb-agent","title":"USB 에이전트 설정하기","description":"클라이언트 PC에서 BioStar X에 접속했을 때 USB 지문 등록 장치 및 카드 등록 장치를 사용하기 위한 방법을 안내합니다.","keywords":["USB Agent"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"이미지 로그 설정하기","permalink":"/platform/biostar_x/settings-device-image-log"},"next":{"title":"장치 연결 관리 설정하기","permalink":"/platform/biostar_x/settings-device-connection-manager"}}')
