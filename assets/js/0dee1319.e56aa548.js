...
1146: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_enroll_credential_card_mdx_0de_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-card","title":"출입 카드 등록하기","description":"사용자에게 출입 카드를 할당하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/enroll-credential-card.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-card","permalink":"/docs/platform/biostar_x/enroll-credential-card","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-card.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-card","title":"출입 카드 등록하기","description":"사용자에게 출입 카드를 할당하는 방법을 안내합니다.","keywords":["출입 카드","등록","크리덴셜","인증","카드"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"얼굴 등록하기","permalink":"/docs/platform/biostar_x/enroll-credential-face"},"next":{"title":"모바일 출입 카드 등록하기","permalink":"/docs/platform/biostar_x/enroll-credential-mobile"}}')
