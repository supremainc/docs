...
var site_docs_device_extendedmodule_sc_installation_mdx_6a7_namespaceObject = JSON.parse('{"id":"device/extendedmodule_sc/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/extendedmodule_sc/installation.mdx","sourceDirName":"device/extendedmodule_sc","slug":"/device/extendedmodule_sc/installation","permalink":"/docs/device/extendedmodule_sc/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/extendedmodule_sc/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"extendedmodule_sc","previous":{"title":"시작하기","permalink":"/docs/device/extendedmodule_sc/getting-started"},"next":{"title":"제품 사양","permalink":"/docs/device/extendedmodule_sc/product-specifications"}}')
