"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6025"], {
8274: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_diretory_integration_mdx_cb6_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 **BioStar X**를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-diretory-integration.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-diretory-integration","permalink":"/docs/platform/biostar_x/settings-diretory-integration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-diretory-integration.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 **BioStar X**를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"CSN 모바일 카드 삭제 시 관리 지침","permalink":"/docs/platform/biostar_x/settings-credential-card-csn-mobile"},"next":{"title":"퀵 액션 사용하기","permalink":"/docs/platform/biostar_x/settings-custom-interface"}}')
