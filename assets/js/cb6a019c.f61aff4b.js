...
var site_docs_platform_biostar_x_settings_diretory_integration_mdx_cb6_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 BioStar X를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-diretory-integration.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-diretory-integration","permalink":"/platform/biostar_x/settings-diretory-integration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-diretory-integration.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 BioStar X를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"방문자 설정하기","permalink":"/platform/biostar_x/settings-visitor"},"next":{"title":"리모트 액세스 설정하기","permalink":"/platform/biostar_x/settings-remote-access"}}')
