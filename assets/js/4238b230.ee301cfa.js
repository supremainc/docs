...
var site_docs_device_vionyx_webserver_add_users_mdx_423_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/add-users","title":"사용자 추가하기","description":"얼굴 인식 사용자를 등록하고 얼굴 사진을 등록하는 방법을 안내하세요.","source":"@site/docs/device/vionyx_webserver/add-users.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/add-users","permalink":"/docs/device/vionyx_webserver/add-users","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/add-users.mdx","tags":[],"version":"current","frontMatter":{"id":"add-users","title":"사용자 추가하기","description":"얼굴 인식 사용자를 등록하고 얼굴 사진을 등록하는 방법을 안내하세요.","keywords":["사용자","등록","얼굴","Face User","추가","사진"],"isTranslationMissing":false},"sidebar":"aicamwebserver","previous":{"title":"사용자 관리하기","permalink":"/docs/device/vionyx_webserver/manage-people"},"next":{"title":"사용자 수정 및 삭제하기","permalink":"/docs/device/vionyx_webserver/modify-delete-users"}}')
