"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["50341"], {
...
var site_docs_platform_biostar_x_settings_device_image_log_mdx_1c4_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-image-log","title":"이미지 로그 설정하기","description":"장치에서 이미지 로그를 생성하기 위한 이벤트 및 스케줄 설정 방법, 이미지 로그의 삭제 옵션과 저장 경로 설정 방법 등을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-image-log.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-image-log","permalink":"/platform/biostar_x/settings-device-image-log","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-image-log.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-image-log","title":"이미지 로그 설정하기","description":"장치에서 이미지 로그를 생성하기 위한 이벤트 및 스케줄 설정 방법, 이미지 로그의 삭제 옵션과 저장 경로 설정 방법 등을 안내합니다.","keywords":["장치","이미지 로그"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"RTSP 설정하기","permalink":"/platform/biostar_x/settings-device-details-rtsp"},"next":{"title":"USB 에이전트 설정하기","permalink":"/platform/biostar_x/settings-device-usb-agent"}}')
