...
var site_docs_platform_biostar_x_express_install_mdx_36e_namespaceObject = JSON.parse('{"id":"platform/biostar_x/express-install","title":"간편 설치하기","description":"내장된 MariaDB 서버와 데이터베이스를 자동으로 생성하여 BioStar X를 빠르게 설치하는 과정을 안내합니다.","source":"@site/docs/platform/biostar_x/express-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/express-install","permalink":"/platform/biostar_x/express-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/express-install.mdx","tags":[],"version":"current","frontMatter":{"id":"express-install","title":"간편 설치하기","description":"내장된 MariaDB 서버와 데이터베이스를 자동으로 생성하여 BioStar X를 빠르게 설치하는 과정을 안내합니다.","keywords":["간편 설치"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"네트워크 우선순위 확인하기","permalink":"/platform/biostar_x/check-ethernet"},"next":{"title":"사용자 정의 설치하기","permalink":"/platform/biostar_x/custom-install"}}')
