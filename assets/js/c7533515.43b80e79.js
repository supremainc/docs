"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["40400"], {
29780: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_ui_monitoring_mdx_c75_namespaceObject = JSON.parse('{"id":"platform/biostar_x/ui-monitoring","title":"모니터링","description":"모니터링 페이지의 사용자 인터페이스(User Interface)를 안내합니다.","source":"@site/docs/platform/biostar_x/ui-monitoring.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/ui-monitoring","permalink":"/platform/biostar_x/ui-monitoring","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/ui-monitoring.mdx","tags":[],"version":"current","frontMatter":{"id":"ui-monitoring","title":"모니터링","description":"모니터링 페이지의 사용자 인터페이스(User Interface)를 안내합니다.","keywords":["모니터링","UI"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자","permalink":"/platform/biostar_x/ui-user"},"next":{"title":"대시보드","permalink":"/platform/biostar_x/ui-dashboard"}}')
