"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["74274"], {
...
var site_docs_platform_biostar_x_settings_device_details_advanced_mdx_8d4_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-details-advanced","title":"고급 설정하기","description":"고급 설정 섹션에서 마스터 관리자, 장치 관리자, 화면/소리, 작업 조건 및 동작 등을 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-device-details-advanced.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-details-advanced","permalink":"/platform/biostar_x/settings-device-details-advanced","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-details-advanced.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-details-advanced","title":"고급 설정하기","description":"고급 설정 섹션에서 마스터 관리자, 장치 관리자, 화면/소리, 작업 조건 및 동작 등을 설정할 수 있습니다.","keywords":["장치","고급"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"인증 설정하기","permalink":"/platform/biostar_x/settings-device-details-auth"},"next":{"title":"열화상 및 마스크 설정하기","permalink":"/platform/biostar_x/settings-device-details-thermal-mask"}}')
