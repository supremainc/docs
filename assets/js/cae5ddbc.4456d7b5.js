...
var site_docs_platform_biostar_x_settings_advanced_ac_scheduled_unlock_mdx_cae_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-advanced-ac-scheduled-unlock","title":"스케줄 개방","description":"스케줄 개방 설정 방법을 안내합니다. 스케줄 개방은 특정 시간에 출입문을 개방하는 기능을 제공합니다.","source":"@site/docs/platform/biostar_x/settings-advanced-ac-scheduled-unlock.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-advanced-ac-scheduled-unlock","permalink":"/platform/biostar_x/settings-advanced-ac-scheduled-unlock","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-advanced-ac-scheduled-unlock.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-advanced-ac-scheduled-unlock","title":"스케줄 개방","description":"스케줄 개방 설정 방법을 안내합니다. 스케줄 개방은 특정 시간에 출입문을 개방하는 기능을 제공합니다.","keywords":["고급 출입 통제","스케줄 개방"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"스케줄 잠금","permalink":"/platform/biostar_x/settings-advanced-ac-scheduled-lock"},"next":{"title":"경비","permalink":"/platform/biostar_x/settings-advanced-ac-intrusion-alarm"}}')
