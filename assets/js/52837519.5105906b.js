"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["16780"], {
...
var site_docs_platform_biostar_x_settings_schedule_mdx_528_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-schedule","title":"스케줄 설정하기","description":"출입 및 휴일 스케줄을 설정하여 출입 통제와 근태 관리를 효율적으로 운영하세요.","source":"@site/docs/platform/biostar_x/settings-schedule.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-schedule","permalink":"/platform/biostar_x/settings-schedule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-schedule.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-schedule","title":"스케줄 설정하기","description":"출입 및 휴일 스케줄을 설정하여 출입 통제와 근태 관리를 효율적으로 운영하세요.","keywords":["스케줄","출입","휴일"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"출입 권한 상태 확인하기","permalink":"/platform/biostar_x/settings-access-control-ac-status"},"next":{"title":"작업 조건 및 동작 설정하기","permalink":"/platform/biostar_x/settings-triger-and-action"}}')
