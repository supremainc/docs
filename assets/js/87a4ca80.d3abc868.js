...
var site_docs_device_xpass_s_2_installation_mdx_87a_namespaceObject = JSON.parse('{"id":"device/xpass_s2/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/xpass_s2/installation.mdx","sourceDirName":"device/xpass_s2","slug":"/device/xpass_s2/installation","permalink":"/device/xpass_s2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xpass_s2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","확장 브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xpasss2","previous":{"title":"시작하기","permalink":"/device/xpass_s2/getting-started"},"next":{"title":"제품 사양","permalink":"/device/xpass_s2/product-specifications"}}')
