"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["80227"], {
45114: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_adding_slave_device_mdx_083_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-adding-slave-device","title":"슬레이브 장치 등록하기","description":"마스터 장치에 슬레이브 장치를 추가하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-adding-slave-device.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-adding-slave-device","permalink":"/platform/biostar_x/settings-adding-slave-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-adding-slave-device.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-adding-slave-device","title":"슬레이브 장치 등록하기","description":"마스터 장치에 슬레이브 장치를 추가하는 방법을 안내합니다.","keywords":["장치","슬레이브 장치"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Wiegand 장치 등록하기","permalink":"/platform/biostar_x/settings-adding-wiegand"},"next":{"title":"장치에 등록한 사용자 관리하기","permalink":"/platform/biostar_x/settings-device-manage-device-users"}}')
