...
var site_docs_device_xstation_2_installation_mdx_bbd_namespaceObject = JSON.parse('{"id":"device/xstation_2/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/xstation_2/installation.mdx","sourceDirName":"device/xstation_2","slug":"/device/xstation_2/installation","permalink":"/device/xstation_2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xstation_2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xstation2","previous":{"title":"시작하기","permalink":"/device/xstation_2/getting-started"},"next":{"title":"사용하기","permalink":"/device/xstation_2/using-device"}}')
