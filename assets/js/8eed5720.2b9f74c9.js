"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["18584"], {
...
var site_docs_platform_biostar_x_check_ethernet_mdx_8ee_namespaceObject = JSON.parse('{"id":"platform/biostar_x/check-ethernet","title":"네트워크 우선순위 확인하기","description":"BioStar X를 설치하기 전에 서버의 네트워크 우선순위를 확인하고 설정하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/check-ethernet.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/check-ethernet","permalink":"/platform/biostar_x/check-ethernet","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/check-ethernet.mdx","tags":[],"version":"current","frontMatter":{"id":"check-ethernet","title":"네트워크 우선순위 확인하기","description":"BioStar X를 설치하기 전에 서버의 네트워크 우선순위를 확인하고 설정하는 방법을 안내합니다.","keywords":["네트워크","BioStar X"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"시작하기","permalink":"/platform/biostar_x/getting-started"},"next":{"title":"간편 설치하기","permalink":"/platform/biostar_x/express-install"}}')
