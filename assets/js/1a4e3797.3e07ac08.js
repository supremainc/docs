"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["5230"], {
8352: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var client = __webpack_require__(8057);
...
var useSearchPage = __webpack_require__(2871);
...
var useAlgoliaThemeConfig = __webpack_require__(8019);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-search-algolia/lib/client/useSearchResultUrlProcessor.js
var useSearchResultUrlProcessor = __webpack_require__(1117);
...
function useDocsSearchVersionsHelpers() {
    const allDocsData = (0,client/* useAllDocsData */._r)();
    // State of the version select menus / algolia facet filters
    // docsPluginId -> versionName map
    const [searchVersions, setSearchVersions] = (0,react.useState)(()=>Object.entries(allDocsData).reduce((acc, param)=>{
            let [pluginId, pluginData] = param;
            return {
                ...acc,
...
function SearchVersionSelectList(param) {
    let { docsSearchVersionsHelpers } = param;
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        className: (0,clsx/* default */.Z)('col', 'col--3', 'padding-left--none', styles_module.searchVersionColumn),
        children: versionedPluginEntries.map((param)=>{
            let [pluginId, docsData] = param;
...
function getSearchPageTitle(searchQuery) {
    return searchQuery ? (0,Translate/* translate */.I)({
...
function SearchPageContent() {
    ...
    const { algolia: { appId, apiKey, indexName, contextualSearch } } = (0,useAlgoliaThemeConfig/* useAlgoliaThemeConfig */.L)();
    const processSearchResultUrl = (0,useSearchResultUrlProcessor/* useSearchResultUrlProcessor */.l)();
    const documentsFoundPlural = useDocumentsFoundPlural();
    const docsSearchVersionsHelpers = useDocsSearchVersionsHelpers();
    const [searchQuery, setSearchQuery] = (0,useSearchPage/* useSearchQueryString */.K)();
    ...
    const algoliaClient = (0,browser/* liteClient */.C)(appId, apiKey);
    ...
    algoliaHelper.on('result', (param)=>{
        let { results: { query, hits, page, nbHits, nbPages } } = param;
        ...
        const items = hits.map((param)=>{
            let { url, _highlightResult: { hierarchy }, _snippetResult: snippet = {} } = param;
    ...
    const observer = (0,react.useRef)(ExecutionEnvironment/* default,canUseIntersectionObserver */.Z.canUseIntersectionObserver && new IntersectionObserver(// TODO need to fix this React Compiler lint error
    ...
    const makeSearch = (0,reactUtils/* useEvent */.zX)(function() {
        let page = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
        if (contextualSearch) {
            algoliaHelper.addDisjunctiveFacetRefinement('docusaurus_tag', 'default');
            algoliaHelper.addDisjunctiveFacetRefinement('language', currentLocale);
            Object.entries(docsSearchVersionsHelpers.searchVersions).forEach((param)=>{
                let [pluginId, searchVersion] = param;
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("form", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                className: (0,clsx/* default */.Z)('col', styles_module.searchQueryColumn, {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                className: (0,clsx/* default */.Z)('col', 'col--8', styles_module.searchResultsColumn),
                                children: !!searchResultState.totalResults && documentsFoundPlural(searchResultState.totalResults)
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                className: (0,clsx/* default */.Z)('col', 'col--4', 'text--right', styles_module.searchLogoColumn),
                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Link/* default */.Z, {
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("svg", {
                                        viewBox: "0 0 168 24",
                                        className: styles_module.algoliaLogo,
                                        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("g", {
                                            fill: "none",
                                            children: [
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
                                                    className: styles_module.algoliaLogoPathFill,
                    ...
                    searchResultState.items.length > 0 ? /*#__PURE__*/ (0,jsx_runtime.jsx)("main", {
                        children: searchResultState.items.map((param, i)=>{
                            let { title, url, summary, breadcrumbs } = param;
                                ...
                                children: [
                                    ...
                                    breadcrumbs.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsx)("nav", {
                                        ...
                                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("ul", {
                                            className: (0,clsx/* default */.Z)('breadcrumbs', styles_module.searchResultItemPath),
