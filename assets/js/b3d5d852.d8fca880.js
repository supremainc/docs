...
| <Image src='/img/device/component-device-bs3.svg' className='none' alone /> | <Image src='/img/device/component-wall-bracket-bs3.svg' className='none' alone /> | <Image src='/img/device/component-drilling-template-bs3.svg' className='none' alone /> | <Image src='/img/device/component-quick-guide.svg' alone /> | <Image src='/img/device/component-connection-cables-bs3.svg' className='none' alone /> |
| :--: | :--: | :--: | :--: | :--: |
| BioStation 3 | 벽걸이용 브래킷 | 드릴링 템플릿 | 퀵 가이드 | 연결 케이블 |
| <Image src='/img/device/component-diode1.svg' className='none' alone /> | <Image src='/img/device/component-resistor.svg' className='none' alone /> | <Image src='/img/device/component-pvc-anchors2.svg' className='none' alone /> | <Image src='/img/device/component-fixing-screws2.svg' className='none' alone /> | <Image src='/img/device/component-bracket-fixing-screw.svg' className='none' alone /> |
| 다이오드 | 120 Ω 저항 | PVC 앵커 x2 | 고정용 나사 x2 | 브래킷 고정용 나사(별 모양) |
