...
var site_docs_platform_biostar_x_settings_remote_access_mdx_e9c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-remote-access","title":"리모트 액세스 설정하기","description":"ngrok 서비스를 통해 리모트 액세스를 설정하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-remote-access","permalink":"/platform/biostar_x/settings-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-remote-access","title":"리모트 액세스 설정하기","description":"ngrok 서비스를 통해 리모트 액세스를 설정하는 방법을 안내합니다.","keywords":["리모트","액세스","ngrok"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"디렉토리 연동 설정하기","permalink":"/platform/biostar_x/settings-diretory-integration"},"next":{"title":"가상 장치 이벤트 로그 연동하기","permalink":"/platform/biostar_x/settings-virtual-device-event-log"}}')
