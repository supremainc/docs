...
var site_docs_platform_biostar_x_add_sub_db_mdx_286_namespaceObject = JSON.parse('{"id":"platform/biostar_x/add-sub-db","title":"보조 데이터베이스 추가하기","description":"커뮤니케이션 서버를 추가했을 때 메인 서버의 부하를 줄이기 위해 커뮤니케이션 서버와 연동할 보조 데이터베이스를 추가하고 연결하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/add-sub-db.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/add-sub-db","permalink":"/platform/biostar_x/add-sub-db","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/add-sub-db.mdx","tags":[],"version":"current","frontMatter":{"id":"add-sub-db","title":"보조 데이터베이스 추가하기","description":"커뮤니케이션 서버를 추가했을 때 메인 서버의 부하를 줄이기 위해 커뮤니케이션 서버와 연동할 보조 데이터베이스를 추가하고 연결하는 방법을 안내합니다.","keywords":["데이터베이스","추가","연결"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"데이터베이스 변경하기","permalink":"/platform/biostar_x/change-db"},"next":{"title":"런처","permalink":"/platform/biostar_x/ui-launcher"}}')
