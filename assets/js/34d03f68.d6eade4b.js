"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["13132"], {
93846: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_user_manage_mdx_34d_namespaceObject = JSON.parse('{"id":"platform/biostar_x/user-manage","title":"사용자 관리하기","description":"사용자 정보 수정, 삭제, 장치 동기화, 출입 이력 추적, 데이터 내보내기/가져오기 등 사용자 관리 기능을 안내합니다.","source":"@site/docs/platform/biostar_x/user-manage.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/user-manage","permalink":"/platform/biostar_x/user-manage","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/user-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"user-manage","title":"사용자 관리하기","description":"사용자 정보 수정, 삭제, 장치 동기화, 출입 이력 추적, 데이터 내보내기/가져오기 등 사용자 관리 기능을 안내합니다.","keywords":["사용자","기본 정보","관리"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자 탐색하기","permalink":"/platform/biostar_x/view-users"},"next":{"title":"사용자 정보 수정하기","permalink":"/platform/biostar_x/edit-user"}}')
