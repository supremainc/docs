"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["79533"], {
15143: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
58972: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_set_permission_mdx_2ba_namespaceObject = JSON.parse('{"id":"platform/biostar_x/set-permission","title":"사용자 권한 설정하기","description":"BioStar X 사용자의 관리자 권한과 출입 권한을 설정하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/set-permission.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/set-permission","permalink":"/platform/biostar_x/set-permission","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/set-permission.mdx","tags":[],"version":"current","frontMatter":{"id":"set-permission","title":"사용자 권한 설정하기","description":"BioStar X 사용자의 관리자 권한과 출입 권한을 설정하는 방법을 안내합니다.","keywords":["사용자","권한"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"PIN 등록하기","permalink":"/platform/biostar_x/enroll-credential-pin"},"next":{"title":"사용자 고급 설정하기","permalink":"/platform/biostar_x/set-user-advanced"}}')
...
var _account_list = __webpack_require__(15143);
