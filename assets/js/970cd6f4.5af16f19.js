...
var site_docs_platform_biostar_air_site_security_settings_mdx_970_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-security-settings","title":"보안 설정하기","description":"관리자 계정 잠금, 2차 인증, 비밀번호 정책, 모바일 크리덴셜 유효 시간 등 BioStar Air 사이트의 보안 수준을 높이는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/site-security-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-security-settings","permalink":"/docs/platform/biostar_air/site-security-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-security-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-security-settings","title":"보안 설정하기","description":"관리자 계정 잠금, 2차 인증, 비밀번호 정책, 모바일 크리덴셜 유효 시간 등 BioStar Air 사이트의 보안 수준을 높이는 방법을 안내합니다.","keywords":["사이트 보안","보안 설정"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"고급 설정하기","permalink":"/docs/platform/biostar_air/site-advanced-settings"},"next":{"title":"추가 기능 설정하기","permalink":"/docs/platform/biostar_air/site-additional-settings"}}')
