...
var site_docs_platform_biostar_air_manage_elevator_mdx_22e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-elevator","title":"엘리베이터 관리","description":"Description","source":"@site/docs/platform/biostar_air/manage-elevator.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-elevator","permalink":"/docs/platform/biostar_air/manage-elevator","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-elevator.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-elevator","title":"엘리베이터 관리","description":"Description","keywords":["keyword1","keyword2"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"출입문 스케줄 관리하기","permalink":"/docs/platform/biostar_air/managing-door-schedules"},"next":{"title":"이벤트 로그와 감사 로그","permalink":"/docs/platform/biostar_air/event-and-audit-logs"}}')
...
function _createMdxContent(props) {
  const _components = {
    ...
    ...props.components
  }, {Cmd, IcAirRemove, Image, YouTube} = _components;
