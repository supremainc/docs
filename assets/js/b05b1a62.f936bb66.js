"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["50699"], {
37427: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_manage_door_mdx_b05_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-manage-door","title":"출입문 관리하기","description":"등록한 장치가 설치된 출입문 정보를 설정하고 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-manage-door.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-manage-door","permalink":"/platform/biostar_x/settings-manage-door","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-manage-door.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-manage-door","title":"출입문 관리하기","description":"등록한 장치가 설치된 출입문 정보를 설정하고 관리하는 방법을 안내합니다.","keywords":["출입문","설정"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"장치 연결 관리 설정하기","permalink":"/platform/biostar_x/settings-device-connection-manager"},"next":{"title":"출입문 그룹 관리하기","permalink":"/platform/biostar_x/settings-manage-door-group"}}')
