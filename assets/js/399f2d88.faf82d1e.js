...
var site_docs_platform_biostar_x_settings_system_daylight_saving_time_mdx_399_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-system-daylight-saving-time","title":"일광 절약 시간 설정하기","description":"일광 절약 시간(Daylight Saving Time, DST)을 설정하여 현지 법정 시간에 맞춰 시스템 시간을 자동으로 조정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-system-daylight-saving-time.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-system-daylight-saving-time","permalink":"/platform/biostar_x/settings-system-daylight-saving-time","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-system-daylight-saving-time.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-system-daylight-saving-time","title":"일광 절약 시간 설정하기","description":"일광 절약 시간(Daylight Saving Time, DST)을 설정하여 현지 법정 시간에 맞춰 시스템 시간을 자동으로 조정할 수 있습니다.","keywords":["일광 절약 시간"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"시스템 보안 강화하기","permalink":"/platform/biostar_x/settings-system-security"},"next":{"title":"기본 설정 구성하기","permalink":"/platform/biostar_x/settings-preferences"}}')
