...
var site_docs_platform_biostar_x_login_mdx_3b9_namespaceObject = JSON.parse('{"id":"platform/biostar_x/login","title":"로그인하기","description":"웹 브라우저로 접속해 BioStar X에 로그인하세요.","source":"@site/docs/platform/biostar_x/login.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/login","permalink":"/platform/biostar_x/login","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/login.mdx","tags":[],"version":"current","frontMatter":{"id":"login","title":"로그인하기","description":"웹 브라우저로 접속해 BioStar X에 로그인하세요.","keywords":["로그인","웹 브라우저"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"커뮤니케이션 서버 설치하기","permalink":"/platform/biostar_x/install-communication-server"},"next":{"title":"라이선스 키 등록하기","permalink":"/platform/biostar_x/register-license-key"}}')
