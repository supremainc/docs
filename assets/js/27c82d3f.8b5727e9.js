...
var site_docs_platform_biostar_x_before_start_mdx_27c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/before-start","title":"시작하기 전에","description":"BioStar X를 시작하기 전에 알아야 할 내용을 안내합니다.","source":"@site/docs/platform/biostar_x/before-start.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/before-start","permalink":"/platform/biostar_x/before-start","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/before-start.mdx","tags":[],"version":"current","frontMatter":{"id":"before-start","title":"시작하기 전에","description":"BioStar X를 시작하기 전에 알아야 할 내용을 안내합니다.","keywords":["설치 안내","MariaDB","SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"개요","permalink":"/platform/biostar_x/overview"},"next":{"title":"시스템 최소 요구사항","permalink":"/platform/biostar_x/system-requirements"}}')
