"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["17463"], {
...
var site_docs_platform_biostar_x_settings_credential_card_manage_mdx_92b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-credential-card-manage","title":"카드 관리하기","description":"카드 발급 상태 확인, Wiegand 카드 데이터 형식 변경, CSN 모바일 카드 삭제 이력 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-credential-card-manage.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-credential-card-manage","permalink":"/platform/biostar_x/settings-credential-card-manage","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-credential-card-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-credential-card-manage","title":"카드 관리하기","description":"카드 발급 상태 확인, Wiegand 카드 데이터 형식 변경, CSN 모바일 카드 삭제 이력 관리 방법을 안내합니다.","keywords":["카드","관리"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"크리덴셜 관리하기","permalink":"/platform/biostar_x/settings-credential-manage"},"next":{"title":"Wiegand 카드 형식 설정하기","permalink":"/platform/biostar_x/settings-credential-wiegand-format"}}')
