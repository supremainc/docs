...
var site_docs_platform_biostar_x_migration_x_mdx_c9c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/migration-x","title":"업그레이드하기","description":"BioStar 2를 BioStar X로 업그레이드하는 절차와 업그레이드 전 확인해야 할 요구 사항을 안내합니다.","source":"@site/docs/platform/biostar_x/migration-x.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/migration-x","permalink":"/platform/biostar_x/migration-x","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/migration-x.mdx","tags":[],"version":"current","frontMatter":{"id":"migration-x","title":"업그레이드하기","description":"BioStar 2를 BioStar X로 업그레이드하는 절차와 업그레이드 전 확인해야 할 요구 사항을 안내합니다.","keywords":["업그레이드"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자 정의 설치하기","permalink":"/platform/biostar_x/custom-install"},"next":{"title":"커뮤니케이션 서버 설치하기","permalink":"/platform/biostar_x/install-communication-server"}}')
