"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["16328"], {
...
var site_docs_platform_biostar_x_tna_rule_shift_schedule_mdx_92c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-rule-shift-schedule","title":"주간 근무 규칙 설정하기","description":"설정한 일일 근무 규칙을 기반으로 주간 단위의 근무 규칙을 생성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/tna-rule-shift-schedule.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-rule-shift-schedule","permalink":"/platform/biostar_x/tna-rule-shift-schedule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-rule-shift-schedule.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-rule-shift-schedule","title":"주간 근무 규칙 설정하기","description":"설정한 일일 근무 규칙을 기반으로 주간 단위의 근무 규칙을 생성하는 방법을 안내합니다.","keywords":["주간 근무 규칙"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"일일 근무 규칙 설정하기","permalink":"/platform/biostar_x/tna-rule-shift-day"},"next":{"title":"기타 근무 규칙 설정하기","permalink":"/platform/biostar_x/tna-rule-shift-overtime"}}')
