"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["2131"], {
...
73015: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */.eW)(() => (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getConfig2 */.nV)().requirement, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */.eW)(this, "RequirementDB");
  }
  getDirection() {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info("Added new element: ", name);
    }
...
(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__export */.r2)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */.eW)(async function(text, id, _version, diag) {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log.info */.cM.info("Drawing requirement diagram (unified)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getConfig2 */.nV)();
  ...
  (0,_chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */.j)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
