"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["51141"], {
...
73972: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_bioentry_p_2_getting_started_mdx_1b0_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-bioentry-p-2-getting-started-mdx-1b0.json
var site_docs_device_bioentry_p_2_getting_started_mdx_1b0_namespaceObject = JSON.parse('{"id":"device/bioentry_p2/getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","source":"@site/docs/device/bioentry_p2/getting-started.mdx","sourceDirName":"device/bioentry_p2","slug":"/device/bioentry_p2/getting-started","permalink":"/docs/device/bioentry_p2/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_p2/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","keywords":["구성품","명칭","기능","케이블","커넥터"],"isTranslationMissing":false},"sidebar":"bioentryp2","previous":{"title":"안전을 위한 주의 사항","permalink":"/docs/device/bioentry_p2/safety-instructions"},"next":{"title":"설치하기","permalink":"/docs/device/bioentry_p2/installation"}}')
...
;// CONCATENATED MODULE: ./docs/device/bioentry_p2/getting-started.mdx
