...
var site_docs_platform_biostar_air_api_authentication_mdx_3a7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/api-authentication","title":"API 인증하기","description":"BioStar Air Cloud API 인증 흐름, API Base URL 목록, Bearer 토큰 발급 및 브라우저에서 토큰을 얻는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/api-authentication.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/api-authentication","permalink":"/docs/platform/biostar_air/api-authentication","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/api-authentication.mdx","tags":[],"version":"current","frontMatter":{"id":"api-authentication","title":"API 인증하기","description":"BioStar Air Cloud API 인증 흐름, API Base URL 목록, Bearer 토큰 발급 및 브라우저에서 토큰을 얻는 방법을 안내합니다.","keywords":["API 인증","Bearer 토큰","API Base URL","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"빠른 시작하기","permalink":"/docs/platform/biostar_air/integration-quickstart"},"next":{"title":"사용자 관리 API 사용하기","permalink":"/docs/platform/biostar_air/api-user-management"}}')
