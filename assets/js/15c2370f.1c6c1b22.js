...
var site_docs_platform_biostar_x_settings_device_using_functions_mdx_15c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-using-functions","title":"장치 관리 기능 사용하기","description":"장치를 재연결하거나 동기화, 일괄 편집 기능에 대해 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-using-functions.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-using-functions","permalink":"/platform/biostar_x/settings-device-using-functions","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-using-functions.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-using-functions","title":"장치 관리 기능 사용하기","description":"장치를 재연결하거나 동기화, 일괄 편집 기능에 대해 안내합니다.","keywords":["장치"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"펌웨어 업그레이드하기","permalink":"/platform/biostar_x/settings-device-upgrade-firmware"},"next":{"title":"장치 설정하기","permalink":"/platform/biostar_x/settings-device-details"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: "팝업 메뉴를 통해 제공하는 기능은 아래를 참고하세요. 장치에 따라 제공하는 기능은 다를 수 있습니다."
