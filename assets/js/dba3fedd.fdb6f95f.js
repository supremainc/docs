"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["48387"], {
74315: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_view_user_by_access_mdx_dba_namespaceObject = JSON.parse('{"id":"platform/biostar_x/view-user-by-access","title":"출입 그룹 관리하기","description":"출입 그룹별로 사용자를 조회하고 출입 권한 구조를 탐색하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/view-user-by-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/view-user-by-access","permalink":"/platform/biostar_x/view-user-by-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/view-user-by-access.mdx","tags":[],"version":"current","frontMatter":{"id":"view-user-by-access","title":"출입 그룹 관리하기","description":"출입 그룹별로 사용자를 조회하고 출입 권한 구조를 탐색하는 방법을 안내합니다.","keywords":["사용자","출입 권한"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"사용자 정보 내보내기/가져오기","permalink":"/platform/biostar_x/export-import-user-info"},"next":{"title":"다중 인증으로 로그인하기","permalink":"/platform/biostar_x/login-with-mfa"}}')
