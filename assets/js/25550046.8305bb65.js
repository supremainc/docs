...
var site_docs_platform_biostar_x_settings_email_setting_mdx_255_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-email-setting","title":"이메일 설정하기","description":"사용자에게 얼굴 등록 모바일 링크를 전송하거나 QR/바코드를 발급할 이메일의 제목, 회사 이름, 회사 로고, 연락처와 같은 정보를 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-email-setting.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-email-setting","permalink":"/platform/biostar_x/settings-email-setting","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-email-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-email-setting","title":"이메일 설정하기","description":"사용자에게 얼굴 등록 모바일 링크를 전송하거나 QR/바코드를 발급할 이메일의 제목, 회사 이름, 회사 로고, 연락처와 같은 정보를 설정할 수 있습니다.","keywords":["이메일 설정","얼굴 등록"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"카드 인쇄하기","permalink":"/platform/biostar_x/settings-card-printer"},"next":{"title":"퀵 액션 사용하기","permalink":"/platform/biostar_x/settings-custom-interface"}}')
