"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["90814"], {
91303: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_server_https_mdx_a38_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-server-https","title":"HTTPS 인증서 설치하기","description":"BioStar X를 HTTPS로 연결하려면 BioStar X를 설치한 서버의 IP 주소를 등록하여 인증서를 설치해야 합니다.","source":"@site/docs/platform/biostar_x/settings-server-https.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-server-https","permalink":"/platform/biostar_x/settings-server-https","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-server-https.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-server-https","title":"HTTPS 인증서 설치하기","description":"BioStar X를 HTTPS로 연결하려면 BioStar X를 설치한 서버의 IP 주소를 등록하여 인증서를 설치해야 합니다.","keywords":["HTTPS","인증서"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"서버 상세 설정하기","permalink":"/platform/biostar_x/settings-server-server"},"next":{"title":"라이선스 활성화하기","permalink":"/platform/biostar_x/settings-license"}}')
