...
var site_docs_platform_biostar_x_enroll_credential_qrbarcode_mdx_353_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-qrbarcode","title":"QR/Barcode 등록하기","description":"QR 코드 또는 바코드를 사용자 인증 수단으로 등록하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/enroll-credential-qrbarcode.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-qrbarcode","permalink":"/docs/platform/biostar_x/enroll-credential-qrbarcode","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-qrbarcode.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-qrbarcode","title":"QR/Barcode 등록하기","description":"QR 코드 또는 바코드를 사용자 인증 수단으로 등록하는 방법을 안내합니다.","keywords":["QR 코드","바코드","등록","크리덴셜","인증"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"모바일 출입 카드 등록하기","permalink":"/docs/platform/biostar_x/enroll-credential-mobile"},"next":{"title":"PIN 등록하기","permalink":"/docs/platform/biostar_x/enroll-credential-pin"}}')
