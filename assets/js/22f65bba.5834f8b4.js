...
var site_docs_platform_biostar_x_user_template_mdx_22f_namespaceObject = JSON.parse('{"id":"platform/biostar_x/user-template","title":"사용자 템플릿 관리","description":"사용자 템플릿을 생성해 조직별, 부서별 기본 정보를 미리 입력해할 수 있습니다.","source":"@site/docs/platform/biostar_x/user-template.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/user-template","permalink":"/docs/platform/biostar_x/user-template","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/user-template.mdx","tags":[],"version":"current","frontMatter":{"id":"user-template","title":"사용자 템플릿 관리","description":"사용자 템플릿을 생성해 조직별, 부서별 기본 정보를 미리 입력해할 수 있습니다.","keywords":["사용자 템플릿"],"isTranslationMissing":false}}')
