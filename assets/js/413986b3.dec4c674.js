...
var site_docs_platform_biostar_x_settings_card_printer_mdx_413_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-card-printer","title":"카드 인쇄하기","description":"BioStar X와 cardPresso를 연동하여 사용자가 원하는 디자인의 카드를 인쇄할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-card-printer.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-card-printer","permalink":"/platform/biostar_x/settings-card-printer","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-card-printer.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-card-printer","title":"카드 인쇄하기","description":"BioStar X와 cardPresso를 연동하여 사용자가 원하는 디자인의 카드를 인쇄할 수 있습니다.","keywords":["cardPresso","카드 프린터"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"모바일 출입 카드 관리하기","permalink":"/platform/biostar_x/settings-credential-mobile-access-card"},"next":{"title":"이메일 설정하기","permalink":"/platform/biostar_x/settings-email-setting"}}')
