"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["19183"], {
92524: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_settings_adding_devices_mdx_40f_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-adding-devices","title":"장치 등록하기","description":"BioStar X에 장치를 등록하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-adding-devices.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-adding-devices","permalink":"/platform/biostar_x/settings-adding-devices","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-adding-devices.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-adding-devices","title":"장치 등록하기","description":"BioStar X에 장치를 등록하는 방법을 안내합니다.","keywords":["장치","장치 추가"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"장치 그룹 관리하기","permalink":"/platform/biostar_x/settings-manage-device-group"},"next":{"title":"Wiegand 장치 등록하기","permalink":"/platform/biostar_x/settings-adding-wiegand"}}')
