...
var site_docs_platform_biostar_x_settings_server_server_mdx_d2b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-server-server","title":"서버 상세 설정하기","description":"BioStar X 서버의 기본 정보, 사용자 및 장치 관리, 서버 매칭, 시스템 로그 단계, 얼굴 이미지 저장에 대한 설정을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-server-server.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-server-server","permalink":"/platform/biostar_x/settings-server-server","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-server-server.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-server-server","title":"서버 상세 설정하기","description":"BioStar X 서버의 기본 정보, 사용자 및 장치 관리, 서버 매칭, 시스템 로그 단계, 얼굴 이미지 저장에 대한 설정을 안내합니다.","keywords":["서버 설정","사용자 관리","장치 관리","서버 매칭","시스템 로그"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"서버 설정하기","permalink":"/platform/biostar_x/settings-server"},"next":{"title":"HTTPS 인증서 설치하기","permalink":"/platform/biostar_x/settings-server-https"}}')
