"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["58410"], {
...
var site_docs_platform_biostar_x_settings_custom_interface_mdx_f4b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-custom-interface","title":"퀵 액션 사용하기","description":"설정된 퀵 액션을 메인화면에 추가할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-custom-interface.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-custom-interface","permalink":"/platform/biostar_x/settings-custom-interface","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-custom-interface.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-custom-interface","title":"퀵 액션 사용하기","description":"설정된 퀵 액션을 메인화면에 추가할 수 있습니다.","keywords":["퀵 액션","커스텀 인터페이스"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"이메일 설정하기","permalink":"/platform/biostar_x/settings-email-setting"},"next":{"title":"서버 설정하기","permalink":"/platform/biostar_x/settings-server"}}')
