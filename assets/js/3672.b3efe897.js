"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["3672"], {
82040: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
/* ESM import */var _chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(92581);
...
/* ESM import */var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(49235);
...
var _drawLongText = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)((_text, x, y, g) => {
  ...
  text = text.replace(/\n/g, "<br/>");
  const lines = text.split(_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default.lineBreakRegex */.SY.lineBreakRegex);
...
var drawEdge = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)(function(elem, path, relation) {
  const getRelationType = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)(function(type) {
    switch (type) {
      case _chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .StateDB.relationType.AGGREGATION */.oI.relationType.AGGREGATION:
        return "aggregation";
      case _chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .StateDB.relationType.EXTENSION */.oI.relationType.EXTENSION:
        return "extension";
      case _chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .StateDB.relationType.COMPOSITION */.oI.relationType.COMPOSITION:
        return "composition";
      case _chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .StateDB.relationType.DEPENDENCY */.oI.relationType.DEPENDENCY:
        return "dependency";
    }
  }, "getRelationType");
  ...
  svgPath.attr(
    "marker-end",
    "url(" + url + "#" + getRelationType(_chunk_AEK57VVT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .StateDB.relationType.DEPENDENCY */.oI.relationType.DEPENDENCY) + "End)"
  );
  if (relation.title !== void 0) {
    const label = elem.append("g").attr("class", "stateLabel");
    const { x, y } = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default.calcLabelPosition */.w8.calcLabelPosition(path.points);
    const rows = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default.getRows */.SY.getRows(relation.title);
    let titleHeight = 0;
    const titleRows = [];
    let maxWidth = 0;
    let minX = 0;
    for (let i = 0; i <= rows.length; i++) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info(boundsTmp.x, x, y + titleHeight);
      if (titleHeight === 0) {
        const titleBox = title.node().getBBox();
        titleHeight = titleBox.height;
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info("Title height", titleHeight, y);
      }
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.info */.cM.info(bounds);
  }
  edgeCount++;
}, "drawEdge");
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)(function(text, id, _version, diagObj) {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Rendering diagram " + text);
...
var renderDoc = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */.eW)((doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Count=", graph.nodeCount(), graph);
  let cnt = 0;
  relations.forEach(function(relation) {
    cnt++;
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Setting edge", relation);
    graph.setEdge(
      relation.id1,
      relation.id2,
      {
        ...
        height: conf.labelHeight * _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default.getRows */.SY.getRows(relation.title).length,
        labelpos: "c"
      },
      "id" + cnt
    );
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Graph after layout", graph.nodes());
  const svgElem = diagram2.node();
  graph.nodes().forEach(function(v) {
    if (v !== void 0 && graph.node(v) !== void 0) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.warn */.cM.warn("Node " + v + ": " + JSON.stringify(graph.node(v)));
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("No Node " + v + ": " + JSON.stringify(graph.node(v)));
    }
  });
  let stateBox = svgElem.getBBox();
  graph.edges().forEach(function(e) {
    if (e !== void 0 && graph.edge(e) !== void 0) {
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log.debug */.cM.debug("Doc rendered", stateInfo, graph);
  return stateInfo;
}, "renderDoc");
