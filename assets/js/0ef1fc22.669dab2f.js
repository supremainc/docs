...
var site_docs_platform_biostar_x_dashboard_adding_widget_mdx_0ef_namespaceObject = JSON.parse('{"id":"platform/biostar_x/dashboard-adding-widget","title":"위젯 추가하기","description":"대시보드는 사용자가 원하는 정보를 자유롭게 배치할 수 있는 사용자 정의형 모니터링 화면입니다.","source":"@site/docs/platform/biostar_x/dashboard-adding-widget.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/dashboard-adding-widget","permalink":"/platform/biostar_x/dashboard-adding-widget","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/dashboard-adding-widget.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-adding-widget","title":"위젯 추가하기","description":"대시보드는 사용자가 원하는 정보를 자유롭게 배치할 수 있는 사용자 정의형 모니터링 화면입니다.","keywords":["대시보드","위젯"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"대시보드","permalink":"/platform/biostar_x/how-to-guide-dashboard"},"next":{"title":"위젯 수정하기","permalink":"/platform/biostar_x/dashboard-edit-widget"}}')
