"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["97587"], {
...
var site_docs_platform_biostar_x_tna_settings_mdx_5bc_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-settings","title":"근태 관리 설정하기","description":"근태 관리에 사용할 장치를 등록하거나 알림 이메일을 발신할 때 사용할 발신자 정보를 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/tna-settings.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-settings","permalink":"/platform/biostar_x/tna-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-settings","title":"근태 관리 설정하기","description":"근태 관리에 사용할 장치를 등록하거나 알림 이메일을 발신할 때 사용할 발신자 정보를 설정할 수 있습니다.","keywords":["근태","설정"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"근태 기록 수정하기","permalink":"/platform/biostar_x/tna-report-edit"},"next":{"title":"방문자 신청 및 관리하기","permalink":"/platform/biostar_x/visitor"}}')
