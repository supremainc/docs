...
var site_docs_device_vionyx_webserver_add_operators_mdx_149_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/add-operators","title":"운영자 추가하기","description":"카메라 운영을 위한 추가 관리자(운영자) 계정을 추가하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/add-operators.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/add-operators","permalink":"/docs/device/vionyx_webserver/add-operators","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/add-operators.mdx","tags":[],"version":"current","frontMatter":{"id":"add-operators","title":"운영자 추가하기","description":"카메라 운영을 위한 추가 관리자(운영자) 계정을 추가하는 방법을 안내합니다.","keywords":["운영자","관리자","계정","추가","권한","Operator"],"isTranslationMissing":false},"sidebar":"aicamwebserver","previous":{"title":"관리자 계정 비밀번호 업데이트하기","permalink":"/docs/device/vionyx_webserver/update-admin-password"},"next":{"title":"시스템 로그 확인하기","permalink":"/docs/device/vionyx_webserver/view-system-logs"}}')
