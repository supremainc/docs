"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["31928"], {
...
var site_docs_platform_biostar_x_settings_device_manage_device_users_mdx_7d6_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-device-manage-device-users","title":"장치에 등록한 사용자 관리하기","description":"장치에 등록한 사용자를 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-device-manage-device-users.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-device-manage-device-users","permalink":"/platform/biostar_x/settings-device-manage-device-users","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-device-manage-device-users.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-device-manage-device-users","title":"장치에 등록한 사용자 관리하기","description":"장치에 등록한 사용자를 관리하는 방법을 안내합니다.","keywords":["장치","사용자"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"슬레이브 장치 등록하기","permalink":"/platform/biostar_x/settings-adding-slave-device"},"next":{"title":"펌웨어 업그레이드하기","permalink":"/platform/biostar_x/settings-device-upgrade-firmware"}}')
