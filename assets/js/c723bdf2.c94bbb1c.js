...
var site_docs_platform_biostar_air_settings_mdx_c72_namespaceObject = JSON.parse('{"id":"platform/biostar_air/settings","title":"사이트 설정하기","description":"BioStar Air 시스템의 관리자 권한 설정, 사이트 기본 정보, 시간대 설정, 이메일 알림, 경고 및 보고서, 카드 형식 등 시스템 운영에 필요한 각종 설정을 관리합니다.","source":"@site/docs/platform/biostar_air/settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/settings","permalink":"/docs/platform/biostar_air/settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/settings.mdx","tags":[],"version":"current","frontMatter":{"id":"settings","title":"사이트 설정하기","description":"BioStar Air 시스템의 관리자 권한 설정, 사이트 기본 정보, 시간대 설정, 이메일 알림, 경고 및 보고서, 카드 형식 등 시스템 운영에 필요한 각종 설정을 관리합니다.","keywords":["관리자 관리","사이트 설정","이메일 템플릿","일광절약시간","경고 및 보고","Wiegand 카드 형식"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"비상 호출","permalink":"/docs/platform/biostar_air/managing-roll-call-fire-muster"},"next":{"title":"기본 정보 설정하기","permalink":"/docs/platform/biostar_air/site-basic-settings"}}')
