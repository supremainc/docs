...
var site_docs_platform_biostar_air_custom_wiegand_card_formats_mdx_0b1_namespaceObject = JSON.parse('{"id":"platform/biostar_air/custom-wiegand-card-formats","title":"커스텀 Wiegand 카드 형식","description":"기존 출입 통제 시스템에서 원활하게 마이그레이션하기 위한 시설 코드, ID 세그먼트, 패리티 비트, 비트 할당을 비롯하여 BioStar Air v2.10에서 사용자 정의 Wiegand 카드 형식을 만들고 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/custom-wiegand-card-formats.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/custom-wiegand-card-formats","permalink":"/platform/biostar_air/custom-wiegand-card-formats","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/custom-wiegand-card-formats.mdx","tags":[],"version":"current","frontMatter":{"id":"custom-wiegand-card-formats","title":"커스텀 Wiegand 카드 형식","description":"기존 출입 통제 시스템에서 원활하게 마이그레이션하기 위한 시설 코드, ID 세그먼트, 패리티 비트, 비트 할당을 비롯하여 BioStar Air v2.10에서 사용자 정의 Wiegand 카드 형식을 만들고 구성하는 방법을 안내합니다.","keywords":["Wiegand","카드 형식","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"모바일 앱에서 사이트 관리하기","permalink":"/platform/biostar_air/managing-sites-with-phone"},"next":{"title":"출입문 관리하기","permalink":"/platform/biostar_air/managing-door-access"}}')
