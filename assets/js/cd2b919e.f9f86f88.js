...
var site_docs_platform_biostar_air_daylight_saving_time_mdx_cd2_namespaceObject = JSON.parse('{"id":"platform/biostar_air/daylight-saving-time","title":"일광 절약 시간(DST) 구성하기","description":"BioStar Air에서 자동 및 수동 DST 설정 구성 방법, 장치에 대한 DST 활성화 방법, 여러 위치에서 표준 시간대 조정 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/daylight-saving-time.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/daylight-saving-time","permalink":"/docs/platform/biostar_air/daylight-saving-time","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/daylight-saving-time.mdx","tags":[],"version":"current","frontMatter":{"id":"daylight-saving-time","title":"일광 절약 시간(DST) 구성하기","description":"BioStar Air에서 자동 및 수동 DST 설정 구성 방법, 장치에 대한 DST 활성화 방법, 여러 위치에서 표준 시간대 조정 관리 방법을 안내합니다.","keywords":["일광 절약 시간","DST","시간대"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"서비스 구성하기","permalink":"/docs/platform/biostar_air/service-configuration"},"next":{"title":"이메일 템플릿 사용자 정의하기","permalink":"/docs/platform/biostar_air/customizing-email-templates"}}')
