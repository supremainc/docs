"use strict";
(self['webpackChunksuprema_docs'] = self['webpackChunksuprema_docs'] || []).push([["9607"], {
"3915": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  H: () => (/* binding */ autocomplete_autocomplete)
});
...
var invariant = __webpack_require__("6498");
...
function getNormalizedSources(getSources, params) {
  ...
  return Promise.resolve(getSources(params)).then(function (sources) {
    (0,invariant/* invariant */.k)(Array.isArray(sources), function () {
    ...
    .filter(function (maybeSource) {
      ...
      (0,invariant/* invariant */.k)(typeof source.sourceId === 'string', 'A source must provide a `sourceId` string.');
...
function postResolve(responses, sources, store) {
  return sources.map(function (source) {
    ...
    (0,invariant/* invariant */.k)(Array.isArray(items), function () {
    ...
    (0,invariant/* invariant */.k)(items.every(Boolean), "The `getItems` function from source \"".concat(source.sourceId, "\" must return an array of items but returned ").concat(JSON.stringify(undefined), ".\n\nDid you forget to return items?\n\nSee: https://www.algolia.com/doc/ui-libraries/autocomplete/core-concepts/sources/#param-getitems"));
    return {
      source: source,
      items: items
    };
...
var userAgents = __webpack_require__("3448");
...
function getMetadata(_ref) {
  ...
  return {
    ...
    ua: userAgents/* userAgents,concat */.R.concat(((_options$__autocomple3 = options.__autocomplete_metadata) === null || _options$__autocomple3 === void 0 ? void 0 : _options$__autocomple3.userAgents) || [])
  };
}
...
var stateReducer_stateReducer = function stateReducer(state, action) {
  switch (action.type) {
    ...
    default:
      (0,invariant/* invariant */.k)(false, "The reducer action ".concat(JSON.stringify(action.type), " is not supported."));
      return state;
  }
};
...
var constants = __webpack_require__("8786");
...
function parseAttribute(_ref) {
  ...
  var preTagParts = highlightedValue.split(constants/* HIGHLIGHT_PRE_TAG */.S);
  ...
  preTagParts.forEach(function (part) {
    var postTagParts = part.split(constants/* HIGHLIGHT_POST_TAG */.Z);
    parts.add({
...
function getHTMLElement(environment, value) {
  if (typeof value === 'string') {
    ...
    (0,invariant/* invariant */.k)(element !== null, "The element ".concat(JSON.stringify(value), " is not in the document."));
    return element;
  }
  return value;
}
...
function getDefaultOptions(options) {
  ...
  (0,invariant/* invariant */.k)(containerElement.tagName !== 'INPUT', 'The `container` option does not support `input` elements. You need to change the container to a `div`.');
   false ? 0 : void 0;
   false ? 0 : void 0;
...
var esm_userAgents = __webpack_require__("500");
  ...
  var autocomplete = reactive(function () {
    return createAutocomplete(autocomplete_objectSpread(autocomplete_objectSpread({}, props.value.core), {}, {
      ...
      __autocomplete_metadata: {
        userAgents: esm_userAgents/* userAgents */.R,
        options: options
      }
    }));
  });
...
"9398": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  g: () => (/* binding */ getAlgoliaResults)
});
...
// EXTERNAL MODULE: ./node_modules/@algolia/autocomplete-shared/dist/esm/userAgents.js
var esm_userAgents = __webpack_require__("3448");
// EXTERNAL MODULE: ./node_modules/@algolia/autocomplete-shared/dist/esm/invariant.js
var invariant = __webpack_require__("6498");
// EXTERNAL MODULE: ./node_modules/@algolia/autocomplete-preset-algolia/dist/esm/constants/index.js
var constants = __webpack_require__("8786");
...
function fetchAlgoliaResults(_ref) {
  ...
  if (typeof searchClient.addAlgoliaAgent === 'function') {
    var algoliaAgents = [].concat(_toConsumableArray(esm_userAgents/* userAgents */.R), _toConsumableArray(userAgents));
  ...
  (0,invariant/* invariant */.k)(Boolean(appId), 'The Algolia `appId` was not accessible from the searchClient passed.');
  (0,invariant/* invariant */.k)(Boolean(apiKey), 'The Algolia `apiKey` was not accessible from the searchClient passed.');
  return searchClient.search(queries.map(function (searchParameters) {
    ...
    return fetchAlgoliaResults_objectSpread(fetchAlgoliaResults_objectSpread({}, headers), {}, {
      params: fetchAlgoliaResults_objectSpread({
        hitsPerPage: 5,
        highlightPreTag: constants/* HIGHLIGHT_PRE_TAG */.S,
        highlightPostTag: constants/* HIGHLIGHT_POST_TAG */.Z
      }, params)
    });
...
// EXTERNAL MODULE: ./node_modules/@algolia/autocomplete-js/dist/esm/userAgents.js
var dist_esm_userAgents = __webpack_require__("500");
...
var createAlgoliaRequester = createRequester(function (params) {
  return fetchAlgoliaResults(createAlgoliaRequester_objectSpread(createAlgoliaRequester_objectSpread({}, params), {}, {
    userAgents: dist_esm_userAgents/* userAgents */.R
  }));
}, 'algolia');
...
"500": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  R: function() { return userAgents; }
});
/* ESM import */var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3269);

var userAgents = [{
  segment: 'autocomplete-js',
  version: _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_0__/* .version */.i
}];

}),
"8786": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  S: function() { return HIGHLIGHT_PRE_TAG; },
  Z: function() { return HIGHLIGHT_POST_TAG; }
});
var HIGHLIGHT_PRE_TAG = '__aa-highlight__';
var HIGHLIGHT_POST_TAG = '__/aa-highlight__';

}),
"6498": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  k: function() { return invariant; }
});
/**
...
"3448": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  R: function() { return userAgents; }
});
/* ESM import */var _version__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3269);

var userAgents = [{
  segment: 'autocomplete-core',
  version: _version__WEBPACK_IMPORTED_MODULE_0__/* .version */.i
}];

}),
"3269": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  i: function() { return version; }
});
var version = '1.18.1';
