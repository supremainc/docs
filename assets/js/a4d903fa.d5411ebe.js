...
var site_docs_device_biostation_2_a_installation_mdx_a4d_namespaceObject = JSON.parse('{"id":"device/biostation_2a/installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/biostation_2a/installation.mdx","sourceDirName":"device/biostation_2a","slug":"/device/biostation_2a/installation","permalink":"/device/biostation_2a/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_2a/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["브래킷","전원","네트워크","입력","릴레이","독립형","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"biostation2a","previous":{"title":"시작하기","permalink":"/device/biostation_2a/getting-started"},"next":{"title":"사용하기","permalink":"/device/biostation_2a/using-device"}}')
