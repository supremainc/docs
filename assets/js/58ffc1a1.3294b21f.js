...
var site_docs_platform_biostar_x_settings_system_system_restore_mdx_58f_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-system-system-restore","title":"시스템 복원하기","description":"시스템 백업 파일을 사용하여 BioStar X의 데이터베이스, 설정, 라이선스 등을 이전 상태로 복원하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-system-system-restore.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-system-system-restore","permalink":"/platform/biostar_x/settings-system-system-restore","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-system-system-restore.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-system-system-restore","title":"시스템 복원하기","description":"시스템 백업 파일을 사용하여 BioStar X의 데이터베이스, 설정, 라이선스 등을 이전 상태로 복원하는 방법을 안내합니다.","keywords":["시스템 복원","restore","백업 복원","데이터 복구","BioStar X Restore"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"시스템 백업하기","permalink":"/platform/biostar_x/settings-system-system-backup"},"next":{"title":"시스템 보안 강화하기","permalink":"/platform/biostar_x/settings-system-security"}}')
