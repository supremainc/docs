...
var site_docs_device_vionyx_webserver_configure_network_mdx_625_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/configure-network","title":"네트워크 설정하기","description":"IPv4 주소를 자동 또는 수동으로 설정하고, 웹 UI와 영상 스트리밍 포트를 구성하며, CLUe 클라우드 서비스에 연결하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/configure-network.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/configure-network","permalink":"/docs/device/vionyx_webserver/configure-network","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/configure-network.mdx","tags":[],"version":"current","frontMatter":{"id":"configure-network","title":"네트워크 설정하기","description":"IPv4 주소를 자동 또는 수동으로 설정하고, 웹 UI와 영상 스트리밍 포트를 구성하며, CLUe 클라우드 서비스에 연결하는 방법을 안내합니다.","keywords":["네트워크","IPv4","DHCP","Static","포트","CLUe","클라우드"],"isTranslationMissing":false},"sidebar":"aicamwebserver","previous":{"title":"날짜와 시간 설정하기","permalink":"/docs/device/vionyx_webserver/configure-date-time"},"next":{"title":"사용자 관리하기","permalink":"/docs/device/vionyx_webserver/manage-people"}}')
