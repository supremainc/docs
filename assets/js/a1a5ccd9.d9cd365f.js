...
var site_docs_device_outputmodule_installation_mdx_a1a_namespaceObject = JSON.parse('{"id":"device/outputmodule/installation","title":"설치하기","description":"제품 설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/outputmodule/installation.mdx","sourceDirName":"device/outputmodule","slug":"/device/outputmodule/installation","permalink":"/docs/device/outputmodule/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/outputmodule/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"제품 설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["설치","전원","RS-485","릴레이","AUX","함체","탬퍼"],"isTranslationMissing":false},"sidebar":"outputmodule","previous":{"title":"시작하기","permalink":"/docs/device/outputmodule/getting-started"},"next":{"title":"제품 사양","permalink":"/docs/device/outputmodule/product-specifications"}}')
