...
var site_docs_platform_biostar_x_tna_rule_shift_overtime_mdx_aae_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-rule-shift-overtime","title":"기타 근무 규칙 설정하기","description":"일일 근무 규칙에 연장 근무 시간 규칙을 추가하지 않았을 때 유용하게 사용할 수 있는 기타 근무 규칙 추가 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/tna-rule-shift-overtime.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-rule-shift-overtime","permalink":"/docs/platform/biostar_x/tna-rule-shift-overtime","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-rule-shift-overtime.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-rule-shift-overtime","title":"기타 근무 규칙 설정하기","description":"일일 근무 규칙에 연장 근무 시간 규칙을 추가하지 않았을 때 유용하게 사용할 수 있는 기타 근무 규칙 추가 방법을 안내합니다.","keywords":["기타 근무 규칙","연장 근무"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"주간 근무 규칙 설정하기","permalink":"/docs/platform/biostar_x/tna-rule-shift-schedule"},"next":{"title":"근무 스케줄 설정하기","permalink":"/docs/platform/biostar_x/tna-rule-schedule"}}')
