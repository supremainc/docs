"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6973"], {
81187: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_reference_glossary_mdx_9ce_namespaceObject = JSON.parse('{"id":"reference/glossary","title":"용어집","description":"이 문서는 슈프리마의 제품 및 서비스에 사용되는 용어를 정리한 문서입니다.","source":"@site/docs/reference/glossary.mdx","sourceDirName":"reference","slug":"/reference/glossary","permalink":"/reference/glossary","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/glossary.mdx","tags":[],"version":"current","frontMatter":{"id":"glossary","title":"용어집","description":"이 문서는 슈프리마의 제품 및 서비스에 사용되는 용어를 정리한 문서입니다.","keywords":["슈프리마","용어집"],"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"참조 문서","permalink":"/reference/"},"next":{"title":"제품 기능 및 사양 비교","permalink":"/reference/compares/"}}')
