...
var site_docs_platform_biostar_x_login_with_mfa_mdx_b73_namespaceObject = JSON.parse('{"id":"platform/biostar_x/login-with-mfa","title":"멀티팩터 인증으로 로그인하기","description":"BioStar X에 로그인할 때 멀티팩터 인증 기능을 사용하면 계정의 보안을 향상할 수 있습니다.","source":"@site/docs/platform/biostar_x/login-with-mfa.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/login-with-mfa","permalink":"/docs/platform/biostar_x/login-with-mfa","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/login-with-mfa.mdx","tags":[],"version":"current","frontMatter":{"id":"login-with-mfa","title":"멀티팩터 인증으로 로그인하기","description":"BioStar X에 로그인할 때 멀티팩터 인증 기능을 사용하면 계정의 보안을 향상할 수 있습니다.","keywords":["로그인","MFA","다중 인증"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"출입 권한별 사용자 확인하기","permalink":"/docs/platform/biostar_x/view-user-by-access"},"next":{"title":"비주얼 페이스 마이그레이션","permalink":"/docs/platform/biostar_x/migration-visual-face"}}')
...
const frontMatter = {
	...
	description: 'BioStar X에 로그인할 때 멀티팩터 인증 기능을 사용하면 계정의 보안을 향상할 수 있습니다.',
	keywords: [
		'로그인',
		'MFA',
		'다중 인증'
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "전체 관리자(ID 1번) 계정에 멀티팩터 인증 기능을 설정한 후, 지문 인증 기능을 사용할 수 없게 되면 해당 계정으로 더 이상 로그인할 수 없으므로 주의하세요."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
