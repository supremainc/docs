...
var site_docs_platform_biostar_air_16_monitoring_airfob_pro_monitoring_event_logs_and_audit_logs_mdx_bf6_namespaceObject = JSON.parse('{"id":"platform/biostar_air/event-and-audit-logs","title":"이벤트 로그와 감사 로그","description":"BioStar Air에서 이벤트 로그와 감사 로그를 모니터링 및 분석하고, 필터 적용, 데이터 내보내기 및 관리 활동 추적 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/16-monitoring-airfob-pro-monitoring-event-logs-and-audit-logs.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/event-and-audit-logs","permalink":"/platform/biostar_air/event-and-audit-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/16-monitoring-airfob-pro-monitoring-event-logs-and-audit-logs.mdx","tags":[],"version":"current","sidebarPosition":16,"frontMatter":{"id":"event-and-audit-logs","title":"이벤트 로그와 감사 로그","description":"BioStar Air에서 이벤트 로그와 감사 로그를 모니터링 및 분석하고, 필터 적용, 데이터 내보내기 및 관리 활동 추적 방법을 안내합니다.","keywords":["모니터링","이벤트 로그","감사 로그","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"출입문 스케줄 관리하기","permalink":"/platform/biostar_air/managing-door-schedules"},"next":{"title":"출입문 상태 모니터링","permalink":"/platform/biostar_air/monitoring-door-status"}}')
