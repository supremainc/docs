...
var site_docs_platform_biostar_x_settings_adding_wiegand_mdx_c10_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-adding-wiegand","title":"Wiegand 장치 등록하기","description":"등록한 마스터 장치나 슬레이브 장치에 Wiegand 장치를 추가하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-adding-wiegand.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-adding-wiegand","permalink":"/platform/biostar_x/settings-adding-wiegand","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-adding-wiegand.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-adding-wiegand","title":"Wiegand 장치 등록하기","description":"등록한 마스터 장치나 슬레이브 장치에 Wiegand 장치를 추가하는 방법을 안내합니다.","keywords":["장치","Wiegand"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"장치 등록하기","permalink":"/platform/biostar_x/settings-adding-devices"},"next":{"title":"슬레이브 장치 등록하기","permalink":"/platform/biostar_x/settings-adding-slave-device"}}')
