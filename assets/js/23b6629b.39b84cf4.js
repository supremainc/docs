...
var site_docs_platform_biostar_x_tna_rule_shift_day_mdx_23b_namespaceObject = JSON.parse('{"id":"platform/biostar_x/tna-rule-shift-day","title":"일일 근무 규칙 설정하기","description":"24 시간을 기준으로 시간에 따라 시간 규칙을 다르게 적용하여 근무 규칙을 생성할 수 있습니다.","source":"@site/docs/platform/biostar_x/tna-rule-shift-day.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/tna-rule-shift-day","permalink":"/platform/biostar_x/tna-rule-shift-day","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/tna-rule-shift-day.mdx","tags":[],"version":"current","frontMatter":{"id":"tna-rule-shift-day","title":"일일 근무 규칙 설정하기","description":"24 시간을 기준으로 시간에 따라 시간 규칙을 다르게 적용하여 근무 규칙을 생성할 수 있습니다.","keywords":["근무 시간","일일 근무 규칙"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"시간 규칙 설정하기","permalink":"/platform/biostar_x/tna-rule-shift-paycode"},"next":{"title":"주간 근무 규칙 설정하기","permalink":"/platform/biostar_x/tna-rule-shift-schedule"}}')
