"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["67500"], {
...
var site_docs_platform_biostar_x_settings_alert_mdx_543_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-alert","title":"경보 설정하기","description":"장치, 출입문, 구역에 이벤트가 발생했을 경우 화면에 표시할 경보 종류와 메시지를 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-alert.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-alert","permalink":"/platform/biostar_x/settings-alert","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-alert","title":"경보 설정하기","description":"장치, 출입문, 구역에 이벤트가 발생했을 경우 화면에 표시할 경보 종류와 메시지를 설정할 수 있습니다.","keywords":["경보"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"이벤트 로그 가져오기","permalink":"/platform/biostar_x/settings-event-log-import"},"next":{"title":"크리덴셜 관리하기","permalink":"/platform/biostar_x/settings-credential-manage"}}')
