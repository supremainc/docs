"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["69210"], {
86999: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_x_getting_started_mdx_b09_namespaceObject = JSON.parse('{"id":"platform/biostar_x/getting-started","title":"시작하기","description":"BioStar X의 설치, 업그레이드, 초기 설정에 필요한 기본 절차를 단계별로 안내하는 가이드 문서 모음입니다.","source":"@site/docs/platform/biostar_x/getting-started.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/getting-started","permalink":"/platform/biostar_x/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"시작하기","description":"BioStar X의 설치, 업그레이드, 초기 설정에 필요한 기본 절차를 단계별로 안내하는 가이드 문서 모음입니다.","keywords":["Tutorial","설치","기본 설정"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"시스템 최소 요구사항","permalink":"/platform/biostar_x/system-requirements"},"next":{"title":"네트워크 우선순위 확인하기","permalink":"/platform/biostar_x/check-ethernet"}}')
