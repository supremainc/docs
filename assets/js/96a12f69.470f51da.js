...
var site_docs_platform_biostar_x_server_management_mdx_96a_namespaceObject = JSON.parse('{"id":"platform/biostar_x/server-management","title":"서버 관리","description":"BioStar X Service Manager를 사용해 BioStar X 서버의 서비스 관리 방법, 포트 변경, 데이터베이스 변경 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/server-management.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/server-management","permalink":"/platform/biostar_x/server-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/server-management.mdx","tags":[],"version":"current","frontMatter":{"id":"server-management","title":"서버 관리","description":"BioStar X Service Manager를 사용해 BioStar X 서버의 서비스 관리 방법, 포트 변경, 데이터베이스 변경 방법을 안내합니다.","keywords":["서버 관리","BioStar X"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"초기 설정 가이드","permalink":"/platform/biostar_x/initial-setup-guide"},"next":{"title":"서버 시작 및 종료","permalink":"/platform/biostar_x/manage-server"}}')
