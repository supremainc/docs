"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["60612"], {
...
var site_docs_platform_biostar_x_settings_access_control_manage_access_group_mdx_7ae_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-access-control-manage-access-group","title":"출입 그룹 관리하기","description":"출입 등급과 사용자 그룹 정보를 사용해 출입 그룹을 설정할 수 있습니다.","source":"@site/docs/platform/biostar_x/settings-access-control-manage-access-group.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-access-control-manage-access-group","permalink":"/platform/biostar_x/settings-access-control-manage-access-group","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-access-control-manage-access-group.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-access-control-manage-access-group","title":"출입 그룹 관리하기","description":"출입 등급과 사용자 그룹 정보를 사용해 출입 그룹을 설정할 수 있습니다.","keywords":["출입 그룹","출입 등급","사용자 그룹"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"출입 등급 관리하기","permalink":"/platform/biostar_x/settings-access-control-manage-access-level"},"next":{"title":"층 등급 관리하기","permalink":"/platform/biostar_x/settings-access-control-manage-floor-level"}}')
