"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["3572"], {
...
31440: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_air_14_elevator_management_managing_elevator_access_mdx_f4f_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-elevator-access","title":"엘리베이터 출입 관리하기","description":"BioStar Air에서 슈프리마의 OM120 모듈을 사용해 엘리베이터 출입 통제 구성, 층 권한 설정, 사용자 접근 수준 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/14-elevator-management-managing-elevator-access.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-elevator-access","permalink":"/docs/platform/biostar_air/managing-elevator-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/14-elevator-management-managing-elevator-access.mdx","tags":[],"version":"current","sidebarPosition":14,"frontMatter":{"id":"managing-elevator-access","title":"엘리베이터 출입 관리하기","description":"BioStar Air에서 슈프리마의 OM120 모듈을 사용해 엘리베이터 출입 통제 구성, 층 권한 설정, 사용자 접근 수준 관리 방법을 안내합니다.","keywords":["엘리베이터 출입","BioStar Air","OM120"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"출입문 관리하기","permalink":"/docs/platform/biostar_air/managing-door-access"},"next":{"title":"이벤트 로그와 감사 로그","permalink":"/docs/platform/biostar_air/event-and-audit-logs"}}')
...
const frontMatter = {
	...
	title: '엘리베이터 출입 관리하기',
	description: 'BioStar Air에서 슈프리마의 OM120 모듈을 사용해 엘리베이터 출입 통제 구성, 층 권한 설정, 사용자 접근 수준 관리 방법을 안내합니다.',
	keywords: [
		'엘리베이터 출입',
		'BioStar Air',
		'OM120'
