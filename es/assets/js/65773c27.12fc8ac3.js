...
var site_docs_platform_biostar_air_site_advanced_settings_mdx_657_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-advanced-settings","title":"고급 설정하기","description":"BioStar Air 사이트의 고급 설정으로 시스템을 조직의 요구사항에 맞게 구성하세요. 시간대, 근태 관리, 모바일 인증, 리더 호환성 등 다양한 옵션을 설정할 수 있습니다.","source":"@site/docs/platform/biostar_air/site-advanced-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-advanced-settings","permalink":"/docs/es/platform/biostar_air/site-advanced-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-advanced-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-advanced-settings","title":"고급 설정하기","description":"BioStar Air 사이트의 고급 설정으로 시스템을 조직의 요구사항에 맞게 구성하세요. 시간대, 근태 관리, 모바일 인증, 리더 호환성 등 다양한 옵션을 설정할 수 있습니다.","keywords":["고급 설정","구성하기"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"기본 정보 설정하기","permalink":"/docs/es/platform/biostar_air/site-basic-settings"},"next":{"title":"보안 설정하기","permalink":"/docs/es/platform/biostar_air/site-security-settings"}}')
