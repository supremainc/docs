...
var site_docs_platform_biostar_air_managing_registered_doors_mdx_257_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-registered-doors","title":"등록 출입문 관리하기","description":"BioStar Air에서 등록한 출입문 관리, 출입 장치 구성, 릴레이 설정 및 출입문 스케줄을 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/managing-registered-doors.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-registered-doors","permalink":"/docs/es/platform/biostar_air/managing-registered-doors","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-registered-doors.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-registered-doors","title":"등록 출입문 관리하기","description":"BioStar Air에서 등록한 출입문 관리, 출입 장치 구성, 릴레이 설정 및 출입문 스케줄을 구성하는 방법을 안내합니다.","keywords":["출입문 관리","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문 관리","permalink":"/docs/es/platform/biostar_air/manage-door"},"next":{"title":"출입문 그룹 관리하기","permalink":"/docs/es/platform/biostar_air/managing-door-groups"}}')
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["BioStar Air 모바일 앱에서 장치 등록에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
