"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["19900"], {
...
81528: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_bioentry_w_3_regulatory_information_mdx_1fd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-bioentry-w-3-regulatory-information-mdx-1fd.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_bioentry_w_3_regulatory_information_mdx_1fd_namespaceObject = JSON.parse('{"id":"device/bioentry_w3/regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/bioentry_w3/regulatory-information.mdx","sourceDirName":"device/bioentry_w3","slug":"/device/bioentry_w3/regulatory-information","permalink":"/docs/es/device/bioentry_w3/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_w3/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","Licencia","FCC","CE"],"isTranslationMissing":false},"sidebar":"bioentryw3","previous":{"title":"Especificaciones del producto","permalink":"/docs/es/device/bioentry_w3/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/bioentry_w3/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/bioentry_w3/regulatory-information.mdx
