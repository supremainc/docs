...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_adding_users_in_bulk_mdx_1f6_namespaceObject = JSON.parse('{"id":"platform/biostar_air/adding-users-in-bulk","title":"Add Users in Bulk","description":"Learn how to efficiently add multiple users at once by uploading a CSV file in BioStar Air Portal, configure bulk access levels, and manage profile images.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/adding-users-in-bulk","permalink":"/docs/es/platform/biostar_air/adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"adding-users-in-bulk","title":"Add Users in Bulk","description":"Learn how to efficiently add multiple users at once by uploading a CSV file in BioStar Air Portal, configure bulk access levels, and manage profile images.","keywords":["User Management","BioStar Air","bulk users"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Manage Users","permalink":"/docs/es/platform/biostar_air/user-management-user-list"},"next":{"title":"Manage User Groups","permalink":"/docs/es/platform/biostar_air/managing-user-groups"}}')
...
const toc = [{
  ...
  "value": "CSV File Validation",
  "id": "csv-file-validation",
  "level": 3
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "If you need to add multiple users at once, use BioStar Air's bulk user import feature. Upload a CSV file to register tens or hundreds of employees in just minutes. You can also bulk-upload profile images while entering user information. This document provides step-by-step instructions for downloading the CSV template, preparing the file, uploading it, managing profile images, and verifying user information after upload."
      ...
      children: "You can freely configure any Wiegand format, including facility codes, segments, parity bits, and more."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.p, {
            children: ["If the users' profile images are ready, enable the ", (0,jsx_runtime.jsx)(Cmd, {
              ...
              product: "air"
            }), " option. For more information, see ", (0,jsx_runtime.jsx)(DocLink, {
      ...
      children: ["If you encounter issues with CSV upload, see ", (0,jsx_runtime.jsx)(DocLink, {
        docId: "platform/biostar_air/troubleshooting-adding-users-in-bulk"
      }), " for help troubleshooting common problems. The document also includes Excel formulas that help validate data and remove duplicates."]
    })]
  });
}
