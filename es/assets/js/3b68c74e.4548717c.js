"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["9450"], {
...
84908: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biostation_3_max_installation_mdx_3b6_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-biostation-3-max-installation-mdx-3b6.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biostation_3_max_installation_mdx_3b6_namespaceObject = JSON.parse('{"id":"device/biostation_3_max/installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/biostation_3_max/installation.mdx","sourceDirName":"device/biostation_3_max","slug":"/device/biostation_3_max/installation","permalink":"/docs/es/device/biostation_3_max/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3_max/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","keywords":["Soporte","Alimentación","Red","Entrada","Relé","Independiente","E/S Segura","Wiegand"],"isTranslationMissing":false},"sidebar":"biostation3max","previous":{"title":"Primeros Pasos","permalink":"/docs/es/device/biostation_3_max/getting-started"},"next":{"title":"Cómo Usar","permalink":"/docs/es/device/biostation_3_max/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/biostation_3_max/installation.mdx
...
function _createMdxContent(props) {
  const _components = {
    ...
    ...props.components
  }, {Column, Columns, Image, PageBreak} = _components;
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Este documento describe el procedimiento de instalación basado en los modelos BS3M-ODB y BS3M-OAPB. Instale los modelos BS3M-DB y BS3M-APB de la misma manera."
      })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "Después de instalar la cubierta del cable, apriete firmemente los seis tornillos de la cubierta y monte el producto en el soporte fijo."
        }), "\n", (0,jsx_runtime.jsx)(Image, {
