...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_remote_access_mdx_926_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-remote-access","title":"Configuración de Acceso Remoto","description":"Aprende a configurar el acceso remoto con el servicio ngrok.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-remote-access","permalink":"/docs/es/platform/biostar_x/settings-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-remote-access","title":"Configuración de Acceso Remoto","description":"Aprende a configurar el acceso remoto con el servicio ngrok.","keywords":["Acceso Remoto","ngrok"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Configuración de Integración de Directorios","permalink":"/docs/es/platform/biostar_x/settings-diretory-integration"},"next":{"title":"Integrar el Registro de Eventos de Dispositivos Virtuales","permalink":"/docs/es/platform/biostar_x/settings-virtual-device-event-log"}}')
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["El acceso remoto se proporciona mediante el servicio de túnel de terceros de ngrok. El acceso remoto se proporciona a través del servicio de túneles de terceros de ngrok. Antes de usar esta función, revise ", (0,jsx_runtime.jsx)(_components.a, {
