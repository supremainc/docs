...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_enroll_credential_card_mdx_9cb_namespaceObject = JSON.parse('{"id":"platform/biostar_x/enroll-credential-card","title":"Inscribir Tarjeta de Acceso","description":"Guía a los usuarios sobre cómo registrar tarjetas CSN, Wiegand y tarjetas inteligentes.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/enroll-credential-card.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/enroll-credential-card","permalink":"/docs/es/platform/biostar_x/enroll-credential-card","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/enroll-credential-card.mdx","tags":[],"version":"current","frontMatter":{"id":"enroll-credential-card","title":"Inscribir Tarjeta de Acceso","description":"Guía a los usuarios sobre cómo registrar tarjetas CSN, Wiegand y tarjetas inteligentes.","keywords":["Tarjeta de acceso","Enrolamiento","Credenciales","Autenticación","tarjeta"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Registrar Cara","permalink":"/docs/es/platform/biostar_x/enroll-credential-face"},"next":{"title":"Registrar Credenciales Móviles","permalink":"/docs/es/platform/biostar_x/enroll-credential-mobile"}}')
...
const frontMatter = {
	...
	title: 'Inscribir Tarjeta de Acceso',
