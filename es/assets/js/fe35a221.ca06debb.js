"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["48079"], {
44116: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_biostation_3_max_settings_mdx_fe3_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ settings_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-biostation-3-max-settings-mdx-fe3.json
var site_docs_device_biostation_3_max_settings_mdx_fe3_namespaceObject = JSON.parse('{"id":"device/biostation_3_max/settings","title":"설정","description":"시스템 및 장치 설정 방법을 안내합니다.","source":"@site/docs/device/biostation_3_max/settings.mdx","sourceDirName":"device/biostation_3_max","slug":"/device/biostation_3_max/settings","permalink":"/docs/es/device/biostation_3_max/settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3_max/settings.mdx","tags":[],"version":"current","frontMatter":{"id":"settings","title":"설정","description":"시스템 및 장치 설정 방법을 안내합니다.","keywords":["화면","소리","통신","장치"],"isTranslationMissing":true},"sidebar":"biostation3max","previous":{"title":"인증","permalink":"/docs/es/device/biostation_3_max/authentication"},"next":{"title":"이벤트 로그","permalink":"/docs/es/device/biostation_3_max/event-log"}}')
...
;// CONCATENATED MODULE: ./docs/device/biostation_3_max/settings.mdx
...
function settings_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "타사 비디오 관리 시스템(VMS)과 연결하여 제품의 비주얼 카메라를 통해 촬영된 영상을 모니터링 할 수 있습니다."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Image, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["원하는 인증 수단을 설정한 후 저장하려면 ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "ui_373",
            product: "dev"
          }), "를 누르세요."]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
