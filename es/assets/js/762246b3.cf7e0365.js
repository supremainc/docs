"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["40160"], {
...
41480: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doormodule_regulatory_information_mdx_762_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-doormodule-regulatory-information-mdx-762.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doormodule_regulatory_information_mdx_762_namespaceObject = JSON.parse('{"id":"device/doormodule/regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/doormodule/regulatory-information.mdx","sourceDirName":"device/doormodule","slug":"/device/doormodule/regulatory-information","permalink":"/docs/es/device/doormodule/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doormodule/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","FCC"],"isTranslationMissing":false},"sidebar":"doormodule","previous":{"title":"Especificaciones del producto","permalink":"/docs/es/device/doormodule/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/doormodule/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/doormodule/regulatory-information.mdx
