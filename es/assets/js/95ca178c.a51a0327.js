...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_monitoring_map_mdx_95c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/monitoring-map","title":"Monitorear Mapa","description":"Esta guía explica cómo monitorear y controlar el estado en tiempo real de puertas y cámaras por zona y piso mediante la función de monitoreo de mapas. Gestione visualmente las áreas y las estructuras de pisos vinculadas al mapa GIS, utilizando varias funciones como control de acceso y reproducción de video de cámaras.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/monitoring-map.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/monitoring-map","permalink":"/docs/es/platform/biostar_x/monitoring-map","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/monitoring-map.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-map","title":"Monitorear Mapa","description":"Esta guía explica cómo monitorear y controlar el estado en tiempo real de puertas y cámaras por zona y piso mediante la función de monitoreo de mapas. Gestione visualmente las áreas y las estructuras de pisos vinculadas al mapa GIS, utilizando varias funciones como control de acceso y reproducción de video de cámaras.","keywords":["Monitorizar","Mapa","Zona","Planta"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Gestionar el Control de Acceso Avanzado","permalink":"/docs/es/platform/biostar_x/control-zone"},"next":{"title":"Monitorear Dispositivo","permalink":"/docs/es/platform/biostar_x/monitoring-device"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "Barra lateral de seguimiento",
