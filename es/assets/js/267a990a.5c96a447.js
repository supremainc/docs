...
var site_docs_platform_biostar_air_managing_door_schedules_mdx_267_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-door-schedules","title":"출입문 스케줄 관리하기","description":"시간대별로 출입문 자동 잠금을 설정하고, 잠김 해제 시간을 구성하며, 인증 기반 출입 통제 옵션을 관리합니다. 스케줄을 통해 안전하고 통제된 출입을 보장합니다.","source":"@site/docs/platform/biostar_air/managing-door-schedules.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-door-schedules","permalink":"/docs/es/platform/biostar_air/managing-door-schedules","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-door-schedules.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-door-schedules","title":"출입문 스케줄 관리하기","description":"시간대별로 출입문 자동 잠금을 설정하고, 잠김 해제 시간을 구성하며, 인증 기반 출입 통제 옵션을 관리합니다. 스케줄을 통해 안전하고 통제된 출입을 보장합니다.","keywords":["출입문 스케줄","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문 그룹 관리하기","permalink":"/docs/es/platform/biostar_air/managing-door-groups"},"next":{"title":"엘리베이터","permalink":"/docs/es/platform/biostar_air/manage-elevator"}}')
