"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["83182"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biostation_2_a_regulatory_information_mdx_1ef_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-biostation-2-a-regulatory-information-mdx-1ef.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biostation_2_a_regulatory_information_mdx_1ef_namespaceObject = JSON.parse('{"id":"device/biostation_2a/regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/biostation_2a/regulatory-information.mdx","sourceDirName":"device/biostation_2a","slug":"/device/biostation_2a/regulatory-information","permalink":"/docs/es/device/biostation_2a/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_2a/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","Licencia","FCC","CE"],"isTranslationMissing":false},"sidebar":"biostation2a","previous":{"title":"Especificaciones del producto","permalink":"/docs/es/device/biostation_2a/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/biostation_2a/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/biostation_2a/regulatory-information.mdx
