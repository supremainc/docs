"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["65658"], {
...
81521: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_facestation_f_2_installation_mdx_379_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-facestation-f-2-installation-mdx-379.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_facestation_f_2_installation_mdx_379_namespaceObject = JSON.parse('{"id":"device/facestation_f2/installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/facestation_f2/installation.mdx","sourceDirName":"device/facestation_f2","slug":"/device/facestation_f2/installation","permalink":"/docs/es/device/facestation_f2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/facestation_f2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","keywords":["Soporte","Alimentación","Red","Entrada","Relé","Independiente","E/S Segura","Wiegand"],"isTranslationMissing":false},"sidebar":"facestationf2","previous":{"title":"Primeros Pasos","permalink":"/docs/es/device/facestation_f2/getting-started"},"next":{"title":"Cómo Usar","permalink":"/docs/es/device/facestation_f2/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/facestation_f2/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Este documento describe el método de instalación basado en la forma del modelo FSF2-ODB. Utilice el mismo método para instalar los modelos FSF2-DB y FSF2-AB."
      })
