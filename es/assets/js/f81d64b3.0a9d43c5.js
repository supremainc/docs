...
var site_docs_platform_biostar_air_managing_roll_call_fire_muster_mdx_f81_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-roll-call-fire-muster","title":"비상 호출","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/managing-roll-call-fire-muster.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-roll-call-fire-muster","permalink":"/docs/es/platform/biostar_air/managing-roll-call-fire-muster","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-roll-call-fire-muster.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-roll-call-fire-muster","title":"비상 호출","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","keywords":["Roll call","비상 호출","화재 소집 구역","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문 상태 모니터링하기","permalink":"/docs/es/platform/biostar_air/monitoring-door-status"},"next":{"title":"설정","permalink":"/docs/es/platform/biostar_air/settings"}}')
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["소집 구역에 여러 개의 장치를 추가할 경우 개별 장치를 선택하는 것보다 장치 그룹을 선택하기를 권장합니다. 장치 그룹을 사용하면 여러 장치를 한 번에 관리할 수 있습니다. 장치 그룹 관리에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
