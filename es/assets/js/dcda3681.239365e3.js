"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["79480"], {
82377: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_troubleshooting_adding_users_in_bulk_mdx_dcd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-troubleshooting-adding-users-in-bulk-mdx-dcd.json
var site_docs_platform_biostar_air_troubleshooting_adding_users_in_bulk_mdx_dcd_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","permalink":"/docs/es/platform/biostar_air/troubleshooting-adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-adding-users-in-bulk","title":"일괄 사용자 추가 문제","description":"BioStar Air 포털을 사용하여 사용자를 일괄 추가할 때 발생하는 일반적인 문제를 해결하는 방법을 알아보세요.","keywords":["문제 해결","대량 사용자","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"문제 해결","permalink":"/docs/es/platform/biostar_air/troubleshooting"},"next":{"title":"모바일 카드가 작동하지 않아요","permalink":"/docs/es/platform/biostar_air/troubleshooting-suprema-pass-app"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["추가 필드(예: 직원 ID 또는 부서)를 포함해야 한다면, 사용자 목록 상단의 ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "user_setting_templ_action",
            product: "air"
          }), "(", (0,jsx_runtime.jsx)(IcAirUtemplate, {}), ") 기능을 이용해 해당 필드를 추가하세요. 필드를 추가하면 다운로드한 CSV 파일에 해당 열이 자동으로 포함됩니다."]
        }), "\n"]
      }), "\n"]
