"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["54022"], {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["Haga clic en el botón ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmd, {
            ...
            product: "2"
          }), " para descargar el archivo de solicitud de licencia (**.req*)."]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
      ...
      children: ["Después de recibir el archivo de licencia (**.lic*) del lugar de compra, haga clic en el botón ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmd, {
...
95379: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_license_biostar_x_license_mdx_30c_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-platform-biostar-x-settings-license-biostar-x-license-mdx-30c.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_license_biostar_x_license_mdx_30c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-license-biostar-x-license","title":"Licencia Biostar X","description":"Active la licencia de BioStar X adquirida.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-license-biostar-x-license.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-license-biostar-x-license","permalink":"/docs/es/platform/biostar_x/settings-license-biostar-x-license","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-license-biostar-x-license.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-license-biostar-x-license","title":"Licencia Biostar X","description":"Active la licencia de BioStar X adquirida.","keywords":["Licencia"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Activar Licencia","permalink":"/docs/es/platform/biostar_x/settings-license"},"next":{"title":"Licencia de dispositivo","permalink":"/docs/es/platform/biostar_x/settings-license-device-license"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-license-biostar-x-license.mdx
...
const toc = [..._register_license_key/* .toc */.RM, {
  "value": "Verificar licencia activada",
  "id": "verificar-licencia-activada",
  "level": 2
}];
function _createMdxContent(props) {
  const _components = {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Active la licencia adquirida de ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
      }), "."]
      ...
      id: "verificar-licencia-activada",
      children: "Verificar licencia activada"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Compruebe la información de la licencia ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
      }), " activada en ", (0,jsx_runtime.jsx)(Cmd, {
