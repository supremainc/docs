"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["92787"], {
...
8911: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_xstation_2_regulatory_information_mdx_aa2_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-xstation-2-regulatory-information-mdx-aa2.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_xstation_2_regulatory_information_mdx_aa2_namespaceObject = JSON.parse('{"id":"device/xstation_2/regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/xstation_2/regulatory-information.mdx","sourceDirName":"device/xstation_2","slug":"/device/xstation_2/regulatory-information","permalink":"/docs/es/device/xstation_2/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xstation_2/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","Licencia","FCC","CE"],"isTranslationMissing":false},"sidebar":"xstation2","previous":{"title":"Especificaciones del producto","permalink":"/docs/es/device/xstation_2/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/xstation_2/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/xstation_2/regulatory-information.mdx
