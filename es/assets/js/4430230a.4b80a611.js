"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["67611"], {
8156: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_adding_users_in_bulk_mdx_443_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-adding-users-in-bulk-mdx-443.json
var site_docs_platform_biostar_air_adding_users_in_bulk_mdx_443_namespaceObject = JSON.parse('{"id":"platform/biostar_air/adding-users-in-bulk","title":"일괄 작업으로 사용자 추가하기","description":"BioStar Air Portal에서 CSV 파일 업로드를 사용하여 여러 사용자를 한 번에 효율적으로 추가하는 방법, 대량 출입 등급을 구성하는 방법, 프로필 이미지를 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/adding-users-in-bulk","permalink":"/docs/es/platform/biostar_air/adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"adding-users-in-bulk","title":"일괄 작업으로 사용자 추가하기","description":"BioStar Air Portal에서 CSV 파일 업로드를 사용하여 여러 사용자를 한 번에 효율적으로 추가하는 방법, 대량 출입 등급을 구성하는 방법, 프로필 이미지를 관리하는 방법을 안내합니다.","keywords":["사용자 관리","BioStar Air","대량 사용자"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"사용자 관리하기","permalink":"/docs/es/platform/biostar_air/user-management-user-list"},"next":{"title":"사용자 그룹 관리하기","permalink":"/docs/es/platform/biostar_air/managing-user-groups"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./docs/platform/biostar_air/adding-users-in-bulk.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "여러 사용자를 한 번에 추가해야 한다면, BioStar Air의 일괄 사용자 추가 기능을 사용하세요. CSV 파일 업로드로 수십, 수백 명의 직원 정보를 몇 분 안에 시스템에 등록할 수 있습니다. 사용자 정보 입력과 동시에 프로필 이미지를 일괄 업로드할 수도 있습니다. 이 문서에서는 CSV 템플릿 다운로드, 파일 준비, 업로드, 프로필 이미지 관리, 그리고 업로드 후 사용자 정보를 검증하는 방법을 단계별로 안내합니다."
      ...
      children: "시설 코드, 세그먼트, 패리티 비트 등의 정보를 포함한 모든 Wiegand 형식을 자유롭게 구성할 수 있습니다."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.p, {
            children: ["사용자의 프로필 이미지가 준비되어 있다면 ", (0,jsx_runtime.jsx)(Cmd, {
              ...
              product: "air"
            }), " 옵션을 활성화하세요. 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
      ...
      children: ["CSV 업로드와 관련하여 문제가 발생한다면, 일반적인 문제를 해결하는 데 도움이 되는 ", (0,jsx_runtime.jsx)(DocLink, {
        docId: "platform/biostar_air/troubleshooting-adding-users-in-bulk"
      }), "를 확인하세요. 이 문서에는 데이터를 검증하고 중복을 제거하는 데 도움이 되는 엑셀 수식도 포함되어 있습니다."]
    })]
  });
}
