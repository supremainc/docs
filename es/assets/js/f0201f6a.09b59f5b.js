...
var site_docs_platform_biostar_air_configuring_reports_mdx_f02_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-reports","title":"리포트 생성 및 예약하기","description":"BioStar Air에서 자동 이메일 전송을 통해 사용자 리포트, 이벤트 로그 리포트, 변경 로그 리포트 생성 및 필터링, 예약하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/configuring-reports.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-reports","permalink":"/docs/es/platform/biostar_air/configuring-reports","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/configuring-reports.mdx","tags":[],"version":"current","frontMatter":{"id":"configuring-reports","title":"리포트 생성 및 예약하기","description":"BioStar Air에서 자동 이메일 전송을 통해 사용자 리포트, 이벤트 로그 리포트, 변경 로그 리포트 생성 및 필터링, 예약하는 방법을 안내합니다.","keywords":["리포트","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"근태 보고서 구성하기","permalink":"/docs/es/platform/biostar_air/reports-time-attendance-reports"},"next":{"title":"파트너 및 설치 관리자","permalink":"/docs/es/platform/biostar_air/partner-install-guide"}}')
