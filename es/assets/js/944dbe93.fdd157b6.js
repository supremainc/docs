...
var site_docs_device_vionyx_webserver_configure_date_time_mdx_944_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/configure-date-time","title":"날짜와 시간 설정하기","description":"시간대를 설정하고 수동 입력 또는 NTP 서버를 통해 정확한 시간을 유지하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/configure-date-time.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/configure-date-time","permalink":"/docs/es/device/vionyx_webserver/configure-date-time","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/configure-date-time.mdx","tags":[],"version":"current","frontMatter":{"id":"configure-date-time","title":"날짜와 시간 설정하기","description":"시간대를 설정하고 수동 입력 또는 NTP 서버를 통해 정확한 시간을 유지하는 방법을 안내합니다.","keywords":["날짜","시간","NTP","시간대","시간 동기화"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"프라이버시 및 오버레이 설정하기","permalink":"/docs/es/device/vionyx_webserver/configure-privacy-overlay"},"next":{"title":"네트워크 설정하기","permalink":"/docs/es/device/vionyx_webserver/configure-network"}}')
