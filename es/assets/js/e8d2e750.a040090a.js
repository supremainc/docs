"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["1882"], {
71019: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_doorinterface_ul_product_specifications_mdx_e8d_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-doorinterface-ul-product-specifications-mdx-e8d.json
var site_docs_device_doorinterface_ul_product_specifications_mdx_e8d_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/product-specifications","title":"제품 사양","description":"제품에 대한 크기, 기능, 성능 등 주요 사양 정보를 제공합니다.","source":"@site/docs/device/doorinterface_ul/product-specifications.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/product-specifications","permalink":"/docs/es/device/doorinterface_ul/product-specifications","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/product-specifications.mdx","tags":[],"version":"current","frontMatter":{"id":"product-specifications","title":"제품 사양","description":"제품에 대한 크기, 기능, 성능 등 주요 사양 정보를 제공합니다.","keywords":["일반","인터페이스","전기 규격","제품 치수"],"isTranslationMissing":true},"sidebar":"doorinterface_ul","previous":{"title":"설치하기","permalink":"/docs/es/device/doorinterface_ul/installation"},"next":{"title":"규제 인증 정보","permalink":"/docs/es/device/doorinterface_ul/regulatory-information"}}')
...
;// CONCATENATED MODULE: ./docs/device/doorinterface_ul/product-specifications.mdx
