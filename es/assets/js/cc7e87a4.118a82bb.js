...
var site_docs_platform_biostar_air_site_setup_networking_mdx_cc7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-setup-networking","title":"네트워크 포트 및 장치 식별하기","description":"BioStar Air 호환 장치의 네트워크 포트를 설정하고 MAC 주소를 확인하세요.","source":"@site/docs/platform/biostar_air/site-setup-networking.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-setup-networking","permalink":"/docs/es/platform/biostar_air/site-setup-networking","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-setup-networking.mdx","tags":[],"version":"current","frontMatter":{"id":"site-setup-networking","title":"네트워크 포트 및 장치 식별하기","description":"BioStar Air 호환 장치의 네트워크 포트를 설정하고 MAC 주소를 확인하세요.","keywords":["networking","ports"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"E200 QR Scanner 배선 및 구성하기","permalink":"/docs/es/platform/biostar_air/e200-qr-scanner"},"next":{"title":"인증된 사용자","permalink":"/docs/es/platform/biostar_air/credential-users-guide"}}')
...
const frontMatter = {
	...
	title: '네트워크 포트 및 장치 식별하기',
	description: 'BioStar Air 호환 장치의 네트워크 포트를 설정하고 MAC 주소를 확인하세요.',
	keywords: [
		'networking',
		'ports'
	],
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "BioStar Air와 호환 장치가 원활하게 연결되려면 특정 네트워크 포트에 접근할 수 있어야 합니다. 네트워크 포트를 통해 호환 장치, 클라우드 서비스 및 사용자 애플리케이션 간에 안전하게 통신할 수 있습니다. 관리자는 네트워크 구성 작업을 위해 BioStar Air 호환 장치의 일련 번호를 통해 MAC 주소를 확인해야 할 수도 있습니다."
