...
var site_docs_platform_biostar_air_account_settings_mdx_161_namespaceObject = JSON.parse('{"id":"platform/biostar_air/account-settings","title":"계정 설정하기","description":"비밀번호 및 알림, IP 인터폰 등 BioStar Air 개인 계정 설정을 변경하고, 사이트 탈퇴 및 계정 삭제하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/account-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/account-settings","permalink":"/docs/es/platform/biostar_air/account-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/account-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"account-settings","title":"계정 설정하기","description":"비밀번호 및 알림, IP 인터폰 등 BioStar Air 개인 계정 설정을 변경하고, 사이트 탈퇴 및 계정 삭제하는 방법을 안내합니다.","keywords":["계정 설정","프로필","알림","SIP 인터폰","계정 관리"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"관리자 계정 및 역할 관리하기","permalink":"/docs/es/platform/biostar_air/managing-administrators"},"next":{"title":"서비스 구성하기","permalink":"/docs/es/platform/biostar_air/service-configuration"}}')
