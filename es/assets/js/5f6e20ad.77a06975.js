"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["76405"], {
23895: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_controller_devices_funcs_mdx_5f6_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-reference-compares-controller-devices-funcs-mdx-5f6.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_controller_devices_funcs_mdx_5f6_namespaceObject = JSON.parse('{"id":"reference/compares/controller-devices-funcs","title":"Comparar Características","description":"","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/reference/compares/controller-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/controller-devices-funcs","permalink":"/docs/es/reference/compares/controller-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/controller-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"controller-devices-funcs","title":"Comparar Características","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Comparar Especificaciones","permalink":"/docs/es/reference/compares/finger-rfid-devices-specs"},"next":{"title":"Comparar Especificaciones","permalink":"/docs/es/reference/compares/controller-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/reference/compares/controller-devices-funcs.mdx
...
const contentTitle = 'Comparar las funciones del controlador inteligente y de los periféricos';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "comparar-las-funciones-del-controlador-inteligente-y-de-los-periféricos",
        children: "Comparar las funciones del controlador inteligente y de los periféricos"
      })
