...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_managing_registered_devices_mdx_fc9_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-registered-devices","title":"Manage Registered Devices","description":"In the BioStar Air portal, check device connection status, change biometric and card settings, and update firmware. Efficiently manage the security system using individual or bulk operations.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/managing-registered-devices.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-registered-devices","permalink":"/docs/es/platform/biostar_air/managing-registered-devices","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-registered-devices.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-registered-devices","title":"Manage Registered Devices","description":"In the BioStar Air portal, check device connection status, change biometric and card settings, and update firmware. Efficiently manage the security system using individual or bulk operations.","keywords":["Device Management","Device Settings","BioStar Air","Biometric","Card Setting","Firmware Upgrade","Network settings"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Register and Delete Devices","permalink":"/docs/es/platform/biostar_air/manage-device-with-app"},"next":{"title":"Device Information and Configuration Options","permalink":"/docs/es/platform/biostar_air/device-info-settings"}}')
