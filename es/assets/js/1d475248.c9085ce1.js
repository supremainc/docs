...
var site_docs_platform_biostar_air_managing_registered_devices_mdx_1d4_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-registered-devices","title":"등록 장치 관리하기","description":"BioStar Air 포털에서 등록된 슈프리마 장치의 연결 상태를 확인하고, 생체 인증, 카드 설정, 네트워크, 펌웨어 등 세부 설정을 구성하는 방법을 안내합니다. 개별 장치 관리 및 대량 작업을 통해 효율적으로 여러 장치를 관리할 수 있습니다.","source":"@site/docs/platform/biostar_air/managing-registered-devices.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-registered-devices","permalink":"/docs/es/platform/biostar_air/managing-registered-devices","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-registered-devices.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-registered-devices","title":"등록 장치 관리하기","description":"BioStar Air 포털에서 등록된 슈프리마 장치의 연결 상태를 확인하고, 생체 인증, 카드 설정, 네트워크, 펌웨어 등 세부 설정을 구성하는 방법을 안내합니다. 개별 장치 관리 및 대량 작업을 통해 효율적으로 여러 장치를 관리할 수 있습니다.","keywords":["장치 관리","장치 설정","BioStar Air","생체 인증","카드 설정","펌웨어 업데이트","네트워크 설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"장치 등록하기","permalink":"/docs/es/platform/biostar_air/register-device"},"next":{"title":"장치 그룹 관리하기","permalink":"/docs/es/platform/biostar_air/manage-device-group"}}')
