"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["33953"], {
...
89975: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biolite_n_2_installation_mdx_838_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-biolite-n-2-installation-mdx-838.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_biolite_n_2_installation_mdx_838_namespaceObject = JSON.parse('{"id":"device/biolite_n2/installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/biolite_n2/installation.mdx","sourceDirName":"device/biolite_n2","slug":"/device/biolite_n2/installation","permalink":"/docs/es/device/biolite_n2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biolite_n2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Instalación","description":"Ofrece los procedimientos completos de instalación y ejemplos de conexión necesarios para el dispositivo.","keywords":["Soporte","Alimentación","Red","Entrada","Relé","Independiente","E/S Segura","Wiegand"],"isTranslationMissing":false},"sidebar":"bioliten2","previous":{"title":"Primeros Pasos","permalink":"/docs/es/device/biolite_n2/getting-started"},"next":{"title":"Cómo Usar","permalink":"/docs/es/device/biolite_n2/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/biolite_n2/installation.mdx
