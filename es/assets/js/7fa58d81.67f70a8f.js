"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["55512"], {
89633: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_finger_rfid_devices_funcs_mdx_7fa_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-reference-compares-finger-rfid-devices-funcs-mdx-7fa.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_finger_rfid_devices_funcs_mdx_7fa_namespaceObject = JSON.parse('{"id":"reference/compares/finger-rfid-devices-funcs","title":"Comparar Características","description":"🔶: El soporte puede variar según el modelo del producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/reference/compares/finger-rfid-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/finger-rfid-devices-funcs","permalink":"/docs/es/reference/compares/finger-rfid-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/finger-rfid-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"finger-rfid-devices-funcs","title":"Comparar Características","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Comparar Especificaciones","permalink":"/docs/es/reference/compares/rfid-devices-specs"},"next":{"title":"Comparar Especificaciones","permalink":"/docs/es/reference/compares/finger-rfid-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/reference/compares/finger-rfid-devices-funcs.mdx
...
const contentTitle = 'Compara las características de los lectores de huellas digitales y RFID';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "compara-las-características-de-los-lectores-de-huellas-digitales-y-rfid",
        children: "Compara las características de los lectores de huellas digitales y RFID"
      })
