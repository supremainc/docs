...
var site_docs_platform_biostar_air_site_basic_settings_mdx_2b6_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-basic-settings","title":"기본 정보 설정하기","description":"BioStar Air에서 사이트의 기본 정보를 관리하고 사이트 삭제하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/site-basic-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-basic-settings","permalink":"/docs/es/platform/biostar_air/site-basic-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-basic-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-basic-settings","title":"기본 정보 설정하기","description":"BioStar Air에서 사이트의 기본 정보를 관리하고 사이트 삭제하는 방법을 안내합니다.","keywords":["사이트 설정","구성하기"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"설정","permalink":"/docs/es/platform/biostar_air/settings"},"next":{"title":"고급 설정하기","permalink":"/docs/es/platform/biostar_air/site-advanced-settings"}}')
