"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["62227"], {
...
58965: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_doorinterface_ul_installation_mdx_cf0_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ installation_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-doorinterface-ul-installation-mdx-cf0.json
var site_docs_device_doorinterface_ul_installation_mdx_cf0_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/installation","title":"설치하기","description":"제품 설치에 필요한 전체 과정과 연결 예시를 제공합니다.","source":"@site/docs/device/doorinterface_ul/installation.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/installation","permalink":"/docs/es/device/doorinterface_ul/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"설치하기","description":"제품 설치에 필요한 전체 과정과 연결 예시를 제공합니다.","keywords":["설치","Door Interface","장치"],"isTranslationMissing":true},"sidebar":"doorinterface_ul","previous":{"title":"시작하기","permalink":"/docs/es/device/doorinterface_ul/getting-started"},"next":{"title":"제품 사양","permalink":"/docs/es/device/doorinterface_ul/product-specifications"}}')
...
;// CONCATENATED MODULE: ./docs/device/doorinterface_ul/installation.mdx
