"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["30193"], {
...
78523: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_securemodule_getting_started_mdx_6a0_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-securemodule-getting-started-mdx-6a0.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_securemodule_getting_started_mdx_6a0_namespaceObject = JSON.parse('{"id":"device/securemodule/getting-started","title":"Primeros pasos","description":"Proporciona procedimientos iniciales para empezar con el dispositivo.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/securemodule/getting-started.mdx","sourceDirName":"device/securemodule","slug":"/device/securemodule/getting-started","permalink":"/docs/es/device/securemodule/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/securemodule/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"Primeros pasos","description":"Proporciona procedimientos iniciales para empezar con el dispositivo.","keywords":["Componentes","Nombre","Función","Cable","Conector"],"isTranslationMissing":false},"sidebar":"securemodule","previous":{"title":"Instrucciones de seguridad","permalink":"/docs/es/device/securemodule/safety-instructions"},"next":{"title":"Conectar","permalink":"/docs/es/device/securemodule/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/securemodule/getting-started.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "Este producto se conecta mediante RS-485 y puede instalarse en diversos lugares gracias a su tamaño compacto."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Puede instalarse junto con una caja de conexiones o montarse en una caja de control de pared existente. También puede instalarse detrás del botón de salida."
