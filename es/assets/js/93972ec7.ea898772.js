"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["91764"], {
...
20969: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doorinterface_regulatory_information_mdx_939_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-doorinterface-regulatory-information-mdx-939.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doorinterface_regulatory_information_mdx_939_namespaceObject = JSON.parse('{"id":"device/doorinterface/regulatory-information","title":"Información Reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/doorinterface/regulatory-information.mdx","sourceDirName":"device/doorinterface","slug":"/device/doorinterface/regulatory-information","permalink":"/docs/es/device/doorinterface/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información Reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","FCC"],"isTranslationMissing":false},"sidebar":"doorinterface","previous":{"title":"Especificaciones del Producto","permalink":"/docs/es/device/doorinterface/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/doorinterface/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/doorinterface/regulatory-information.mdx
