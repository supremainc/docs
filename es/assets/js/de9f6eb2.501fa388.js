...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_reports_time_attendance_reports_mdx_de9_namespaceObject = JSON.parse('{"id":"platform/biostar_air/reports-time-attendance-reports","title":"Time and Attendance Report","description":"This guide explains how to configure the basic time and attendance report in BioStar Air. It supports on-site work hour tracking, CSV export options, and API integration.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/reports-time-attendance-reports.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/reports-time-attendance-reports","permalink":"/docs/es/platform/biostar_air/reports-time-attendance-reports","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/reports-time-attendance-reports.mdx","tags":[],"version":"current","frontMatter":{"id":"reports-time-attendance-reports","title":"Time and Attendance Report","description":"This guide explains how to configure the basic time and attendance report in BioStar Air. It supports on-site work hour tracking, CSV export options, and API integration.","keywords":["reports","time and attendance","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Time & Attendance (T&A)","permalink":"/docs/es/platform/biostar_air/configuring-ta"},"next":{"title":"Create and Schedule Reports","permalink":"/docs/es/platform/biostar_air/configuring-reports"}}')
...
const frontMatter = {
	...
	title: 'Time and Attendance Report',
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["Configure an automated schedule in ", (0,jsx_runtime.jsx)(Cmd, {
              ...
              product: "air"
            }), ". For more information, refer to ", (0,jsx_runtime.jsx)(DocLink, {
