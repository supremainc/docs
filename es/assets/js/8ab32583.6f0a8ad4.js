"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["67612"], {
14686: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_api_user_management_mdx_8ab_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-api-user-management-mdx-8ab.json
var site_docs_platform_biostar_air_api_user_management_mdx_8ab_namespaceObject = JSON.parse('{"id":"platform/biostar_air/api-user-management","title":"사용자 관리 API 사용하기","description":"BioStar Air API를 통해 사용자를 생성·수정·중단하는 방법과 권장 통합 범위, Python 샘플 코드를 안내합니다.","source":"@site/docs/platform/biostar_air/api-user-management.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/api-user-management","permalink":"/docs/es/platform/biostar_air/api-user-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/api-user-management.mdx","tags":[],"version":"current","frontMatter":{"id":"api-user-management","title":"사용자 관리 API 사용하기","description":"BioStar Air API를 통해 사용자를 생성·수정·중단하는 방법과 권장 통합 범위, Python 샘플 코드를 안내합니다.","keywords":["사용자 관리","API","BioStar Air","Python 샘플"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"API 인증하기","permalink":"/docs/es/platform/biostar_air/api-authentication"},"next":{"title":"문제 해결","permalink":"/docs/es/platform/biostar_air/troubleshooting"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./docs/platform/biostar_air/api-user-management.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "인증 토큰을 발급받은 후에는 API를 통해 사용자 라이프사이클을 관리할 수 있습니다. 사용자 조회, 생성, 수정, 중단 등의 엔드포인트를 사용하여 BioStar Air 사이트의 사용자를 자동화된 방식으로 관리하세요."
