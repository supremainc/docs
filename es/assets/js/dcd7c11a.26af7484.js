"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["35318"], {
5492: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_extendedmodule_sc_product_specifications_mdx_dcd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-extendedmodule-sc-product-specifications-mdx-dcd.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_extendedmodule_sc_product_specifications_mdx_dcd_namespaceObject = JSON.parse('{"id":"device/extendedmodule_sc/product-specifications","title":"Especificaciones del producto","description":"Incluye las especificaciones clave del producto, como tamaño, características y rendimiento.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/extendedmodule_sc/product-specifications.mdx","sourceDirName":"device/extendedmodule_sc","slug":"/device/extendedmodule_sc/product-specifications","permalink":"/docs/es/device/extendedmodule_sc/product-specifications","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/extendedmodule_sc/product-specifications.mdx","tags":[],"version":"current","frontMatter":{"id":"product-specifications","title":"Especificaciones del producto","description":"Incluye las especificaciones clave del producto, como tamaño, características y rendimiento.","keywords":["General","Interfaz","Dimensiones"],"isTranslationMissing":false},"sidebar":"extendedmodule_sc","previous":{"title":"Instalación","permalink":"/docs/es/device/extendedmodule_sc/installation"},"next":{"title":"Apéndices","permalink":"/docs/es/device/extendedmodule_sc/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/extendedmodule_sc/product-specifications.mdx
