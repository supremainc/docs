...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_manage_device_with_app_mdx_675_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-device-with-app","title":"Register and Delete Devices","description":"Learn how to register and delete devices and upgrade firmware with the BioStar Air mobile app.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/manage-device-with-app.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-device-with-app","permalink":"/docs/es/platform/biostar_air/manage-device-with-app","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-device-with-app.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device-with-app","title":"Register and Delete Devices","description":"Learn how to register and delete devices and upgrade firmware with the BioStar Air mobile app.","keywords":["BioStar Air","Register Device","Mobile App"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Device","permalink":"/docs/es/platform/biostar_air/manage-device"},"next":{"title":"Manage Registered Devices","permalink":"/docs/es/platform/biostar_air/managing-registered-devices"}}')
