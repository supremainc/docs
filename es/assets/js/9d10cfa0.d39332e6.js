"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["86704"], {
...
58562: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_vionyx_regulatory_information_mdx_9d1_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-vionyx-regulatory-information-mdx-9d1.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_vionyx_regulatory_information_mdx_9d1_namespaceObject = JSON.parse('{"id":"device/vionyx/regulatory-information","title":"Información Reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/vionyx/regulatory-information.mdx","sourceDirName":"device/vionyx","slug":"/device/vionyx/regulatory-information","permalink":"/docs/es/device/vionyx/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información Reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","Licencia","FCC","CE"],"isTranslationMissing":false},"sidebar":"vionyx","previous":{"title":"Especificaciones del Producto","permalink":"/docs/es/device/vionyx/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/vionyx/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/vionyx/regulatory-information.mdx
