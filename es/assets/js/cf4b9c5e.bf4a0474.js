"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["72345"], {
...
18343: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_express_install_mdx_cf4_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-platform-biostar-x-express-install-mdx-cf4.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_x_express_install_mdx_cf4_namespaceObject = JSON.parse('{"id":"platform/biostar_x/express-install","title":"Instalación Exprés","description":"Esta guía proporciona pasos para instalar rápidamente BioStar X mediante la creación automática del servidor y la base de datos MariaDB integrados.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/express-install.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/express-install","permalink":"/docs/es/platform/biostar_x/express-install","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/express-install.mdx","tags":[],"version":"current","frontMatter":{"id":"express-install","title":"Instalación Exprés","description":"Esta guía proporciona pasos para instalar rápidamente BioStar X mediante la creación automática del servidor y la base de datos MariaDB integrados.","keywords":["Instalación exprés"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"Verificar la prioridad de red","permalink":"/docs/es/platform/biostar_x/check-ethernet"},"next":{"title":"Instalación Personalizada​","permalink":"/docs/es/platform/biostar_x/custom-install"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_x/express-install.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Este procedimiento le guía paso a paso para instalar ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "BioStar X"
        ...
        code: "biostar2.install.expressInstall",
        className: "bold"
      }), " instala automáticamente el servidor MariaDB integrado y crea la base de datos, lo que permite una instalación rápida sin configuración de base de datos por separado."]
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        ...
        }), " para continuar con ", (0,jsx_runtime.jsx)(Cmd, {
          code: "biostar2.install.customInstall",
          className: "bold"
        }), " y conectar con una base de datos ya instalada."]
      })
