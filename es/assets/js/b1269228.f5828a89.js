"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["11516"], {
53718: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_fingerprint_devices_funcs_mdx_b12_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-reference-compares-fingerprint-devices-funcs-mdx-b12.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_reference_compares_fingerprint_devices_funcs_mdx_b12_namespaceObject = JSON.parse('{"id":"reference/compares/fingerprint-devices-funcs","title":"Comparar Características","description":"🔶: El soporte puede variar según el modelo del producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/reference/compares/fingerprint-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/fingerprint-devices-funcs","permalink":"/docs/es/reference/compares/fingerprint-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/fingerprint-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"fingerprint-devices-funcs","title":"Comparar Características","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Comparar Funciones y Especificaciones del Producto","permalink":"/docs/es/reference/compares/"},"next":{"title":"Comparar Especificaciones","permalink":"/docs/es/reference/compares/fingerprint-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/reference/compares/fingerprint-devices-funcs.mdx
...
const contentTitle = 'Compara las funciones del dispositivo de autenticación por huellas dactilares';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "compara-las-funciones-del-dispositivo-de-autenticación-por-huellas-dactilares",
        children: "Compara las funciones del dispositivo de autenticación por huellas dactilares"
      })
