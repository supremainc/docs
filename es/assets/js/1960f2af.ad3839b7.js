"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["10759"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doorinterface_installation_mdx_196_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-doorinterface-installation-mdx-196.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_doorinterface_installation_mdx_196_namespaceObject = JSON.parse('{"id":"device/doorinterface/installation","title":"Instalación","description":"Proporciona el proceso completo y ejemplos de conexión necesarios para la instalación del producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/doorinterface/installation.mdx","sourceDirName":"device/doorinterface","slug":"/device/doorinterface/installation","permalink":"/docs/es/device/doorinterface/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Instalación","description":"Proporciona el proceso completo y ejemplos de conexión necesarios para la instalación del producto.","keywords":["Instalar","Door Interface","Dispositivo"],"isTranslationMissing":false},"sidebar":"doorinterface","previous":{"title":"Primeros Pasos","permalink":"/docs/es/device/doorinterface/getting-started"},"next":{"title":"Especificaciones del Producto","permalink":"/docs/es/device/doorinterface/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/doorinterface/installation.mdx
...
function _createMdxContent(props) {
  const _components = {
    ...
    ...props.components
  }, {Image, PageBreak, Row, Table, Tbody, Td, Th, Thead} = _components;
  if (!Image) _missingMdxReference("Image", true);
  if (!PageBreak) _missingMdxReference("PageBreak", true);
  if (!Row) _missingMdxReference("Row", true);
  if (!Table) _missingMdxReference("Table", true);
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      src: "/img/device/device-fix-di24.png",
      className: "none",
      width: "50%",
      alone: true
      ...
      src: "/img/device/installation-rs485-connection-di24.svg",
      width: "80%",
      className: "none"
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "El número máximo de dispositivos esclavos que se pueden conectar al puerto RS-485 del producto es 4."
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
