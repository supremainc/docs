...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_site_selector_mdx_30b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-selector","title":"Site Selector","description":"This article explains how to manage multiple BioStar Air sites with a single email address and streamline the login process using the Site Selector feature.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/site-selector.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-selector","permalink":"/docs/es/platform/biostar_air/site-selector","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-selector.mdx","tags":[],"version":"current","frontMatter":{"id":"site-selector","title":"Site Selector","description":"This article explains how to manage multiple BioStar Air sites with a single email address and streamline the login process using the Site Selector feature.","keywords":["BioStar Air","login","Site Selector"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Getting Started","permalink":"/docs/es/platform/biostar_air/getting-started"},"next":{"title":"Getting Started with the BioStar Air App","permalink":"/docs/es/platform/biostar_air/managing-sites-with-app"}}')
