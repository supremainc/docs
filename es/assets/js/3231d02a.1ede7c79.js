"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["34880"], {
...
50532: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_device_outputmodule_regulatory_information_mdx_323_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-device-outputmodule-regulatory-information-mdx-323.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_device_outputmodule_regulatory_information_mdx_323_namespaceObject = JSON.parse('{"id":"device/outputmodule/regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/device/outputmodule/regulatory-information.mdx","sourceDirName":"device/outputmodule","slug":"/device/outputmodule/regulatory-information","permalink":"/docs/es/device/outputmodule/regulatory-information","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/outputmodule/regulatory-information.mdx","tags":[],"version":"current","frontMatter":{"id":"regulatory-information","title":"Información reglamentaria","description":"Proporciona información sobre las normativas y certificaciones que cumple el producto.","keywords":["Normativa","FCC"],"isTranslationMissing":false},"sidebar":"outputmodule","previous":{"title":"Especificaciones del producto","permalink":"/docs/es/device/outputmodule/product-specifications"},"next":{"title":"Apéndices","permalink":"/docs/es/device/outputmodule/appendices"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/device/outputmodule/regulatory-information.mdx
