...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_site_advanced_settings_mdx_964_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-advanced-settings","title":"Advanced Settings","description":"Use the advanced settings on the BioStar Air site to configure the system to meet your organization\'s requirements. You can configure various options, including time zone, time and attendance, mobile authentication, and reader compatibility.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/site-advanced-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-advanced-settings","permalink":"/docs/es/platform/biostar_air/site-advanced-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-advanced-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-advanced-settings","title":"Advanced Settings","description":"Use the advanced settings on the BioStar Air site to configure the system to meet your organization\'s requirements. You can configure various options, including time zone, time and attendance, mobile authentication, and reader compatibility.","keywords":["Advanced Settings","configure"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Profile Settings","permalink":"/docs/es/platform/biostar_air/site-basic-settings"},"next":{"title":"Security Settings","permalink":"/docs/es/platform/biostar_air/site-security-settings"}}')
