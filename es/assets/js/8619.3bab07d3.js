"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["8619"], {
13894: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var BandAxis = class extends BaseAxis {
  ...
  recalculateScale() {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.trace */.Rm.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
function getChartDefaultConfig() {
  ...
  return (0,_chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */.$t)(
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default.xyChart */.UI.xyChart,
    config.xyChart
  );
}
...
var draw = /* @__PURE__ */ (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.K2)((txt, id, _version, diagObj) => {
  ...
  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.Rm.debug("Rendering xychart chart\n" + txt);
