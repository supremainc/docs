"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["51072"], {
17575: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_video_troubleshooting_mdx_6bd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-es-docusaurus-plugin-content-docs-current-platform-biostar-air-video-troubleshooting-mdx-6bd.json
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_video_troubleshooting_mdx_6bd_namespaceObject = JSON.parse('{"id":"platform/biostar_air/video-troubleshooting","title":"Solución de problemas de reproducción de video","description":"Aprenda a solucionar problemas de reproducción de video en BioStar Air: verifique si se admite ONVIF Profile G, resuelva incompatibilidades de códecs y corrija problemas con el formato de la tarjeta SD.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/video-troubleshooting.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/video-troubleshooting","permalink":"/docs/es/platform/biostar_air/video-troubleshooting","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/video-troubleshooting.mdx","tags":[],"version":"current","frontMatter":{"id":"video-troubleshooting","title":"Solución de problemas de reproducción de video","description":"Aprenda a solucionar problemas de reproducción de video en BioStar Air: verifique si se admite ONVIF Profile G, resuelva incompatibilidades de códecs y corrija problemas con el formato de la tarjeta SD.","keywords":["Cámara IP","Reproducción de video grabado","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"¿Por qué se me solicita activar los servicios de ubicación?","permalink":"/docs/es/platform/biostar_air/location-services-issues"},"next":{"title":"Notas de la Versión","permalink":"/docs/es/platform/biostar_air/release-notes"}}')
...
;// CONCATENATED MODULE: ./i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/video-troubleshooting.mdx
