...
var site_docs_device_vionyx_webserver_manage_device_mdx_578_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/manage-device","title":"카메라 유지 관리하기","description":"카메라를 재부팅하거나 설정을 초기화하여 카메라를 효과적으로 관리하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/manage-device.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/manage-device","permalink":"/docs/es/device/vionyx_webserver/manage-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/manage-device.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device","title":"카메라 유지 관리하기","description":"카메라를 재부팅하거나 설정을 초기화하여 카메라를 효과적으로 관리하는 방법을 안내합니다.","keywords":["재부팅","초기화","유지 관리","리셋","Factory Reset","Config Reset"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"펌웨어 업데이트하기","permalink":"/docs/es/device/vionyx_webserver/update-firmware"},"next":{"title":"오디오 클립 업로드하기","permalink":"/docs/es/device/vionyx_webserver/upload-audio-clips"}}')
