...
var site_docs_platform_biostar_air_manage_holiday_group_mdx_463_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-holiday-group","title":"휴일 그룹 관리하기","description":"휴일을 그룹으로 구성하여 출입 통제에 적용하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-holiday-group.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-holiday-group","permalink":"/docs/es/platform/biostar_air/manage-holiday-group","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-holiday-group.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-holiday-group","title":"휴일 그룹 관리하기","description":"휴일을 그룹으로 구성하여 출입 통제에 적용하는 방법을 안내합니다.","keywords":["출입 권한 관리","휴일 그룹","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입 권한","permalink":"/docs/es/platform/biostar_air/manage-access-authority"},"next":{"title":"스케줄 관리하기","permalink":"/docs/es/platform/biostar_air/manage-schedule"}}')
