"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["48428"], {
...
70250: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_doorinterface_ul_getting_started_mdx_78f_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-doorinterface-ul-getting-started-mdx-78f.json
var site_docs_device_doorinterface_ul_getting_started_mdx_78f_namespaceObject = JSON.parse('{"id":"device/doorinterface_ul/getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","source":"@site/docs/device/doorinterface_ul/getting-started.mdx","sourceDirName":"device/doorinterface_ul","slug":"/device/doorinterface_ul/getting-started","permalink":"/docs/es/device/doorinterface_ul/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface_ul/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"시작하기","description":"장치 사용을 위한 초기 절차를 안내합니다.","keywords":["구성품","명칭","기능","케이블","커넥터"],"isTranslationMissing":true},"sidebar":"doorinterface_ul","previous":{"title":"안전을 위한 주의 사항","permalink":"/docs/es/device/doorinterface_ul/safety-instructions"},"next":{"title":"설치하기","permalink":"/docs/es/device/doorinterface_ul/installation"}}')
...
;// CONCATENATED MODULE: ./docs/device/doorinterface_ul/getting-started.mdx
