...
var site_docs_platform_biostar_air_site_settings_mdx_a12_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-settings","title":"사이트 설정하기","description":"BioStar Air를 최적으로 관리하기 위해 사이트 프로필, 보안 설정, 표준 시간대, 인증 옵션 및 추가 기능을 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/site-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-settings","permalink":"/docs/es/platform/biostar_air/site-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-settings","title":"사이트 설정하기","description":"BioStar Air를 최적으로 관리하기 위해 사이트 프로필, 보안 설정, 표준 시간대, 인증 옵션 및 추가 기능을 구성하는 방법을 안내합니다.","keywords":["사이트 설정","구성하기"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"관리자 관리하기","permalink":"/docs/es/platform/biostar_air/managing-administrators"},"next":{"title":"일광 절약 시간(DST) 설정하기","permalink":"/docs/es/platform/biostar_air/daylight-saving-time"}}')
