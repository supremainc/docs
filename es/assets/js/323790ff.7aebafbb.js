...
var site_docs_platform_biostar_air_index_mdx_323_namespaceObject = JSON.parse('{"id":"platform/biostar_air/index","title":"BioStar Air","description":"BioStar Air는 생체 인식 보안 분야의 세계적인 선도 기업인 슈프리마가 개발한 클라우드 네이티브 출입 통제 솔루션입니다.","source":"@site/docs/platform/biostar_air/index.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/","permalink":"/docs/es/platform/biostar_air/","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/index.mdx","tags":[],"version":"current","frontMatter":{"title":"BioStar Air","description":"BioStar Air는 생체 인식 보안 분야의 세계적인 선도 기업인 슈프리마가 개발한 클라우드 네이티브 출입 통제 솔루션입니다.","keywords":["BioStar Air","출입 통제","클라우드 기반 솔루션"],"isTranslationMissing":true},"sidebar":"biostar_air","next":{"title":"BioStar Air란?","permalink":"/docs/es/platform/biostar_air/what-is-biostar-air"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "사용자 가이드는 역할에 따라 네 가지로 구성되어 있습니다. 본인의 역할에 해당하는 가이드를 선택하세요."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(DocLink, {
            docId: "platform/biostar_air/site-admin-guide"
          }), ": 사용자·크리덴셜 등록, 장치·출입문·엘리베이터 설정, 출입 권한 구성, 이벤트 모니터링, 사이트 설정 및 서비스 구성 등 BioStar Air 사이트의 일상적인 운영을 담당합니다."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(DocLink, {
            docId: "platform/biostar_air/partner-install-guide"
          }), ": 파트너 포털을 통한 사이트 생성 및 관리, 리더기·모듈·카메라 등 하드웨어 설치와 네트워크 구성을 담당합니다."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(DocLink, {
            docId: "platform/biostar_air/credential-users-guide"
          }), ": 슈프리마 패스 앱으로 모바일 크리덴셜을 사용해 출입문을 열고, 인증 방식과 블루투스 감도를 설정하는 최종 사용자입니다."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(DocLink, {
            docId: "platform/biostar_air/developer-guide"
          }), ": BioStar Air Cloud API를 통해 사용자 관리와 크리덴셜 발급을 자동화하려는 개발자를 위한 문서입니다."]
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "가이드-구성",
