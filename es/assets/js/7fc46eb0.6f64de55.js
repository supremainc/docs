...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_monitoring_audit_logs_mdx_7fc_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-audit-logs","title":"Use Audit Logs","description":"This guide explains how to monitor and analyze audit logs in BioStar Air, apply filters, export data, and track administrative activity.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/monitoring-audit-logs.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-audit-logs","permalink":"/docs/es/platform/biostar_air/monitoring-audit-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring-audit-logs.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-audit-logs","title":"Use Audit Logs","description":"This guide explains how to monitor and analyze audit logs in BioStar Air, apply filters, export data, and track administrative activity.","keywords":["Monitoring","Audit logs","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Use Event Logs","permalink":"/docs/es/platform/biostar_air/monitoring-event-logs"},"next":{"title":"Check Alert & Report History","permalink":"/docs/es/platform/biostar_air/monitoring-alert-report-history"}}')
