"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["73864"], {
...
94923: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_corestation_20_ul_installation_mdx_b8c_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ installation_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-corestation-20-ul-installation-mdx-b8c.json
var site_docs_device_corestation_20_ul_installation_mdx_b8c_namespaceObject = JSON.parse('{"id":"device/corestation_20_ul/installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","source":"@site/docs/device/corestation_20_ul/installation.mdx","sourceDirName":"device/corestation_20_ul","slug":"/device/corestation_20_ul/installation","permalink":"/docs/es/device/corestation_20_ul/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/corestation_20_ul/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"Installation","description":"Provides the complete process and connection examples required for product installation.","keywords":["Install","CoreStation 20","Device"],"isTranslationMissing":true},"sidebar":"corestation20_ul","previous":{"title":"Getting Started","permalink":"/docs/es/device/corestation_20_ul/getting-started"},"next":{"title":"Product Specifications","permalink":"/docs/es/device/corestation_20_ul/product-specifications"}}')
...
;// CONCATENATED MODULE: ./docs/common/_cs-fatory-reset.mdx


const _cs_fatory_reset_frontMatter = (/* unused pure expression or super */ null && ({}));
const _cs_fatory_reset_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _cs_fatory_reset_toc = [{
  "value": "공장 초기화",
  "id": "factory-reset",
  "level": 2
}];
function _cs_fatory_reset_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    h2: "h2",
  ...
  if (!Include) _cs_fatory_reset_missingMdxReference("Include", true);
  if (!Linkto) _cs_fatory_reset_missingMdxReference("Linkto", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "factory-reset",
      children: "공장 초기화"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["CoreStation Setup Manager에 접속한 뒤 ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "CONFIGURE"
          }), "을 클릭하세요."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
      ...
      children: [(0,jsx_runtime.jsxs)(_components.ul, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["CoreStation Setup Manager에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(Linkto, {
...
function _cs_fatory_reset_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* .useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_cs_fatory_reset_createMdxContent, {
      ...props
    })
  }) : _cs_fatory_reset_createMdxContent(props);
}
function _cs_fatory_reset_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/device/corestation_20_ul/installation.mdx
...
function installation_createMdxContent(props) {
  ...
  if (!Badge) installation_missingMdxReference("Badge", true);
  if (!Image) installation_missingMdxReference("Image", true);
  if (!PageBreak) installation_missingMdxReference("PageBreak", true);
  if (!Row) installation_missingMdxReference("Row", true);
  if (!Table) installation_missingMdxReference("Table", true);
  if (!Tbody) installation_missingMdxReference("Tbody", true);
  if (!Td) installation_missingMdxReference("Td", true);
  if (!Th) installation_missingMdxReference("Th", true);
  if (!Thead) installation_missingMdxReference("Thead", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
    ...
    }), "\n", (0,jsx_runtime.jsx)(PageBreak, {}), "\n", "\n", "\n", (0,jsx_runtime.jsx)(_cs_fatory_reset_MDXContent, {})]
  });
}
