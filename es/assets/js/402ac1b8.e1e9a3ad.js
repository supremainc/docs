...
var site_docs_platform_biostar_air_suprema_pass_app_advanced_features_mdx_402_namespaceObject = JSON.parse('{"id":"platform/biostar_air/suprema-pass-app-advanced-features","title":"고급 기능 설정하기","description":"슈프리마 패스 앱에서 Bluetooth 및 NFC 인증 모드 구성 방법, PIN 또는 생체 인식 옵션으로 2단계 인증 설정 방법, 액세스 로그 검토 방법, 지원 기능 사용 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/suprema-pass-app-advanced-features.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/suprema-pass-app-advanced-features","permalink":"/docs/es/platform/biostar_air/suprema-pass-app-advanced-features","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/suprema-pass-app-advanced-features.mdx","tags":[],"version":"current","frontMatter":{"id":"suprema-pass-app-advanced-features","title":"고급 기능 설정하기","description":"슈프리마 패스 앱에서 Bluetooth 및 NFC 인증 모드 구성 방법, PIN 또는 생체 인식 옵션으로 2단계 인증 설정 방법, 액세스 로그 검토 방법, 지원 기능 사용 방법을 안내합니다.","keywords":["고급 기능","슈프리마 패스 앱","2단계 인증","액세스 로그","지원 옵션"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"모바일 크리덴셜 사용하기","permalink":"/docs/es/platform/biostar_air/opening-doors-with-mobile-credentials"},"next":{"title":"민감도 설정하기","permalink":"/docs/es/platform/biostar_air/suprema-pass-app-sensitivity-settings"}}')
