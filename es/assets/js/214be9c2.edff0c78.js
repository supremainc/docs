...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_service_configuration_mdx_214_namespaceObject = JSON.parse('{"id":"platform/biostar_air/service-configuration","title":"Additional Site Configuration","description":"This guide explains how to configure the detailed features required to operate the BioStar Air service, including daylight saving time settings, email templates, alerts and reports, custom Wiegand card formats, and time and attendance management.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/service-configuration.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/service-configuration","permalink":"/docs/es/platform/biostar_air/service-configuration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/service-configuration.mdx","tags":[],"version":"current","frontMatter":{"id":"service-configuration","title":"Additional Site Configuration","description":"This guide explains how to configure the detailed features required to operate the BioStar Air service, including daylight saving time settings, email templates, alerts and reports, custom Wiegand card formats, and time and attendance management.","keywords":["Service Settings","BioStar Air","Daylight Saving Time","Email template","alerts","Report","Wiegand card","Time Attendance"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Personal Account Settings","permalink":"/docs/es/platform/biostar_air/account-settings"},"next":{"title":"Daylight Saving Time (DST)","permalink":"/docs/es/platform/biostar_air/daylight-saving-time"}}')
