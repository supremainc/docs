...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_elevator_add_edit_delete_mdx_2f3_namespaceObject = JSON.parse('{"id":"platform/biostar_air/elevator-add-edit-delete","title":"Managing Elevators","description":"Configure elevator access control to manage access to each floor. Connect the OM-120 module to the device, configure the floor button relays, and manage access schedules.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/elevator-add-edit-delete.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/elevator-add-edit-delete","permalink":"/docs/es/platform/biostar_air/elevator-add-edit-delete","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/elevator-add-edit-delete.mdx","tags":[],"version":"current","frontMatter":{"id":"elevator-add-edit-delete","title":"Managing Elevators","description":"Configure elevator access control to manage access to each floor. Connect the OM-120 module to the device, configure the floor button relays, and manage access schedules.","keywords":["Elevator","Per-floor access control","OM-120","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Elevator","permalink":"/docs/es/platform/biostar_air/manage-elevator"},"next":{"title":"Set floor access permissions","permalink":"/docs/es/platform/biostar_air/elevator-set-floor-access"}}')
