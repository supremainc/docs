...
var site_docs_platform_biostar_air_managing_registered_devices_mdx_1d4_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-registered-devices","title":"등록 장치 관리하기","description":"BioStar Air 포털에서 장치의 연결 상태를 확인하고, 생체 인증과 카드 설정을 변경하며, 펌웨어를 업데이트합니다. 개별 또는 일괄 작업으로 보안 시스템을 효율적으로 관리합니다.","source":"@site/docs/platform/biostar_air/managing-registered-devices.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-registered-devices","permalink":"/docs/es/platform/biostar_air/managing-registered-devices","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-registered-devices.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-registered-devices","title":"등록 장치 관리하기","description":"BioStar Air 포털에서 장치의 연결 상태를 확인하고, 생체 인증과 카드 설정을 변경하며, 펌웨어를 업데이트합니다. 개별 또는 일괄 작업으로 보안 시스템을 효율적으로 관리합니다.","keywords":["장치 관리","장치 설정","BioStar Air","생체 인증","카드 설정","펌웨어 업데이트","네트워크 설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"장치 등록 및 삭제하기","permalink":"/docs/es/platform/biostar_air/manage-device-with-app"},"next":{"title":"장치 정보 및 설정 옵션 안내","permalink":"/docs/es/platform/biostar_air/device-info-settings"}}')
