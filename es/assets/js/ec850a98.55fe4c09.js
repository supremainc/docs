...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_user_management_user_list_mdx_ec8_namespaceObject = JSON.parse('{"id":"platform/biostar_air/user-management-user-list","title":"Manage Users","description":"Efficiently manage users registered in BioStar Air. You can manage all users within your organization through functions such as viewing user lists, filtering, editing details, assigning groups and access levels, issuing credentials, performing batch operations, and generating reports.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/user-management-user-list.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/user-management-user-list","permalink":"/docs/es/platform/biostar_air/user-management-user-list","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/user-management-user-list.mdx","tags":[],"version":"current","frontMatter":{"id":"user-management-user-list","title":"Manage Users","description":"Efficiently manage users registered in BioStar Air. You can manage all users within your organization through functions such as viewing user lists, filtering, editing details, assigning groups and access levels, issuing credentials, performing batch operations, and generating reports.","keywords":["BioStar Air","User Management","User list","Credentials","access level","User group","Report"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Add Users","permalink":"/docs/es/platform/biostar_air/adding-individual-users"},"next":{"title":"Add Users in Bulk","permalink":"/docs/es/platform/biostar_air/adding-users-in-bulk"}}')
