...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_manage_access_authority_mdx_3fc_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-access-authority","title":"Permisos de acceso","description":"Gestiona eficazmente los permisos de acceso de los usuarios en BioStar Air.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/manage-access-authority.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-access-authority","permalink":"/docs/es/platform/biostar_air/manage-access-authority","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-access-authority.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-access-authority","title":"Permisos de acceso","description":"Gestiona eficazmente los permisos de acceso de los usuarios en BioStar Air.","keywords":["BioStar Air","Gestión de Acceso","Grupo de días festivos","Horario","nivel de acceso","Nivel de piso"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Establecer permisos de acceso por piso","permalink":"/docs/es/platform/biostar_air/elevator-set-floor-access"},"next":{"title":"Gestionar grupos de días festivos","permalink":"/docs/es/platform/biostar_air/manage-holiday-group"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "La gestión de los permisos de acceso es fundamental en un sistema de seguridad. Para controlar con precisión cuándo y dónde tienen acceso los usuarios, combina grupos de días festivos, horarios, niveles de acceso y niveles de piso."
    }), "\n", (0,jsx_runtime.jsxs)(_components.admonition, {
      type: "tip",
      children: [(0,jsx_runtime.jsx)(_components.p, {
        children: "Consulta la siguiente guía en video sobre cómo gestionar los permisos de acceso."
