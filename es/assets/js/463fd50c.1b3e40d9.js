...
var site_docs_platform_biostar_air_elevator_set_floor_aceess_mdx_463_namespaceObject = JSON.parse('{"id":"platform/biostar_air/elevator-set-floor-access","title":"층별 출입 권한 설정","description":"엘리베이터를 등록하고, 사용자와 그룹별로 접근 가능한 층을 설정하세요. 층 레벨을 정의하고 스케줄과 휴일 정책을 적용하여 층별 출입을 제어합니다.","source":"@site/docs/platform/biostar_air/elevator-set-floor-aceess.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/elevator-set-floor-access","permalink":"/docs/es/platform/biostar_air/elevator-set-floor-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/elevator-set-floor-aceess.mdx","tags":[],"version":"current","frontMatter":{"id":"elevator-set-floor-access","title":"층별 출입 권한 설정","description":"엘리베이터를 등록하고, 사용자와 그룹별로 접근 가능한 층을 설정하세요. 층 레벨을 정의하고 스케줄과 휴일 정책을 적용하여 층별 출입을 제어합니다.","keywords":["층별 출입 권한","엘리베이터","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"엘리베이터 관리하기","permalink":"/docs/es/platform/biostar_air/elevator-add-edit-delete"},"next":{"title":"출입 권한","permalink":"/docs/es/platform/biostar_air/manage-access-authority"}}')
