...
var site_docs_platform_biostar_air_daylight_saving_time_mdx_cd2_namespaceObject = JSON.parse('{"id":"platform/biostar_air/daylight-saving-time","title":"일광 절약 시간(DST) 구성하기","description":"BioStar Air에서 자동 및 수동 DST 설정 구성 방법, 장치에 대한 DST 활성화 방법, 여러 위치에서 표준 시간대 조정 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/daylight-saving-time.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/daylight-saving-time","permalink":"/docs/es/platform/biostar_air/daylight-saving-time","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/daylight-saving-time.mdx","tags":[],"version":"current","frontMatter":{"id":"daylight-saving-time","title":"일광 절약 시간(DST) 구성하기","description":"BioStar Air에서 자동 및 수동 DST 설정 구성 방법, 장치에 대한 DST 활성화 방법, 여러 위치에서 표준 시간대 조정 관리 방법을 안내합니다.","keywords":["일광 절약 시간","DST","시간대"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"서비스 구성하기","permalink":"/docs/es/platform/biostar_air/service-configuration"},"next":{"title":"이메일 템플릿 사용자 정의하기","permalink":"/docs/es/platform/biostar_air/customizing-email-templates"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "일광 절약 시간(Daylight Saving Time, DST) 설정을 통해 사이트의 시간 조정 방식을 구성할 수 있습니다. 이는 특히 여러 시간대에 걸쳐 방문자가 있는 사이트를 관리할 때 일관되고 정확한 시간 추적을 보장하는 데 중요합니다."
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["목록에서 수정하려는 DST 구성을 클릭하세요. 또는 체크박스를 클릭하고 상단의 ", (0,jsx_runtime.jsx)(IcAirEdit, {
            title: "Edit"
          }), " 버튼을 클릭하세요."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
