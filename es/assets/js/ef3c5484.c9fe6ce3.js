...
var site_docs_platform_biostar_x_settings_external_remote_access_mdx_ef3_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-external-remote-access","title":"사용자 리모트 액세스 설정하기","description":"ngrok 서비스를 통해 사용자 리모트 액세스 설정 방법을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-external-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-external-remote-access","permalink":"/docs/es/platform/biostar_x/settings-external-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-external-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-external-remote-access","title":"사용자 리모트 액세스 설정하기","description":"ngrok 서비스를 통해 사용자 리모트 액세스 설정 방법을 안내합니다.","keywords":["사용자 리모트 액세스","ngrok"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"Configurar acceso remoto","permalink":"/docs/es/platform/biostar_x/settings-remote-access"},"next":{"title":"Integrar el registro de eventos de dispositivos virtuales","permalink":"/docs/es/platform/biostar_x/settings-virtual-device-event-log"}}')
