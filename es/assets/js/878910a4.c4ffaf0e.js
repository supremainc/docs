...
var site_i_18_n_es_docusaurus_plugin_content_docs_current_platform_biostar_air_daylight_saving_time_mdx_878_namespaceObject = JSON.parse('{"id":"platform/biostar_air/daylight-saving-time","title":"Daylight Saving Time (DST)","description":"Learn how to configure automatic and manual DST settings in BioStar Air, enable DST for devices, and manage time zone adjustments across multiple locations.","source":"@site/i18n/es/docusaurus-plugin-content-docs/current/platform/biostar_air/daylight-saving-time.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/daylight-saving-time","permalink":"/docs/es/platform/biostar_air/daylight-saving-time","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/daylight-saving-time.mdx","tags":[],"version":"current","frontMatter":{"id":"daylight-saving-time","title":"Daylight Saving Time (DST)","description":"Learn how to configure automatic and manual DST settings in BioStar Air, enable DST for devices, and manage time zone adjustments across multiple locations.","keywords":["Daylight Saving Time","DST","time zone"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Additional Site Configuration","permalink":"/docs/es/platform/biostar_air/service-configuration"},"next":{"title":"Customize Email Templates","permalink":"/docs/es/platform/biostar_air/customizing-email-templates"}}')
