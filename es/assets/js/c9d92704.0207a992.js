...
var site_docs_platform_biostar_air_site_admin_guide_mdx_c9d_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-admin-guide","title":"사이트 관리자","description":"사용자, 장치, 출입문, 엘리베이터 관리부터 출입 권한 구성, 모니터링, 시스템 설정 및 서비스 구성까지 BioStar Air 사이트 운영에 필요한 모든 관리 기능을 안내합니다.","source":"@site/docs/platform/biostar_air/site-admin-guide.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-admin-guide","permalink":"/docs/es/platform/biostar_air/site-admin-guide","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-admin-guide.mdx","tags":[],"version":"current","frontMatter":{"id":"site-admin-guide","title":"사이트 관리자","description":"사용자, 장치, 출입문, 엘리베이터 관리부터 출입 권한 구성, 모니터링, 시스템 설정 및 서비스 구성까지 BioStar Air 사이트 운영에 필요한 모든 관리 기능을 안내합니다.","keywords":["사이트 관리자","관리","설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"보안 체계","permalink":"/docs/es/platform/biostar_air/security-overview"},"next":{"title":"시작하기","permalink":"/docs/es/platform/biostar_air/getting-started"}}')
