...
var site_docs_platform_biostar_air_account_settings_mdx_161_namespaceObject = JSON.parse('{"id":"platform/biostar_air/account-settings","title":"개인 계정 설정하기","description":"비밀번호 및 알림, IP 인터폰 등 BioStar Air 개인 계정 설정을 변경하고, 사이트 탈퇴 및 계정 삭제하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/account-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/account-settings","permalink":"/docs/es/platform/biostar_air/account-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/account-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"account-settings","title":"개인 계정 설정하기","description":"비밀번호 및 알림, IP 인터폰 등 BioStar Air 개인 계정 설정을 변경하고, 사이트 탈퇴 및 계정 삭제하는 방법을 안내합니다.","keywords":["계정 설정","프로필","알림","SIP 인터폰","계정 관리"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"관리자 계정 및 역할 관리하기","permalink":"/docs/es/platform/biostar_air/managing-administrators"},"next":{"title":"추가 사이트 구성하기","permalink":"/docs/es/platform/biostar_air/service-configuration"}}')
...
const frontMatter = {
	id: 'account-settings',
	title: '개인 계정 설정하기',
	description: '비밀번호 및 알림, IP 인터폰 등 BioStar Air 개인 계정 설정을 변경하고, 사이트 탈퇴 및 계정 삭제하는 방법을 안내합니다.',
	keywords: [
		'계정 설정',
		'프로필',
		'알림',
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "비밀번호 변경, 알림 수신 방식 조정, IP 인터폰 설정 등 계정과 관련된 개인 설정을 직접 관리할 수 있습니다. 사이트를 탈퇴하거나 계정을 영구적으로 삭제할 수도 있습니다."
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(Cmd, {
                sid: "account",
                product: "air"
              }), ": 사용자 이름, 비밀번호, 전화번호 등을 수정할 수 있습니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(Cmd, {
                sid: "alerts.alerts",
                product: "air"
              }), ": 알림 수신 방식을 설정할 수 있습니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(Cmd, {
                ...
                product: "air"
              }), ": SIP 인터폰 설정 정보를 관리할 수 있습니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(Cmd, {
                ...
                product: "air"
              }), ": 사이트를 탈퇴하거나 계정을 삭제할 수 있습니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
                inner: "#manageAccount"
              }), "를 참고하세요."]
            }), "\n"]
          }), "\n"]
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["SIP 인터폰 설정에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(DocLink, {
