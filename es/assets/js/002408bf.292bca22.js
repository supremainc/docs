...
var site_docs_platform_biostar_air_suprema_pass_app_sensitivity_settings_mdx_002_namespaceObject = JSON.parse('{"id":"platform/biostar_air/suprema-pass-app-sensitivity-settings","title":"민감도 설정하기","description":"슈프리마 패스 앱에서 블루투스 인식 감도를 조정하여 의도치 않은 인증 방지, 인식 거리 개선, Apple Pay 간섭 문제 해결 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/suprema-pass-app-sensitivity-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/suprema-pass-app-sensitivity-settings","permalink":"/docs/es/platform/biostar_air/suprema-pass-app-sensitivity-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/suprema-pass-app-sensitivity-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"suprema-pass-app-sensitivity-settings","title":"민감도 설정하기","description":"슈프리마 패스 앱에서 블루투스 인식 감도를 조정하여 의도치 않은 인증 방지, 인식 거리 개선, Apple Pay 간섭 문제 해결 방법을 안내합니다.","keywords":["감도 설정","블루투스","Airfob"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"고급 기능","permalink":"/docs/es/platform/biostar_air/suprema-pass-app-advanced-features"},"next":{"title":"API 통합","permalink":"/docs/es/platform/biostar_air/integration-quickstart"}}')
