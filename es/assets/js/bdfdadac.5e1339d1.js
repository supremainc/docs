"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["14837"], {
...
62273: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_configuring_the_airfob_patch_and_tag_mdx_bdf_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-configuring-the-airfob-patch-and-tag-mdx-bdf.json
var site_docs_platform_biostar_air_configuring_the_airfob_patch_and_tag_mdx_bdf_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-the-airfob-patch-and-tag","title":"에어팝 패치(Patch)와 태그(Tag) 구성하기","description":"기존 출입 통제 시스템을 BioStar Air로 업그레이드하기 위해 에어팝 패치 및 태그 장치를 구성하고, BLE 모드 설정, 카드 ID 커스텀 출력 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/configuring-the-airfob-patch-and-tag.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-the-airfob-patch-and-tag","permalink":"/docs/es/platform/biostar_air/configuring-the-airfob-patch-and-tag","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/configuring-the-airfob-patch-and-tag.mdx","tags":[],"version":"current","frontMatter":{"id":"configuring-the-airfob-patch-and-tag","title":"에어팝 패치(Patch)와 태그(Tag) 구성하기","description":"기존 출입 통제 시스템을 BioStar Air로 업그레이드하기 위해 에어팝 패치 및 태그 장치를 구성하고, BLE 모드 설정, 카드 ID 커스텀 출력 방법을 안내합니다.","keywords":["Airfob","Patch","Tag","configuration"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"근태 관리(T&A) 설정하기","permalink":"/docs/es/platform/biostar_air/configuring-ta"},"next":{"title":"SIO2 보안 모듈 구성하기","permalink":"/docs/es/platform/biostar_air/configuring-the-sio2-secure-module"}}')
...
;// CONCATENATED MODULE: ./docs/platform/biostar_air/configuring-the-airfob-patch-and-tag.mdx
