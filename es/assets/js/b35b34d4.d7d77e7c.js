...
var site_docs_platform_biostar_air_security_overview_mdx_b35_namespaceObject = JSON.parse('{"id":"platform/biostar_air/security-overview","title":"보안 체계","description":"BioStar Air의 포괄적인 보안 조치에 대해 알아보세요. 종단 간 암호화, ISO 27001 인증, 모바일 자격 증명 보호 및 취약성 관리 관행이 포함되어 있습니다.","source":"@site/docs/platform/biostar_air/security-overview.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/security-overview","permalink":"/docs/es/platform/biostar_air/security-overview","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/security-overview.mdx","tags":[],"version":"current","frontMatter":{"id":"security-overview","title":"보안 체계","description":"BioStar Air의 포괄적인 보안 조치에 대해 알아보세요. 종단 간 암호화, ISO 27001 인증, 모바일 자격 증명 보호 및 취약성 관리 관행이 포함되어 있습니다.","keywords":["security","Biostar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"지원 장치","permalink":"/docs/es/platform/biostar_air/access-control-hardware-compatibility"},"next":{"title":"마이그레이션","permalink":"/docs/es/platform/biostar_air/biostar-air-migration"}}')
