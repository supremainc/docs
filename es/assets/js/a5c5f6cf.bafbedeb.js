"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["76143"], {
...
87165: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_device_corestation_20_ul_getting_started_mdx_a5c_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-device-corestation-20-ul-getting-started-mdx-a5c.json
var site_docs_device_corestation_20_ul_getting_started_mdx_a5c_namespaceObject = JSON.parse('{"id":"device/corestation_20_ul/getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","source":"@site/docs/device/corestation_20_ul/getting-started.mdx","sourceDirName":"device/corestation_20_ul","slug":"/device/corestation_20_ul/getting-started","permalink":"/docs/es/device/corestation_20_ul/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/corestation_20_ul/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"Getting Started","description":"Provides initial procedures for getting started with the device.","keywords":["Components","Name","Feature","Cable","Connector"],"isTranslationMissing":true},"sidebar":"corestation20_ul","previous":{"title":"Safety Instructions","permalink":"/docs/es/device/corestation_20_ul/safety-instructions"},"next":{"title":"Installation","permalink":"/docs/es/device/corestation_20_ul/installation"}}')
...
;// CONCATENATED MODULE: ./docs/device/corestation_20_ul/getting-started.mdx
