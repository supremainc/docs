...
import collectionData from '@site/static/specs/clue-api-postman-collection.json';
...
export default function ApiV2Page() {
  ...
  const pageTitle = selected
    ? (selected._folder?.name || selected.name) + ' — CLUe API'
    : 'CLUe API';

  return (
    <Layout title={pageTitle} description="CLUe REST API Documentation">
      <Head>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "TechArticle",
            "headline": "CLUe API",
            "description": "Complete REST API documentation for CLUe access control system",
            "author": {
              "@type": "Organization",
              "name": "Suprema Inc.",
