"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["27329"], {
15232: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_elevator_set_floor_aceess_mdx_463_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-elevator-set-floor-aceess-mdx-463.json
var site_docs_platform_biostar_air_elevator_set_floor_aceess_mdx_463_namespaceObject = JSON.parse('{"id":"platform/biostar_air/elevator-set-floor-access","title":"층별 출입 권한 설정","description":"엘리베이터를 등록하고, 사용자와 그룹별로 접근 가능한 층을 설정하세요. 층 레벨을 정의하고 스케줄과 휴일 정책을 적용하여 층별 출입을 제어합니다.","source":"@site/docs/platform/biostar_air/elevator-set-floor-aceess.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/elevator-set-floor-access","permalink":"/docs/ja/platform/biostar_air/elevator-set-floor-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/elevator-set-floor-aceess.mdx","tags":[],"version":"current","frontMatter":{"id":"elevator-set-floor-access","title":"층별 출입 권한 설정","description":"엘리베이터를 등록하고, 사용자와 그룹별로 접근 가능한 층을 설정하세요. 층 레벨을 정의하고 스케줄과 휴일 정책을 적용하여 층별 출입을 제어합니다.","keywords":["층별 출입 권한","엘리베이터","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"엘리베이터 관리하기","permalink":"/docs/ja/platform/biostar_air/elevator-add-edit-delete"},"next":{"title":"출입 권한","permalink":"/docs/ja/platform/biostar_air/manage-access-authority"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./docs/platform/biostar_air/elevator-set-floor-aceess.mdx
