    ...
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h3, {
          ...
          children: "VMS サーバーの録画映像を再生するには、HTTPS プロトコルを使用する必要があります。 一般的なSSL証明書はドメイン名を基に発行されるため、VMSサーバーにIPアドレスでアクセスする環境では有効ではありません。 そのため、VMSサーバーのIPアドレスを含む証明書を別途作成する必要があります。"
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["VMSサーバーと", (0,jsx_runtime.jsx)(_components.strong, {
                  children: "BioStar X"
                }), "を同じサーバーにインストールする場合でも、別々のサーバーにインストールする場合でも、証明書をインストールする必要があります。"]
              }), "\n"]
            }), "\n"]
          })
