...
var site_docs_device_vionyx_webserver_configure_ai_events_and_rules_mdx_88f_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/configure-ai-events-and-rules","title":"AI 이벤트 및 규칙 설정하기","description":"AI 기반 이벤트를 설정하고 이벤트 발생 시 실행할 규칙을 정의하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/configure-ai-events-and-rules.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/configure-ai-events-and-rules","permalink":"/docs/ja/device/vionyx_webserver/configure-ai-events-and-rules","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/configure-ai-events-and-rules.mdx","tags":[],"version":"current","frontMatter":{"id":"configure-ai-events-and-rules","title":"AI 이벤트 및 규칙 설정하기","description":"AI 기반 이벤트를 설정하고 이벤트 발생 시 실행할 규칙을 정의하는 방법을 안내합니다.","keywords":["AI 이벤트","규칙","사람 추적","라인 통과","침입 감지","인원 카운팅"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"라이브 영상 보기","permalink":"/docs/ja/device/vionyx_webserver/live-basic"},"next":{"title":"사람 추적 이벤트로 출입자 동선 파악하기","permalink":"/docs/ja/device/vionyx_webserver/configure-people-tracking"}}')
