"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["40794"], {
...
3969: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_site_settings_mdx_a12_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-site-settings-mdx-a12.json
var site_docs_platform_biostar_air_site_settings_mdx_a12_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-settings","title":"사이트 설정하기","description":"BioStar Air를 최적으로 관리하기 위해 사이트 프로필, 보안 설정, 표준 시간대, 인증 옵션 및 추가 기능을 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/site-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-settings","permalink":"/docs/ja/platform/biostar_air/site-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-settings","title":"사이트 설정하기","description":"BioStar Air를 최적으로 관리하기 위해 사이트 프로필, 보안 설정, 표준 시간대, 인증 옵션 및 추가 기능을 구성하는 방법을 안내합니다.","keywords":["사이트 설정","구성하기"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"관리자 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-administrators"},"next":{"title":"일광 절약 시간(DST) 설정하기","permalink":"/docs/ja/platform/biostar_air/daylight-saving-time"}}')
...
;// CONCATENATED MODULE: ./docs/platform/biostar_air/site-settings.mdx
