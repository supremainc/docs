...
var site_docs_platform_biostar_air_user_management_user_list_mdx_310_namespaceObject = JSON.parse('{"id":"platform/biostar_air/user-management-user-list","title":"사용자 관리하기","description":"사용자 목록에서 제공하는 부가 기능에 대해 안내합니다.","source":"@site/docs/platform/biostar_air/user-management-user-list.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/user-management-user-list","permalink":"/docs/ja/platform/biostar_air/user-management-user-list","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/user-management-user-list.mdx","tags":[],"version":"current","frontMatter":{"id":"user-management-user-list","title":"사용자 관리하기","description":"사용자 목록에서 제공하는 부가 기능에 대해 안내합니다.","keywords":["BioStar Air","사용자 관리","사용자 목록"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"사용자 추가하기","permalink":"/docs/ja/platform/biostar_air/adding-individual-users"},"next":{"title":"일괄 작업으로 사용자 추가하기","permalink":"/docs/ja/platform/biostar_air/adding-users-in-bulk"}}')
...
function _createMdxContent(props) {
  const _components = {
    ...
    ...props.components
  }, {Cmd, IcAirActive, IcAirDown, IcAirEdit, IcAirFaceLink, IcAirFilter, IcAirFilterReset, IcAirGroup, IcAirLock, IcAirMore, IcAirMtag, IcAirReissue, IcAirRemove, IcAirReport, IcAirSuspend, IcAirUpface, IcAirUtemplate, Image} = _components;
