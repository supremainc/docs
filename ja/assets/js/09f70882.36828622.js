...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_site_security_settings_mdx_09f_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-security-settings","title":"Security Settings","description":"Learn how to enhance the security of the BioStar Air site by locking administrator accounts, enabling 2-factor authentication, enforcing password policies, and setting mobile credential validity periods.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/site-security-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-security-settings","permalink":"/docs/ja/platform/biostar_air/site-security-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-security-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-security-settings","title":"Security Settings","description":"Learn how to enhance the security of the BioStar Air site by locking administrator accounts, enabling 2-factor authentication, enforcing password policies, and setting mobile credential validity periods.","keywords":["Site Security","Security Settings"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Advanced Settings","permalink":"/docs/ja/platform/biostar_air/site-advanced-settings"},"next":{"title":"Settings for Additional Features","permalink":"/docs/ja/platform/biostar_air/site-additional-settings"}}')
