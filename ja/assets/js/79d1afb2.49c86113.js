"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["4448"], {
...
77495: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_facestation_f_2_getting_started_mdx_79d_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-facestation-f-2-getting-started-mdx-79d.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_facestation_f_2_getting_started_mdx_79d_namespaceObject = JSON.parse('{"id":"device/facestation_f2/getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/facestation_f2/getting-started.mdx","sourceDirName":"device/facestation_f2","slug":"/device/facestation_f2/getting-started","permalink":"/docs/ja/device/facestation_f2/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/facestation_f2/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","keywords":["同梱物","名称","機能","ケーブル","コネクター"],"isTranslationMissing":false},"sidebar":"facestationf2","previous":{"title":"安全のための注意事項","permalink":"/docs/ja/device/facestation_f2/safety-instructions"},"next":{"title":"インストール","permalink":"/docs/ja/device/facestation_f2/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/facestation_f2/getting-started.mdx
      ...
      children: (0,jsx_runtime.jsxs)(Tbody, {
        children: [(0,jsx_runtime.jsxs)(Row, {
          ...
          children: [(0,jsx_runtime.jsx)(Td, {
            ...
            children: "壁掛け用ブラケット (FSF2-ODB)"
          }), (0,jsx_runtime.jsx)(Td, {
            children: "ドリルテンプレート (FSF2-ODB)"
          })]
        }), (0,jsx_runtime.jsxs)(Row, {
          className: "center white",
          children: [(0,jsx_runtime.jsx)(Td, {
          ...
          children: [(0,jsx_runtime.jsx)(Td, {
            ...
            children: "壁掛け用ブラケット (FSF2-DB, FSF2-AB)"
          }), (0,jsx_runtime.jsx)(Td, {
            children: "ドリルテンプレート (FSF2-DB, FSF2-AB)"
          })]
        }), (0,jsx_runtime.jsxs)(Row, {
          className: "center white",
          children: [(0,jsx_runtime.jsx)(Td, {
