...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_device_manager_index_mdx_000_namespaceObject = JSON.parse('{"id":"device/device_manager/index","title":"Device Manager","description":"Suprema Device Manager は、BLE 通信を使ってシュプリマの XPass D2、XPass 2、BioEntry W3、XPass Q2 を設定できるモバイルアプリケーションです。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/device_manager/index.mdx","sourceDirName":"device/device_manager","slug":"/device/device_manager/","permalink":"/docs/ja/device/device_manager/","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/device_manager/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Device Manager","description":"Suprema Device Manager は、BLE 通信を使ってシュプリマの XPass D2、XPass 2、BioEntry W3、XPass Q2 を設定できるモバイルアプリケーションです。","keywords":["Device Manager","モバイルベース入退室装置管理アプリケーション"],"isTranslationMissing":false},"sidebar":"device_manager","next":{"title":"はじめに","permalink":"/docs/ja/device/device_manager/getting-started"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "Suprema Device Manager は、BLE 通信を使ってシュプリマの XPass D2、XPass 2、BioEntry W3、XPass Q2 を設定できるモバイルアプリケーションです。"
