...
var site_docs_platform_biostar_air_manage_elevator_mdx_22e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-elevator","title":"엘리베이터 관리","description":"BioStar Air는 슈프리마의 OM-120 모듈을 사용하여 엘리베이터 출입 통제를 지원합니다.","source":"@site/docs/platform/biostar_air/manage-elevator.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-elevator","permalink":"/docs/ja/platform/biostar_air/manage-elevator","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-elevator.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-elevator","title":"엘리베이터 관리","description":"BioStar Air는 슈프리마의 OM-120 모듈을 사용하여 엘리베이터 출입 통제를 지원합니다.","keywords":["BioStar Air","OM-120","엘리베이터 출입 통제"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문 스케줄 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-door-schedules"},"next":{"title":"출입 권한 관리","permalink":"/docs/ja/platform/biostar_air/manage-access-authority"}}')
