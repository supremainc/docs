"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["67588"], {
...
8508: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_doormodule_getting_started_mdx_0cf_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-doormodule-getting-started-mdx-0cf.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_doormodule_getting_started_mdx_0cf_namespaceObject = JSON.parse('{"id":"device/doormodule/getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/doormodule/getting-started.mdx","sourceDirName":"device/doormodule","slug":"/device/doormodule/getting-started","permalink":"/docs/ja/device/doormodule/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doormodule/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","keywords":["同梱物","名称","機能","ケーブル","コネクター"],"isTranslationMissing":false},"sidebar":"doormodule","previous":{"title":"安全のための注意事項","permalink":"/docs/ja/device/doormodule/safety-instructions"},"next":{"title":"インストール","permalink":"/docs/ja/device/doormodule/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/doormodule/getting-started.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "Supervised Inputを使用する際は、以下のLED状態を参照してください。"
      ...
      children: "本製品は多様な入出力とWiegand接続をサポートし、Suprema製デバイスおよび他社製デバイスと連携して拡張性を高めることができます。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Supervised Inputも使用でき、ショート、オープン、On、Offの状態を監視できます。"
