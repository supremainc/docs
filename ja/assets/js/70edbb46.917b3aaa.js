...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_custom_wiegand_card_formats_mdx_70e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/custom-wiegand-card-formats","title":"Custom Wiegand card format","description":"Create and configure a custom Wiegand card format in BioStar Air v2.10—including facility codes, ID segments, parity bits, and bit assignments—to migrate smoothly from an existing access control system.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/custom-wiegand-card-formats.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/custom-wiegand-card-formats","permalink":"/docs/ja/platform/biostar_air/custom-wiegand-card-formats","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/custom-wiegand-card-formats.mdx","tags":[],"version":"current","frontMatter":{"id":"custom-wiegand-card-formats","title":"Custom Wiegand card format","description":"Create and configure a custom Wiegand card format in BioStar Air v2.10—including facility codes, ID segments, parity bits, and bit assignments—to migrate smoothly from an existing access control system.","keywords":["Wiegand","Card format","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Set Up Alerts and Reports","permalink":"/docs/ja/platform/biostar_air/settings-alert-report"},"next":{"title":"Time & Attendance (T&A)","permalink":"/docs/ja/platform/biostar_air/configuring-ta"}}')
...
const frontMatter = {
	...
	title: 'Custom Wiegand card format',
