...
var site_docs_platform_biostar_air_federated_sites_mdx_b94_namespaceObject = JSON.parse('{"id":"platform/biostar_air/federated-sites","title":"Federated 사이트","description":"중앙 집중식 제어를 통해 다중 테넌트 빌딩과 다중 지점 조직을 위한 BioStar Air에서 Federated 사이트를 설정하고 관리하는 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/federated-sites.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/federated-sites","permalink":"/docs/ja/platform/biostar_air/federated-sites","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/federated-sites.mdx","tags":[],"version":"current","frontMatter":{"id":"federated-sites","title":"Federated 사이트","description":"중앙 집중식 제어를 통해 다중 테넌트 빌딩과 다중 지점 조직을 위한 BioStar Air에서 Federated 사이트를 설정하고 관리하는 방법을 알아보세요.","keywords":["federated","sites","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"BioStar Air 파트너 포털 상세 사용 안내","permalink":"/docs/ja/platform/biostar_air/biostar-air-partner-portal-detailed-use"},"next":{"title":"API 통합 시작하기","permalink":"/docs/ja/platform/biostar_air/integration-quickstart"}}')
