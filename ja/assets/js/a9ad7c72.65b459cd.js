"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["33480"], {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: "フェイルセーフロックを使用するには、下図のように N/C リレーを接続してください。 Fail Safe Lock は通常、リレー回路に電流が流れており、リレーが動作して電流を一時的に遮断するとドアが開きます。 停電や外部要因で装置の電源が切れた場合、ドアが開きます。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Include, {
      product: "biostation_3",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Image, {
      ...
      children: "フェイルセキュアロックを使用するには、下図のように N/O リレーを接続してください。 Fail Secure Lock は通常、リレー回路に電流が流れず、リレーが動作して電流が流れるとドアが開きます。 停電や外部要因で装置の電源が切れた場合、ドアが施錠されます。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Include, {
      product: "biostation_3",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Image, {
...
29596: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_3_installation_mdx_a9a_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-bioentry-w-3-installation-mdx-a9a.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_3_installation_mdx_a9a_namespaceObject = JSON.parse('{"id":"device/bioentry_w3/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w3/installation.mdx","sourceDirName":"device/bioentry_w3","slug":"/device/bioentry_w3/installation","permalink":"/docs/ja/device/bioentry_w3/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_w3/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"bioentryw3","previous":{"title":"はじめに","permalink":"/docs/ja/device/bioentry_w3/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/bioentry_w3/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w3/installation.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "「管理者認証が必要です」というメッセージが表示されたら、管理者権限の認証方法で認証してください。"
        }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
          type: "info",
          children: (0,jsx_runtime.jsxs)(_components.p, {
            children: ["BioStar Xでデバイスに管理者を登録してください。 デバイスに管理者が登録されていない場合、ファームウェアをアップグレードできません。 管理者登録方法の詳細については、", (0,jsx_runtime.jsx)(Linkto, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "管理者認証に成功すると、ファームウェアファイルがデバイスに転送されます。"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ファームウェアファイルの転送が完了すると、USBメモリを取り外すメッセージが画面に表示されます。 USBメモリを取り外してください。"
        }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
          type: "info",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "USBメモリを取り外さない場合、デバイスの再起動後にファームウェアアップグレードが再度実行されます。"
          })
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ファームウェアアップグレード完了後、デバイスが自動的に再起動します。"
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "caution",
