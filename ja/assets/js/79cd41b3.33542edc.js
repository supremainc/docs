...
var site_docs_platform_biostar_air_device_info_settings_mdx_79c_namespaceObject = JSON.parse('{"id":"platform/biostar_air/device-info-settings","title":"장치 정보 및 설정 옵션 안내","description":"BioStar Air 포털에서 장치 모델별로 제공되는 정보 확인 및 네트워크, 인증, 근태 관리 등의 설정 옵션을 안내합니다.","source":"@site/docs/platform/biostar_air/device-info-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/device-info-settings","permalink":"/docs/ja/platform/biostar_air/device-info-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/device-info-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"device-info-settings","title":"장치 정보 및 설정 옵션 안내","description":"BioStar Air 포털에서 장치 모델별로 제공되는 정보 확인 및 네트워크, 인증, 근태 관리 등의 설정 옵션을 안내합니다.","keywords":["장치 정보","설정 옵션","BioStar Air"],"toc_max_heading_level":2,"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"등록 장치 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-registered-devices"},"next":{"title":"장치 그룹 관리하기","permalink":"/docs/ja/platform/biostar_air/manage-device-group"}}')
