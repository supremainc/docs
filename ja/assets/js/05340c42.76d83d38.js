...
var site_docs_platform_biostar_air_settings_alert_report_mdx_053_namespaceObject = JSON.parse('{"id":"platform/biostar_air/settings-alert-report","title":"알림 및 리포트 설정하기","description":"BioStar Air에서 이벤트 알림과 자동 리포트를 설정하는 단계별 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/settings-alert-report.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/settings-alert-report","permalink":"/docs/ja/platform/biostar_air/settings-alert-report","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/settings-alert-report.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-alert-report","title":"알림 및 리포트 설정하기","description":"BioStar Air에서 이벤트 알림과 자동 리포트를 설정하는 단계별 방법을 안내합니다.","keywords":["BioStar Air","알림 설정","리포트 설정","시스템 알림","사용자 리포트"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"이메일 템플릿 사용자 정의하기","permalink":"/docs/ja/platform/biostar_air/customizing-email-templates"},"next":{"title":"커스텀 Wiegand 카드 형식 구성하기","permalink":"/docs/ja/platform/biostar_air/custom-wiegand-card-formats"}}')
