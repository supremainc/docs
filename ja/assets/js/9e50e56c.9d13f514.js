"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["87886"], {
37047: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_air_20_settings_managing_administrators_in_airfob_space_mdx_9e5_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-administrators","title":"관리자 관리하기","description":"BioStar Air에서 관리자 초대, 역할 등급 지정, 권한 관리, Observer, Operator, Administrator 및 Master 역할에 대한 출입 통제 설정 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/20-settings-managing-administrators-in-airfob-space.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-administrators","permalink":"/docs/ja/platform/biostar_air/managing-administrators","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/20-settings-managing-administrators-in-airfob-space.mdx","tags":[],"version":"current","sidebarPosition":20,"frontMatter":{"id":"managing-administrators","title":"관리자 관리하기","description":"BioStar Air에서 관리자 초대, 역할 등급 지정, 권한 관리, Observer, Operator, Administrator 및 Master 역할에 대한 출입 통제 설정 방법을 안내합니다.","keywords":["관리자","역할","출입 통제 설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"비상 호출 사용하기","permalink":"/docs/ja/platform/biostar_air/managing-roll-call-fire-muster"},"next":{"title":"사이트 설정하기","permalink":"/docs/ja/platform/biostar_air/site-settings"}}')
...
const frontMatter = {
	...
	title: '관리자 관리하기',
	description: 'BioStar Air에서 관리자 초대, 역할 등급 지정, 권한 관리, Observer, Operator, Administrator 및 Master 역할에 대한 출입 통제 설정 방법을 안내합니다.',
	keywords: [
		'관리자',
		'역할',
		'출입 통제 설정'
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "각 관리자 등급은 BioStar Air 전반에 걸쳐 서로 다른 권한을 가지고 있습니다. Observer는 가장 제한된 접근을 가지며, 화면에 나타나지 않는 제한된 메뉴가 있습니다."
    })]
  });
}
