...
95489: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_platform_biostar_air_06_user_management_managing_user_groups_mdx_ccd_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-user-groups","title":"사용자 그룹 관리하기","description":"BioStar Air에서 효율적인 사용자 분류 및 출입 통제 관리를 위해 사용자 그룹과 하위 그룹을 생성 및 구성, 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/06-user-management-managing-user-groups.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-user-groups","permalink":"/docs/ja/platform/biostar_air/managing-user-groups","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/06-user-management-managing-user-groups.mdx","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"id":"managing-user-groups","title":"사용자 그룹 관리하기","description":"BioStar Air에서 효율적인 사용자 분류 및 출입 통제 관리를 위해 사용자 그룹과 하위 그룹을 생성 및 구성, 관리하는 방법을 안내합니다.","keywords":["사용자 관리","BioStar Air","사용자 그룹"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"일괄 작업으로 사용자 추가하기","permalink":"/docs/ja/platform/biostar_air/adding-users-in-bulk"},"next":{"title":"카드 템플릿 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-card-templates"}}')
