...
var site_docs_platform_biostar_air_overview_compatibility_mdx_e0b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/access-control-hardware-compatibility","title":"지원 장치","description":"BioStar Air는 슈프리마 및 모카(MOCA) 시스템의 장치와 원활하게 통합되어 클라우드 기반 출입 관리가 가능합니다.","source":"@site/docs/platform/biostar_air/overview-compatibility.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/access-control-hardware-compatibility","permalink":"/docs/ja/platform/biostar_air/access-control-hardware-compatibility","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/overview-compatibility.mdx","tags":[],"version":"current","frontMatter":{"id":"access-control-hardware-compatibility","title":"지원 장치","description":"BioStar Air는 슈프리마 및 모카(MOCA) 시스템의 장치와 원활하게 통합되어 클라우드 기반 출입 관리가 가능합니다.","keywords":["BioStar Air","출입 통제","장치 호환성"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"BioStar Air란?","permalink":"/docs/ja/platform/biostar_air/what-is-biostar-air"},"next":{"title":"보안 체계","permalink":"/docs/ja/platform/biostar_air/security-overview"}}')
