...
var site_docs_platform_biostar_air_managing_administrators_mdx_c7b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-administrators","title":"관리자 계정 및 역할 관리하기","description":"BioStar Air에서 관리자 초대, 역할 등급 지정, 권한 관리, 옵저버(Observer), 오퍼레이터(Operator), 관리자(Administrator) 및 마스터(Master) 역할에 대한 출입 통제 설정 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/managing-administrators.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-administrators","permalink":"/docs/ja/platform/biostar_air/managing-administrators","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-administrators.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-administrators","title":"관리자 계정 및 역할 관리하기","description":"BioStar Air에서 관리자 초대, 역할 등급 지정, 권한 관리, 옵저버(Observer), 오퍼레이터(Operator), 관리자(Administrator) 및 마스터(Master) 역할에 대한 출입 통제 설정 방법을 안내합니다.","keywords":["관리자","역할","출입 통제 설정"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"추가 기능 설정하기","permalink":"/docs/ja/platform/biostar_air/site-additional-settings"},"next":{"title":"개인 계정 설정하기","permalink":"/docs/ja/platform/biostar_air/account-settings"}}')
