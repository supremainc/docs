...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_system_audit_trail_mdx_e55_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-system-audit-trail","title":"監査履歴を管理する​","description":"ユーザーの接続情報だけでなく、システムで変更されるすべての情報を追跡できます。​","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-system-audit-trail.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-system-audit-trail","permalink":"/docs/ja/platform/biostar_x/settings-system-audit-trail","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-system-audit-trail.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-system-audit-trail","title":"監査履歴を管理する​","description":"ユーザーの接続情報だけでなく、システムで変更されるすべての情報を追跡できます。​","keywords":["監査履歴​","システム変更履歴​","audit trail​","ログ管理​","セキュリティ監査​","システム監視​"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"システム設定","permalink":"/docs/ja/platform/biostar_x/settings-system"},"next":{"title":"システムをバックアップする","permalink":"/docs/ja/platform/biostar_x/settings-system-system-backup"}}')
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(Cmd, {
        ...
        product: "2"
      }), " オプションをクリックして、監査履歴を次の動作タイプで分類します。"]
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: ["管理者レベルに応じて監査履歴を分類できます。 ", (0,jsx_runtime.jsx)(Cmd, {
        sid: "auditTrail.filter.title",
        product: "2"
      }), " セクションで ", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: "照会する期間を設定し、特定期間の監査履歴履歴を確認します。​"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "事前定義された期間で照会",
      ...
      children: "監査履歴一覧を効率的に閲覧できるよう、さまざまな条件でフィルターします。​"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: [(0,jsx_runtime.jsx)(Cmd, {
        sid: "auditTrail.filter.title",
        product: "2"
      }), " セクションで次のオプションを設定できます。​ フィルターオプションは監査履歴一覧の列項目と一致します。​ ただし、", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: "監査履歴の一覧をCSVファイルにエクスポートし、外部分析ツールで活用します。​"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["CSV エクスポートウィンドウが表示されたら、", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: [(0,jsx_runtime.jsx)(Column, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.p, {
          children: ["監査履歴リストの列の位置を変更したり、非表示にしたりできます。 ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "auditTrail.filter.title",
            product: "2"
      ...
      children: "監査履歴で記録されるすべてのアクティビティをカテゴリ別に整理しました。 各項目をクリックして詳細を確認します。"
