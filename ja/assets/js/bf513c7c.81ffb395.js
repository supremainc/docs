...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_site_additional_settings_mdx_bf5_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-additional-settings","title":"Settings for Additional Features","description":"This guide explains how to enable and configure BioStar Air\'s additional features, such as QR code readers, IP camera integration, and webhooks.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/site-additional-settings.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-additional-settings","permalink":"/docs/ja/platform/biostar_air/site-additional-settings","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-additional-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"site-additional-settings","title":"Settings for Additional Features","description":"This guide explains how to enable and configure BioStar Air\'s additional features, such as QR code readers, IP camera integration, and webhooks.","keywords":["Additional Site Settings","Additional Settings"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Security Settings","permalink":"/docs/ja/platform/biostar_air/site-security-settings"},"next":{"title":"Manage Administrator Accounts and Roles","permalink":"/docs/ja/platform/biostar_air/managing-administrators"}}')
...
const frontMatter = {
	...
	title: 'Settings for Additional Features',
