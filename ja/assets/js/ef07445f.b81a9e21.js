...
var site_docs_device_vionyx_webserver_getting_started_mdx_ef0_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/getting-started","title":"시작하기","description":"ViOnyx Web Server에 처음 로그인하고 비밀번호 설정하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/getting-started.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/getting-started","permalink":"/docs/ja/device/vionyx_webserver/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"시작하기","description":"ViOnyx Web Server에 처음 로그인하고 비밀번호 설정하는 방법을 안내합니다.","keywords":["ViOnyx","Web Server","시작하기"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"ViOnyx Web Server","permalink":"/docs/ja/device/vionyx_webserver/"},"next":{"title":"사용자 인터페이스 이해하기","permalink":"/docs/ja/device/vionyx_webserver/ui-navigation"}}')
