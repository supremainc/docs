...
var site_docs_platform_biostar_air_user_management_user_list_mdx_310_namespaceObject = JSON.parse('{"id":"platform/biostar_air/user-management-user-list","title":"사용자 관리하기","description":"BioStar Air에 등록된 사용자를 효율적으로 관리합니다. 사용자 목록 조회, 필터링, 세부 정보 편집, 그룹 및 출입 레벨 할당, 크리덴셜 발급, 일괄 작업 및 리포트 생성 등의 기능을 통해 조직 내 모든 사용자를 관리할 수 있습니다.","source":"@site/docs/platform/biostar_air/user-management-user-list.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/user-management-user-list","permalink":"/docs/ja/platform/biostar_air/user-management-user-list","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/user-management-user-list.mdx","tags":[],"version":"current","frontMatter":{"id":"user-management-user-list","title":"사용자 관리하기","description":"BioStar Air에 등록된 사용자를 효율적으로 관리합니다. 사용자 목록 조회, 필터링, 세부 정보 편집, 그룹 및 출입 레벨 할당, 크리덴셜 발급, 일괄 작업 및 리포트 생성 등의 기능을 통해 조직 내 모든 사용자를 관리할 수 있습니다.","keywords":["BioStar Air","사용자 관리","사용자 목록","크리덴셜","출입 레벨","사용자 그룹","리포트"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"사용자 추가하기","permalink":"/docs/ja/platform/biostar_air/adding-individual-users"},"next":{"title":"일괄 작업으로 사용자 추가하기","permalink":"/docs/ja/platform/biostar_air/adding-users-in-bulk"}}')
...
function _createMdxContent(props) {
  const _components = {
    ...
    ...props.components
  }, {Cmd, DocLink, IcAirActive, IcAirDown, IcAirEdit, IcAirFaceLink, IcAirFilter, IcAirFilterReset, IcAirGroup, IcAirLock, IcAirMask, IcAirMore, IcAirMtag, IcAirReissue, IcAirRemove, IcAirReport, IcAirSuspend, IcAirUpface, IcAirUtemplate, Image} = _components;
