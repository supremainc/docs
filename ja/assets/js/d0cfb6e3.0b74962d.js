...
var site_docs_platform_biostar_x_settings_credential_ir_face_group_matching_mdx_d0c_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-credential-ir-face-group-matching","title":"IR 페이스 그룹 매칭 설정하기","description":"사용자 그룹을 기반으로 매칭 그룹을 설정하여 사용자를 인증하는 IR 페이스 그룹 매칭 기능을 안내합니다.","source":"@site/docs/platform/biostar_x/settings-credential-ir-face-group-matching.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-credential-ir-face-group-matching","permalink":"/docs/ja/platform/biostar_x/settings-credential-ir-face-group-matching","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-credential-ir-face-group-matching.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-credential-ir-face-group-matching","title":"IR 페이스 그룹 매칭 설정하기","description":"사용자 그룹을 기반으로 매칭 그룹을 설정하여 사용자를 인증하는 IR 페이스 그룹 매칭 기능을 안내합니다.","keywords":["IR 페이스 그룹 매칭","인증"],"isTranslationMissing":true},"sidebar":"biostarx","previous":{"title":"モバイルアクセスカードを管理する","permalink":"/docs/ja/platform/biostar_x/settings-credential-mobile-access-card"},"next":{"title":"カードを印刷する","permalink":"/docs/ja/platform/biostar_x/settings-card-printer"}}')
