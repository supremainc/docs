"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["61262"], {
90150: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_rfid_devices_funcs_mdx_841_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-reference-compares-rfid-devices-funcs-mdx-841.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_rfid_devices_funcs_mdx_841_namespaceObject = JSON.parse('{"id":"reference/compares/rfid-devices-funcs","title":"機能比較","description":"🔶: 製品の詳細モデルによってサポート対象が異なる場合があります。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/rfid-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/rfid-devices-funcs","permalink":"/docs/ja/reference/compares/rfid-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/rfid-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"rfid-devices-funcs","title":"機能比較","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"仕様比較","permalink":"/docs/ja/reference/compares/face-devices-specs"},"next":{"title":"仕様比較","permalink":"/docs/ja/reference/compares/rfid-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/rfid-devices-funcs.mdx
...
const contentTitle = 'RFIDデバイス機能比較';
