...
var site_docs_platform_biostar_air_18_advanced_features_managing_roll_call_and_fire_muster_mdx_f21_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-roll-call-fire-muster","title":"비상 호출 사용하기","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/18-advanced-features-managing-roll-call-and-fire-muster.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-roll-call-fire-muster","permalink":"/docs/ja/platform/biostar_air/managing-roll-call-fire-muster","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/18-advanced-features-managing-roll-call-and-fire-muster.mdx","tags":[],"version":"current","sidebarPosition":18,"frontMatter":{"id":"managing-roll-call-fire-muster","title":"비상 호출 사용하기","description":"BioStar Air에서 소집 구역 설정, 비상 점호 시작, 사용자 안전 상태 추적, 점호 내역 보고서를 생성하는 방법을 안내합니다.","keywords":["Roll call","비상 호출","화재 소집 구역","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"알림 & 리포트 이력 확인하기","permalink":"/docs/ja/platform/biostar_air/monitoring-alert-report-history"},"next":{"title":"관리자 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-administrators"}}')
