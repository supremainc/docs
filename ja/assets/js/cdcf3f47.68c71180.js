...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_fingerprint_devices_funcs_mdx_cdc_namespaceObject = JSON.parse('{"id":"reference/compares/fingerprint-devices-funcs","title":"機能比較","description":"🔶: 製品の詳細モデルによってサポート対象が異なる場合があります。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/fingerprint-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/fingerprint-devices-funcs","permalink":"/docs/ja/reference/compares/fingerprint-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/fingerprint-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"fingerprint-devices-funcs","title":"機能比較","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"製品機能と仕様比較","permalink":"/docs/ja/reference/compares/"},"next":{"title":"仕様比較","permalink":"/docs/ja/reference/compares/fingerprint-devices-specs"}}')
...
const contentTitle = '指紋認証装置の機能比較​';
