...
var site_docs_platform_biostar_air_manage_device_mdx_b34_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-device","title":"장치","description":"BioStar Air에서 장치 생명주기를 관리하는 모든 방법을 안내합니다. 장치 등록부터 세부 설정 구성, 그룹 관리, 펌웨어 업그레이드, 그리고 생체 인식 및 보안 모듈 구성까지 장치를 효율적으로 운영하는 전체 과정을 다룹니다.","source":"@site/docs/platform/biostar_air/manage-device.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-device","permalink":"/docs/ja/platform/biostar_air/manage-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-device.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device","title":"장치","description":"BioStar Air에서 장치 생명주기를 관리하는 모든 방법을 안내합니다. 장치 등록부터 세부 설정 구성, 그룹 관리, 펌웨어 업그레이드, 그리고 생체 인식 및 보안 모듈 구성까지 장치를 효율적으로 운영하는 전체 과정을 다룹니다.","keywords":["장치 관리","장치 등록","장치 설정","장치 그룹","펌웨어 업그레이드","생체 인식","근태 관리","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"링크패스 크리덴셜","permalink":"/docs/ja/platform/biostar_air/linkpass-credentials"},"next":{"title":"등록 장치 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-registered-devices"}}')
