"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["82949"], {
...
11088: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_2_getting_started_mdx_046_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-xpass-2-getting-started-mdx-046.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_2_getting_started_mdx_046_namespaceObject = JSON.parse('{"id":"device/xpass_2/getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_2/getting-started.mdx","sourceDirName":"device/xpass_2","slug":"/device/xpass_2/getting-started","permalink":"/docs/ja/device/xpass_2/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xpass_2/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","keywords":["同梱物","名称","機能","ケーブル","コネクター"],"isTranslationMissing":false},"sidebar":"xpass2","previous":{"title":"安全のための注意事項","permalink":"/docs/ja/device/xpass_2/safety-instructions"},"next":{"title":"インストール","permalink":"/docs/ja/device/xpass_2/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_2/getting-started.mdx
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsxs)(Tbody, {
        children: [(0,jsx_runtime.jsxs)(Row, {
          ...
          className: "center",
          children: [(0,jsx_runtime.jsx)(Td, {
            children: "XPass 2 マリオンタイプ (XP2-MDPB, XP2-MAPB, XP2-MAPB-H)"
          }), (0,jsx_runtime.jsxs)(Td, {
            children: ["壁掛け用ブラケット (XP2-MDPB,", (0,jsx_runtime.jsx)("br", {}), "XP2-MAPB, XP2-MAPB-H)"]
          }), (0,jsx_runtime.jsx)(Td, {
            children: "XPass 2 ギャングボックスタイプ (XP2-GDPB)"
          }), (0,jsx_runtime.jsx)(Td, {
            children: "壁掛け用ブラケット (XP2-GDPB)"
          })]
        })]
        ...
        children: [(0,jsx_runtime.jsxs)(Row, {
          ...
          className: "center",
          children: [(0,jsx_runtime.jsx)(Td, {
            children: "XPass 2 キーパッドタイプ (XP2-GKDPB)"
          }), (0,jsx_runtime.jsx)(Td, {
            children: "壁掛け用ブラケット (XP2-GKDPB)"
          }), (0,jsx_runtime.jsx)(Td, {
            children: "固定用ネジ ×2"
          }), (0,jsx_runtime.jsx)(Td, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: "電源 / RS-485 / イーサネット / Wiegand 入出力 / 入力 / リレー"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            only: true,
            children: "XP2-GKDPB"
          }), " カードIDを直接入力して認証するときに使用します。 直接入力方式で認証するには、BioStar X で認証方法の設定を変更してください。"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(_components.strong, {
