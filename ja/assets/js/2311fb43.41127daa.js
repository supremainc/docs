...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_monitoring_event_logs_mdx_231_namespaceObject = JSON.parse('{"id":"platform/biostar_air/monitoring-event-logs","title":"Use Event Logs","description":"This guide explains how to monitor and analyze event logs in BioStar Air, apply filters, export data, and track administrative activity.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/monitoring-event-logs.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/monitoring-event-logs","permalink":"/docs/ja/platform/biostar_air/monitoring-event-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/monitoring-event-logs.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-event-logs","title":"Use Event Logs","description":"This guide explains how to monitor and analyze event logs in BioStar Air, apply filters, export data, and track administrative activity.","keywords":["Monitoring","Event Logs","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Monitoring","permalink":"/docs/ja/platform/biostar_air/monitoring"},"next":{"title":"Use Audit Logs","permalink":"/docs/ja/platform/biostar_air/monitoring-audit-logs"}}')
