"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["89275"], {
...
23025: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_doorinterface_installation_mdx_861_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-doorinterface-installation-mdx-861.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_doorinterface_installation_mdx_861_namespaceObject = JSON.parse('{"id":"device/doorinterface/installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/doorinterface/installation.mdx","sourceDirName":"device/doorinterface","slug":"/device/doorinterface/installation","permalink":"/docs/ja/device/doorinterface/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/doorinterface/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","keywords":["インストール","Door Interface","デバイス"],"isTranslationMissing":false},"sidebar":"doorinterface","previous":{"title":"はじめに","permalink":"/docs/ja/device/doorinterface/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/doorinterface/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/doorinterface/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "電源接続に使用するケーブルの規格と設置環境によって、接続できる距離が異なる場合があります。 正しく接続しないと装置が誤動作する恐れがあるため、注意してください。 本製品はDC12VとDC24Vの両電源に対応しています。ケーブル規格ごとの最大延長距離を確認し、正しく電源を接続してください。"
      ...
      children: "本製品はRS-485ポートを3つ搭載しており、マスター装置に複数のDoor Interfaceをデイジーチェーン接続することで、最大34ドアの構成が可能です。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "RS-485ポートに接続できるスレーブ装置は最大4台です。"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
