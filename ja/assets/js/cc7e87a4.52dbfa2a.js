...
var site_docs_platform_biostar_air_site_setup_networking_mdx_cc7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-setup-networking","title":"네트워크 포트 및 장치 식별하기","description":"BioStar Air 호환 장치의 네트워크 포트를 설정하고 MAC 주소를 확인하세요.","source":"@site/docs/platform/biostar_air/site-setup-networking.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-setup-networking","permalink":"/docs/ja/platform/biostar_air/site-setup-networking","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-setup-networking.mdx","tags":[],"version":"current","frontMatter":{"id":"site-setup-networking","title":"네트워크 포트 및 장치 식별하기","description":"BioStar Air 호환 장치의 네트워크 포트를 설정하고 MAC 주소를 확인하세요.","keywords":["networking","ports"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"E200 QR Scanner 배선 및 구성하기","permalink":"/docs/ja/platform/biostar_air/e200-qr-scanner"},"next":{"title":"인증된 사용자","permalink":"/docs/ja/platform/biostar_air/credential-users-guide"}}')
