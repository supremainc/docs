...
var site_docs_platform_biostar_air_integration_quickstart_mdx_19b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/integration-quickstart","title":"API 통합 시작하기","description":"BioStar Air 데모 사이트 설정, 호환 리더기 등록, API 키 생성, 클라우드 API와의 통합 테스트 방법을 알아보세요.","source":"@site/docs/platform/biostar_air/integration-quickstart.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/integration-quickstart","permalink":"/docs/ja/platform/biostar_air/integration-quickstart","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/integration-quickstart.mdx","tags":[],"version":"current","frontMatter":{"id":"integration-quickstart","title":"API 통합 시작하기","description":"BioStar Air 데모 사이트 설정, 호환 리더기 등록, API 키 생성, 클라우드 API와의 통합 테스트 방법을 알아보세요.","keywords":["API 통합","빠른 시작","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"Federated 사이트","permalink":"/docs/ja/platform/biostar_air/federated-sites"},"next":{"title":"E200 QR Scanner 배선 및 구성","permalink":"/docs/ja/platform/biostar_air/wiring-and-configuration"}}')
