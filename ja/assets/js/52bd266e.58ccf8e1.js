"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["13052"], {
46299: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_video_troubleshooting_mdx_52b_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-platform-biostar-air-video-troubleshooting-mdx-52b.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_video_troubleshooting_mdx_52b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/video-troubleshooting","title":"ビデオ再生のトラブルシューティング","description":"BioStar Airでのビデオ再生問題のトラブルシューティングと、ONVIF Profile Gのサポート可否、コーデック互換性、SDカードのフォーマットに関する問題の解決方法を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/video-troubleshooting.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/video-troubleshooting","permalink":"/docs/ja/platform/biostar_air/video-troubleshooting","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/video-troubleshooting.mdx","tags":[],"version":"current","frontMatter":{"id":"video-troubleshooting","title":"ビデオ再生のトラブルシューティング","description":"BioStar Airでのビデオ再生問題のトラブルシューティングと、ONVIF Profile Gのサポート可否、コーデック互換性、SDカードのフォーマットに関する問題の解決方法を案内します。","keywords":["IPカメラ","録画ビデオの再生","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"位置サービスを有効にする必要がありますか？","permalink":"/docs/ja/platform/biostar_air/location-services-issues"},"next":{"title":"リリースノート","permalink":"/docs/ja/platform/biostar_air/release-notes"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/video-troubleshooting.mdx
