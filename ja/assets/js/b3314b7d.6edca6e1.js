"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["85902"], {
...
44962: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_corestation_20_installation_mdx_b33_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-corestation-20-installation-mdx-b33.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_corestation_20_installation_mdx_b33_namespaceObject = JSON.parse('{"id":"device/corestation_20/installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/corestation_20/installation.mdx","sourceDirName":"device/corestation_20","slug":"/device/corestation_20/installation","permalink":"/docs/ja/device/corestation_20/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/corestation_20/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","keywords":["インストール","CoreStation 20","デバイス"],"isTranslationMissing":false},"sidebar":"corestation20","previous":{"title":"はじめに","permalink":"/docs/ja/device/corestation_20/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/corestation_20/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/corestation_20/installation.mdx
...
const toc = [{
  ...
  "value": "SAM カードスロット <Badge>CS-20P</Badge>",
  "id": "sam-カードスロット-cs-20p",
  "level": 2
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "取り付け位置で固定用ネジを使用して製品をしっかり固定してください。"
      ...
      children: [(0,jsx_runtime.jsx)(_components.thead, {
        children: (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.th, {
            ...
            children: "リーダー（最大電流、台数）"
          }), (0,jsx_runtime.jsx)(_components.th, {
            children: "ロック（最大電流、台数）"
          })]
        })
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            ...
            children: "600mA（300mA × 2台）"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "1.2A（600mA × 2台）"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "DC 24V"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "300mA（150mA × 2台）"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "600mA（300mA × 2台）"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
      ...
      children: "電源接続に使用するケーブルの規格と設置環境によって、接続できる距離が異なる場合があります。 正しく接続しないと装置が誤動作する恐れがあるため、注意してください。 本製品は DC 12V、DC 24V、PoE+ の電源にすべて対応しています。ケーブル規格ごとの最大延長距離を確認して、電源を正しく接続してください。"
      ...
      children: "本製品は RS-485 ポートを 3 つサポートしており、Door Interface をデイジーチェーン接続すると最大 34 のドアを構成できます。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "本製品に接続できる RS-485 デバイスは合計 84 台を超えることはできません。 （Door Interface を含む）"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "RS-485 0 ポートおよび RS-485 1 ポートには、ポートあたり最大 2 台のデバイスを接続できます。"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "1 つの RS-485 ポートに 3 台以上のデバイスが接続されている場合、スレーブデバイスを検索するときに目的のデバイスが接続可能リストに表示されないことがあります。"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      id: "sam-カードスロット-cs-20p",
      children: ["SAM カードスロット ", (0,jsx_runtime.jsx)(Badge, {
        only: true,
        children: "CS-20P"
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "SAM（Secure Access Module）カードを使用できます。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(Badge, {
          only: true,
          children: "CS-20P"
        }), " SAM カードを装着して使用している場合、CS-20P のリーダーポートに直接接続されたスレーブデバイスのみ使用できます。"]
      })
