...
44948: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  frontMatter: () => (/* binding */ _19_reports_configuring_reports_frontMatter),
  toc: () => (/* binding */ _19_reports_configuring_reports_toc),
  "default": () => (/* binding */ _19_reports_configuring_reports_MDXContent),
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_19_reports_configuring_reports_mdx_7b0_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ _19_reports_configuring_reports_contentTitle)
});
...
var site_docs_platform_biostar_air_19_reports_configuring_reports_mdx_7b0_namespaceObject = JSON.parse('{"id":"platform/biostar_air/configuring-reports","title":"리포트 구성하기","description":"BioStar Air에서 자동 이메일 전송을 통해 사용자 리포트, 이벤트 로그 리포트, 변경 로그 리포트 생성 및 필터링, 예약하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/19-reports-configuring-reports.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/configuring-reports","permalink":"/docs/ja/platform/biostar_air/configuring-reports","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/19-reports-configuring-reports.mdx","tags":[],"version":"current","sidebarPosition":19,"frontMatter":{"id":"configuring-reports","title":"리포트 구성하기","description":"BioStar Air에서 자동 이메일 전송을 통해 사용자 리포트, 이벤트 로그 리포트, 변경 로그 리포트 생성 및 필터링, 예약하는 방법을 안내합니다.","keywords":["리포트","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"민감도 설정하기","permalink":"/docs/ja/platform/biostar_air/suprema-pass-app-sensitivity-settings"},"next":{"title":"근태 보고서 구성하기","permalink":"/docs/ja/platform/biostar_air/reports-time-attendance-reports"}}')
...
const _19_reports_configuring_reports_frontMatter = {
...
const _19_reports_configuring_reports_contentTitle = undefined;
...
const _19_reports_configuring_reports_toc = [..._biostarair_customer_notice/* .toc */.RM, {
  "value": "리포트 구성으로 이동",
...
function _19_reports_configuring_reports_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    h2: "h2",
  ...
  if (!Cmd) _19_reports_configuring_reports_missingMdxReference("Cmd", true);
  if (!IcAirReport) _19_reports_configuring_reports_missingMdxReference("IcAirReport", true);
  if (!Image) _19_reports_configuring_reports_missingMdxReference("Image", true);
...
function _19_reports_configuring_reports_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* .useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_19_reports_configuring_reports_createMdxContent, {
      ...props
    })
  }) : _19_reports_configuring_reports_createMdxContent(props);
}
function _19_reports_configuring_reports_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
