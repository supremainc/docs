...
var site_docs_device_vionyx_webserver_view_system_logs_mdx_2a1_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/view-system-logs","title":"시스템 로그 확인하기","description":"카메라의 접속, 이벤트, 시스템 로그를 조회하고 내보내는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/view-system-logs.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/view-system-logs","permalink":"/docs/ja/device/vionyx_webserver/view-system-logs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/view-system-logs.mdx","tags":[],"version":"current","frontMatter":{"id":"view-system-logs","title":"시스템 로그 확인하기","description":"카메라의 접속, 이벤트, 시스템 로그를 조회하고 내보내는 방법을 안내합니다.","keywords":["로그","시스템 로그","이벤트 로그","접속 로그","CSV","내보내기"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"운영자 추가하기","permalink":"/docs/ja/device/vionyx_webserver/add-operators"}}')
