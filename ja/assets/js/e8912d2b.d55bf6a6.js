...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_finger_rfid_devices_funcs_mdx_e89_namespaceObject = JSON.parse('{"id":"reference/compares/finger-rfid-devices-funcs","title":"Compare Features","description":"🔶: Support may vary depending on the product model.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/finger-rfid-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/finger-rfid-devices-funcs","permalink":"/docs/ja/reference/compares/finger-rfid-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/finger-rfid-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"finger-rfid-devices-funcs","title":"Compare Features","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"Compare Specifications","permalink":"/docs/ja/reference/compares/rfid-devices-specs"},"next":{"title":"Compare Specifications","permalink":"/docs/ja/reference/compares/finger-rfid-devices-specs"}}')
