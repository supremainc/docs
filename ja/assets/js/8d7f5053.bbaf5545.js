"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["64772"], {
...
30501: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_platform_biostar_air_location_services_issues_mdx_8d7_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-platform-biostar-air-location-services-issues-mdx-8d7.json
var site_docs_platform_biostar_air_location_services_issues_mdx_8d7_namespaceObject = JSON.parse('{"id":"platform/biostar_air/location-services-issues","title":"위치 서비스를 활성화해야 하나요?","description":"슈프리마 패스 앱에서 안전한 블루투스 통신 및 모바일 출입 카드 기능을 위해 위치 서비스를 활성화하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/location-services-issues.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/location-services-issues","permalink":"/docs/ja/platform/biostar_air/location-services-issues","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/location-services-issues.mdx","tags":[],"version":"current","frontMatter":{"id":"location-services-issues","title":"위치 서비스를 활성화해야 하나요?","description":"슈프리마 패스 앱에서 안전한 블루투스 통신 및 모바일 출입 카드 기능을 위해 위치 서비스를 활성화하는 방법을 안내합니다.","keywords":["위치 서비스","슈프리마 패스","Bluetooth"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"일괄 사용자 추가 문제","permalink":"/docs/ja/platform/biostar_air/troubleshooting-adding-users-in-bulk"},"next":{"title":"모바일 카드가 작동하지 않아요","permalink":"/docs/ja/platform/biostar_air/troubleshooting-suprema-pass-app"}}')
...
;// CONCATENATED MODULE: ./docs/platform/biostar_air/location-services-issues.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "모바일 기기의 슈프리마 패스 앱에서 모바일 출입 카드로 인증하려면 위치 서비스가 필요합니다. 이를 통해 모바일 기기와 출입 통제 장치 간의 안전한 블루투스 통신을 보장합니다."
