"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["58975"], {
...
2410: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_p_2_installation_mdx_0cc_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-bioentry-p-2-installation-mdx-0cc.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_p_2_installation_mdx_0cc_namespaceObject = JSON.parse('{"id":"device/bioentry_p2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_p2/installation.mdx","sourceDirName":"device/bioentry_p2","slug":"/device/bioentry_p2/installation","permalink":"/docs/ja/device/bioentry_p2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_p2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"bioentryp2","previous":{"title":"はじめに","permalink":"/docs/ja/device/bioentry_p2/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/bioentry_p2/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_p2/installation.mdx
