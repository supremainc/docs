...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_api_authentication_mdx_93e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/api-authentication","title":"API Authentication","description":"This article explains the BioStar Air Cloud API authentication flow, lists the API base URLs, describes how to issue Bearer tokens, and shows how to obtain a token from a browser.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/api-authentication.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/api-authentication","permalink":"/docs/ja/platform/biostar_air/api-authentication","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/api-authentication.mdx","tags":[],"version":"current","frontMatter":{"id":"api-authentication","title":"API Authentication","description":"This article explains the BioStar Air Cloud API authentication flow, lists the API base URLs, describes how to issue Bearer tokens, and shows how to obtain a token from a browser.","keywords":["API authentication","Bearer token","API base URL","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Quick Start","permalink":"/docs/ja/platform/biostar_air/integration-quickstart"},"next":{"title":"Using the User Management API","permalink":"/docs/ja/platform/biostar_air/api-user-management"}}')
