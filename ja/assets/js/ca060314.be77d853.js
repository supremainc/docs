"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["41238"], {
...
34581: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_securemodule_getting_started_mdx_ca0_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-securemodule-getting-started-mdx-ca0.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_securemodule_getting_started_mdx_ca0_namespaceObject = JSON.parse('{"id":"device/securemodule/getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/securemodule/getting-started.mdx","sourceDirName":"device/securemodule","slug":"/device/securemodule/getting-started","permalink":"/docs/ja/device/securemodule/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/securemodule/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","keywords":["同梱物","名称","機能","ケーブル","コネクター"],"isTranslationMissing":false},"sidebar":"securemodule","previous":{"title":"安全のための注意事項","permalink":"/docs/ja/device/securemodule/safety-instructions"},"next":{"title":"接続する","permalink":"/docs/ja/device/securemodule/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/securemodule/getting-started.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "本製品は RS-485 で接続し、コンパクトなためさまざまな場所に設置できます。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "ジャンクションボックスと一緒に設置したり、既存のウォールコントロールボックスに取り付けたりできます。 また、退出ボタンの背面にも設置できます。"
