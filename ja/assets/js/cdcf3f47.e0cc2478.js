"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["79634"], {
45096: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_fingerprint_devices_funcs_mdx_cdc_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-reference-compares-fingerprint-devices-funcs-mdx-cdc.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_fingerprint_devices_funcs_mdx_cdc_namespaceObject = JSON.parse('{"id":"reference/compares/fingerprint-devices-funcs","title":"Compare Features","description":"🔶: Support may vary depending on the product model.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/fingerprint-devices-funcs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/fingerprint-devices-funcs","permalink":"/docs/ja/reference/compares/fingerprint-devices-funcs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/fingerprint-devices-funcs.mdx","tags":[],"version":"current","frontMatter":{"id":"fingerprint-devices-funcs","title":"Compare Features","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"제품 기능 및 사양 비교","permalink":"/docs/ja/reference/compares/"},"next":{"title":"Compare Specifications","permalink":"/docs/ja/reference/compares/fingerprint-devices-specs"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/fingerprint-devices-funcs.mdx
