...
const frontMatter = {
	...
	title: '点呼招集',
	description: '点呼招集設定の方法を案内します。 緊急時にユーザーが集まる場所を設定し、特定の場所内の人数をモニタリングします。',
	keywords: [
		'高度なアクセス制御',
		'点呼招集'
	],
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "点呼招集は、緊急事態発生時の効果的な人員管理と安全確保のために必須の設定です。 この機能により、管理者は特定の場所を点呼招集地点として指定し、緊急時にユーザーが集まる場所を事前に定義できます。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "点呼招集設定は次の目的で活用します。"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "common.setting",
            product: "2"
          }), " セクションで、点呼招集設定の詳細項目を設定します。 詳しくは ", (0,jsx_runtime.jsx)(_components.a, {
            href: "#setting",
            children: "次のドキュメント"
          }), " を参照してください。"]
        }), "\n"]
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "common.alarm",
            product: "2"
          }), " セクションで、点呼招集設定で特定のイベントが発生したときに実行する動作を設定します。"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "zone.globalZone",
            product: "2"
          }), "：適用範囲を確認できます。 点呼招集設定は ", (0,jsx_runtime.jsx)(Cmd, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            ...
            product: "2"
          }), "：点呼招集場所に滞在するユーザーが属する入退室グループを設定します。 最大16個の入退室グループを設定できます。"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            ...
            product: "2"
          }), "：点呼招集場所に滞在できる最大時間を設定できます。 最大4320分まで設定でき、指定時間を超えてユーザーが点呼招集場所に滞在した場合にアラームが発生します。"]
        }), "\n"]
      }), "\n"]
