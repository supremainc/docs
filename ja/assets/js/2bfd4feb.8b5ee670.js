...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_remote_access_mdx_2bf_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-remote-access","title":"リモートアクセスを設定する","description":"ngrok サービス経由でリモートアクセスを設定する方法を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-remote-access.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-remote-access","permalink":"/docs/ja/platform/biostar_x/settings-remote-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-remote-access.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-remote-access","title":"リモートアクセスを設定する","description":"ngrok サービス経由でリモートアクセスを設定する方法を案内します。","keywords":["リモートアクセス","ngrok"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"ディレクトリ連携を設定する","permalink":"/docs/ja/platform/biostar_x/settings-diretory-integration"},"next":{"title":"仮想デバイスのイベントログを連携する","permalink":"/docs/ja/platform/biostar_x/settings-virtual-device-event-log"}}')
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["リモートアクセス（Remote Access）機能は、追加オプションで利用できます。 ライセンス ポリシーの詳細については、", (0,jsx_runtime.jsx)(_components.a, {
