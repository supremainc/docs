...
var site_docs_platform_biostar_air_managing_door_schedules_mdx_267_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-door-schedules","title":"출입문 스케줄 관리하기","description":"BioStar Air에서 자동화 출입문 스케줄을 만들고 구성하는 방법, 잠김 해제 및 잠김 시간 설정 방법, 인증 기반 출입 통제를 관리하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/managing-door-schedules.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-door-schedules","permalink":"/docs/ja/platform/biostar_air/managing-door-schedules","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-door-schedules.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-door-schedules","title":"출입문 스케줄 관리하기","description":"BioStar Air에서 자동화 출입문 스케줄을 만들고 구성하는 방법, 잠김 해제 및 잠김 시간 설정 방법, 인증 기반 출입 통제를 관리하는 방법을 안내합니다.","keywords":["출입문 스케줄","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문 그룹 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-door-groups"},"next":{"title":"엘리베이터 관리","permalink":"/docs/ja/platform/biostar_air/manage-elevator"}}')
