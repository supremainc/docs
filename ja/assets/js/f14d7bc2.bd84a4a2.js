"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["87641"], {
...
48728: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_biostation_3_installation_mdx_f14_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-biostation-3-installation-mdx-f14.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_biostation_3_installation_mdx_f14_namespaceObject = JSON.parse('{"id":"device/biostation_3/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/biostation_3/installation.mdx","sourceDirName":"device/biostation_3","slug":"/device/biostation_3/installation","permalink":"/docs/ja/device/biostation_3/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"biostation3","previous":{"title":"はじめに","permalink":"/docs/ja/device/biostation_3/getting-started"},"next":{"title":"使用","permalink":"/docs/ja/device/biostation_3/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/biostation_3/installation.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ケーブルカバーを取り付けた後、カバーに差し込まれている6本のネジを締めてしっかり固定します。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
