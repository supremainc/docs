"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["59836"], {
...
86885: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_s_2_installation_mdx_0d7_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-xpass-s-2-installation-mdx-0d7.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_s_2_installation_mdx_0d7_namespaceObject = JSON.parse('{"id":"device/xpass_s2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_s2/installation.mdx","sourceDirName":"device/xpass_s2","slug":"/device/xpass_s2/installation","permalink":"/docs/ja/device/xpass_s2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xpass_s2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","拡張ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xpasss2","previous":{"title":"はじめに","permalink":"/docs/ja/device/xpass_s2/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/xpass_s2/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_s2/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "拡張ブラケットに含まれている固定用ネジを使用して、通常ブラケットと拡張ブラケットを組み立ててください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "製品を取り付ける位置に固定用ネジを使用して、拡張ブラケットをしっかり固定してください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "固定された拡張ブラケットの上に製品を取り付けてください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "製品固定用ネジを締めて、製品と拡張ブラケットを組み立ててください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
          ...
          type: "info",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "拡張ブラケットと製品を組み立てる際、セキュリティを強化するために製品固定用ネジの代わりに同梱のブラケット固定用ネジ（星形）を使用できます。"
          })
        }), "\n"]
      }), "\n"]
