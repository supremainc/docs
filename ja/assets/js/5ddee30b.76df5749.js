"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["44588"], {
...
51583: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_inputmodule_installation_mdx_5dd_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-inputmodule-installation-mdx-5dd.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_inputmodule_installation_mdx_5dd_namespaceObject = JSON.parse('{"id":"device/inputmodule/installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/inputmodule/installation.mdx","sourceDirName":"device/inputmodule","slug":"/device/inputmodule/installation","permalink":"/docs/ja/device/inputmodule/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/inputmodule/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"製品の設置に必要な全工程と接続例を提供します。","keywords":["インストール","電源","RS-485","リレー","スーパーバイズド入力","タンパー","エンクロージャ","AUX"],"isTranslationMissing":false},"sidebar":"inputmodule","previous":{"title":"はじめに","permalink":"/docs/ja/device/inputmodule/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/inputmodule/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/inputmodule/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      id: "スーパーバイズド入力の接続",
      children: "スーパーバイズド入力の接続"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["火災検知センサー、温度検知センサー、防犯センサー、ドアセンサー、退室ボタンなどを接続できます。 ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "SUPERVISED INPUT"
      }), " 0〜11 端子は回路の電圧を検知して装置の断線、短絡、オン、オフ状態を監視でき、一般的な入力として使用することもできます。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "BioStar X で製品の状態別動作を設定し、入力状態を監視できます。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "マスター装置の入力ポートに接続されている機器に、本製品の入力を重複して接続しないでください。"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "本製品は 1㏀、2.2㏀、4.7㏀、10㏀ の抵抗を接続して使用できます。 接続する入力機器に適切な抵抗を取り付けた後、BioStar X で抵抗値を同じ値に設定してください。"
          }), "\n"]
        }), "\n"]
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "外部要因により製品が設置場所から外れた場合、警報を鳴らす、またはイベントログを残すことができます。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
