...
var site_docs_platform_biostar_air_manage_alarm_zone_mdx_51b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-alarm-zone","title":"경비 구역 관리","description":"경비 구역을 추가하고 수정, 삭제하는 관리 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-alarm-zone.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-alarm-zone","permalink":"/docs/ja/platform/biostar_air/manage-alarm-zone","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-alarm-zone.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-alarm-zone","title":"경비 구역 관리","description":"경비 구역을 추가하고 수정, 삭제하는 관리 방법을 안내합니다.","keywords":["BioStar Air","경비 구역 관리"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"층 레벨 관리하기","permalink":"/docs/ja/platform/biostar_air/manage-floor-level"},"next":{"title":"이벤트 및 변경 로그 사용하기","permalink":"/docs/ja/platform/biostar_air/monitoring-event-and-audit-logs"}}')
