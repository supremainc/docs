"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["4618"], {
...
86915: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_2_installation_mdx_0da_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-bioentry-w-2-installation-mdx-0da.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_2_installation_mdx_0da_namespaceObject = JSON.parse('{"id":"device/bioentry_w2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w2/installation.mdx","sourceDirName":"device/bioentry_w2","slug":"/device/bioentry_w2/installation","permalink":"/docs/ja/device/bioentry_w2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_w2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"bioentryw2","previous":{"title":"はじめに","permalink":"/docs/ja/device/bioentry_w2/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/bioentry_w2/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w2/installation.mdx
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.ul, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "ワイヤレス電子製品は、物理的なクレデンシャルと同じ方法で使用しなければならず、近距離でユーザーデータを送信する必要があります。"
              }), "\n"]
            }), "\n"]
          })]
        }), "\n"]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
          children: "本Secure I/O 2接続方法に関する説明は、UL294規格による評価を受けていない内容です。"
        }), "\n"]
      })
