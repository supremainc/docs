...
var site_docs_platform_biostar_air_manage_device_with_app_mdx_e3d_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-device-with-app","title":"장치 등록 및 삭제하기","description":"BioStar Air 모바일 앱을 통해 장치를 등록 및 제거, 펌웨어 업그레이드 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/manage-device-with-app.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-device-with-app","permalink":"/docs/ja/platform/biostar_air/manage-device-with-app","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-device-with-app.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-device-with-app","title":"장치 등록 및 삭제하기","description":"BioStar Air 모바일 앱을 통해 장치를 등록 및 제거, 펌웨어 업그레이드 방법을 안내합니다.","keywords":["BioStar Air","장치 등록","모바일 앱"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"장치","permalink":"/docs/ja/platform/biostar_air/manage-device"},"next":{"title":"등록 장치 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-registered-devices"}}')
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "장치를 BioStar Air에 추가하려면 BioStar Air 모바일 앱을 사용해야 합니다. 모바일 앱에서는 무선 연결을 통해 새로운 장치를 등록하거나 기존 장치를 제거할 수 있으며, 펌웨어를 업그레이드할 수도 있습니다."
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "X-Station 2 제외한 장치는 BioStar Air 포털에서 삭제할 수 있습니다. 단, 장치는 온라인 상태여야 합니다. BioStar Air 모바일 앱을 사용하여 장치를 삭제할 것을 권장합니다."
      })
    })]
  });
}
