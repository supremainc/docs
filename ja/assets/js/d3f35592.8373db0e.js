...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_site_setup_networking_mdx_d3f_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-setup-networking","title":"Identify Network Ports and Devices","description":"Set network ports for BioStar Air-compatible devices and check MAC addresses.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/site-setup-networking.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-setup-networking","permalink":"/docs/ja/platform/biostar_air/site-setup-networking","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-setup-networking.mdx","tags":[],"version":"current","frontMatter":{"id":"site-setup-networking","title":"Identify Network Ports and Devices","description":"Set network ports for BioStar Air-compatible devices and check MAC addresses.","keywords":["networking","ports"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Wiring and Configuring the E200 QR Scanner","permalink":"/docs/ja/platform/biostar_air/e200-qr-scanner"},"next":{"title":"Credential User","permalink":"/docs/ja/platform/biostar_air/credential-users-guide"}}')
...
const frontMatter = {
	...
	title: 'Identify Network Ports and Devices',
	description: 'Set network ports for BioStar Air-compatible devices and check MAC addresses.',
	keywords: [
		'networking',
		'ports'
	],
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "BioStar Air and compatible devices must access specific network ports for seamless connection. Network ports allow secure communication between compatible devices, cloud services, and user applications. Administrators may need to verify a BioStar Air-compatible device's MAC address from its serial number for network configuration tasks."
