...
var site_docs_platform_biostar_air_integration_quickstart_mdx_19b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/integration-quickstart","title":"빠른 시작하기","description":"BioStar Air 데모 환경 구성, 호환 장치 등록, API 키 발급 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/integration-quickstart.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/integration-quickstart","permalink":"/docs/ja/platform/biostar_air/integration-quickstart","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/integration-quickstart.mdx","tags":[],"version":"current","frontMatter":{"id":"integration-quickstart","title":"빠른 시작하기","description":"BioStar Air 데모 환경 구성, 호환 장치 등록, API 키 발급 방법을 안내합니다.","keywords":["API 통합","빠른 시작","BioStar Air","데모"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"개발자","permalink":"/docs/ja/platform/biostar_air/developer-guide"},"next":{"title":"API 인증하기","permalink":"/docs/ja/platform/biostar_air/api-authentication"}}')
