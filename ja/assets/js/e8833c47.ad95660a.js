"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["81427"], {
77091: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_add_sub_db_mdx_e88_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ add_sub_db_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-platform-biostar-x-add-sub-db-mdx-e88.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_add_sub_db_mdx_e88_namespaceObject = JSON.parse('{"id":"platform/biostar_x/add-sub-db","title":"補助データベースを追加する","description":"通信サーバーを追加した際にメインサーバーの負荷を軽減するため、通信サーバーと連携する補助データベースを追加して接続する方法を説明します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/add-sub-db.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/add-sub-db","permalink":"/docs/ja/platform/biostar_x/add-sub-db","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/add-sub-db.mdx","tags":[],"version":"current","frontMatter":{"id":"add-sub-db","title":"補助データベースを追加する","description":"通信サーバーを追加した際にメインサーバーの負荷を軽減するため、通信サーバーと連携する補助データベースを追加して接続する方法を説明します。","keywords":["データベース","追加","接続"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"データベースを変更する","permalink":"/docs/ja/platform/biostar_x/change-db"},"next":{"title":"ランチャー","permalink":"/docs/ja/platform/biostar_x/ui-launcher"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common/_bsx-sub-db-create-table-query-mariadb.mdx
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common/_bsx-sub-db-create-table-query-mssql.mdx
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/add-sub-db.mdx
...
const add_sub_db_toc = [{
  ...
  "value": "FederatedX 使用状況の確認",
  "id": "federatedx-使用状況の確認",
  "level": 4
}, {
  "value": "サーバーエイリアスの登録",
  "id": "サーバーエイリアスの登録",
  ...
  "value": "Service Manager 設定",
  "id": "service-manager-設定",
  "level": 4
}, {
  "value": "SQL Server",
  "id": "sqlserver",
  ...
  "value": "Service Manager 設定",
  "id": "service-manager-設定-1",
  "level": 4
}, {
  "value": "Linked Temp Table クエリの生成",
  "id": "linked-temp-table-クエリの生成",
  "level": 4
}, ..._bsx_sub_db_create_table_query_mssql_toc, {
  "value": "補助データベースでクエリを実行",
  "id": "補助データベースでクエリを実行",
  "level": 4
}];
function add_sub_db_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "通信サーバーを追加した際にメインサーバーの負荷を軽減するため、通信サーバーと連携する補助データベースを追加して接続する方法を説明します。"
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["補助データベースを追加するには ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "マルチ通信サーバー"
            }), " ライセンスが必要です。 ライセンス ポリシーの詳細については、", (0,jsx_runtime.jsx)(_components.a, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["通信サーバーのインストールの詳細は", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "MariaDB を使用する環境でデータベース間通信に IP アドレスではなくドメインまたはホスト名を使用する場合は、次の案内事項を必ず確認してください。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["IP アドレスを使用しない場合、", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ドメインまたはホスト名で通信する場合は、必ず localhost に対してユーザーと権限が登録されていることを確認してください。"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["BioStar X を簡易インストール方式でインストールした場合、root アカウントは localhost のみユーザーと権限が登録されているため、当該サーバーの IP アドレスまたは ", (0,jsx_runtime.jsx)(_components.em, {
            children: "127.0.0.1"
          }), " で追加登録する必要があります。"]
        }), "\n"]
      }), "\n"]
      ...
      children: ["ホストが ", (0,jsx_runtime.jsx)(_components.em, {
        children: "127.0.0.1"
      }), " でユーザーが root のアカウントにパスワードが設定されているか確認し、設定されていない場合は必ずパスワードを設定して権限を付与してください。"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["ホストが ", (0,jsx_runtime.jsx)(_components.em, {
            children: "127.0.0.1"
          }), " でユーザーが root のアカウントにパスワードが設定されているか確認してください。"]
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: "空欄であればパスワードが設定されていないため、次の項目にあるクエリを実行してパスワードの追加と権限付与を必ず行ってください。"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["ホストが ", (0,jsx_runtime.jsx)(_components.em, {
            children: "127.0.0.1"
          }), " でユーザーが root のアカウントにパスワードを設定し、権限を付与してください。"]
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
      ...
      id: "ip-アドレスで通信を設定",
      children: "IP アドレスで通信を設定"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "以下の設定により、強制的に IP アドレスで通信するように設定できます。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            children: "BioStar X"
          }), " をインストールした後、次のパスに移動してください。"]
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.em, {
            children: "my.cnf"
          }), " ファイルを管理者権限で開き、[mysqld] セクションに ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "MariaDB サービスを再起動してください。"
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "add-sub-db",
      children: "補助データベースを追加"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "補助データベースを追加する方法を説明します。 使用するデータベースの種類に応じて、MariaDB と SQL Server の 2 通りの方法があります。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "mariadb",
      children: "MariaDB"
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: "新しい補助データベースからメインデータベースへアクセスできるように、アカウントと権限を付与してください。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: "メインデータベースから新しい補助データベースへアクセスできるように、アカウントと権限を付与してください。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "federatedx-使用状況の確認",
          children: "FederatedX 使用状況の確認"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "メインおよび補助データベースで以下のコマンドを実行し、FederatedX ストレージエンジンが有効になっているか確認してください。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: ["クエリ結果に ", (0,jsx_runtime.jsx)(_components.code, {
            children: "Engine : FEDERATED, Support : YES"
          }), " と表示されれば、すでにインストールされています。 FederatedX ストレージエンジンがインストールされていない場合は、以下のクエリを実行してください。"]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: (0,jsx_runtime.jsxs)(_components.p, {
            children: ["MariaDB をインストールしたパス配下の ", (0,jsx_runtime.jsx)(_components.em, {
              children: "lib/plugin"
            }), " フォルダーに ", (0,jsx_runtime.jsx)(_components.em, {
              children: "ha_federatedx.dll"
            }), " ファイルがあるか確認してください。 通常、", (0,jsx_runtime.jsx)(_components.em, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "サーバーエイリアスの登録",
          children: "サーバーエイリアスの登録"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "補助データベースに作成される FederatedX テーブルがメインデータベースの元テーブルにアクセスできるように、サーバーエイリアス(alias)を登録してください。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: ["既に登録したサーバー名の Host、Port、DB、User、Password の情報を変更する必要がある場合は、", (0,jsx_runtime.jsx)(_components.code, {
            children: "ALTER"
          }), " 文で修正できます。 一部の情報のみを変更することもできます。"]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: "補助データベースに必要なテーブルは、以下の順序で進めてメインデータベースのテーブルを補助データベースにリンク設定してください。"
        }), (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["以下はメインデータベースで ", (0,jsx_runtime.jsx)(_components.code, {
                children: "CREATE TABLE"
              }), " 文を生成するクエリです。"]
            }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
              ...
              type: "info",
              children: (0,jsx_runtime.jsxs)(_components.p, {
                children: ["FederatedX の特性上、", (0,jsx_runtime.jsx)(_components.code, {
                  children: "Table_type"
                }), " は 'BASE TABLE' に設定することを推奨します。 ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "VIEW"
                }), " タイプも可能ですが、推奨しません。"]
              })
            }), "\n"]
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["上記クエリで生成された以下の ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "CREATE"
                }), " 文を必ず補助データベースに入力してください。"]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "service-manager-設定",
          children: "Service Manager 設定"
        }), (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(_components.strong, {
                children: "BioStar X Service Manager"
              }), " を実行してください。 （", (0,jsx_runtime.jsx)(Start, {}), " → ", (0,jsx_runtime.jsx)(_components.strong, {
                children: "BioStar X"
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "データベース追加画面で各項目を入力してください。"
            }), "\n", (0,jsx_runtime.jsx)(Image, {
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
                ...
                children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                  children: [(0,jsx_runtime.jsx)(Cmd, {
                    children: "DB Type"
                  }), "：データベースの種類を選択します。 （MariaDB, MS SQL）"]
                }), "\n"]
              }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
                children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                  children: [(0,jsx_runtime.jsx)(Cmd, {
                ...
                children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                  children: [(0,jsx_runtime.jsx)(Cmd, {
                    ...
                    children: "TA"
                  }), "：AC、TA データベースの名前、ユーザー、パスワードを入力してください。"]
                }), "\n"]
              }), "\n"]
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["データベースが正常に接続されているか確認するには、画面右上の ", (0,jsx_runtime.jsx)(Cmd, {
      ...
      children: [(0,jsx_runtime.jsxs)(Step, {
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "メインデータベース権限付与",
          children: "メインデータベース権限付与"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "sysadmin 権限を持つアカウントでメインデータベースに以下の権限を付与してください。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "補助データベース権限付与",
          children: "補助データベース権限付与"
        }), (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["sysadmin 権限を持つアカウントで補助データベースにテーブルおよびユーザーの User Mapping 接続が必要です。 このとき ", (0,jsx_runtime.jsx)(_components.code, {
                children: "db_owner"
              }), " ロールの追加が必要です。"]
            }), "\n", (0,jsx_runtime.jsx)(Image, {
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "追加するデータベースに以下の権限を付与します。"
            }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-sql",
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "設定を完了すると、メインデータベースと補助データベースそれぞれに Linked Server 設定が自動で実行されます。"
              }), "\n"]
            }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
              children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
                children: "データベース情報を修正する際も、Linked Server 設定は自動で更新されます。 メインデータベースを修正すると、登録されているすべての補助データベースに対して Linked Server 設定が変更内容で反映されます。 補助データベースを修正すると、メインデータベースとその補助データベースのみに変更内容が反映されます。"
              }), "\n"]
            }), "\n"]
          })
        })]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "linked-temp-table-クエリの生成",
          children: "Linked Temp Table クエリの生成"
        }), (0,jsx_runtime.jsx)(_components.p, {
          children: "メインデータベースで次のクエリを実行し、補助データベースに作成する Linked Temp Table 用クエリを生成します。"
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
          ...
          children: (0,jsx_runtime.jsxs)(_components.admonition, {
            type: "info",
            children: [(0,jsx_runtime.jsxs)(_components.p, {
              children: ["上記のクエリで生成される ", (0,jsx_runtime.jsx)(_components.code, {
                children: "CREATE"
              }), " 文の例です。"]
        ...
        children: [(0,jsx_runtime.jsx)(_components.h4, {
          id: "補助データベースでクエリを実行",
          children: "補助データベースでクエリを実行"
        }), (0,jsx_runtime.jsxs)(_components.p, {
          children: ["先ほど生成した ", (0,jsx_runtime.jsx)(_components.code, {
            children: "CREATE SYNONYM"
          }), " クエリをすべてコピーします。 追加する補助データベースサーバーに接続し、以下のようにクエリを作成して実行します。 補助データベースの AC スキーマ内の Synonyms に保存されます。"]
        }), (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-sql",
