...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_settings_map_manage_floor_mdx_4bd_namespaceObject = JSON.parse('{"id":"platform/biostar_x/settings-map-manage-floor","title":"フロアを構成する","description":"区域と設備を構成する前にフロアを構成してください。 フロア画像にドアとカメラを配置して視覚的に確認できます。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/settings-map-manage-floor.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/settings-map-manage-floor","permalink":"/docs/ja/platform/biostar_x/settings-map-manage-floor","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/settings-map-manage-floor.mdx","tags":[],"version":"current","frontMatter":{"id":"settings-map-manage-floor","title":"フロアを構成する","description":"区域と設備を構成する前にフロアを構成してください。 フロア画像にドアとカメラを配置して視覚的に確認できます。","keywords":["マップ","フロア","施設","ドア","カメラ","配置図","画像"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"マップ管理","permalink":"/docs/ja/platform/biostar_x/settings-map-management"},"next":{"title":"施設を構成","permalink":"/docs/ja/platform/biostar_x/settings-map-manage-facility"}}')
...
const frontMatter = {
	...
	title: 'フロアを構成する',
	description: '区域と設備を構成する前にフロアを構成してください。 フロア画像にドアとカメラを配置して視覚的に確認できます。',
	keywords: [
		'マップ',
		'フロア',
		'施設',
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["区域と設備を構成する前にフロアを構成してください。 該当フロアの配置図を画像としてアップロードし、ドアとカメラを配置して視覚的に管理できます。 フロアを構成すると、", (0,jsx_runtime.jsx)(Cmd, {
        sid: "shell.header.arena"
      }), " ページで該当フロアのドアとカメラを確認できます。"]
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["フロアを構成する前に、先にドアを登録してください。 ドア登録の詳細については ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "フロアの配置図または3D鳥瞰図画像をアップロードしてフロアを追加し、ドアとカメラを配置できます。"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "setting.floor.configuration.section.title"
          }), " セクションにアップロードした画像にドアを追加するには、画像の任意の位置で右クリックし、", (0,jsx_runtime.jsx)(Cmd, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
            sid: "setting.floor.configuration.dialog.title.addDoor"
          }), " ウィンドウが表示されたら、登録済みのドアのいずれかを選択します。"]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
          src: "/img/biostarx-settings-map-add-floor-03.png"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["ドアを画像に配置するには、", (0,jsx_runtime.jsx)(Cmd, {
            sid: "common.apply"
          }), " ボタンをクリックします。"]
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "実際のフロアに配置されているドアとカメラを追加で配置してください。"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
            children: "フロアに配置されたドアとカメラの位置を変更するには、該当するドアまたはカメラをクリックしたまま、目的の位置へドラッグします。"
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["フロアに配置されたドアとカメラのアイコンおよび状態の詳細は、", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "ドアとカメラを追加したフロアの配置図を編集できます。 フロアの配置図を編集すると、ドアとカメラの位置を変更または削除できます。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmd, {
      ...
      children: ["フロア画像で削除したいドアまたはカメラの ", (0,jsx_runtime.jsx)(IcFremove, {}), " アイコンをクリックします。 該当するドアまたはカメラを削除できます。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "カメラ撮影範囲の設定",
      children: "カメラ撮影範囲の設定"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
