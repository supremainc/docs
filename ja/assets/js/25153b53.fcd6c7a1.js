"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["42050"], {
56126: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_elevator_set_floor_aceess_mdx_251_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-platform-biostar-air-elevator-set-floor-aceess-mdx-251.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_elevator_set_floor_aceess_mdx_251_namespaceObject = JSON.parse('{"id":"platform/biostar_air/elevator-set-floor-access","title":"階別アクセス権の設定","description":"エレベーターを登録し、ユーザーやグループごとにアクセス可能な階を設定してください。 階レベルを定義し、スケジュールと休日ポリシーを適用して、階ごとの入退室を制御します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/elevator-set-floor-aceess.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/elevator-set-floor-access","permalink":"/docs/ja/platform/biostar_air/elevator-set-floor-access","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/elevator-set-floor-aceess.mdx","tags":[],"version":"current","frontMatter":{"id":"elevator-set-floor-access","title":"階別アクセス権の設定","description":"エレベーターを登録し、ユーザーやグループごとにアクセス可能な階を設定してください。 階レベルを定義し、スケジュールと休日ポリシーを適用して、階ごとの入退室を制御します。","keywords":["階ごとのアクセス権","エレベーター","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"エレベーター管理","permalink":"/docs/ja/platform/biostar_air/elevator-add-edit-delete"},"next":{"title":"アクセス権限","permalink":"/docs/ja/platform/biostar_air/manage-access-authority"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/elevator-set-floor-aceess.mdx
