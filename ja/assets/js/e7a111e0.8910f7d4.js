...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_troubleshooting_adding_users_in_bulk_mdx_e7a_namespaceObject = JSON.parse('{"id":"platform/biostar_air/troubleshooting-adding-users-in-bulk","title":"Fix Bulk User Addition Issues","description":"Learn how to troubleshoot common issues when adding users in bulk with the BioStar Air portal.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/troubleshooting-adding-users-in-bulk","permalink":"/docs/ja/platform/biostar_air/troubleshooting-adding-users-in-bulk","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/troubleshooting-adding-users-in-bulk.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting-adding-users-in-bulk","title":"Fix Bulk User Addition Issues","description":"Learn how to troubleshoot common issues when adding users in bulk with the BioStar Air portal.","keywords":["Troubleshooting","bulk users","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Troubleshooting","permalink":"/docs/ja/platform/biostar_air/troubleshooting"},"next":{"title":"Fix Mobile Card Issues","permalink":"/docs/ja/platform/biostar_air/troubleshooting-suprema-pass-app"}}')
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["If you need to include additional fields (for example, employee ID or department), use the ", (0,jsx_runtime.jsx)(Cmd, {
            sid: "user_setting_templ_action",
            product: "air"
          }), "(", (0,jsx_runtime.jsx)(IcAirUtemplate, {}), ") feature at the top of the user list to add them. When a field is added, the downloaded CSV file automatically includes the corresponding column."]
        }), "\n"]
      }), "\n"]
