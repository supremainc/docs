...
var site_docs_platform_biostar_air_site_management_mdx_8a6_namespaceObject = JSON.parse('{"id":"platform/biostar_air/site-management","title":"사이트 관리하기","description":"BioStar Air에서 사이트는 출입 통제 시스템의 핵심 단위로, 사용자가 출입할 수 있는 물리적 위치를 의미합니다. 각 사이트는 고유한 설정, 사용자, 장치 및 접근 권한을 가질 수 있습니다. 관리자는 여러 사이트를 생성하고 관리하여 다양한 위치에서 출입 통제를 효율적으로 운영할 수 있습니다.","source":"@site/docs/platform/biostar_air/site-management.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/site-management","permalink":"/docs/ja/platform/biostar_air/site-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/site-management.mdx","tags":[],"version":"current","frontMatter":{"id":"site-management","title":"사이트 관리하기","description":"BioStar Air에서 사이트는 출입 통제 시스템의 핵심 단위로, 사용자가 출입할 수 있는 물리적 위치를 의미합니다. 각 사이트는 고유한 설정, 사용자, 장치 및 접근 권한을 가질 수 있습니다. 관리자는 여러 사이트를 생성하고 관리하여 다양한 위치에서 출입 통제를 효율적으로 운영할 수 있습니다.","keywords":["BioStar Air","사이트 관리","출입 통제"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"모바일 앱에서 장치 관리하기","permalink":"/docs/ja/platform/biostar_air/manage-device-with-app"},"next":{"title":"사용자 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-users"}}')
