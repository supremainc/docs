  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["CSVファイルのインポート機能を使用して複数ユーザーの顔を一括登録したり、複数ユーザーにメールで顔登録リンクを送信してモバイルデバイスで直接顔を登録することもできます。 詳細については", (0,jsx_runtime.jsx)(_components.a, {
