"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["93164"], {
...
45327: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_2_getting_started_mdx_562_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-bioentry-w-2-getting-started-mdx-562.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_bioentry_w_2_getting_started_mdx_562_namespaceObject = JSON.parse('{"id":"device/bioentry_w2/getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w2/getting-started.mdx","sourceDirName":"device/bioentry_w2","slug":"/device/bioentry_w2/getting-started","permalink":"/docs/ja/device/bioentry_w2/getting-started","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/bioentry_w2/getting-started.mdx","tags":[],"version":"current","frontMatter":{"id":"getting-started","title":"はじめに","description":"デバイスを使用するための初期手順を案内します。","keywords":["同梱物","名称","機能","ケーブル","コネクター"],"isTranslationMissing":false},"sidebar":"bioentryw2","previous":{"title":"安全のための注意事項","permalink":"/docs/ja/device/bioentry_w2/safety-instructions"},"next":{"title":"インストール","permalink":"/docs/ja/device/bioentry_w2/installation"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/bioentry_w2/getting-started.mdx
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "緑色／白色が点滅：Suprema Airfob Pass (BLE) アプリケーションと接続中"
            }), "\n"]
          }), "\n"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: "電源 / イーサネット + PoE / RS-485 / Wiegand 入出力 / Input / リレー"
        }), "\n"]
      }), "\n"]
