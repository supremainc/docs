...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_api_user_management_mdx_93e_namespaceObject = JSON.parse('{"id":"platform/biostar_air/api-user-management","title":"Using the User Management API","description":"This guide explains how to create, update, and deactivate users using the BioStar Air API, outlines the recommended integration scope, and includes Python sample code.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/api-user-management.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/api-user-management","permalink":"/docs/ja/platform/biostar_air/api-user-management","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/api-user-management.mdx","tags":[],"version":"current","frontMatter":{"id":"api-user-management","title":"Using the User Management API","description":"This guide explains how to create, update, and deactivate users using the BioStar Air API, outlines the recommended integration scope, and includes Python sample code.","keywords":["User Management","API","BioStar Air","Python sample code"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"API Authentication","permalink":"/docs/ja/platform/biostar_air/api-authentication"},"next":{"title":"Troubleshooting","permalink":"/docs/ja/platform/biostar_air/troubleshooting"}}')
