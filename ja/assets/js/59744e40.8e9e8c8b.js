...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_securemodule_index_mdx_597_namespaceObject = JSON.parse('{"id":"device/securemodule/index","title":"セキュアモジュール","description":"Secure Moduleは、外部ドアリレー1系統の制御と入出力拡張のための分離型コントローラーです。 SupremaのIP入退室管理端末と暗号化通信を行うことでセキュリティを強化でき、利用環境に最適化されたソリューションを提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/securemodule/index.mdx","sourceDirName":"device/securemodule","slug":"/device/securemodule/","permalink":"/docs/ja/device/securemodule/","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/securemodule/index.mdx","tags":[],"version":"current","frontMatter":{"title":"セキュアモジュール","description":"Secure Moduleは、外部ドアリレー1系統の制御と入出力拡張のための分離型コントローラーです。 SupremaのIP入退室管理端末と暗号化通信を行うことでセキュリティを強化でき、利用環境に最適化されたソリューションを提供します。","keywords":["セキュアモジュール","分離型コントローラー"],"isTranslationMissing":false},"sidebar":"securemodule","next":{"title":"安全のための注意事項","permalink":"/docs/ja/device/securemodule/safety-instructions"}}')
