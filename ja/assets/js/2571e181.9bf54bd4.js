...
var site_docs_platform_biostar_air_managing_registered_doors_mdx_257_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-registered-doors","title":"등록 출입문 관리하기","description":"등록된 출입문에 입출입 장치를 할당하고 릴레이를 설정하여 출입 스케줄을 관리합니다. 보안, 화재 대피, 근태 관리를 위해 출입을 통제할 수 있습니다.","source":"@site/docs/platform/biostar_air/managing-registered-doors.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-registered-doors","permalink":"/docs/ja/platform/biostar_air/managing-registered-doors","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-registered-doors.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-registered-doors","title":"등록 출입문 관리하기","description":"등록된 출입문에 입출입 장치를 할당하고 릴레이를 설정하여 출입 스케줄을 관리합니다. 보안, 화재 대피, 근태 관리를 위해 출입을 통제할 수 있습니다.","keywords":["출입문 관리","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"출입문","permalink":"/docs/ja/platform/biostar_air/manage-door"},"next":{"title":"출입문 그룹 관리하기","permalink":"/docs/ja/platform/biostar_air/managing-door-groups"}}')
