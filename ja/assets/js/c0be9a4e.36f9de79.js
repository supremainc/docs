...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_integration_quickstart_mdx_c0b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/integration-quickstart","title":"Quick Start","description":"This guide shows how to set up the BioStar Air demo environment, register compatible devices, and generate API keys.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/integration-quickstart.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/integration-quickstart","permalink":"/docs/ja/platform/biostar_air/integration-quickstart","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/integration-quickstart.mdx","tags":[],"version":"current","frontMatter":{"id":"integration-quickstart","title":"Quick Start","description":"This guide shows how to set up the BioStar Air demo environment, register compatible devices, and generate API keys.","keywords":["API Integration","Quick start","BioStar Air","Demo"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Developer","permalink":"/docs/ja/platform/biostar_air/developer-guide"},"next":{"title":"API Authentication","permalink":"/docs/ja/platform/biostar_air/api-authentication"}}')
