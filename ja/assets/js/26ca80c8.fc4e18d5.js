...
var site_docs_device_vionyx_webserver_upload_audio_clips_mdx_26c_namespaceObject = JSON.parse('{"id":"device/vionyx_webserver/upload-audio-clips","title":"오디오 클립 업로드하기","description":"경보음 및 안내음으로 사용할 오디오 파일을 업로드하고 관리하는 방법을 안내합니다.","source":"@site/docs/device/vionyx_webserver/upload-audio-clips.mdx","sourceDirName":"device/vionyx_webserver","slug":"/device/vionyx_webserver/upload-audio-clips","permalink":"/docs/ja/device/vionyx_webserver/upload-audio-clips","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/vionyx_webserver/upload-audio-clips.mdx","tags":[],"version":"current","frontMatter":{"id":"upload-audio-clips","title":"오디오 클립 업로드하기","description":"경보음 및 안내음으로 사용할 오디오 파일을 업로드하고 관리하는 방법을 안내합니다.","keywords":["오디오","클립","업로드","WAV","음성","경보음"],"isTranslationMissing":true},"sidebar":"aicamwebserver","previous":{"title":"카메라 유지 관리하기","permalink":"/docs/ja/device/vionyx_webserver/manage-device"},"next":{"title":"관리자 계정 비밀번호 업데이트하기","permalink":"/docs/ja/device/vionyx_webserver/update-admin-password"}}')
