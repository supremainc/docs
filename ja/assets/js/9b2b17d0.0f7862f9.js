"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["73035"], {
...
18225: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_biostation_3_max_installation_mdx_9b2_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-biostation-3-max-installation-mdx-9b2.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_biostation_3_max_installation_mdx_9b2_namespaceObject = JSON.parse('{"id":"device/biostation_3_max/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/biostation_3_max/installation.mdx","sourceDirName":"device/biostation_3_max","slug":"/device/biostation_3_max/installation","permalink":"/docs/ja/device/biostation_3_max/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/biostation_3_max/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"biostation3max","previous":{"title":"はじめに","permalink":"/docs/ja/device/biostation_3_max/getting-started"},"next":{"title":"使用","permalink":"/docs/ja/device/biostation_3_max/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/biostation_3_max/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "本書では、BS3M-ODB、BS3M-OAPBモデルの形状を基準に設置方法を説明します。 BS3M-DB、BS3M-APBモデルも同じ方法で設置してください。"
      })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ケーブルカバーを取り付けた後、カバーに差し込まれている6本のネジを締めてしっかり固定し、固定されたブラケットの上に製品を取り付けてください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
