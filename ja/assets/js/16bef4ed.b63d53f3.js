...
var site_docs_platform_biostar_air_elevator_add_edit_delete_mdx_16b_namespaceObject = JSON.parse('{"id":"platform/biostar_air/elevator-add-edit-delete","title":"엘리베이터 관리하기","description":"엘리베이터 출입 통제를 구성하여 층별 접근을 관리합니다. OM-120 모듈을 장치에 연결하고, 층 버튼 릴레이를 설정한 후 접근 스케줄을 관리합니다.","source":"@site/docs/platform/biostar_air/elevator-add-edit-delete.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/elevator-add-edit-delete","permalink":"/docs/ja/platform/biostar_air/elevator-add-edit-delete","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/elevator-add-edit-delete.mdx","tags":[],"version":"current","frontMatter":{"id":"elevator-add-edit-delete","title":"엘리베이터 관리하기","description":"엘리베이터 출입 통제를 구성하여 층별 접근을 관리합니다. OM-120 모듈을 장치에 연결하고, 층 버튼 릴레이를 설정한 후 접근 스케줄을 관리합니다.","keywords":["엘리베이터","층별 출입 통제","OM-120","BioStar Air"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"엘리베이터","permalink":"/docs/ja/platform/biostar_air/manage-elevator"},"next":{"title":"층별 출입 권한 설정","permalink":"/docs/ja/platform/biostar_air/elevator-set-floor-access"}}')
