"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["73392"], {
...
19012: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_d_2_installation_mdx_f99_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-xpass-d-2-installation-mdx-f99.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xpass_d_2_installation_mdx_f99_namespaceObject = JSON.parse('{"id":"device/xpass_d2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_d2/installation.mdx","sourceDirName":"device/xpass_d2","slug":"/device/xpass_d2/installation","permalink":"/docs/ja/device/xpass_d2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xpass_d2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xpassd2","previous":{"title":"はじめに","permalink":"/docs/ja/device/xpass_d2/getting-started"},"next":{"title":"製品仕様","permalink":"/docs/ja/device/xpass_d2/product-specifications"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/xpass_d2/installation.mdx
...
const toc = [{
  ...
  "value": "Wiegandおよびその他のケーブル接続",
  "id": "wiegandおよびその他のケーブル接続",
  "level": 2
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "本製品はマスター装置またはCoreStationに接続することで、RFIDカードやモバイルカードリーダーとして使用できます。"
    }), "\n", (0,jsx_runtime.jsx)(Image, {
