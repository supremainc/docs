...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_manage_access_level_mdx_c73_namespaceObject = JSON.parse('{"id":"platform/biostar_air/manage-access-level","title":"Manage Access Levels","description":"Create and manage access levels in BioStar Air.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/manage-access-level.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/manage-access-level","permalink":"/docs/ja/platform/biostar_air/manage-access-level","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/manage-access-level.mdx","tags":[],"version":"current","frontMatter":{"id":"manage-access-level","title":"Manage Access Levels","description":"Create and manage access levels in BioStar Air.","keywords":["access level","Manage","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Manage Schedules","permalink":"/docs/ja/platform/biostar_air/manage-schedule"},"next":{"title":"Manage Floor Levels","permalink":"/docs/ja/platform/biostar_air/manage-floor-level"}}')
