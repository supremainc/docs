...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_federated_sites_mdx_a2c_namespaceObject = JSON.parse('{"id":"platform/biostar_air/federated-sites","title":"Manage Federated Sites","description":"Set up and manage federated sites in BioStar Air for multi-tenant buildings and multi-branch organizations through centralized control.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/federated-sites.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/federated-sites","permalink":"/docs/ja/platform/biostar_air/federated-sites","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/federated-sites.mdx","tags":[],"version":"current","frontMatter":{"id":"federated-sites","title":"Manage Federated Sites","description":"Set up and manage federated sites in BioStar Air for multi-tenant buildings and multi-branch organizations through centralized control.","keywords":["federated","sites","BioStar Air"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Use the Partner Portal","permalink":"/docs/ja/platform/biostar_air/biostar-air-partner-portal-detailed-use"},"next":{"title":"Hardware Setup","permalink":"/docs/ja/platform/biostar_air/hardware-setup"}}')
