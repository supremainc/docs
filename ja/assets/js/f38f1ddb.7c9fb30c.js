...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_x_monitoring_device_mdx_f38_namespaceObject = JSON.parse('{"id":"platform/biostar_x/monitoring-device","title":"デバイスをモニタリングする","description":"すべてのエリアとドアに接続されたデバイスとカメラをリアルタイムでモニタリングします。 デバイスとカメラの状態チェック、詳細情報の確認、カメラ映像の再生など、さまざまな機能で効率的に管理できます。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_x/monitoring-device.mdx","sourceDirName":"platform/biostar_x","slug":"/platform/biostar_x/monitoring-device","permalink":"/docs/ja/platform/biostar_x/monitoring-device","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_x/monitoring-device.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-device","title":"デバイスをモニタリングする","description":"すべてのエリアとドアに接続されたデバイスとカメラをリアルタイムでモニタリングします。 デバイスとカメラの状態チェック、詳細情報の確認、カメラ映像の再生など、さまざまな機能で効率的に管理できます。","keywords":["モニタリング","デバイス","カメラ"],"isTranslationMissing":false},"sidebar":"biostarx","previous":{"title":"マップをモニタリングする","permalink":"/docs/ja/platform/biostar_x/monitoring-map"},"next":{"title":"ビデオをモニタリングする","permalink":"/docs/ja/platform/biostar_x/monitoring-video"}}')
...
const frontMatter = {
	...
	title: 'デバイスをモニタリングする',
	description: 'すべてのエリアとドアに接続されたデバイスとカメラをリアルタイムでモニタリングします。 デバイスとカメラの状態チェック、詳細情報の確認、カメラ映像の再生など、さまざまな機能で効率的に管理できます。',
	keywords: [
		'モニタリング',
		'デバイス',
		'カメラ'
