"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["19590"], {
...
7540: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xstation_2_installation_mdx_992_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-xstation-2-installation-mdx-992.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_xstation_2_installation_mdx_992_namespaceObject = JSON.parse('{"id":"device/xstation_2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/xstation_2/installation.mdx","sourceDirName":"device/xstation_2","slug":"/device/xstation_2/installation","permalink":"/docs/ja/device/xstation_2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/xstation_2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"xstation2","previous":{"title":"はじめに","permalink":"/docs/ja/device/xstation_2/getting-started"},"next":{"title":"使用","permalink":"/docs/ja/device/xstation_2/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/xstation_2/installation.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      type: "info",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "本書では XS2-ODPB と XS2-OAPB モデルの形状を基準にして取り付け方法を説明します。 XS2-DPB、XS2-APB、XS2-QDPB、XS2-QAPB モデルの場合も同じ方法で取り付けてください。"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "付属のドリル用テンプレートを使用して、製品を設置する位置を決めます。 製品を取り付ける位置にブラケットを固定ネジでしっかり固定してください。"
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "ケーブルカバーを取り付けた後、カバーに差し込まれている4本のネジを回してしっかり固定し、固定したブラケットの上に製品を取り付けてください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
