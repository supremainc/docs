"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["6131"], {
...
6523: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_facestation_2_installation_mdx_d03_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-device-facestation-2-installation-mdx-d03.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_device_facestation_2_installation_mdx_d03_namespaceObject = JSON.parse('{"id":"device/facestation_2/installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/device/facestation_2/installation.mdx","sourceDirName":"device/facestation_2","slug":"/device/facestation_2/installation","permalink":"/docs/ja/device/facestation_2/installation","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/device/facestation_2/installation.mdx","tags":[],"version":"current","frontMatter":{"id":"installation","title":"インストール","description":"インストールに必要な全手順と接続例を提供します。","keywords":["ブラケット","電源","ネットワーク","入力","リレー","スタンドアロン","Secure I/O","Wiegand"],"isTranslationMissing":false},"sidebar":"facestation2","previous":{"title":"はじめに","permalink":"/docs/ja/device/facestation_2/getting-started"},"next":{"title":"使用","permalink":"/docs/ja/device/facestation_2/using-device"}}')
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/device/facestation_2/installation.mdx
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "付属のドリル用テンプレートを使用して、製品を設置する位置を決めます。"
      ...
      children: "本製品は、専用チルトブラケットを使用して、認証時に角度調整が可能となるように設置できます。 専用チルトブラケットは別売品です。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "付属のドリル用テンプレートを使用して、製品を設置する位置を決めます。"
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "製品を取り付ける位置に、チルトブラケット固定用ネジを使用してチルトブラケットをしっかり固定してください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "チルトブラケットの上にブラケットをしっかり固定してください。"
        }), "\n", (0,jsx_runtime.jsx)(Image, {
