...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_reference_compares_controller_devices_specs_mdx_b7f_namespaceObject = JSON.parse('{"id":"reference/compares/controller-devices-specs","title":"仕様比較","description":"\\\\* 指紋センサー付きデバイスをスレーブとして接続すると、そのスレーブデバイスで指紋を認証できます。","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/reference/compares/controller-devices-specs.mdx","sourceDirName":"reference/compares","slug":"/reference/compares/controller-devices-specs","permalink":"/docs/ja/reference/compares/controller-devices-specs","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/reference/compares/controller-devices-specs.mdx","tags":[],"version":"current","frontMatter":{"id":"controller-devices-specs","title":"仕様比較","hide_table_of_contents":true,"isTranslationMissing":false},"sidebar":"reference","previous":{"title":"機能比較","permalink":"/docs/ja/reference/compares/controller-devices-funcs"},"next":{"title":"How to Issue Suprema Smart Cards","permalink":"/docs/ja/reference/smartcardissue"}}')
...
const contentTitle = 'インテリジェントコントローラーと周辺機器の仕様比較';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "インテリジェントコントローラーと周辺機器の仕様比較",
        children: "インテリジェントコントローラーと周辺機器の仕様比較"
      })
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: "** Input またはスーパーバイズド入力を選択できます。"
      })]
