...
var site_docs_platform_biostar_air_service_configuration_mdx_275_namespaceObject = JSON.parse('{"id":"platform/biostar_air/service-configuration","title":"서비스 구성하기","description":"일광 절약 시간, 이메일 템플릿, 알림·리포트, 커스텀 Wiegand 카드 형식, 근태 관리 등 BioStar Air 서비스 운영에 필요한 세부 기능을 구성하는 방법을 안내합니다.","source":"@site/docs/platform/biostar_air/service-configuration.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/service-configuration","permalink":"/docs/ja/platform/biostar_air/service-configuration","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/service-configuration.mdx","tags":[],"version":"current","frontMatter":{"id":"service-configuration","title":"서비스 구성하기","description":"일광 절약 시간, 이메일 템플릿, 알림·리포트, 커스텀 Wiegand 카드 형식, 근태 관리 등 BioStar Air 서비스 운영에 필요한 세부 기능을 구성하는 방법을 안내합니다.","keywords":["서비스 구성","BioStar Air","일광 절약 시간","이메일 템플릿","알림","리포트","Wiegand 카드","근태 관리"],"isTranslationMissing":true},"sidebar":"biostar_air","previous":{"title":"계정 설정하기","permalink":"/docs/ja/platform/biostar_air/account-settings"},"next":{"title":"일광 절약 시간(DST) 구성하기","permalink":"/docs/ja/platform/biostar_air/daylight-saving-time"}}')
