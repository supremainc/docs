...
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_managing_card_templates_mdx_270_namespaceObject = JSON.parse('{"id":"platform/biostar_air/managing-card-templates","title":"Manage Card Templates","description":"Create, customize, and manage mobile card templates in BioStar Air using branding elements such as logos, colors, and user attributes.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/managing-card-templates.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/managing-card-templates","permalink":"/docs/ja/platform/biostar_air/managing-card-templates","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/managing-card-templates.mdx","tags":[],"version":"current","frontMatter":{"id":"managing-card-templates","title":"Manage Card Templates","description":"Create, customize, and manage mobile card templates in BioStar Air using branding elements such as logos, colors, and user attributes.","keywords":["card template","BioStar Air","User Management"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Manage User Groups","permalink":"/docs/ja/platform/biostar_air/managing-user-groups"},"next":{"title":"User Card and Credential Types","permalink":"/docs/ja/platform/biostar_air/user-card-types"}}')
