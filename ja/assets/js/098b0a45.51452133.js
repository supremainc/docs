"use strict";
(self["webpackChunksuprema_docs"] = self["webpackChunksuprema_docs"] || []).push([["18589"], {
21364: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_diff_unlock_lock_schedule_mdx_098_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-ja-docusaurus-plugin-content-docs-current-platform-biostar-air-diff-unlock-lock-schedule-mdx-098.json
var site_i_18_n_ja_docusaurus_plugin_content_docs_current_platform_biostar_air_diff_unlock_lock_schedule_mdx_098_namespaceObject = JSON.parse('{"id":"platform/biostar_air/diff-unlock-lock-schedule","title":"Difference Between Unlock and Lock Schedules","description":"Compare the differences between unlock and lock schedules in BioStar Air and learn when to use each one.","source":"@site/i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/diff-unlock-lock-schedule.mdx","sourceDirName":"platform/biostar_air","slug":"/platform/biostar_air/diff-unlock-lock-schedule","permalink":"/docs/ja/platform/biostar_air/diff-unlock-lock-schedule","draft":false,"unlisted":false,"editUrl":"https://github.com/supremainc/docs/tree/main/docs/platform/biostar_air/diff-unlock-lock-schedule.mdx","tags":[],"version":"current","frontMatter":{"id":"diff-unlock-lock-schedule","title":"Difference Between Unlock and Lock Schedules","description":"Compare the differences between unlock and lock schedules in BioStar Air and learn when to use each one.","keywords":["Unlock schedule","Lock schedule","Schedule","Access control"],"isTranslationMissing":false},"sidebar":"biostar_air","previous":{"title":"Troubleshoot Video Playback Issues","permalink":"/docs/ja/platform/biostar_air/video-troubleshooting"},"next":{"title":"v2.11","permalink":"/docs/ja/platform/biostar_air/release-notes/v2_11"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(84429);
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/platform/biostar_air/diff-unlock-lock-schedule.mdx
